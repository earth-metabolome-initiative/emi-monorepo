...
pub enum PhysicalAssetExtensionAttribute {
    Asset(crate::codegen::structs_codegen::tables::insertables::AssetAttribute),
}
impl core::fmt::Display for PhysicalAssetExtensionAttribute {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            Self::Asset(e) => write!(f, "physical_assets({e})"),
        }
    }
}
impl From<crate::codegen::structs_codegen::tables::insertables::AssetAttribute>
    for PhysicalAssetExtensionAttribute
{
    fn from(
...
impl From<common_traits::builder::EmptyTuple> for PhysicalAssetExtensionAttribute {
...
#[derive(Copy, Clone, PartialEq, Eq, PartialOrd, Ord, Hash, core::fmt::Debug)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub enum PhysicalAssetAttribute {
    Extension(PhysicalAssetExtensionAttribute),
    Id,
    Model,
}
impl core::str::FromStr for PhysicalAssetAttribute {
...
impl<T1> common_traits::builder::Attributed
    for crate::codegen::structs_codegen::tables::insertables::InsertablePhysicalAssetBuilder<T1>
{
    type Attribute = PhysicalAssetAttribute;
}
impl web_common_traits::database::TableField for PhysicalAssetAttribute {}
impl web_common_traits::database::HasTableType for PhysicalAssetAttribute {
    type Table = crate::codegen::tables::table_names::TableName;
}
impl
    web_common_traits::database::FromExtension<
        crate::codegen::structs_codegen::tables::insertables::AssetAttribute,
    > for PhysicalAssetAttribute
{
    fn from_extension(
        attribute: crate::codegen::structs_codegen::tables::insertables::AssetAttribute,
    ) -> Self {
        PhysicalAssetAttribute::Extension(From::from(attribute))
    }
}
...
impl core::fmt::Display for PhysicalAssetAttribute {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            Self::Extension(e) => write!(f, "{e}"),
            Self::Id => write!(f, "physical_assets.id"),
            Self::Model => write!(f, "physical_assets.model"),
        }
    }
}
#[derive(Debug)]
...
///
/// ```rust,ignore
/// use core_structures::PhysicalAsset;
/// use core_structures::tables::insertables::AssetSettable;
/// use core_structures::tables::insertables::PhysicalAssetSettable;
/// use web_common_traits::database::Insertable;
/// use web_common_traits::database::InsertableVariant;
///
/// let physical_asset = PhysicalAsset::new()
...
impl<Asset> diesel::associations::HasTable for InsertablePhysicalAssetBuilder<Asset> {
    type Table = crate::codegen::diesel_codegen::tables::physical_assets::physical_assets::table;
    fn table() -> Self::Table {
        crate::codegen::diesel_codegen::tables::physical_assets::physical_assets::table
    }
}
impl From<InsertablePhysicalAssetBuilder>
    for web_common_traits::database::IdOrBuilder<
        ::rosetta_uuid::Uuid,
        InsertablePhysicalAssetBuilder,
    >
{
    fn from(builder: InsertablePhysicalAssetBuilder) -> Self {
...
/// descendant tables.
pub trait PhysicalAssetSettable: Sized {
...
impl<
    Asset: crate::codegen::structs_codegen::tables::insertables::AssetSettable<
            ...
            >,
        >,
> PhysicalAssetSettable for InsertablePhysicalAssetBuilder<Asset>
where
    ...
    >,
{
    ...
    where
        ...
        >,
    {
        self.id = <Asset as crate::codegen::structs_codegen::tables::insertables::AssetSettable>::id(
                self.id,
                id,
            )
            .map_err(|e| {
    ...
    {
        self.id = <Asset as crate::codegen::structs_codegen::tables::insertables::AssetSettable>::name(
                self.id,
                name,
            )
            .map_err(|e| {
    ...
    where
        M: web_common_traits::database::PrimaryKeyLike<PrimaryKey = i32>,
    {
        <Self as PhysicalAssetSettable>::model(self, model)
    }
    #[inline]
...
where
    Self: web_common_traits::database::DispatchableInsertableVariant<
            ...
            Error = web_common_traits::database::InsertError<PhysicalAssetAttribute>,
        > + web_common_traits::database::SetPrimaryKey<PrimaryKey = ::rosetta_uuid::Uuid>
        + common_traits::builder::IsCompleteBuilder,
{
    type Error = web_common_traits::database::InsertError<PhysicalAssetAttribute>;
