...
pub struct DisposalStepModelForeignKeys {
...
{
    type ForeignKeys = DisposalStepModelForeignKeys;
...
impl web_common_traits::prelude::ForeignKeys for DisposalStepModelForeignKeys {}
