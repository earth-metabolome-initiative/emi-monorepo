...
impl From<common_traits::builder::EmptyTuple> for CommercialCapLotExtensionAttribute {
...
impl web_common_traits::database::TableField for CommercialCapLotAttribute {}
impl web_common_traits::database::HasTableType for CommercialCapLotAttribute {
    ...
    > for CommercialCapLotAttribute
{
    fn from_extension(
        ...
        CommercialCapLotAttribute::Extension(From::from(attribute))
    }
}
impl
    web_common_traits::database::FromExtension<
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct InsertableCommercialCapLot {
    pub(crate) id: i32,
    pub(crate) product_model: i32,
}
impl InsertableCommercialCapLot {
...
/// [`CommercialCapLot`](crate::codegen::structs_codegen::tables::commercial_cap_lots::CommercialCapLot).
///
///
...
///
/// ```rust,ignore
/// use core_structures::CommercialCapLot;
/// use core_structures::tables::insertables::AssetModelSettable;
/// use core_structures::tables::insertables::CommercialCapLotSettable;
/// use core_structures::tables::insertables::CommercialProductLotSettable;
/// use web_common_traits::database::Insertable;
/// use web_common_traits::database::InsertableVariant;
///
/// let commercial_cap_lot = CommercialCapLot::new()
...
impl<CommercialProductLot, CapModel> common_traits::builder::IsCompleteBuilder
    for crate::codegen::structs_codegen::tables::insertables::InsertableCommercialCapLotBuilder<
        CommercialProductLot,
        CapModel,
    >
...
pub trait CommercialCapLotSettable: Sized {
    ...
    ///   `public.commercial_cap_lots.product_model` column.
    ///
    /// # Implementation details
    ...
    >,
{
        ...
        PM: web_common_traits::database::PrimaryKeyLike<PrimaryKey = i32>,
    {
        ...
        self.commercial_cap_lots_id_fkey = <CommercialProductLot as crate::codegen::structs_codegen::tables::insertables::CommercialProductLotSettable>::product_model(
    ...
    >,
{
    ...
    {
        self.commercial_cap_lots_id_fkey = <CommercialProductLot as crate::codegen::structs_codegen::tables::insertables::CommercialProductLotSettable>::lot(
                self.commercial_cap_lots_id_fkey,
                lot,
            )
            .map_err(|e| {
    ...
    where
        PM: web_common_traits::database::PrimaryKeyLike<PrimaryKey = i32>,
    {
        <Self as CommercialCapLotSettable>::product_model(self, product_model)
    }
}
impl<
    CommercialProductLot,
    ...
    >,
{
    ...
    where
        PM: web_common_traits::database::MaybePrimaryKeyLike<PrimaryKey = i32>,
    {
        <Self as CommercialCapLotSettable>::product_model(
            self,
...
impl<CommercialProductLot, CapModel> web_common_traits::database::MostConcreteTable
    for InsertableCommercialCapLotBuilder<CommercialProductLot, CapModel>
where
    ...
    CapModel: web_common_traits::database::MostConcreteTable,
{
    fn set_most_concrete_table(&mut self, table_name: &str) {
        self.commercial_cap_lots_id_fkey.set_most_concrete_table(table_name);
        self.commercial_cap_lots_id_fkey1.set_most_concrete_table(table_name);
    }
}
impl<CommercialProductLot, CapModel> web_common_traits::prelude::SetPrimaryKey
    for InsertableCommercialCapLotBuilder<CommercialProductLot, CapModel>
where
    ...
    CapModel: web_common_traits::prelude::SetPrimaryKey<PrimaryKey = i32>,
{
    ...
    fn set_primary_key(mut self, primary_key: Self::PrimaryKey) -> Self {
        self.commercial_cap_lots_id_fkey =
            self.commercial_cap_lots_id_fkey.set_primary_key(primary_key);
        self.commercial_cap_lots_id_fkey1 =
            self.commercial_cap_lots_id_fkey1.set_primary_key(primary_key);
        self
    }
}
...
{
    type Error = web_common_traits::database::InsertError<CommercialCapLotAttribute>;
