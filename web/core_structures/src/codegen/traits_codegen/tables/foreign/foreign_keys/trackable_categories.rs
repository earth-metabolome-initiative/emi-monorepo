...
pub struct TrackableCategoryForeignKeys {
...
{
    type ForeignKeys = TrackableCategoryForeignKeys;
...
impl web_common_traits::prelude::ForeignKeys for TrackableCategoryForeignKeys {}
