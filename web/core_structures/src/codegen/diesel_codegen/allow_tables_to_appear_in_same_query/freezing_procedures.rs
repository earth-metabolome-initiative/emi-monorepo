use crate::codegen::diesel_codegen::tables::{
    asset_compatibility_rules::asset_compatibility_rules, freezing_procedures::freezing_procedures,
};
diesel::allow_tables_to_appear_in_same_query!(freezing_procedures, asset_compatibility_rules);
...
diesel::allow_tables_to_appear_in_same_query!(freezing_procedures, procedure_asset_models);
use crate::codegen::diesel_codegen::tables::procedure_template_asset_models::procedure_template_asset_models;
diesel::allow_tables_to_appear_in_same_query!(freezing_procedures, procedure_template_asset_models);
...
diesel::allow_tables_to_appear_in_same_query!(freezing_procedures, volumetric_container_models);
