...
impl crate::database::Tabular for NestedNotification {
    const TABLE: crate::database::Table = crate::database::Table::Notifications;
}
impl crate::database::Filtrable for NestedNotification {
    type Filter = crate::database::filter_variants::NotificationFilter;
}
impl crate::database::Describable for NestedNotification {
    fn description(&self) -> Option<&str> {
        self.inner.description()
    }
}
impl crate::database::Colorable for NestedNotification {
    fn color(&self) -> Option<&str> {
        None
    }
}
#[cfg(feature = "frontend")]
impl crate::database::AllRecords for NestedNotification {
...
impl NestedNotification {
    ...
    pub(crate) async fn from_flat(
        flat_variant: crate::database::flat_variants::Notification,
    ...
    pub async fn get<C: gluesql::core::store::GStore + gluesql::core::store::GStoreMut>(
        ...
        if let Some(flat_variant) =
            crate::database::flat_variants::Notification::get(id, connection).await?
        {
    ...
    >(
        ...
        crate::database::flat_variants::Notification::delete_from_id(id, connection).await
    }
    ...
    pub async fn all<C: gluesql::core::store::GStore + gluesql::core::store::GStoreMut>(
        ...
        for flat_variant in
            crate::database::flat_variants::Notification::all(filter, limit, offset, connection)
                .await?
                .into_iter()
        {
            notifications.push(Self::from_flat(flat_variant, connection).await?);
        }
        Ok(notifications)
    }
    ...
    >(
        ...
        .await?;
        crate::database::flat_variants::Notification::update_or_insert(
            self.inner.as_ref(),
            connection,
        )
        .await
