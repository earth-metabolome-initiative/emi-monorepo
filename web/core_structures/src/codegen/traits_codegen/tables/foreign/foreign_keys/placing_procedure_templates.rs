...
pub struct PlacingProcedureTemplateForeignKeys {
...
for crate::codegen::structs_codegen::tables::placing_procedure_templates::PlacingProcedureTemplate {
    type ForeignKeys = PlacingProcedureTemplateForeignKeys;
        ...
        match (row, crud) {
            (
                ...
                if self.procedure_template
                    == geolocation_procedure_templates.procedure_template
                {
                    foreign_keys.procedure_template = Some(
                        geolocation_procedure_templates,
                    );
                    updated = true;
                }
...
impl web_common_traits::prelude::ForeignKeys for PlacingProcedureTemplateForeignKeys {}
