impl super::Rows {
    pub fn len(&self) -> usize {
        match self {
            ...
            super::Rows::CommercialBeadsLot(rows) => rows.len(),
            super::Rows::CommercialBeadsModel(rows) => rows.len(),
            ...
            super::Rows::SharedProcedureTemplateAssetModel(rows) => rows.len(),
