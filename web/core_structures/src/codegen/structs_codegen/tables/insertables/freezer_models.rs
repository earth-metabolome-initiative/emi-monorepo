...
pub enum InsertableFreezerModelExtensionAttributes {
    Trackable(crate::codegen::structs_codegen::tables::insertables::InsertableTrackableAttributes),
}
impl core::fmt::Display for InsertableFreezerModelExtensionAttributes {
...
#[derive(Copy, Clone, PartialEq, Eq, PartialOrd, Ord, Hash, core::fmt::Debug)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub enum InsertableFreezerModelAttributes {
    Extension(InsertableFreezerModelExtensionAttributes),
    Id,
}
impl From<crate::codegen::structs_codegen::tables::insertables::InsertableTrackableAttributes>
    for InsertableFreezerModelAttributes
{
    fn from(
        trackables: crate::codegen::structs_codegen::tables::insertables::InsertableTrackableAttributes,
    ) -> Self {
        Self::Extension(InsertableFreezerModelExtensionAttributes::Trackable(trackables))
    }
}
impl core::str::FromStr for InsertableFreezerModelAttributes {
...
impl core::fmt::Display for InsertableFreezerModelAttributes {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
...
for InsertableFreezerModelBuilder<Trackable>
where
    ...
    >,
{
    type Attributes = InsertableFreezerModelAttributes;
    fn extend_builder(
        mut self,
        other: Self,
        ...
        self.id = self
            ...
            .map_err(|err| {
                err.into_field_name(|attribute| InsertableFreezerModelAttributes::Extension(
                    InsertableFreezerModelExtensionAttributes::Trackable(attribute),
                ))
            })?;
        Ok(self)
    }
    ...
    >
{
    ...
    ) -> Result<Self, web_common_traits::database::InsertError<InsertableFreezerModelAttributes>>
    where
    ...
    >
{
    ...
    /// columns from table `freezer_models`.
...
where
    Self: web_common_traits::database::InsertableVariant<
            ...
            Error = web_common_traits::database::InsertError<InsertableFreezerModelAttributes>,
        >,
