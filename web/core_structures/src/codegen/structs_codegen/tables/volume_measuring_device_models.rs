...
impl web_common_traits::prelude::TableName for VolumeMeasuringDeviceModel {
    const TABLE_NAME: &'static str = "volume_measuring_device_models";
}
impl<'a> From<&'a VolumeMeasuringDeviceModel>
for web_common_traits::database::IdOrBuilder<
    i32,
    crate::codegen::structs_codegen::tables::insertables::InsertableVolumeMeasuringDeviceModelBuilder,
> {
    fn from(value: &'a VolumeMeasuringDeviceModel) -> Self {
        web_common_traits::database::IdOrBuilder::Id(value.id)
    }
}
impl web_common_traits::prelude::ExtensionTable<crate::AssetModel> for VolumeMeasuringDeviceModel where
...
impl diesel::Identifiable for VolumeMeasuringDeviceModel {
    type Id = i32;
    fn id(self) -> Self::Id {
        self.id
    }
}
impl VolumeMeasuringDeviceModel {
    ...
    where
        ...
        <Self as diesel::associations::HasTable>::Table: diesel::query_dsl::methods::FilterDsl<
            <crate::codegen::diesel_codegen::tables::volume_measuring_device_models::volume_measuring_device_models::id as diesel::expression_methods::EqAll<
                i32,
            >>::Output,
        >,
        ...
        >>::Output: diesel::query_dsl::methods::OrderDsl<
            diesel::helper_types::Asc<
                crate::codegen::diesel_codegen::tables::volume_measuring_device_models::volume_measuring_device_models::id,
            >,
        >,
        <<<Self as diesel::associations::HasTable>::Table as diesel::query_dsl::methods::FilterDsl<
            <crate::codegen::diesel_codegen::tables::volume_measuring_device_models::volume_measuring_device_models::id as diesel::expression_methods::EqAll<
        ...
        Self::table()
            .inner_join(
                physical_asset_models::table
                    .on(volume_measuring_device_models::id.eq(physical_asset_models::id)),
            )
    ...
    pub fn from_name(
        ...
        Self::table()
            .inner_join(
                asset_models::table.on(volume_measuring_device_models::id.eq(asset_models::id)),
            )
...
impl AsRef<VolumeMeasuringDeviceModel> for VolumeMeasuringDeviceModel {
    fn as_ref(&self) -> &VolumeMeasuringDeviceModel {
        self
    }
}
