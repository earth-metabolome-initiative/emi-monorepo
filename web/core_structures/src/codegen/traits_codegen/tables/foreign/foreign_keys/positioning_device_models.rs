...
pub struct PositioningDeviceModelForeignKeys {
    pub id: Option<crate::PhysicalAssetModel>,
}
impl web_common_traits::prelude::HasForeignKeys for crate::PositioningDeviceModel {
    type ForeignKeys = PositioningDeviceModelForeignKeys;
...
impl web_common_traits::prelude::ForeignKeys for PositioningDeviceModelForeignKeys {}
