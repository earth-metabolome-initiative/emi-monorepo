...
impl LoginProvider {
        ...
        Self::table()
            .filter(
                diesel::ExpressionMethods::eq(
                    crate::codegen::diesel_codegen::tables::login_providers::login_providers::client_id_var_name,
                    client_id_var_name,
                ),
            )
            .first::<Self>(conn)
    ...
    pub async fn from_redirect_uri_var_name(
        ...
        Self::table()
            .filter(
                diesel::ExpressionMethods::eq(
                    crate::codegen::diesel_codegen::tables::login_providers::login_providers::redirect_uri_var_name,
