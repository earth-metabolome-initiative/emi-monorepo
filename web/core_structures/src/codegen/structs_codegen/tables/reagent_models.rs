...
impl web_common_traits::prelude::ExtensionTable<crate::ReagentModel> for ReagentModel where
    for<'a> &'a Self: diesel::Identifiable<Id = &'a i32>
{
}
...
impl ReagentModel {
    ...
    where
        ...
        <Self as diesel::associations::HasTable>::Table: diesel::query_dsl::methods::FilterDsl<
            <crate::codegen::diesel_codegen::tables::reagent_models::reagent_models::id as diesel::expression_methods::EqAll<
                i32,
            >>::Output,
        >,
        ...
        >>::Output: diesel::query_dsl::methods::OrderDsl<
            diesel::helper_types::Asc<
                crate::codegen::diesel_codegen::tables::reagent_models::reagent_models::id,
            >,
        >,
        <<<Self as diesel::associations::HasTable>::Table as diesel::query_dsl::methods::FilterDsl<
            <crate::codegen::diesel_codegen::tables::reagent_models::reagent_models::id as diesel::expression_methods::EqAll<
