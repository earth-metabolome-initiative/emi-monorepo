...
impl From<common_traits::builder::EmptyTuple> for AliquotingProcedureTemplateExtensionAttribute {
...
impl web_common_traits::database::TableField for AliquotingProcedureTemplateAttribute {}
impl web_common_traits::database::HasTableType for AliquotingProcedureTemplateAttribute {
    ...
    > for AliquotingProcedureTemplateAttribute
{
    fn from_extension(
        ...
        AliquotingProcedureTemplateAttribute::Extension(From::from(attribute))
    }
}
...
{
    type Table = crate::codegen::diesel_codegen::tables::aliquoting_procedure_templates::aliquoting_procedure_templates::table;
    fn table() -> Self::Table {
        crate::codegen::diesel_codegen::tables::aliquoting_procedure_templates::aliquoting_procedure_templates::table
    }
}
...
pub trait AliquotingProcedureTemplateSettable: Sized {
    ...
    /// * If the provided value does not pass schema-defined validation.
    fn aliquoted_from_model<AFM>(self, aliquoted_from_model: AFM) -> Result<Self, Self::Error>
    where
    ...
    /// * If the provided value cannot be converted to the required type `i32`.
    /// * If the provided value does not pass schema-defined validation.
    fn aliquoted_into_model<AIM>(self, aliquoted_into_model: AIM) -> Result<Self, Self::Error>
    where
...
where
    Self: common_traits::builder::Attributed<
        Attribute = crate::codegen::structs_codegen::tables::insertables::AliquotingProcedureTemplateAttribute,
    >,
{
    ...
    where
        AFM: web_common_traits::database::PrimaryKeyLike<PrimaryKey = i32>,
    {
        let aliquoted_from_model = <AFM as web_common_traits::database::PrimaryKeyLike>::primary_key(
    ...
    where
        ...
        >,
    {
        let mut procedure_template_aliquoted_from_model = procedure_template_aliquoted_from_model
            .into();
        if let web_common_traits::database::IdOrBuilder::Builder(builder) = procedure_template_aliquoted_from_model {
            procedure_template_aliquoted_from_model = if let (
                Some(aliquoted_from_model),
                Some(asset_model_id),
            ) = (self.aliquoted_from_model, builder.asset_model_id) {
                if aliquoted_from_model != asset_model_id {
                    return Err(
                        web_common_traits::database::InsertError::BuilderError(
                            web_common_traits::prelude::BuilderError::UnexpectedAttribute(
                                <Self as common_traits::builder::Attributed>::Attribute::AliquotedFromModel,
                            ),
                        ),
                    );
                }
                ...
                self.aliquoted_from_model = Some(asset_model_id);
                builder.into()
    ...
    where
        AIM: web_common_traits::database::PrimaryKeyLike<PrimaryKey = i32>,
    {
        let aliquoted_into_model = <AIM as web_common_traits::database::PrimaryKeyLike>::primary_key(
    ...
    where
        ...
        >,
    {
        let mut procedure_template_aliquoted_into_model = procedure_template_aliquoted_into_model
            .into();
        if let web_common_traits::database::IdOrBuilder::Builder(builder) = procedure_template_aliquoted_into_model {
            procedure_template_aliquoted_into_model = if let (
                Some(aliquoted_into_model),
                Some(asset_model_id),
            ) = (self.aliquoted_into_model, builder.asset_model_id) {
                if aliquoted_into_model != asset_model_id {
                    return Err(
                        web_common_traits::database::InsertError::BuilderError(
                            web_common_traits::prelude::BuilderError::UnexpectedAttribute(
                                <Self as common_traits::builder::Attributed>::Attribute::AliquotedIntoModel,
                            ),
                        ),
                    );
                }
                ...
                self.aliquoted_into_model = Some(asset_model_id);
                builder.into()
    ...
    where
        ...
        >,
    {
        let mut procedure_template_aliquoted_with_model = procedure_template_aliquoted_with_model
            .into();
        if let web_common_traits::database::IdOrBuilder::Builder(builder) = procedure_template_aliquoted_with_model {
