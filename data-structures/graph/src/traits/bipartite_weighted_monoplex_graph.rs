...
//! 
//! * It is bipartite, i.e. it has two sets of nodes, and all edges can
//!   solely connect nodes from different sets.
...
use super::{WeightedEdges, WeightedMonoplexGraph};

/// Trait implemented by bipartite weighted monoplex graphs.
pub trait BipartiteWeightedMonoplexGraph: BipartiteGraph + WeightedMonoplexGraph<
