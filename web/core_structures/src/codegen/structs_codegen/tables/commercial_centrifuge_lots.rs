...
#[diesel(belongs_to(crate::CommercialCentrifugeModel, foreign_key = product_model))]
...
impl<'a> From<&'a CommercialCentrifugeLot>
for web_common_traits::database::IdOrBuilder<
    i32,
    crate::codegen::structs_codegen::tables::insertables::InsertableCommercialCentrifugeLotBuilder,
> {
    fn from(value: &'a CommercialCentrifugeLot) -> Self {
        web_common_traits::database::IdOrBuilder::Id(value.id)
    }
}
impl web_common_traits::prelude::ExtensionTable<crate::AssetModel> for CommercialCentrifugeLot where
    for<'a> &'a Self: diesel::Identifiable<Id = &'a i32>
{
}
impl web_common_traits::prelude::ExtensionTable<crate::CentrifugeModel> for CommercialCentrifugeLot where
    for<'a> &'a Self: diesel::Identifiable<Id = &'a i32>
{
}
...
impl web_common_traits::prelude::ExtensionTable<crate::CommercialCentrifugeLot>
    for CommercialCentrifugeLot
where
    for<'a> &'a Self: diesel::Identifiable<Id = &'a i32>,
{
...
impl CommercialCentrifugeLot {
    ...
    where
        ...
        <Self as diesel::associations::HasTable>::Table: diesel::query_dsl::methods::FilterDsl<
            <crate::codegen::diesel_codegen::tables::commercial_centrifuge_lots::commercial_centrifuge_lots::id as diesel::expression_methods::EqAll<
                i32,
            >>::Output,
        >,
        ...
        >>::Output: diesel::query_dsl::methods::OrderDsl<
            diesel::helper_types::Asc<
                crate::codegen::diesel_codegen::tables::commercial_centrifuge_lots::commercial_centrifuge_lots::id,
            >,
        >,
        <<<Self as diesel::associations::HasTable>::Table as diesel::query_dsl::methods::FilterDsl<
            <crate::codegen::diesel_codegen::tables::commercial_centrifuge_lots::commercial_centrifuge_lots::id as diesel::expression_methods::EqAll<
