...
impl web_common_traits::database::PrimaryKeyLike for CommercialPipetteTipLot {
    type PrimaryKey = i32;
...
impl CommercialPipetteTipLot {
    ...
    where
        ...
        <Self as diesel::associations::HasTable>::Table: diesel::query_dsl::methods::FilterDsl<
            <crate::codegen::diesel_codegen::tables::commercial_pipette_tip_lots::commercial_pipette_tip_lots::id as diesel::expression_methods::EqAll<
                i32,
            >>::Output,
        >,
        ...
        >>::Output: diesel::query_dsl::methods::OrderDsl<
            diesel::helper_types::Asc<
                crate::codegen::diesel_codegen::tables::commercial_pipette_tip_lots::commercial_pipette_tip_lots::id,
            >,
        >,
        <<<Self as diesel::associations::HasTable>::Table as diesel::query_dsl::methods::FilterDsl<
            <crate::codegen::diesel_codegen::tables::commercial_pipette_tip_lots::commercial_pipette_tip_lots::id as diesel::expression_methods::EqAll<
