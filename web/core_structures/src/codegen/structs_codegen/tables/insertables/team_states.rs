...
impl web_common_traits::database::TableField for TeamStateAttribute {}
impl web_common_traits::database::HasTableType for TeamStateAttribute {
    type Table = crate::codegen::tables::table_names::TableName;
}
impl core::fmt::Display for TeamStateAttribute {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            Self::Name => write!(f, "team_states.name"),
            Self::Description => write!(f, "team_states.description"),
            Self::Icon => write!(f, "team_states.icon"),
            Self::ColorId => write!(f, "team_states.color_id"),
            Self::Id => write!(f, "team_states.id"),
        }
    }
}
#[derive(Debug)]
...
///
/// ```rust,ignore
/// use core_structures::TeamState;
/// use core_structures::tables::insertables::TeamStateSettable;
...
{
    type Error = web_common_traits::database::InsertError<TeamStateAttribute>;
