    ...
    fn update(
        ...
        match (row, crud) {
            ...
            (
                ...
                if self.procedure_disposed_asset == procedure_asset_models.id {
                    foreign_keys.procedure_disposed_asset = Some(procedure_asset_models);
                    updated = true;
                }
            }
            (
            ...
            (
                ...
                {
                    foreign_keys.procedure_template_disposed_asset_model_id =
