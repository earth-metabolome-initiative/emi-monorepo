...
pub struct BeadsModelForeignKeys {
    pub id:
        Option<crate::codegen::structs_codegen::tables::physical_asset_models::PhysicalAssetModel>,
}
impl web_common_traits::prelude::HasForeignKeys
    for crate::codegen::structs_codegen::tables::beads_models::BeadsModel
{
    type ForeignKeys = BeadsModelForeignKeys;
...
impl web_common_traits::prelude::ForeignKeys for BeadsModelForeignKeys {}
