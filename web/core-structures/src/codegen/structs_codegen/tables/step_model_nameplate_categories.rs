...
impl diesel::Identifiable for StepModelNameplateCategory {
    type Id = i32;
    fn id(self) -> Self::Id {
        self.id
    }
}
impl StepModelNameplateCategory {
    ...
    pub async fn from_step_model_id(
        ...
        Self::table()
            .filter(
                crate::codegen::diesel_codegen::tables::step_model_nameplate_categories::step_model_nameplate_categories::dsl::step_model_id
                    .eq(step_model_id.id),
            )
            .load::<Self>(conn)
            .await
    ...
    pub async fn from_created_by(
        ...
        Self::table()
            .filter(
                crate::codegen::diesel_codegen::tables::step_model_nameplate_categories::step_model_nameplate_categories::dsl::created_by
                    .eq(created_by.id),
            )
            .load::<Self>(conn)
            .await
    ...
    pub async fn from_created_at(
        ...
        use crate::codegen::diesel_codegen::tables::step_model_nameplate_categories::step_model_nameplate_categories;
        Self::table()
            .filter(step_model_nameplate_categories::created_at.eq(created_at))
            .order_by(step_model_nameplate_categories::id.asc())
            .load::<Self>(conn)
            .await
    }
    ...
    pub async fn from_updated_at(
        ...
        use crate::codegen::diesel_codegen::tables::step_model_nameplate_categories::step_model_nameplate_categories;
        Self::table()
            .filter(step_model_nameplate_categories::updated_at.eq(updated_at))
            .order_by(step_model_nameplate_categories::id.asc())
            .load::<Self>(conn)
            .await
    }
