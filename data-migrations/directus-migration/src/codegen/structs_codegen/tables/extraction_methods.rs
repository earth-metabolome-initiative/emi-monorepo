...
impl ExtractionMethod {
    ...
    pub async fn from_user_created(
        ...
        Self::table()
            .filter(
                crate::codegen::diesel_codegen::tables::extraction_methods::extraction_methods::dsl::user_created
                    .eq(&user_created.id),
            )
            .load::<Self>(conn)
            .await
    ...
    pub async fn from_user_updated(
        ...
        Self::table()
            .filter(
                crate::codegen::diesel_codegen::tables::extraction_methods::extraction_methods::dsl::user_updated
                    .eq(&user_updated.id),
            )
            .load::<Self>(conn)
            .await
