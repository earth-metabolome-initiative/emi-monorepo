...
where
    ...
    diesel::query_builder::InsertStatement<
        <crate::codegen::structs_codegen::tables::instruments::Instrument as diesel::associations::HasTable>::Table,
        <crate::codegen::structs_codegen::tables::insertables::InsertableInstrument as diesel::Insertable<
            <crate::codegen::structs_codegen::tables::instruments::Instrument as diesel::associations::HasTable>::Table,
        >>::Values,
    ...
    >,
{
    ...
    type InsertableVariant = crate::codegen::structs_codegen::tables::insertables::InsertableInstrument;
    type Error = web_common_traits::database::InsertError<
        crate::codegen::structs_codegen::tables::insertables::InsertableInstrumentAttributes,
    >;
    type UserId = i32;
    fn insert(
        self,
        ...
        let insertable_struct: crate::codegen::structs_codegen::tables::insertables::InsertableInstrument = self
