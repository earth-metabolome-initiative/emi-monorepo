...
impl NestedProjectState {
    ...
    pub fn similarity_search_viewable(
        ...
        ProjectState::similarity_search_viewable(filter, query, limit, offset, connection)?
            .into_iter()
            .map(|flat_variant| Self::from_flat(flat_variant, connection))
            .collect()
    }
    ...
    pub fn word_similarity_search_viewable(
        ...
        ProjectState::word_similarity_search_viewable(filter, query, limit, offset, connection)?
            .into_iter()
            .map(|flat_variant| Self::from_flat(flat_variant, connection))
            .collect()
    }
