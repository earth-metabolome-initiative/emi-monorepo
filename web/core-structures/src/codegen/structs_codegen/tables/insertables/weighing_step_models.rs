...
impl Default for InsertableWeighingStepModelBuilder {
    fn default() -> Self {
        Self {
            id: None,
            created_by: None,
...
impl InsertableWeighingStepModelBuilder {
        ...
        <P as TryInto<i32>>::Error: Into<validation_errors::SingleFieldError>,
    {
        let id = id.try_into().map_err(|err: <P as TryInto<i32>>::Error| {
            Into::into(err).rename_field(InsertableWeighingStepModelAttributes::Id)
        })?;
        self.id = Some(id);
        Ok(self)
    }
        ...
        <P as TryInto<i32>>::Error: Into<validation_errors::SingleFieldError>,
    {
        let created_by = created_by.try_into().map_err(|err: <P as TryInto<i32>>::Error| {
            Into::into(err).rename_field(InsertableWeighingStepModelAttributes::CreatedBy)
        })?;
            ...
            Into<validation_errors::SingleFieldError>,
    {
        let created_at = created_at.try_into().map_err(
            |err: <P as TryInto<rosetta_timestamp::TimestampUTC>>::Error| {
                Into::into(err).rename_field(InsertableWeighingStepModelAttributes::CreatedAt)
            },
        )?;
        ...
        <P as TryInto<i32>>::Error: Into<validation_errors::SingleFieldError>,
    {
        let updated_by = updated_by.try_into().map_err(|err: <P as TryInto<i32>>::Error| {
            Into::into(err).rename_field(InsertableWeighingStepModelAttributes::UpdatedBy)
        })?;
            ...
            Into<validation_errors::SingleFieldError>,
    {
        let updated_at = updated_at.try_into().map_err(
            |err: <P as TryInto<rosetta_timestamp::TimestampUTC>>::Error| {
                Into::into(err).rename_field(InsertableWeighingStepModelAttributes::UpdatedAt)
            },
        )?;
