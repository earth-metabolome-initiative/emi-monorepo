...
impl web_common_traits::database::TableField for FreezingProcedureAttribute {}
impl web_common_traits::database::HasTableType for FreezingProcedureAttribute {
    ...
    > for FreezingProcedureAttribute
{
    fn from_extension(
        ...
        FreezingProcedureAttribute::Extension(From::from(attribute))
    }
}
...
/// [`FreezingProcedure`](crate::codegen::structs_codegen::tables::freezing_procedures::FreezingProcedure).
///
///
...
///
/// ```rust,ignore
/// use core_structures::FreezingProcedure;
/// use core_structures::tables::insertables::FreezingProcedureSettable;
/// use core_structures::tables::insertables::ProcedureSettable;
/// use web_common_traits::database::Insertable;
/// use web_common_traits::database::InsertableVariant;
///
/// let freezing_procedure = FreezingProcedure::new()
...
where
    Self: web_common_traits::database::DispatchableInsertableVariant<
        ...
        + common_traits::builder::IsCompleteBuilder,
{
    type Error = web_common_traits::database::InsertError<FreezingProcedureAttribute>;
