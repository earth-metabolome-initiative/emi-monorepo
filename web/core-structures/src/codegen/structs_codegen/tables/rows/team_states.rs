...
impl From<Vec<std::rc::Rc<crate::codegen::structs_codegen::tables::team_states::TeamState>>>
    for super::Rows
{
    fn from(
        value: Vec<std::rc::Rc<crate::codegen::structs_codegen::tables::team_states::TeamState>>,
    ) -> Self {
        Self::from(std::rc::Rc::new(value))
    }
}
impl From<std::rc::Rc<Vec<crate::codegen::structs_codegen::tables::team_states::TeamState>>>
    for super::Rows
{
    fn from(
        value: std::rc::Rc<Vec<crate::codegen::structs_codegen::tables::team_states::TeamState>>,
    ) -> Self {
...
impl
    From<
        std::rc::Rc<
            Vec<std::rc::Rc<crate::codegen::structs_codegen::tables::team_states::TeamState>>,
        >,
    > for super::Rows
{
    fn from(
