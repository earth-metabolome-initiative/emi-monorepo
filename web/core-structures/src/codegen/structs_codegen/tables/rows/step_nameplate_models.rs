...
impl
    From<
        std::rc::Rc<
            Vec<crate::codegen::structs_codegen::tables::step_nameplate_models::StepNameplateModel>,
        >,
    > for super::Rows
{
    fn from(
...
> for super::Rows {
    fn from(
        ...
        super::Rows::StepNameplateModel(value)
    }
}
    ...
    >
{
    ...
    fn try_from(value: super::Rows) -> Result<Self, Self::Error> {
        match value {
            super::Rows::StepNameplateModel(v) => Ok(v),
