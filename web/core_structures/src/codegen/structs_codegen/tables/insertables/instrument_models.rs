...
pub enum InsertableInstrumentModelExtensionAttributes {
    Trackable(crate::codegen::structs_codegen::tables::insertables::InsertableTrackableAttributes),
}
impl core::fmt::Display for InsertableInstrumentModelExtensionAttributes {
...
pub enum InsertableInstrumentModelAttributes {
    Extension(InsertableInstrumentModelExtensionAttributes),
    Id,
}
    ...
    for InsertableInstrumentModelAttributes
{
    fn from(
        ...
        Self::Extension(InsertableInstrumentModelExtensionAttributes::Trackable(trackables))
    }
}
...
for InsertableInstrumentModelBuilder<Trackable>
where
    ...
    >,
{
    type Attributes = InsertableInstrumentModelAttributes;
    fn extend_builder(
        mut self,
        other: Self,
        ...
        self.id = self
            ...
            .map_err(|err| {
                err.into_field_name(|attribute| InsertableInstrumentModelAttributes::Extension(
                    InsertableInstrumentModelExtensionAttributes::Trackable(attribute),
                ))
            })?;
        Ok(self)
    }
    ...
    >
{
    ...
    /// columns from table `instrument_models`.
...
where
    Self: web_common_traits::database::InsertableVariant<
            ...
            Error = web_common_traits::database::InsertError<InsertableInstrumentModelAttributes>,
        >,
    Trackable: web_common_traits::database::TryInsertGeneric<C, PrimaryKey = ::rosetta_uuid::Uuid>,
{
    ...
    fn mint_primary_key(
        ...
        let insertable: crate::codegen::structs_codegen::tables::instrument_models::InstrumentModel = self
            .insert(user_id, conn)?;
        Ok(insertable.id())
    }
}
