...
impl diesel::Identifiable for WeighingStepModel {
    type Id = i32;
    fn id(self) -> Self::Id {
        self.id
    }
}
impl WeighingStepModel {
    ...
    pub async fn from_created_by(
        ...
        Self::table()
            .filter(
                crate::codegen::diesel_codegen::tables::weighing_step_models::weighing_step_models::dsl::created_by
                    .eq(created_by.id),
            )
            .load::<Self>(conn)
            .await
