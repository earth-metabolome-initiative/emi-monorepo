...
pub enum InsertableWeighingDeviceModelExtensionAttributes {
    PhysicalAssetModel(
        crate::codegen::structs_codegen::tables::insertables::InsertablePhysicalAssetModelAttributes,
    ),
}
impl core::fmt::Display for InsertableWeighingDeviceModelExtensionAttributes {
...
impl From<
    crate::codegen::structs_codegen::tables::insertables::InsertablePhysicalAssetModelAttributes,
> for InsertableWeighingDeviceModelExtensionAttributes {
    fn from(
...
#[derive(Copy, Clone, PartialEq, Eq, PartialOrd, Ord, Hash, core::fmt::Debug)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub enum InsertableWeighingDeviceModelAttributes {
    Extension(InsertableWeighingDeviceModelExtensionAttributes),
    Id,
}
impl From<
    crate::codegen::structs_codegen::tables::insertables::InsertablePhysicalAssetModelAttributes,
> for InsertableWeighingDeviceModelAttributes {
    fn from(
        physical_asset_models: crate::codegen::structs_codegen::tables::insertables::InsertablePhysicalAssetModelAttributes,
    ) -> Self {
        Self::Extension(
            InsertableWeighingDeviceModelExtensionAttributes::PhysicalAssetModel(
                physical_asset_models,
            ),
        )
    }
}
impl core::str::FromStr for InsertableWeighingDeviceModelAttributes {
...
impl core::fmt::Display for InsertableWeighingDeviceModelAttributes {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
...
pub trait WeighingDeviceModelBuildable: Sized {
    /// Attributes required to build the insertable.
    type Attributes;
}
impl<PhysicalAssetModel> WeighingDeviceModelBuildable
    for InsertableWeighingDeviceModelBuilder<PhysicalAssetModel>
{
    type Attributes = crate::codegen::structs_codegen::tables::insertables::InsertableWeighingDeviceModelAttributes;
}
impl<
...
where
    Self: web_common_traits::database::InsertableVariant<
        ...
        Error = web_common_traits::database::InsertError<
            InsertableWeighingDeviceModelAttributes,
        >,
    >,
    ...
    >,
{
    type Attributes = InsertableWeighingDeviceModelAttributes;
