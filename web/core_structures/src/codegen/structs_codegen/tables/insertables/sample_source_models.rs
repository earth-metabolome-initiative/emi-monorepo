...
pub enum SampleSourceModelExtensionAttribute {
    PhysicalAssetModel(
        crate::codegen::structs_codegen::tables::insertables::PhysicalAssetModelAttribute,
    ),
}
impl core::fmt::Display for SampleSourceModelExtensionAttribute {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            Self::PhysicalAssetModel(e) => write!(f, "sample_source_models({e})"),
        }
    }
}
impl From<crate::codegen::structs_codegen::tables::insertables::PhysicalAssetModelAttribute>
    for SampleSourceModelExtensionAttribute
{
    fn from(
...
impl From<common_traits::builder::EmptyTuple> for SampleSourceModelExtensionAttribute {
...
#[derive(Copy, Clone, PartialEq, Eq, PartialOrd, Ord, Hash, core::fmt::Debug)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub enum SampleSourceModelAttribute {
    Extension(SampleSourceModelExtensionAttribute),
    Id,
}
impl core::str::FromStr for SampleSourceModelAttribute {
...
impl<T1> common_traits::builder::Attributed
    for crate::codegen::structs_codegen::tables::insertables::InsertableSampleSourceModelBuilder<T1>
{
    type Attribute = SampleSourceModelAttribute;
}
impl web_common_traits::database::TableField for SampleSourceModelAttribute {}
impl web_common_traits::database::HasTableType for SampleSourceModelAttribute {
    type Table = crate::codegen::tables::table_names::TableName;
}
impl
    web_common_traits::database::FromExtension<
        crate::codegen::structs_codegen::tables::insertables::PhysicalAssetModelAttribute,
    > for SampleSourceModelAttribute
{
    fn from_extension(
        attribute: crate::codegen::structs_codegen::tables::insertables::PhysicalAssetModelAttribute,
    ) -> Self {
        SampleSourceModelAttribute::Extension(From::from(attribute))
    }
}
...
impl core::fmt::Display for SampleSourceModelAttribute {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            Self::Extension(e) => write!(f, "{e}"),
            Self::Id => write!(f, "sample_source_models.id"),
        }
    }
}
#[derive(Debug)]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct InsertableSampleSourceModel {
    pub(crate) id: i32,
}
impl InsertableSampleSourceModel {}
#[derive(Clone, Debug, PartialEq, PartialOrd, Eq, Hash, Ord, Default)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
/// Builder for creating and inserting a new
/// [`SampleSourceModel`](crate::codegen::structs_codegen::tables::sample_source_models::SampleSourceModel).
///
///
...
///
/// ```rust,ignore
/// use core_structures::SampleSourceModel;
...
///
/// let sample_source_model = SampleSourceModel::new()
...
///    .insert(user.id, conn)?;
/// ```
pub struct InsertableSampleSourceModelBuilder<
    PhysicalAssetModel
...
impl<PhysicalAssetModel> diesel::associations::HasTable
    for InsertableSampleSourceModelBuilder<PhysicalAssetModel>
{
    type Table =
        crate::codegen::diesel_codegen::tables::sample_source_models::sample_source_models::table;
    fn table() -> Self::Table {
        crate::codegen::diesel_codegen::tables::sample_source_models::sample_source_models::table
    }
}
impl From<InsertableSampleSourceModelBuilder>
    for web_common_traits::database::IdOrBuilder<i32, InsertableSampleSourceModelBuilder>
{
    fn from(builder: InsertableSampleSourceModelBuilder) -> Self {
...
/// Trait defining setters for attributes of an instance of `SampleSourceModel`
/// or descendant tables.
pub trait SampleSourceModelSettable: Sized {
    /// Error type returned when setting attributes.
    type Error;
}
impl<PhysicalAssetModel> SampleSourceModelSettable
for InsertableSampleSourceModelBuilder<PhysicalAssetModel>
where
...
where
    Self: web_common_traits::database::DispatchableInsertableVariant<
            ...
            Error = web_common_traits::database::InsertError<SampleSourceModelAttribute>,
        > + web_common_traits::database::SetPrimaryKey<PrimaryKey = i32>
        + common_traits::builder::IsCompleteBuilder,
{
    type Error = web_common_traits::database::InsertError<SampleSourceModelAttribute>;
