...
pub struct InstrumentModelForeignKeys {
    ...
    pub user_updated:
        Option<std::rc::Rc<crate::codegen::structs_codegen::tables::directus_users::DirectusUser>>,
    pub instrument_type: Option<
        std::rc::Rc<crate::codegen::structs_codegen::tables::instrument_types::InstrumentType>,
    >,
    ...
    for crate::codegen::structs_codegen::tables::instrument_models::InstrumentModel
{
        ...
        C: web_common_traits::crud::Connector<Row = Self::Row>,
    {
        ...
        connector.send(web_common_traits::crud::CrudPrimaryKeyOperation::Read(
            crate::codegen::tables::table_primary_keys::TablePrimaryKey::InstrumentType(
    ...
    fn foreign_keys_loaded(&self, foreign_keys: &Self::ForeignKeys) -> bool {
        (foreign_keys.user_created.is_some() || self.user_created.is_none())
            ...
            && foreign_keys.instrument_type.is_some()
    ...
    fn update(
        ...
        match (row, crud) {
            (
                crate::codegen::tables::row::Row::InstrumentType(instrument_types),
                web_common_traits::crud::CRUD::Read
                | web_common_traits::crud::CRUD::Create
                | web_common_traits::crud::CRUD::Update,
            ) => {
                if instrument_types.id == self.instrument_type {
                    foreign_keys.instrument_type = Some(instrument_types);
                    updated = true;
                }
            }
            (
                ...
                if instrument_types.id == self.instrument_type {
                    foreign_keys.instrument_type = None;
                    updated = true;
                }
            }
            (
