...
where
    diesel::query_builder::InsertStatement<
        <crate::Freezer as diesel::associations::HasTable>::Table,
        <crate::codegen::structs_codegen::tables::insertables::InsertableFreezer as diesel::Insertable<
            <crate::Freezer as diesel::associations::HasTable>::Table,
        >>::Values,
    >: for<'query> diesel::query_dsl::LoadQuery<'query, C, crate::Freezer>,
    C: diesel::connection::LoadConnection,
    ...
    Self: web_common_traits::database::MostConcreteTable,
{
    ...
    fn try_insert(
        ...
        let id = self
            ...
            .map_err(|err| {
                err.into_field_name(|_| crate::codegen::structs_codegen::tables::insertables::FreezerAttribute::Extension(
                    crate::codegen::structs_codegen::tables::insertables::FreezerExtensionAttribute::PhysicalAsset(
