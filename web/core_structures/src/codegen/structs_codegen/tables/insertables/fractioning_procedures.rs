...
impl core::fmt::Display for InsertableFractioningProcedureAttributes {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            ...
            Self::FragmentContainer => write!(f, "fragment_container"),
...
> FractioningProcedureBuildable for InsertableFractioningProcedureBuilder<Procedure> {
    ...
    fn foreign_procedure_template(
        ...
        let foreign_procedure_template = foreign_procedure_template
            ...
            .map_err(|err| {
                validation_errors::SingleFieldError::from(err)
                    .rename_field(
                        InsertableFractioningProcedureAttributes::ForeignProcedureTemplate,
                    )
            })?;
    ...
    fn foreign_procedure(
        ...
        let foreign_procedure = foreign_procedure
            ...
            .map_err(|err| {
                validation_errors::SingleFieldError::from(err)
                    .rename_field(
                        InsertableFractioningProcedureAttributes::ForeignProcedure,
                    )
            })?;
    ...
    fn fragment_container(
        ...
        let fragment_container = fragment_container
            .try_into()
            .map_err(|err| {
                validation_errors::SingleFieldError::from(err)
                    .rename_field(
                        InsertableFractioningProcedureAttributes::FragmentContainer,
                    )
            })?;
    ...
    fn fragment_placed_into(
        ...
        let fragment_placed_into = fragment_placed_into
            .try_into()
            .map_err(|err| {
                validation_errors::SingleFieldError::from(err)
                    .rename_field(
                        InsertableFractioningProcedureAttributes::FragmentPlacedInto,
                    )
            })?;
    ...
    fn weighed_with(
        ...
        let weighed_with = weighed_with
            ...
            .map_err(|err| {
                validation_errors::SingleFieldError::from(err)
                    .rename_field(InsertableFractioningProcedureAttributes::WeighedWith)
            })?;
    ...
    fn weighed_with_model(
        ...
        let weighed_with_model = weighed_with_model
            ...
            .map_err(|err| {
                validation_errors::SingleFieldError::from(err)
                    .rename_field(
                        InsertableFractioningProcedureAttributes::WeighedWithModel,
                    )
            })?;
    ...
    >,
{
    ...
    fn is_complete(&self) -> bool {
        self.procedure.is_complete() && self.procedure_template.is_some()
            ...
            && self.foreign_procedure.is_some() && self.fragment_container.is_some()
            && self.fragment_placed_into.is_some() && self.kilograms.is_some()
