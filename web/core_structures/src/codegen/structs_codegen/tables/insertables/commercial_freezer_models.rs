...
pub trait CommercialFreezerModelBuildable:
...
impl CommercialFreezerModelBuildable for Option<i32> {}
impl<
...
for InsertableCommercialFreezerModelBuilder<CommercialProduct, FreezerModel> {
    ...
    {
        self.commercial_freezer_models_id_fkey1 = <CommercialProduct as crate::codegen::structs_codegen::tables::insertables::AssetModelBuildable>::most_concrete_table(
