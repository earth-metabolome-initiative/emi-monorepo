...
impl CommercialBallMillMachineLot {
    ...
    pub fn from_product_model_id(
        ...
        Self::table()
            .filter(commercial_ball_mill_machine_lots::product_model_id.eq(product_model_id))
        ...
        Self::table()
            .filter(
                commercial_ball_mill_machine_lots::id
                    .eq(id)
                    .and(commercial_ball_mill_machine_lots::product_model_id.eq(product_model_id)),
            )
            .order_by(commercial_ball_mill_machine_lots::id.asc())
            .load::<Self>(conn)
    }
