...
/// * If the Instrument Types in the Directus database do not match those in the Portal database, an error is returned.
///
pub async fn ensure_instrument_types_compatibility(
    ...
    for instrument_type in instrument_types {
        let portal_instrument_type = PortalInstrumentType::from_name(instrument_type.instrument_type.as_ref().ok_or_else(|| {
