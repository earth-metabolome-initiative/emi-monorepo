-- Drop the `can_update_projects_teams_role_invitations` function and trigger on the projects_teams_role_invitations table.

DROP FUNCTION IF EXISTS can_update_projects_teams_role_invitations(INTEGER, INTEGER, INTEGER);
