...
impl web_common_traits::prelude::HasForeignKeys for crate::PipetteModel {
    type ForeignKeys = PipetteModelForeignKeys;
...
impl web_common_traits::prelude::ForeignKeys for PipetteModelForeignKeys {}
