...
pub struct ShakingProcedureModelForeignKeys {
...
{
    type ForeignKeys = ShakingProcedureModelForeignKeys;
...
impl web_common_traits::prelude::ForeignKeys for ShakingProcedureModelForeignKeys {}
