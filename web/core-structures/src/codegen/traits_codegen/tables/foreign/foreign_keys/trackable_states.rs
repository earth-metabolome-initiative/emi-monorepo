...
pub struct TrackableStateForeignKeys {
...
{
    type ForeignKeys = TrackableStateForeignKeys;
...
impl web_common_traits::prelude::ForeignKeys for TrackableStateForeignKeys {}
