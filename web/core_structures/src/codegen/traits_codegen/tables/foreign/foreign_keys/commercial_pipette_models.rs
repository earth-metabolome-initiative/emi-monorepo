...
pub struct CommercialPipetteModelForeignKeys {
    pub parent_model: Option<crate::codegen::structs_codegen::tables::pipette_models::PipetteModel>,
    ...
    fn update(
        ...
        match (row, crud) {
            ...
            (
                ...
                if self.parent_model == pipette_models.id {
                    foreign_keys.parent_model = Some(pipette_models);
                    updated = true;
                }
