...
///
/// This struct maps to the `pg_enum` system catalog table in PostgreSQL, which stores
/// metadata about enum types. Each instance of `PgEnum` corresponds to a single enum value
/// in the database.
///
