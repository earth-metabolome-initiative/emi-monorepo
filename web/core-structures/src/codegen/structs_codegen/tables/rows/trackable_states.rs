...
impl
    From<
        Vec<std::rc::Rc<crate::codegen::structs_codegen::tables::trackable_states::TrackableState>>,
    > for super::Rows
{
    fn from(
        value: Vec<
...
impl
    From<
        std::rc::Rc<Vec<crate::codegen::structs_codegen::tables::trackable_states::TrackableState>>,
    > for super::Rows
{
    fn from(
        value: std::rc::Rc<
    ...
    > for super::Rows
{
    fn from(
        ...
        super::Rows::TrackableState(value)
    }
}
    ...
    >
{
    ...
    fn try_from(value: super::Rows) -> Result<Self, Self::Error> {
        match value {
            super::Rows::TrackableState(v) => Ok(v),
