...
pub struct TeamStateForeignKeys {
    pub color: Option<crate::Color>,
}
impl web_common_traits::prelude::HasForeignKeys for crate::TeamState {
    type ForeignKeys = TeamStateForeignKeys;
...
impl web_common_traits::prelude::ForeignKeys for TeamStateForeignKeys {}
