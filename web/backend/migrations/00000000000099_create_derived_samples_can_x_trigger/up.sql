...
-- We retrieve the value of the parent column from the row, as identified by the provided primary key(s).
    SELECT parent_sample_id, child_sample_id, created_by, 1 INTO this_parent_sample_id, this_child_sample_id, this_created_by, canary FROM derived_samples WHERE derived_samples.parent_sample_id = this_derived_samples_parent_sample_id AND derived_samples.child_sample_id = this_derived_samples_child_sample_id;
