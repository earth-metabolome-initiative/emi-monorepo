diesel::table! {
    ...
    description -> diesel::sql_types::Text, icon_id ->
    font_awesome_icons::diesel_impls::FAIcon, color_id -> diesel::sql_types::SmallInt,
    state_id -> diesel::sql_types::SmallInt, parent_team_id ->
