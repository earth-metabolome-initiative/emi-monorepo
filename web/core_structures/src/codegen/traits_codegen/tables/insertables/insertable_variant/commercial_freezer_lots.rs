...
where
    ...
    crate::codegen::structs_codegen::tables::insertables::CommercialFreezerLotAttribute: web_common_traits::database::FromExtensionAttribute<
            ...
            let id = self
                ...
                .map_err(|err| {
                    err.into_field_name(|attribute| {
                        <crate::codegen::structs_codegen::tables::insertables::CommercialFreezerLotAttribute as web_common_traits::database::FromExtensionAttribute<
                            crate::codegen::structs_codegen::tables::insertables::CommercialProductLotAttribute,
                            CommercialProductLot,
