...
pub use tables::{
    ...
    Organization, PackagingModel, PackagingStepModel, ParentProcedureModel, PermanenceCategory,
    Procedure, ProcedureModel, ProcedureModelContainerCategory, ProcedureModelInstrumentCategory,
