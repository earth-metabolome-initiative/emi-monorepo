...
impl Tabular for OrganismTaxon {
    const TABLE: crate::database::Table = crate::database::Table::OrganismTaxa;
}
impl Describable for OrganismTaxon {
    fn description(&self) -> Option<&str> {
        None
    }
}
impl Colorable for OrganismTaxon {
    fn color(&self) -> Option<&str> {
        None
    }
}

impl Filtrable for crate::database::flat_variants::OrganismTaxon {
    type Filter = crate::database::filter_variants::OrganismTaxonFilter;
}
#[cfg(feature = "frontend")]
impl AllRecords for OrganismTaxon {
...
impl OrganismTaxon {
    ...
    /// Insert the OrganismTaxon into the database.
    ///
