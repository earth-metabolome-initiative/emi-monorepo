...
impl core::fmt::Display for InsertableFreezerModelAttributes {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            InsertableFreezerModelAttributes::Id(id) => write!(f, "{}", id),
        }
    }
}
...
impl InsertableFreezerModelBuilder {
    pub fn id<P>(
        mut self,
        id: P,
        ...
        <P as TryInto<::rosetta_uuid::Uuid>>::Error: Into<validation_errors::SingleFieldError>,
    {
        self.id = self
            .id
            .id(id)
            .map_err(|err| err.into_field_name(InsertableFreezerModelAttributes::Id))?;
        Ok(self)
    }
    pub fn name<P>(
        mut self,
...
impl InsertableFreezerModelBuilder {
    pub(crate) fn try_insert<C>(
        ...
        InsertableFreezerModel,
        web_common_traits::database::InsertError<InsertableFreezerModelAttributes>,
    >
    where
