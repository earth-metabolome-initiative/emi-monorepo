...
/// descendant tables.
pub trait FreezerBuildable: Sized {
        ...
        let model = model
            ...
            .map_err(|err| {
                validation_errors::SingleFieldError::from(err)
                    .rename_field(InsertableFreezerAttributes::Model)
            })?;
...
where
    Self: crate::codegen::structs_codegen::tables::insertables::PhysicalAssetBuildable<
        Attributes = crate::codegen::structs_codegen::tables::insertables::InsertableFreezerAttributes,
    >,
{
    type Attributes = crate::codegen::structs_codegen::tables::insertables::InsertableFreezerAttributes;
    #[inline]
...
for InsertableFreezerBuilder<PhysicalAsset>
where
    Self: crate::codegen::structs_codegen::tables::insertables::FreezerBuildable<
        Attributes = crate::codegen::structs_codegen::tables::insertables::InsertableFreezerAttributes,
    >,
{
    type Attributes = crate::codegen::structs_codegen::tables::insertables::InsertableFreezerAttributes;
    ...
    fn model(
        ...
        <Self as FreezerBuildable>::model(self, model)
    }
}
