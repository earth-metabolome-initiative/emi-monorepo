...
pub struct FreezeDryingStepModelForeignKeys {
    pub id: Option<
...
{
    type ForeignKeys = FreezeDryingStepModelForeignKeys;
...
impl web_common_traits::prelude::ForeignKeys for FreezeDryingStepModelForeignKeys {}
