...
impl From<common_traits::builder::EmptyTuple> for SampleSourceExtensionAttribute {
...
#[derive(Copy, Clone, PartialEq, Eq, PartialOrd, Ord, Hash, core::fmt::Debug)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub enum SampleSourceAttribute {
    Extension(SampleSourceExtensionAttribute),
    Id,
    Model,
}
impl core::str::FromStr for SampleSourceAttribute {
...
impl<T1> common_traits::builder::Attributed
    for crate::codegen::structs_codegen::tables::insertables::InsertableSampleSourceBuilder<T1>
{
    type Attribute = SampleSourceAttribute;
}
impl web_common_traits::database::TableField for SampleSourceAttribute {}
impl web_common_traits::database::HasTableType for SampleSourceAttribute {
    type Table = crate::codegen::tables::table_names::TableName;
}
impl
    web_common_traits::database::FromExtension<
        crate::codegen::structs_codegen::tables::insertables::PhysicalAssetAttribute,
    > for SampleSourceAttribute
{
    fn from_extension(
        attribute: crate::codegen::structs_codegen::tables::insertables::PhysicalAssetAttribute,
    ) -> Self {
        SampleSourceAttribute::Extension(From::from(attribute))
    }
}
...
impl core::fmt::Display for SampleSourceAttribute {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            Self::Extension(e) => write!(f, "{e}"),
            Self::Id => write!(f, "sample_sources.id"),
            Self::Model => write!(f, "sample_sources.model"),
        }
    }
}
#[derive(Debug)]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct InsertableSampleSource {
    pub(crate) id: ::rosetta_uuid::Uuid,
    pub(crate) model: i32,
}
impl InsertableSampleSource {
...
///
/// ```rust,ignore
/// use core_structures::SampleSource;
/// use core_structures::tables::insertables::AssetSettable;
/// use core_structures::tables::insertables::SampleSourceSettable;
...
///    .insert(user.id, conn)?;
/// ```
pub struct InsertableSampleSourceBuilder<
    PhysicalAsset
...
impl<PhysicalAsset> diesel::associations::HasTable
    for InsertableSampleSourceBuilder<PhysicalAsset>
{
    type Table = crate::codegen::diesel_codegen::tables::sample_sources::sample_sources::table;
    fn table() -> Self::Table {
        crate::codegen::diesel_codegen::tables::sample_sources::sample_sources::table
    }
}
impl From<InsertableSampleSourceBuilder>
    for web_common_traits::database::IdOrBuilder<
        ::rosetta_uuid::Uuid,
        InsertableSampleSourceBuilder,
    >
{
    fn from(builder: InsertableSampleSourceBuilder) -> Self {
...
/// Trait defining setters for attributes of an instance of `SampleSource` or
/// descendant tables.
pub trait SampleSourceSettable: Sized {
    /// Error type returned when setting attributes.
    type Error;
    /// Sets the value of the `public.sample_sources.model` column.
    ///
    /// # Arguments
    /// * `model`: The value to set for the `public.sample_sources.model`
    ///   column.
    ///
    /// # Implementation details
...
impl<
    PhysicalAsset: crate::codegen::structs_codegen::tables::insertables::PhysicalAssetSettable<
            ...
            >,
        >,
> SampleSourceSettable for InsertableSampleSourceBuilder<PhysicalAsset>
where
        ...
        >,
{
    ...
    where
        M: web_common_traits::database::PrimaryKeyLike<PrimaryKey = i32>,
    {
        <Self as SampleSourceSettable>::model(self, model)
    }
}
...
where
    Self: web_common_traits::database::DispatchableInsertableVariant<
            C,
            Row = crate::codegen::structs_codegen::tables::sample_sources::SampleSource,
            Error = web_common_traits::database::InsertError<SampleSourceAttribute>,
        > + web_common_traits::database::SetPrimaryKey<PrimaryKey = ::rosetta_uuid::Uuid>
        + common_traits::builder::IsCompleteBuilder,
{
    type Error = web_common_traits::database::InsertError<SampleSourceAttribute>;
