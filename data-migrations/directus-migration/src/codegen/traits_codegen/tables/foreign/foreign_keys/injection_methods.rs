...
pub struct InjectionMethodForeignKeys {
    pub user_created:
...
impl web_common_traits::prelude::HasForeignKeys
    for crate::codegen::structs_codegen::tables::injection_methods::InjectionMethod
{
    type ForeignKeys = InjectionMethodForeignKeys;
...
impl web_common_traits::prelude::ForeignKeys for InjectionMethodForeignKeys {}
