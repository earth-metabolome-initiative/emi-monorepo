...
//! `TableInsertableKeySettable` into an `InternalModule`.
...
impl<'table, T> From<TableInsertableKeySettable<'table, T>> for InternalModule
where
            ...
            .documentation(
                Documentation::new()
                    .documentation(&format!(
                        ...
                        value.table.table_insertable_key_settable_trait_name(),
