    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            Self::CommercialProductLot(e) => {
                write!(f, "commercial_freeze_dryer_lots({e})")
            }
            Self::FreezeDryerModel(e) => write!(f, "commercial_freeze_dryer_lots({e})"),
        }
    }
}
...
impl From<common_traits::builder::EmptyTuple> for CommercialFreezeDryerLotExtensionAttribute {
...
for crate::codegen::structs_codegen::tables::insertables::InsertableCommercialFreezeDryerLotBuilder<
    ...
    T2,
> {
    type Attribute = CommercialFreezeDryerLotAttribute;
}
impl web_common_traits::database::TableField for CommercialFreezeDryerLotAttribute {}
impl web_common_traits::database::HasTableType for CommercialFreezeDryerLotAttribute {
    type Table = crate::codegen::tables::table_names::TableName;
}
impl
    web_common_traits::database::FromExtension<
        crate::codegen::structs_codegen::tables::insertables::CommercialProductLotAttribute,
    > for CommercialFreezeDryerLotAttribute
{
    fn from_extension(
        attribute: crate::codegen::structs_codegen::tables::insertables::CommercialProductLotAttribute,
    ) -> Self {
        CommercialFreezeDryerLotAttribute::Extension(From::from(attribute))
    }
}
impl
    web_common_traits::database::FromExtension<
...
impl core::fmt::Display for CommercialFreezeDryerLotAttribute {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            ...
            Self::Id => write!(f, "commercial_freeze_dryer_lots.id"),
            Self::ProductModel => write!(f, "commercial_freeze_dryer_lots.product_model"),
        }
    }
}
#[derive(Debug)]
...
///
/// ```rust,ignore
/// use core_structures::CommercialFreezeDryerLot;
/// use core_structures::tables::insertables::AssetModelSettable;
/// use core_structures::tables::insertables::CommercialFreezeDryerLotSettable;
/// use core_structures::tables::insertables::CommercialProductLotSettable;
/// use web_common_traits::database::Insertable;
/// use web_common_traits::database::InsertableVariant;
///
/// let commercial_freeze_dryer_lot = CommercialFreezeDryerLot::new()
...
impl<CommercialProductLot, FreezeDryerModel> diesel::associations::HasTable
    for InsertableCommercialFreezeDryerLotBuilder<CommercialProductLot, FreezeDryerModel>
{
    type Table = crate::codegen::diesel_codegen::tables::commercial_freeze_dryer_lots::commercial_freeze_dryer_lots::table;
    fn table() -> Self::Table {
        crate::codegen::diesel_codegen::tables::commercial_freeze_dryer_lots::commercial_freeze_dryer_lots::table
    }
}
...
where
    Self: common_traits::builder::Attributed<
        Attribute = crate::codegen::structs_codegen::tables::insertables::CommercialFreezeDryerLotAttribute,
    >,
{
