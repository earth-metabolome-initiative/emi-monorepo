    ...
    for crate::codegen::structs_codegen::tables::commercial_centrifuge_lots::CommercialCentrifugeLot
{
    ...
    fn foreign_keys_loaded(&self, foreign_keys: &Self::ForeignKeys) -> bool {
        foreign_keys.commercial_centrifuge_lots_id_fkey.is_some()
            && foreign_keys.commercial_centrifuge_lots_id_fkey1.is_some()
        ...
        match (row, crud) {
            (
                ...
                if self.id == centrifuge_models.id {
                    foreign_keys.commercial_centrifuge_lots_id_fkey1 = Some(centrifuge_models);
                    updated = true;
                }
            }
            (
                ...
                if self.id == centrifuge_models.id {
                    foreign_keys.commercial_centrifuge_lots_id_fkey1 = None;
                    updated = true;
                }
            }
            (
                crate::codegen::tables::row::Row::CommercialCentrifugeModel(
                ...
                if self.product_model_id == commercial_centrifuge_models.id {
                    foreign_keys.product_model = Some(commercial_centrifuge_models);
                    updated = true;
                }
            }
            (
            ...
            (
                ...
                if self.id == commercial_product_lots.id {
                    foreign_keys.commercial_centrifuge_lots_id_fkey = Some(commercial_product_lots);
                    updated = true;
                }
            }
            (
                ...
                if self.id == commercial_product_lots.id {
                    foreign_keys.commercial_centrifuge_lots_id_fkey = None;
                    updated = true;
                }
            }
            (_, crud) => {
...
impl web_common_traits::prelude::ForeignKeys for CommercialCentrifugeLotForeignKeys {}
