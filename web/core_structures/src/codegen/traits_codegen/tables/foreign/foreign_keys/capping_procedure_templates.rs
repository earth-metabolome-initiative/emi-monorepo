...
pub struct CappingProcedureTemplateForeignKeys {
    ...
    pub capping_procedure_templates_capped_container_model_capped_fkey:
        Option<crate::AssetCompatibilityRule>,
}
impl web_common_traits::prelude::HasForeignKeys for crate::CappingProcedureTemplate {
    ...
    fn foreign_keys_loaded(&self, foreign_keys: &Self::ForeignKeys) -> bool {
        foreign_keys.procedure_template.is_some()
            ...
            && foreign_keys.capping_procedure_templates_capped_container_model_capped_fkey.is_some()
    }
    fn update(
        &self,
        ...
        match (row, crud) {
            (
                ...
                {
                    foreign_keys.capping_procedure_templates_capped_container_model_capped_fkey =
