...
pub struct DirectusCommentForeignKeys {
...
{
    type ForeignKeys = DirectusCommentForeignKeys;
...
impl web_common_traits::prelude::ForeignKeys for DirectusCommentForeignKeys {}
