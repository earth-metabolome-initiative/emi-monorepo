...
impl core::fmt::Display for InsertablePositioningDeviceModelAttributes {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            InsertablePositioningDeviceModelAttributes::Id(id) => write!(f, "{}", id),
        }
    }
}
...
impl InsertablePositioningDeviceModelBuilder {
    pub fn id<P>(
        mut self,
        id: P,
    ) -> Result<
        ...
        <P as TryInto<::rosetta_uuid::Uuid>>::Error: Into<validation_errors::SingleFieldError>,
    {
        self.id = self
            .id
            .id(id)
            .map_err(|err| err.into_field_name(InsertablePositioningDeviceModelAttributes::Id))?;
        Ok(self)
    }
    pub fn name<P>(
        mut self,
...
impl InsertablePositioningDeviceModelBuilder {
    pub(crate) fn try_insert<C>(
        ...
        InsertablePositioningDeviceModel,
        ...
        >,
    {
        ...
        let id = self
            ...
            .map_err(|err| err.into_field_name(InsertablePositioningDeviceModelAttributes::Id))?
            .id();
        Ok(InsertablePositioningDeviceModel { id })
    }
}
