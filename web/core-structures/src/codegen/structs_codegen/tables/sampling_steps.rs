...
impl diesel::Identifiable for SamplingStep {
...
impl SamplingStep {
    ...
    pub async fn from_id(
        ...
        Self::table()
            .filter(
                crate::codegen::diesel_codegen::tables::sampling_steps::sampling_steps::dsl::id
                    .eq(id.id),
            )
            .first::<Self>(conn)
            .await
    ...
    pub async fn from_processable_id(
        ...
        Self::table()
            .filter(
                crate::codegen::diesel_codegen::tables::sampling_steps::sampling_steps::dsl::processable_id
    ...
    pub async fn from_trackable_id(
        ...
        Self::table()
            .filter(
                crate::codegen::diesel_codegen::tables::sampling_steps::sampling_steps::dsl::trackable_id
                    .eq(trackable_id.id),
            )
            .load::<Self>(conn)
            .await
    ...
    pub async fn from_created_by(
        ...
        Self::table()
            .filter(
                crate::codegen::diesel_codegen::tables::sampling_steps::sampling_steps::dsl::created_by
                    .eq(created_by.id),
            )
            .load::<Self>(conn)
            .await
