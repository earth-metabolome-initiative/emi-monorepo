...
impl crate::database::Tabular for NestedUnit {
    const TABLE: crate::database::Table = crate::database::Table::Units;
}
impl crate::database::Filtrable for NestedUnit {
    type Filter = crate::database::filter_variants::UnitFilter;
}
impl crate::database::Describable for NestedUnit {
    fn description(&self) -> Option<&str> {
        self.inner.description()
    }
}
impl crate::database::Colorable for NestedUnit {
    fn color(&self) -> Option<&str> {
        Some(self.color.name.as_str())
    }
}
#[cfg(feature = "frontend")]
impl crate::database::AllRecords for NestedUnit {
...
impl NestedUnit {
    ...
    pub(crate) async fn from_flat(
        flat_variant: crate::database::flat_variants::Unit,
    ...
    /// Get the Unit from the database by its ID.
    ///
    ...
    pub async fn get<C: gluesql::core::store::GStore + gluesql::core::store::GStoreMut>(
        ...
        if let Some(flat_variant) =
            crate::database::flat_variants::Unit::get(id, connection).await?
        {
    ...
    /// Delete the Unit from the database by its ID.
    ///
    ...
    >(
        ...
        crate::database::flat_variants::Unit::delete_from_id(id, connection).await
    }
    ...
    pub async fn all<C: gluesql::core::store::GStore + gluesql::core::store::GStoreMut>(
        filter: Option<&crate::database::filter_variants::UnitFilter>,
        limit: Option<i64>,
        offset: Option<i64>,
        connection: &mut gluesql::prelude::Glue<C>,
        ...
        for flat_variant in
            crate::database::flat_variants::Unit::all(filter, limit, offset, connection)
                .await?
                .into_iter()
        {
            units.push(Self::from_flat(flat_variant, connection).await?);
        }
        Ok(units)
    }
    ...
    >(
        ...
        crate::database::flat_variants::Color::update_or_insert(self.color.as_ref(), connection)
            .await?;
        crate::database::flat_variants::Unit::update_or_insert(self.inner.as_ref(), connection)
            .await
    }
}
