...
impl core::fmt::Display for BallMillMachineModelExtensionAttribute {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            Self::PhysicalAssetModel(e) => write!(f, "ball_mill_machine_models({e})"),
        }
    }
}
...
impl core::fmt::Display for BallMillMachineModelAttribute {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            ...
            Self::Id => write!(f, "ball_mill_machine_models.id"),
        }
    }
}
#[derive(Debug)]
...
/// [`BallMillMachineModel`](crate::codegen::structs_codegen::tables::ball_mill_machine_models::BallMillMachineModel).
///
///
...
///
/// ```rust,ignore
/// use core_structures::BallMillMachineModel;
...
///
/// let ball_mill_machine_model = BallMillMachineModel::new()
...
{
    type Table = crate::codegen::diesel_codegen::tables::ball_mill_machine_models::ball_mill_machine_models::table;
    fn table() -> Self::Table {
        crate::codegen::diesel_codegen::tables::ball_mill_machine_models::ball_mill_machine_models::table
    }
}
