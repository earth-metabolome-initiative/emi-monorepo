...
pub struct BatchTypeForeignKeys {
    pub user_created:
...
impl web_common_traits::prelude::HasForeignKeys
    for crate::codegen::structs_codegen::tables::batch_types::BatchType
{
    type ForeignKeys = BatchTypeForeignKeys;
...
impl web_common_traits::prelude::ForeignKeys for BatchTypeForeignKeys {}
