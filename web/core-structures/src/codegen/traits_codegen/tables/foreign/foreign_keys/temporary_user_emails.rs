...
pub struct TemporaryUserEmailForeignKeys {
    pub login_provider:
...
{
    type ForeignKeys = TemporaryUserEmailForeignKeys;
...
impl web_common_traits::prelude::ForeignKeys for TemporaryUserEmailForeignKeys {}
