...
impl web_common_traits::prelude::ExtensionTable<crate::PhysicalAssetModel> for CameraModel where
    for<'a> &'a Self: diesel::Identifiable<Id = &'a i32>
{
}
impl web_common_traits::prelude::ExtensionTable<crate::CameraModel> for CameraModel where
    for<'a> &'a Self: diesel::Identifiable<Id = &'a i32>
{
}
...
impl CameraModel {
    ...
    where
        ...
        <Self as diesel::associations::HasTable>::Table: diesel::query_dsl::methods::FilterDsl<
            <crate::codegen::diesel_codegen::tables::camera_models::camera_models::id as diesel::expression_methods::EqAll<
                i32,
            >>::Output,
        >,
        ...
        >>::Output: diesel::query_dsl::methods::OrderDsl<
            diesel::helper_types::Asc<
                crate::codegen::diesel_codegen::tables::camera_models::camera_models::id,
            >,
        >,
        <<<Self as diesel::associations::HasTable>::Table as diesel::query_dsl::methods::FilterDsl<
            <crate::codegen::diesel_codegen::tables::camera_models::camera_models::id as diesel::expression_methods::EqAll<
    ...
    pub fn from_parent_model(
        ...
        Self::table()
            .inner_join(
                physical_asset_models::table.on(camera_models::id.eq(physical_asset_models::id)),
            )
    ...
    pub fn from_name(
        ...
        use crate::codegen::diesel_codegen::tables::{
            asset_models::asset_models, camera_models::camera_models,
        };
        Self::table()
            .inner_join(asset_models::table.on(camera_models::id.eq(asset_models::id)))
