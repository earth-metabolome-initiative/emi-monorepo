...
impl ProjectsUsersRole {
    ...
    pub fn can_view_by_id(
        ...
        diesel::select(crate::sql_function_bindings::can_view_projects_users_roles(
            author_user_id,
            table_id,
            user_id,
        ))
    ...
    pub fn all_viewable(
        ...
        let query = projects_users_roles::dsl::projects_users_roles
            ...
            .filter(crate::sql_function_bindings::can_view_projects_users_roles(
                author_user_id,
    ...
    pub fn can_update_by_id(
        ...
        diesel::select(
            crate::sql_function_bindings::can_update_projects_users_roles(
                author_user_id,
                table_id,
                user_id,
            ),
    ...
    pub fn can_admin_by_id(
        ...
        diesel::select(
            crate::sql_function_bindings::can_admin_projects_users_roles(
                author_user_id,
                table_id,
                user_id,
            ),
