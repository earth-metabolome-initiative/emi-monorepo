CREATE TABLE IF NOT EXISTS procedure_templates.geolocation_procedure_templates (
	...
	-- We define a same-as index to allow for foreign key references to check whether a `geolocation_procedure_templates.procedure_template`
	-- is associated with a given `geolocation_procedure_templates.foreign_procedure_template`.
	UNIQUE (procedure_template, foreign_procedure_template)
);
CREATE TABLE IF NOT EXISTS procedures.geolocation_procedures (
	...
	procedure_template INTEGER NOT NULL REFERENCES procedure_templates.geolocation_procedure_templates(procedure_template),
	...
	FOREIGN KEY (procedure_template, foreign_procedure_template) REFERENCES procedure_templates.geolocation_procedure_templates(procedure_template, foreign_procedure_template)
);