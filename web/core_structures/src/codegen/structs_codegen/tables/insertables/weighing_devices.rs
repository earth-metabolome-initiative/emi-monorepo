...
pub enum InsertableWeighingDeviceExtensionAttributes {
    PhysicalAsset(
        crate::codegen::structs_codegen::tables::insertables::InsertablePhysicalAssetAttributes,
    ),
}
impl core::fmt::Display for InsertableWeighingDeviceExtensionAttributes {
...
impl From<crate::codegen::structs_codegen::tables::insertables::InsertablePhysicalAssetAttributes>
    for InsertableWeighingDeviceExtensionAttributes
{
    fn from(
...
#[derive(Copy, Clone, PartialEq, Eq, PartialOrd, Ord, Hash, core::fmt::Debug)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub enum InsertableWeighingDeviceAttributes {
    Extension(InsertableWeighingDeviceExtensionAttributes),
    Id,
    ModelId,
}
impl core::str::FromStr for InsertableWeighingDeviceAttributes {
...
impl core::fmt::Display for InsertableWeighingDeviceAttributes {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
...
/// descendant tables.
pub trait WeighingDeviceBuildable:
    crate::codegen::structs_codegen::tables::insertables::PhysicalAssetBuildable
{
    /// Sets the value of the `public.weighing_devices.model_id` column.
    ///
    /// # Arguments
    /// * `model_id`: The value to set for the
    ///   `public.weighing_devices.model_id` column.
    ///
...
impl WeighingDeviceBuildable for Option<::rosetta_uuid::Uuid> {
    fn model(
        self,
        _model_id: i32,
    ) -> Result<Self, web_common_traits::database::InsertError<Self::Attributes>> {
...
impl<
    PhysicalAsset: crate::codegen::structs_codegen::tables::insertables::PhysicalAssetBuildable<
        ...
        >,
> WeighingDeviceBuildable for InsertableWeighingDeviceBuilder<PhysicalAsset> {
    ///Sets the value of the `public.weighing_devices.model_id` column.
    fn model(
        mut self,
        model_id: i32,
        ...
        let model_id = model_id
            ...
            .map_err(|err| {
                validation_errors::SingleFieldError::from(err)
                    .rename_field(InsertableWeighingDeviceAttributes::ModelId)
            })?;
...
for InsertableWeighingDeviceBuilder<PhysicalAsset> {
    type Attributes = crate::codegen::structs_codegen::tables::insertables::InsertableWeighingDeviceAttributes;
    #[inline]
    ...
    fn model(
        ...
        <Self as WeighingDeviceBuildable>::model(self, model_id)
    }
    #[inline]
...
where
    Self: web_common_traits::database::InsertableVariant<
            ...
            Error = web_common_traits::database::InsertError<InsertableWeighingDeviceAttributes>,
        >,
    PhysicalAsset:
        web_common_traits::database::TryInsertGeneric<C, PrimaryKey = ::rosetta_uuid::Uuid>,
{
    type Attributes = InsertableWeighingDeviceAttributes;
    ...
    fn mint_primary_key(
        ...
        let insertable: crate::codegen::structs_codegen::tables::weighing_devices::WeighingDevice =
