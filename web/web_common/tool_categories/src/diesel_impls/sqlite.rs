...
impl diesel::deserialize::FromSql<crate::diesel_impls::ToolCategory, diesel::sqlite::Sqlite>
...
impl diesel::serialize::ToSql<crate::diesel_impls::ToolCategory, diesel::sqlite::Sqlite>
    for crate::ToolCategory
{
    fn to_sql<'b>(
        &'b self,
