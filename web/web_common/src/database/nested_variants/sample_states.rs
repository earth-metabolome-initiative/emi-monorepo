...
impl crate::database::Tabular for NestedSampleState {
    const TABLE: crate::database::Table = crate::database::Table::SampleStates;
}
impl crate::database::Filtrable for NestedSampleState {
    type Filter = crate::database::filter_variants::SampleStateFilter;
}
impl crate::database::Describable for NestedSampleState {
    fn description(&self) -> Option<&str> {
        self.inner.description()
    }
}
impl crate::database::Colorable for NestedSampleState {
    fn color(&self) -> Option<&str> {
        Some(self.color.name.as_str())
    }
}
#[cfg(feature = "frontend")]
impl crate::database::AllRecords for NestedSampleState {
...
impl NestedSampleState {
    ...
    pub(crate) async fn from_flat(
        flat_variant: crate::database::flat_variants::SampleState,
    ...
    /// Get the SampleState from the database by its ID.
    ///
    ...
    pub async fn get<C: gluesql::core::store::GStore + gluesql::core::store::GStoreMut>(
        ...
        if let Some(flat_variant) =
            crate::database::flat_variants::SampleState::get(id, connection).await?
        {
    ...
    /// Delete the SampleState from the database.
    ///
    /// * `connection` - The connection to the database.
    ...
    /// Delete the SampleState from the database by its ID.
    ///
    ...
    >(
        ...
        crate::database::flat_variants::SampleState::delete_from_id(id, connection).await
    }
    ...
    pub async fn all<C: gluesql::core::store::GStore + gluesql::core::store::GStoreMut>(
        filter: Option<&crate::database::filter_variants::SampleStateFilter>,
        limit: Option<i64>,
        offset: Option<i64>,
        connection: &mut gluesql::prelude::Glue<C>,
    ) -> Result<Vec<Self>, crate::api::ApiError> {
        let mut sample_states = Vec::new();
        for flat_variant in
            crate::database::flat_variants::SampleState::all(filter, limit, offset, connection)
                .await?
                .into_iter()
        {
            sample_states.push(Self::from_flat(flat_variant, connection).await?);
        }
        Ok(sample_states)
    }
    ...
    >(
        ...
        crate::database::flat_variants::Color::update_or_insert(self.color.as_ref(), connection)
            .await?;
        crate::database::flat_variants::SampleState::update_or_insert(
            self.inner.as_ref(),
            connection,
        )
        .await
