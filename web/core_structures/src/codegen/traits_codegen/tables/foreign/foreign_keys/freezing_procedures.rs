...
pub struct FreezingProcedureForeignKeys {
    ...
    >,
    pub freezing_procedures_procedure_frozen_with_model_fkey: Option<
    ...
    for crate::codegen::structs_codegen::tables::freezing_procedures::FreezingProcedure
{
    ...
    fn foreign_keys_loaded(&self, foreign_keys: &Self::ForeignKeys) -> bool {
        foreign_keys.procedure.is_some()
            ...
            && foreign_keys.freezing_procedures_procedure_frozen_with_model_fkey.is_some()
    }
    fn update(
        &self,
        ...
        match (row, crud) {
            ...
            (
                ...
                if self.procedure == procedure_assets.procedure
                    && self.frozen_with_model == procedure_assets.asset_model
                {
                    foreign_keys.freezing_procedures_procedure_frozen_with_model_fkey =
            ...
            (
                ...
                if self.procedure == procedure_assets.procedure
                    && self.frozen_with_model == procedure_assets.asset_model
                {
                    foreign_keys.freezing_procedures_procedure_frozen_with_model_fkey = None;
                    updated = true;
                }
            }
            (
