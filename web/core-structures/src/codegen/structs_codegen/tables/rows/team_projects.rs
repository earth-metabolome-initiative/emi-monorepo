...
impl From<std::rc::Rc<crate::codegen::structs_codegen::tables::team_projects::TeamProject>>
    for super::Rows
{
    fn from(
        value: std::rc::Rc<crate::codegen::structs_codegen::tables::team_projects::TeamProject>,
    ) -> Self {
        Self::from(vec![value])
    }
}
...
impl From<Vec<std::rc::Rc<crate::codegen::structs_codegen::tables::team_projects::TeamProject>>>
    for super::Rows
{
    fn from(
        value: Vec<
...
impl From<std::rc::Rc<Vec<crate::codegen::structs_codegen::tables::team_projects::TeamProject>>>
    for super::Rows
{
    fn from(
        value: std::rc::Rc<
...
impl
    From<
        std::rc::Rc<
            Vec<std::rc::Rc<crate::codegen::structs_codegen::tables::team_projects::TeamProject>>,
        >,
    > for super::Rows
{
    fn from(
