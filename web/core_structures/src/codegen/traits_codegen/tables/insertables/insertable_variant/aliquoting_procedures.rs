...
where
    ...
    crate::codegen::structs_codegen::tables::insertables::AliquotingProcedureExtensionAttribute: From<
        ...
        let procedure = self
            ...
            .map_err(|err| {
                err.into_field_name(|attribute| {
                    crate::codegen::structs_codegen::tables::insertables::AliquotingProcedureAttribute::Extension(
                        From::from(attribute),
                    )
                })
            })?;
