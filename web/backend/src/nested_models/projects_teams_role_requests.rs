...
impl NestedProjectsTeamsRoleRequest {
    ...
    pub fn similarity_search_viewable(
        ...
        ProjectsTeamsRoleRequest::similarity_search_viewable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn word_similarity_search_viewable(
        ...
        ProjectsTeamsRoleRequest::word_similarity_search_viewable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn similarity_search_updatable(
        ...
        ProjectsTeamsRoleRequest::similarity_search_updatable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn word_similarity_search_updatable(
        ...
        ProjectsTeamsRoleRequest::word_similarity_search_updatable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn similarity_search_administrable(
        ...
        ProjectsTeamsRoleRequest::similarity_search_administrable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn word_similarity_search_administrable(
        ...
        ProjectsTeamsRoleRequest::word_similarity_search_administrable(
            filter,
            author_user_id,
            query,
            limit,
...
impl From<web_common::database::nested_models::NestedProjectsTeamsRoleRequest>
    for NestedProjectsTeamsRoleRequest
{
    fn from(item: web_common::database::nested_models::NestedProjectsTeamsRoleRequest) -> Self {
        Self {
            inner: ProjectsTeamsRoleRequest::from(item.inner),
...
impl From<NestedProjectsTeamsRoleRequest>
    for web_common::database::nested_models::NestedProjectsTeamsRoleRequest
{
    fn from(item: NestedProjectsTeamsRoleRequest) -> Self {
        Self {
            inner: web_common::database::ProjectsTeamsRoleRequest::from(item.inner),
