...
impl diesel::Identifiable for WeighingInstrumentModel {
    type Id = i32;
    fn id(self) -> Self::Id {
        self.id
    }
}
impl WeighingInstrumentModel {
    ...
    pub async fn from_id(
        ...
        Self::table()
            .filter(
                crate::codegen::diesel_codegen::tables::weighing_instrument_models::weighing_instrument_models::dsl::id
                    .eq(id.id),
            )
            .first::<Self>(conn)
            .await
    ...
    pub async fn from_created_by(
        ...
        Self::table()
            .filter(
                crate::codegen::diesel_codegen::tables::weighing_instrument_models::weighing_instrument_models::dsl::created_by
                    .eq(created_by.id),
            )
            .load::<Self>(conn)
            .await
    ...
    pub async fn from_updated_by(
        ...
        Self::table()
            .filter(
                crate::codegen::diesel_codegen::tables::weighing_instrument_models::weighing_instrument_models::dsl::updated_by
                    .eq(updated_by.id),
            )
            .load::<Self>(conn)
            .await
    ...
    pub async fn from_created_at(
        ...
        Self::table()
            .filter(weighing_instrument_models::created_at.eq(created_at))
    ...
    pub async fn from_updated_at(
        ...
        use crate::codegen::diesel_codegen::tables::weighing_instrument_models::weighing_instrument_models;
        Self::table()
            .filter(weighing_instrument_models::updated_at.eq(updated_at))
            .order_by(weighing_instrument_models::id.asc())
            .load::<Self>(conn)
            .await
    }
