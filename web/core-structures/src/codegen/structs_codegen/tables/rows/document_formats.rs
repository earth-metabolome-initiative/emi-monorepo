...
impl From<std::rc::Rc<crate::codegen::structs_codegen::tables::document_formats::DocumentFormat>>
    for super::Rows
{
    fn from(
        value: std::rc::Rc<
...
impl
    From<
        Vec<std::rc::Rc<crate::codegen::structs_codegen::tables::document_formats::DocumentFormat>>,
    > for super::Rows
{
    fn from(
        value: Vec<
            std::rc::Rc<crate::codegen::structs_codegen::tables::document_formats::DocumentFormat>,
        >,
    ) -> Self {
        Self::from(std::rc::Rc::new(value))
    }
...
impl
    From<
        std::rc::Rc<Vec<crate::codegen::structs_codegen::tables::document_formats::DocumentFormat>>,
    > for super::Rows
{
    fn from(
        value: std::rc::Rc<
