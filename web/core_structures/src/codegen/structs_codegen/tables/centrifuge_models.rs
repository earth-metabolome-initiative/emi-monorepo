...
impl web_common_traits::prelude::ExtensionTable<crate::PhysicalAssetModel> for CentrifugeModel where
    for<'a> &'a Self: diesel::Identifiable<Id = &'a i32>
{
}
impl web_common_traits::prelude::ExtensionTable<crate::CentrifugeModel> for CentrifugeModel where
    for<'a> &'a Self: diesel::Identifiable<Id = &'a i32>
{
}
