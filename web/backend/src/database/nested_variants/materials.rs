...
pub struct NestedMaterial {
    pub inner: crate::database::flat_variants::Material,
...
impl From<web_common::database::nested_variants::NestedMaterial>
    for crate::database::nested_variants::NestedMaterial
{
    fn from(item: web_common::database::nested_variants::NestedMaterial) -> Self {
        Self {
            inner: crate::database::flat_variants::Material::from(item.inner.as_ref().clone()),
...
impl From<crate::database::nested_variants::NestedMaterial>
    for web_common::database::nested_variants::NestedMaterial
{
    fn from(item: crate::database::nested_variants::NestedMaterial) -> Self {
        Self {
            inner: Rc::from(web_common::database::flat_variants::Material::from(
                item.inner,
            )),
