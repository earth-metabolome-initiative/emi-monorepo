...
impl web_common_traits::database::TableField for ProjectAttribute {}
impl web_common_traits::database::HasTableType for ProjectAttribute {
...
{
    type Error = web_common_traits::database::InsertError<ProjectAttribute>;
