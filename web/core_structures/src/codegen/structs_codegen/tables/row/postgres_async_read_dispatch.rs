    ...
    async fn read(
        ...
        match primary_key {
            ...
            crate::codegen::tables::table_primary_keys::TablePrimaryKey::Document(
                ...
                Ok(
                    <crate::codegen::structs_codegen::tables::documents::Document as web_common_traits::database::AsyncRead<
                        diesel_async::AsyncPgConnection,
                    >>::read_async(primary_key, conn)
                        .await?
                        .map(super::Row::from),
            ...
            crate::codegen::tables::table_primary_keys::TablePrimaryKey::ParentProcedureModel(
                ...
                Ok(
                    <crate::codegen::structs_codegen::tables::parent_procedure_models::ParentProcedureModel as web_common_traits::database::AsyncRead<
                        diesel_async::AsyncPgConnection,
                    >>::read_async(primary_key, conn)
                        .await?
                        .map(super::Row::from),
            ...
            crate::codegen::tables::table_primary_keys::TablePrimaryKey::StepModelTrackableCategory(
                ...
                Ok(
                    <crate::codegen::structs_codegen::tables::step_model_trackable_categories::StepModelTrackableCategory as web_common_traits::database::AsyncRead<
                        diesel_async::AsyncPgConnection,
                    >>::read_async(primary_key, conn)
                        .await?
                        .map(super::Row::from),
            ...
            crate::codegen::tables::table_primary_keys::TablePrimaryKey::TrackableCategory(
                ...
                Ok(
                    <crate::codegen::structs_codegen::tables::trackable_categories::TrackableCategory as web_common_traits::database::AsyncRead<
                        diesel_async::AsyncPgConnection,
                    >>::read_async(primary_key, conn)
                        .await?
                        .map(super::Row::from),
