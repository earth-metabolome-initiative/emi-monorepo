...
.inner_join(
   projects::dsl::projects.on(
       projects_teams_role_requests::dsl::table_id.eq(
           projects::dsl::id
        )
    )
)
...
.inner_join(
   teams::dsl::teams.on(
       projects_teams_role_requests::dsl::team_id.eq(
           teams::dsl::id
        )
    )
)
...
.inner_join(
   roles::dsl::roles.on(
       projects_teams_role_requests::dsl::role_id.eq(
           roles::dsl::id
        )
    )
)
            ...
            .filter(can_view_projects_teams_role_requests(author_user_id, projects_teams_role_requests::dsl::table_id, projects_teams_role_requests::dsl::team_id))
            .filter(
similarity_op(concat_projects_name_description(projects::dsl::name, projects::dsl::description), query)    .or(
   ...
   roles::dsl::roles.on(
       projects_teams_role_requests::dsl::role_id.eq(
           roles::dsl::id
            ...
            .filter(can_view_projects_teams_role_requests(author_user_id, projects_teams_role_requests::dsl::table_id, projects_teams_role_requests::dsl::team_id))
            .filter(
word_similarity_op(concat_projects_name_description(projects::dsl::name, projects::dsl::description), query)    .or(
   ...
   roles::dsl::roles.on(
       projects_teams_role_requests::dsl::role_id.eq(
           roles::dsl::id
            ...
            .filter(can_view_projects_teams_role_requests(author_user_id, projects_teams_role_requests::dsl::table_id, projects_teams_role_requests::dsl::team_id))
            .filter(
strict_word_similarity_op(concat_projects_name_description(projects::dsl::name, projects::dsl::description), query)    .or(
