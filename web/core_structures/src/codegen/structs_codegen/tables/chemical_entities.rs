...
pub struct ChemicalEntity {
    ...
    pub purity: f32,
    pub gram_per_mole: f32,
    pub created_by: i32,
    pub created_at: ::rosetta_timestamp::TimestampUTC,
    pub updated_by: i32,
    pub updated_at: ::rosetta_timestamp::TimestampUTC,
}
impl diesel::Identifiable for ChemicalEntity {
    type Id = i32;
    fn id(self) -> Self::Id {
        self.id
    }
...
impl ChemicalEntity {
    ...
    pub async fn from_created_by(
        ...
        Self::table()
            .filter(
                crate::codegen::diesel_codegen::tables::chemical_entities::chemical_entities::dsl::created_by
                    .eq(created_by.id),
            )
            .load::<Self>(conn)
            .await
    ...
    pub async fn from_updated_by(
        ...
        Self::table()
            .filter(
                crate::codegen::diesel_codegen::tables::chemical_entities::chemical_entities::dsl::updated_by
                    .eq(updated_by.id),
            )
            .load::<Self>(conn)
            .await
    ...
    pub async fn from_description(
        ...
        use crate::codegen::diesel_codegen::tables::chemical_entities::chemical_entities;
        Self::table()
            .filter(chemical_entities::description.eq(description))
            .order_by(chemical_entities::id.asc())
            .load::<Self>(conn)
            .await
    }
    #[cfg(feature = "postgres")]
    pub async fn from_created_at(
        ...
        use crate::codegen::diesel_codegen::tables::chemical_entities::chemical_entities;
        Self::table()
            .filter(chemical_entities::created_at.eq(created_at))
            .order_by(chemical_entities::id.asc())
            .load::<Self>(conn)
            .await
    }
    ...
    pub async fn from_updated_at(
        ...
        use crate::codegen::diesel_codegen::tables::chemical_entities::chemical_entities;
        Self::table()
            .filter(chemical_entities::updated_at.eq(updated_at))
            .order_by(chemical_entities::id.asc())
            .load::<Self>(conn)
            .await
    }
