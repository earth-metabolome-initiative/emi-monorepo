...
pub struct FreezeDryerModelForeignKeys {
    pub id: Option<crate::PhysicalAssetModel>,
}
impl web_common_traits::prelude::HasForeignKeys for crate::FreezeDryerModel {
    type ForeignKeys = FreezeDryerModelForeignKeys;
...
impl web_common_traits::prelude::ForeignKeys for FreezeDryerModelForeignKeys {}
