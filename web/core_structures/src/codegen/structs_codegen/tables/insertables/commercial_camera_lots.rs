...
impl core::fmt::Display for CommercialCameraLotExtensionAttribute {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            Self::CommercialProductLot(e) => write!(f, "commercial_camera_lots({e})"),
            Self::CameraModel(e) => write!(f, "commercial_camera_lots({e})"),
        }
    }
}
...
impl From<common_traits::builder::EmptyTuple> for CommercialCameraLotExtensionAttribute {
...
impl<CommercialProductLot, CameraModel> diesel::associations::HasTable
    for InsertableCommercialCameraLotBuilder<CommercialProductLot, CameraModel>
{
    type Table = crate::codegen::diesel_codegen::tables::commercial_camera_lots::commercial_camera_lots::table;
    fn table() -> Self::Table {
        crate::codegen::diesel_codegen::tables::commercial_camera_lots::commercial_camera_lots::table
    }
}
...
where
    Self: common_traits::builder::Attributed<
        Attribute = crate::codegen::structs_codegen::tables::insertables::CommercialCameraLotAttribute,
    >,
{
        ...
        PM: web_common_traits::database::PrimaryKeyLike<PrimaryKey = i32>,
    {
        ...
        self.commercial_camera_lots_id_fkey = <CommercialProductLot as crate::codegen::structs_codegen::tables::insertables::PhysicalAssetModelSettable>::parent_model(
                self.commercial_camera_lots_id_fkey,
                product_model,
            )
            .map_err(|err| {
    ...
    >,
{
    ...
    {
        self.commercial_camera_lots_id_fkey = <CommercialProductLot as crate::codegen::structs_codegen::tables::insertables::AssetModelSettable>::name(
                self.commercial_camera_lots_id_fkey,
                name,
            )
            .map_err(|e| {
    ...
    {
        self.commercial_camera_lots_id_fkey = <CommercialProductLot as crate::codegen::structs_codegen::tables::insertables::AssetModelSettable>::description(
                self.commercial_camera_lots_id_fkey,
                description,
            )
            .map_err(|e| {
    ...
    {
        self.commercial_camera_lots_id_fkey = <CommercialProductLot as crate::codegen::structs_codegen::tables::insertables::AssetModelSettable>::created_by(
                self.commercial_camera_lots_id_fkey,
                created_by,
            )
            .map_err(|e| {
    ...
    where
        ...
        >,
    {
        self.commercial_camera_lots_id_fkey = <CommercialProductLot as crate::codegen::structs_codegen::tables::insertables::AssetModelSettable>::created_at(
                self.commercial_camera_lots_id_fkey,
                created_at,
            )
            .map_err(|e| {
    ...
    {
        self.commercial_camera_lots_id_fkey = <CommercialProductLot as crate::codegen::structs_codegen::tables::insertables::AssetModelSettable>::updated_by(
                self.commercial_camera_lots_id_fkey,
                updated_by,
            )
            .map_err(|e| {
    ...
    where
        ...
        >,
    {
        self.commercial_camera_lots_id_fkey = <CommercialProductLot as crate::codegen::structs_codegen::tables::insertables::AssetModelSettable>::updated_at(
                self.commercial_camera_lots_id_fkey,
                updated_at,
            )
            .map_err(|e| {
