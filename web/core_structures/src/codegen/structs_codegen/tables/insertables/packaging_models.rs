...
impl core::fmt::Display for PackagingModelExtensionAttribute {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            Self::PhysicalAssetModel(e) => write!(f, "packaging_models({e})"),
        }
    }
}
...
impl From<common_traits::builder::EmptyTuple> for PackagingModelExtensionAttribute {
...
impl<T1> common_traits::builder::Attributed
    for crate::codegen::structs_codegen::tables::insertables::InsertablePackagingModelBuilder<T1>
{
    type Attribute = PackagingModelAttribute;
}
impl web_common_traits::database::TableField for PackagingModelAttribute {}
impl web_common_traits::database::HasTableType for PackagingModelAttribute {
    ...
    > for PackagingModelAttribute
{
    fn from_extension(
        ...
        PackagingModelAttribute::Extension(From::from(attribute))
    }
}
...
impl core::fmt::Display for PackagingModelAttribute {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            ...
            Self::Id => write!(f, "packaging_models.id"),
        }
    }
}
#[derive(Debug)]
...
/// [`PackagingModel`](crate::codegen::structs_codegen::tables::packaging_models::PackagingModel).
///
///
...
///
/// ```rust,ignore
/// use core_structures::PackagingModel;
...
///
/// let packaging_model = PackagingModel::new()
...
{
    type Table = crate::codegen::diesel_codegen::tables::packaging_models::packaging_models::table;
    fn table() -> Self::Table {
        crate::codegen::diesel_codegen::tables::packaging_models::packaging_models::table
    }
}
...
{
    type Error = web_common_traits::database::InsertError<PackagingModelAttribute>;
