...
impl From<web_common::database::flat_variants::UsersUsersRoleInvitation>
    for crate::database::flat_variants::UsersUsersRoleInvitation
{
    fn from(item: web_common::database::flat_variants::UsersUsersRoleInvitation) -> Self {
        Self {
...
impl From<crate::database::flat_variants::UsersUsersRoleInvitation>
    for web_common::database::flat_variants::UsersUsersRoleInvitation
{
    fn from(item: crate::database::flat_variants::UsersUsersRoleInvitation) -> Self {
        Self {
            table_id: item.table_id,
            user_id: item.user_id,
            role_id: item.role_id,
...
impl UsersUsersRoleInvitation {
    ...
    pub fn can_view_by_id(
        ...
        diesel::select(
            crate::database::sql_function_bindings::can_view_users_users_role_invitations(
                author_user_id,
                table_id,
                user_id,
            ),
    ...
    pub fn all_viewable(
        ...
        let query = users_users_role_invitations::dsl::users_users_role_invitations
            ...
            .order_by(users_users_role_invitations::dsl::table_id);
    ...
    pub fn strict_word_similarity_search_viewable(
        ...
        let mut query = users_users_role_invitations::dsl::users_users_role_invitations
            ...
            .inner_join(
                roles::dsl::roles.on(users_users_role_invitations::dsl::role_id.eq(roles::dsl::id)),
            )
            .select(UsersUsersRoleInvitation::as_select())
            .filter(
                crate::database::sql_function_bindings::can_view_users_users_role_invitations(
    ...
    pub fn strict_word_similarity_search_with_score_viewable(
        ...
        users_users_role_invitations::dsl::users_users_role_invitations
            ...
            .select((
                UsersUsersRoleInvitation::as_select(),
                crate::database::sql_function_bindings::strict_word_similarity_dist_op(
                    crate::database::sql_function_bindings::concat_roles_name(
                        roles::dsl::name,
                        roles::dsl::description,
    ...
    pub fn can_update_by_id(
        ...
        diesel::select(
            crate::database::sql_function_bindings::can_update_users_users_role_invitations(
                author_user_id,
                table_id,
                user_id,
            ),
    ...
    pub fn can_admin_by_id(
        ...
        diesel::select(
            crate::database::sql_function_bindings::can_admin_users_users_role_invitations(
                author_user_id,
                table_id,
                user_id,
            ),
    ...
    pub fn delete_by_id(
        ...
        diesel::delete(
            crate::database::users_users_role_invitations::dsl::users_users_role_invitations
                .filter(crate::database::users_users_role_invitations::dsl::table_id.eq(table_id))
                .filter(crate::database::users_users_role_invitations::dsl::user_id.eq(user_id)),
        )
        .execute(connection)
        .map_err(web_common::api::ApiError::from)
    }
