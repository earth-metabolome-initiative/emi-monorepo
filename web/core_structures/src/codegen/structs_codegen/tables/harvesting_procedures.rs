...
impl HarvestingProcedure {
    ...
    where
        ...
        <Self as diesel::associations::HasTable>::Table: diesel::query_dsl::methods::FilterDsl<
            <crate::codegen::diesel_codegen::tables::harvesting_procedures::harvesting_procedures::procedure as diesel::expression_methods::EqAll<
                ::rosetta_uuid::Uuid,
            >>::Output,
        >,
            ...
            + for<'a> diesel::query_dsl::LoadQuery<'a, C, Self>,
    {
        ...
        Self::table()
            .filter(harvesting_procedures::procedure.eq(procedure))
    ...
    pub fn from_procedure_and_procedure_template(
        ...
        Self::table()
            .filter(
                harvesting_procedures::procedure
                    .eq(procedure)
                    .and(harvesting_procedures::procedure_template.eq(procedure_template)),
            )
            .order_by(harvesting_procedures::procedure.asc())
            .load::<Self>(conn)
    }
