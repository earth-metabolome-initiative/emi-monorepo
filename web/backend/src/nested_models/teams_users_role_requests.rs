...
impl NestedTeamsUsersRoleRequest {
    ...
    pub fn similarity_search_viewable(
        ...
        TeamsUsersRoleRequest::similarity_search_viewable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn word_similarity_search_viewable(
        ...
        TeamsUsersRoleRequest::word_similarity_search_viewable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn similarity_search_updatable(
        ...
        TeamsUsersRoleRequest::similarity_search_updatable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn word_similarity_search_updatable(
        ...
        TeamsUsersRoleRequest::word_similarity_search_updatable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn similarity_search_administrable(
        ...
        TeamsUsersRoleRequest::similarity_search_administrable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn word_similarity_search_administrable(
        ...
        TeamsUsersRoleRequest::word_similarity_search_administrable(
            filter,
            author_user_id,
            query,
            limit,
...
impl From<web_common::database::nested_models::NestedTeamsUsersRoleRequest>
    for NestedTeamsUsersRoleRequest
{
    fn from(item: web_common::database::nested_models::NestedTeamsUsersRoleRequest) -> Self {
        Self {
            inner: TeamsUsersRoleRequest::from(item.inner),
...
impl From<NestedTeamsUsersRoleRequest>
    for web_common::database::nested_models::NestedTeamsUsersRoleRequest
{
    fn from(item: NestedTeamsUsersRoleRequest) -> Self {
        Self {
            inner: web_common::database::TeamsUsersRoleRequest::from(item.inner),
