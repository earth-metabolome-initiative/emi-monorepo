...
CREATE TABLE IF NOT EXISTS procedures.procedures (
	...
	procedure_template INTEGER NOT NULL REFERENCES procedure_templates.procedure_templates(procedure_template),
...
CREATE TABLE IF NOT EXISTS procedure_assets (
	procedure UUID NOT NULL REFERENCES procedures.procedures(procedure),
	procedure_template INTEGER NOT NULL REFERENCES procedure_templates.procedure_templates(procedure_template),
