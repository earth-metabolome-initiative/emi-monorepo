...
impl core::fmt::Display for UnitAttribute {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            Self::Name => write!(f, "units.name"),
            Self::Unit => write!(f, "units.unit"),
            Self::Icon => write!(f, "units.icon"),
            Self::ColorId => write!(f, "units.color_id"),
            Self::Id => write!(f, "units.id"),
        }
    }
}
#[derive(Debug)]
...
///
/// ```rust,ignore
/// use core_structures::Unit;
/// use core_structures::tables::insertables::UnitSettable;
...
impl diesel::associations::HasTable for InsertableUnitBuilder {
    type Table = crate::codegen::diesel_codegen::tables::units::units::table;
    fn table() -> Self::Table {
        crate::codegen::diesel_codegen::tables::units::units::table
    }
}
...
where
    Self: common_traits::builder::Attributed<
            Attribute = crate::codegen::structs_codegen::tables::insertables::UnitAttribute,
        >,
{
