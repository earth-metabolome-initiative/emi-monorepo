...
pub struct PersonalProtectiveEquipmentModelForeignKeys {
    pub id:
...
for crate::codegen::structs_codegen::tables::personal_protective_equipment_models::PersonalProtectiveEquipmentModel {
    type ForeignKeys = PersonalProtectiveEquipmentModelForeignKeys;
...
impl web_common_traits::prelude::ForeignKeys for PersonalProtectiveEquipmentModelForeignKeys {}
