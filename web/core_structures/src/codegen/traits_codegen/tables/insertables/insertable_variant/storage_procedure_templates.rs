...
where
    ...
    crate::codegen::structs_codegen::tables::insertables::StorageProcedureTemplateExtensionAttribute: From<
        ...
        let procedure_template = self
            ...
            .map_err(|err| {
                err.into_field_name(|attribute| {
                    crate::codegen::structs_codegen::tables::insertables::StorageProcedureTemplateAttribute::Extension(
                        From::from(attribute),
                    )
                })
            })?;
