...
impl Filtrable for crate::database::flat_variants::SampleContainerCategory {
    type Filter = crate::database::filter_variants::SampleContainerCategoryFilter;
}
#[cfg(feature = "frontend")]
impl AllRecords for SampleContainerCategory {
...
impl SampleContainerCategory {
    ...
    async fn insert<C: gluesql::core::store::GStore + gluesql::core::store::GStoreMut>(
        ...
        Ok(table("sample_container_categories")
            .insert()
