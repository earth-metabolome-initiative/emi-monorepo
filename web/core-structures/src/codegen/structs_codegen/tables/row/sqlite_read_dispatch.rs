    ...
    fn read(
        ...
        match primary_key {
            ...
            crate::codegen::tables::table_primary_keys::TablePrimaryKey::ProcedureStepModel(
                ...
                Ok(
                    <crate::codegen::structs_codegen::tables::procedure_step_models::ProcedureStepModel as web_common_traits::database::Read<
                        diesel::SqliteConnection,
                    >>::read(primary_key, conn)?
                        .map(super::Row::from),
                )
            ...
            crate::codegen::tables::table_primary_keys::TablePrimaryKey::StepModelCategory(
                ...
                Ok(
                    <crate::codegen::structs_codegen::tables::step_model_categories::StepModelCategory as web_common_traits::database::Read<
                        diesel::SqliteConnection,
                    >>::read(primary_key, conn)?
                        .map(super::Row::from),
                )
