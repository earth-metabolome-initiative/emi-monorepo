...
pub enum PipetteTipModelExtensionAttribute {
    PhysicalAssetModel(
        crate::codegen::structs_codegen::tables::insertables::PhysicalAssetModelAttribute,
    ),
}
impl core::fmt::Display for PipetteTipModelExtensionAttribute {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            Self::PhysicalAssetModel(e) => write!(f, "pipette_tip_models({e})"),
        }
    }
}
impl From<crate::codegen::structs_codegen::tables::insertables::PhysicalAssetModelAttribute>
    for PipetteTipModelExtensionAttribute
{
    fn from(
...
impl From<common_traits::builder::EmptyTuple> for PipetteTipModelExtensionAttribute {
...
#[derive(Copy, Clone, PartialEq, Eq, PartialOrd, Ord, Hash, core::fmt::Debug)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub enum PipetteTipModelAttribute {
    Extension(PipetteTipModelExtensionAttribute),
    Id,
}
impl core::str::FromStr for PipetteTipModelAttribute {
...
impl<T1> common_traits::builder::Attributed
    for crate::codegen::structs_codegen::tables::insertables::InsertablePipetteTipModelBuilder<T1>
{
    type Attribute = PipetteTipModelAttribute;
}
impl web_common_traits::database::TableField for PipetteTipModelAttribute {}
impl web_common_traits::database::HasTableType for PipetteTipModelAttribute {
    type Table = crate::codegen::tables::table_names::TableName;
}
impl
    web_common_traits::database::FromExtension<
        crate::codegen::structs_codegen::tables::insertables::PhysicalAssetModelAttribute,
    > for PipetteTipModelAttribute
{
    fn from_extension(
        attribute: crate::codegen::structs_codegen::tables::insertables::PhysicalAssetModelAttribute,
    ) -> Self {
        PipetteTipModelAttribute::Extension(From::from(attribute))
    }
}
...
impl core::fmt::Display for PipetteTipModelAttribute {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            Self::Extension(e) => write!(f, "{e}"),
            Self::Id => write!(f, "pipette_tip_models.id"),
        }
    }
}
#[derive(Debug)]
...
///
/// ```rust,ignore
/// use core_structures::PipetteTipModel;
...
///
/// let pipette_tip_model = PipetteTipModel::new()
...
impl<PhysicalAssetModel> diesel::associations::HasTable
    for InsertablePipetteTipModelBuilder<PhysicalAssetModel>
{
    type Table =
        crate::codegen::diesel_codegen::tables::pipette_tip_models::pipette_tip_models::table;
    fn table() -> Self::Table {
        crate::codegen::diesel_codegen::tables::pipette_tip_models::pipette_tip_models::table
    }
}
impl From<InsertablePipetteTipModelBuilder>
    for web_common_traits::database::IdOrBuilder<i32, InsertablePipetteTipModelBuilder>
{
    fn from(builder: InsertablePipetteTipModelBuilder) -> Self {
...
/// Trait defining setters for attributes of an instance of `PipetteTipModel` or
/// descendant tables.
pub trait PipetteTipModelSettable: Sized {
    /// Error type returned when setting attributes.
    type Error;
}
impl<PhysicalAssetModel> PipetteTipModelSettable
for InsertablePipetteTipModelBuilder<PhysicalAssetModel>
where
...
where
    Self: web_common_traits::database::DispatchableInsertableVariant<
            ...
            Error = web_common_traits::database::InsertError<PipetteTipModelAttribute>,
        > + web_common_traits::database::SetPrimaryKey<PrimaryKey = i32>
        + common_traits::builder::IsCompleteBuilder,
{
    type Error = web_common_traits::database::InsertError<PipetteTipModelAttribute>;
