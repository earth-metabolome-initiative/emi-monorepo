...
where
    ...
    crate::codegen::structs_codegen::tables::insertables::WeighingProcedureExtensionAttribute: From<
        ...
        let procedure = self
            ...
            .map_err(|err| {
                err.into_field_name(|attribute| {
                    crate::codegen::structs_codegen::tables::insertables::WeighingProcedureAttribute::Extension(
                        From::from(attribute),
                    )
                })
            })?;
