...
CREATE FUNCTION can_update_sample_bio_ott_taxon_items(author_user_id INTEGER, this_sample_bio_ott_taxon_items_sample_id UUID, this_sample_bio_ott_taxon_items_taxon_id INTEGER)
RETURNS BOOLEAN AS $$
DECLARE
