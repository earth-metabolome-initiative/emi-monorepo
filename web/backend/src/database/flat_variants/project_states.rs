...
#[diesel(table_name = crate::database::schema::project_states)]
...
impl From<web_common::database::flat_variants::ProjectState>
    for crate::database::flat_variants::ProjectState
{
    fn from(item: web_common::database::flat_variants::ProjectState) -> Self {
        Self {
            id: item.id,
            name: item.name,
...
impl From<crate::database::flat_variants::ProjectState>
    for web_common::database::flat_variants::ProjectState
{
    fn from(item: crate::database::flat_variants::ProjectState) -> Self {
        Self {
            id: item.id,
            name: item.name,
            description: item.description,
...
impl ProjectState {
    ...
    pub fn all_viewable(
        ...
        use crate::database::schema::project_states;
        let query = project_states::dsl::project_states
            .select(ProjectState::as_select())
            .order_by(project_states::dsl::id);
    ...
    pub fn strict_word_similarity_search_viewable(
        ...
        let mut query = project_states::dsl::project_states
            .select(ProjectState::as_select())
            .filter(
                crate::database::sql_function_bindings::concat_project_states_name_description(
