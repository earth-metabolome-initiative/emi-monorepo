...
pub struct BallMillStepModelForeignKeys {
...
{
    type ForeignKeys = BallMillStepModelForeignKeys;
...
impl web_common_traits::prelude::ForeignKeys for BallMillStepModelForeignKeys {}
