...
pub struct ShakingStepModelForeignKeys {
...
{
    type ForeignKeys = ShakingStepModelForeignKeys;
...
impl web_common_traits::prelude::ForeignKeys for ShakingStepModelForeignKeys {}
