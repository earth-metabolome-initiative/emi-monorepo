...
impl web_common_traits::database::ExtendableBuilder for InsertableProjectStateBuilder {
...
impl crate::codegen::structs_codegen::tables::insertables::InsertableProjectStateBuilder {
    /// Sets the value of the `project_states.color_id` column from table
    /// `project_states`.
    pub fn color(
        mut self,
        color_id: i16,
...
impl crate::codegen::structs_codegen::tables::insertables::InsertableProjectStateBuilder {
    /// Sets the value of the `project_states.description` column from table
    /// `project_states`.
...
impl crate::codegen::structs_codegen::tables::insertables::InsertableProjectStateBuilder {
    /// Sets the value of the `project_states.icon` column from table
    /// `project_states`.
    pub fn icon<P>(
        mut self,
        icon: P,
...
impl crate::codegen::structs_codegen::tables::insertables::InsertableProjectStateBuilder {
    /// Sets the value of the `project_states.name` column from table
    /// `project_states`.
    pub fn name<P>(
        mut self,
        name: P,
