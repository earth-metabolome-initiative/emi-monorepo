...
impl web_common_traits::database::PrimaryKeyLike for CommercialPackagingLot {
    type PrimaryKey = i32;
...
impl CommercialPackagingLot {
    ...
    where
        ...
        <Self as diesel::associations::HasTable>::Table: diesel::query_dsl::methods::FilterDsl<
            <crate::codegen::diesel_codegen::tables::commercial_packaging_lots::commercial_packaging_lots::id as diesel::expression_methods::EqAll<
                i32,
            >>::Output,
        >,
        ...
        >>::Output: diesel::query_dsl::methods::OrderDsl<
            diesel::helper_types::Asc<
                crate::codegen::diesel_codegen::tables::commercial_packaging_lots::commercial_packaging_lots::id,
            >,
        >,
        <<<Self as diesel::associations::HasTable>::Table as diesel::query_dsl::methods::FilterDsl<
            <crate::codegen::diesel_codegen::tables::commercial_packaging_lots::commercial_packaging_lots::id as diesel::expression_methods::EqAll<
