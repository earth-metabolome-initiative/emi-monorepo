...
pub struct CapModelForeignKeys {
    pub id: Option<crate::PhysicalAssetModel>,
}
impl web_common_traits::prelude::HasForeignKeys for crate::CapModel {
    type ForeignKeys = CapModelForeignKeys;
...
impl web_common_traits::prelude::ForeignKeys for CapModelForeignKeys {}
