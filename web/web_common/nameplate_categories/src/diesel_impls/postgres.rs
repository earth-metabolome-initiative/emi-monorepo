...
impl diesel::deserialize::FromSql<crate::diesel_impls::NameplateCategory, diesel::pg::Pg>
...
impl diesel::serialize::ToSql<crate::diesel_impls::NameplateCategory, diesel::pg::Pg>
    for crate::NameplateCategory
{
    fn to_sql<'b>(
        &'b self,
