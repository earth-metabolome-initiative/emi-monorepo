...
impl crate::database::Tabular for NestedProjectState {
    const TABLE: crate::database::Table = crate::database::Table::ProjectStates;
}
impl crate::database::Filtrable for NestedProjectState {
    type Filter = crate::database::filter_variants::ProjectStateFilter;
}
impl crate::database::Describable for NestedProjectState {
    fn description(&self) -> Option<&str> {
        self.inner.description()
    }
}
impl crate::database::Colorable for NestedProjectState {
    fn color(&self) -> Option<&str> {
        Some(self.color.name.as_str())
    }
}
#[cfg(feature = "frontend")]
impl crate::database::AllRecords for NestedProjectState {
...
impl NestedProjectState {
    ...
    pub(crate) async fn from_flat(
        flat_variant: crate::database::flat_variants::ProjectState,
    ...
    pub async fn get<C: gluesql::core::store::GStore + gluesql::core::store::GStoreMut>(
        ...
        if let Some(flat_variant) =
            crate::database::flat_variants::ProjectState::get(id, connection).await?
        {
    ...
    >(
        ...
        crate::database::flat_variants::ProjectState::delete_from_id(id, connection).await
    }
    ...
    pub async fn all<C: gluesql::core::store::GStore + gluesql::core::store::GStoreMut>(
        ...
        let mut project_states = Vec::new();
        for flat_variant in
            crate::database::flat_variants::ProjectState::all(filter, limit, offset, connection)
                .await?
                .into_iter()
        {
            project_states.push(Self::from_flat(flat_variant, connection).await?);
        }
        Ok(project_states)
    }
    ...
    >(
        ...
        crate::database::flat_variants::Color::update_or_insert(self.color.as_ref(), connection)
            .await?;
        crate::database::flat_variants::ProjectState::update_or_insert(
            self.inner.as_ref(),
            connection,
        )
        .await
