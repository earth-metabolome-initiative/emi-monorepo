...
| Crate | Description | Status | Crates.io |
|-------|-------------|--------|-----------|
| [`elements-rs`](https://github.com/earth-metabolome-initiative/emi-monorepo/tree/main/web/web_common/elements-rs) | [Chemical elements](https://en.wikipedia.org/wiki/Chemical_element) and their [isotopes](https://en.wikipedia.org/wiki/Isotope) | [![Test](https://github.com/earth-metabolome-initiative/emi-monorepo/actions/workflows/cargo-test-elements-rs.yml/badge.svg)](https://github.com/earth-metabolome-initiative/emi-monorepo/actions/workflows/cargo-test-elements-rs.yml) | [![Crates.io](https://img.shields.io/crates/v/elements-rs.svg)](https://crates.io/crates/elements-rs) |
