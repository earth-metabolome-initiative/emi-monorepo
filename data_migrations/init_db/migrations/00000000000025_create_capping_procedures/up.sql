CREATE TABLE IF NOT EXISTS procedure_templates.capping_procedure_templates (
	...
	-- We define a same-as index to allow for foreign key references to check whether a `capping_procedure_templates.procedure_template`
	-- is associated with a given `capping_procedure_templates.foreign_procedure_template`.
	UNIQUE (procedure_template, foreign_procedure_template)
);
CREATE TABLE IF NOT EXISTS procedures.capping_procedures (
	...
	procedure_template INTEGER NOT NULL REFERENCES procedure_templates.capping_procedure_templates(procedure_template),
	...
	capped_with_model INTEGER NOT NULL REFERENCES caps_models(id),
	-- We ensure that the parent table's procedure_template is indeed a capping_procedure_templates.
	...
	FOREIGN KEY (procedure_template, foreign_procedure_template) REFERENCES procedure_templates.capping_procedure_templates(procedure_template, foreign_procedure_template)
);