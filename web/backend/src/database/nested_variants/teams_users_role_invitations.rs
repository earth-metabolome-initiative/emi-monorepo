...
pub struct NestedTeamsUsersRoleInvitation {
    ...
    pub table: crate::database::nested_variants::NestedTeam,
...
impl NestedTeamsUsersRoleInvitation {
    ...
    pub(crate) fn from_flat(
        ...
        Ok(Self {
            table: crate::database::nested_variants::NestedTeam::get(
    ...
    /// * `connection` - The connection to the database.
    pub fn all_viewable(
        filter: Option<&web_common::database::filter_variants::TeamsUsersRoleInvitationFilter>,
        author_user_id: Option<i32>,
        limit: Option<i64>,
        offset: Option<i64>,
        connection: &mut diesel::r2d2::PooledConnection<
        ...
        TeamsUsersRoleInvitation::all_viewable(filter, author_user_id, limit, offset, connection)?
            .into_iter()
    ...
    pub fn all_viewable_sorted(
        ...
        TeamsUsersRoleInvitation::all_viewable_sorted(
            filter,
            author_user_id,
            limit,
            offset,
    ...
    pub fn get(
        ...
        TeamsUsersRoleInvitation::get((table_id, user_id), author_user_id, connection)
    ...
    pub fn strict_word_similarity_search_viewable(
        ...
        TeamsUsersRoleInvitation::strict_word_similarity_search_viewable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn strict_word_similarity_search_with_score_viewable(
        ...
        TeamsUsersRoleInvitation::strict_word_similarity_search_with_score_viewable(
            author_user_id,
            query,
            limit,
            offset,
    ...
    pub fn can_update_by_id() -> Result<bool, web_common::api::ApiError> {
        TeamsUsersRoleInvitation::can_update_by_id()
    }
    ...
    pub fn all_updatable(
        ...
        TeamsUsersRoleInvitation::all_updatable(filter, author_user_id, limit, offset, connection)?
            .into_iter()
            .map(|flat_variant| Self::from_flat(flat_variant, connection))
            .collect()
    }
    ...
    pub fn all_updatable_sorted(
        ...
        TeamsUsersRoleInvitation::all_updatable_sorted(
            filter,
            author_user_id,
            limit,
            offset,
    ...
    pub fn strict_word_similarity_search_updatable(
        ...
        TeamsUsersRoleInvitation::strict_word_similarity_search_updatable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn all_administrable(
        ...
        TeamsUsersRoleInvitation::all_administrable(
            filter,
            author_user_id,
            limit,
            offset,
    ...
    pub fn all_administrable_sorted(
        ...
        TeamsUsersRoleInvitation::all_administrable_sorted(
            filter,
            author_user_id,
            limit,
            offset,
    ...
    pub fn strict_word_similarity_search_administrable(
        ...
        TeamsUsersRoleInvitation::strict_word_similarity_search_administrable(
            filter,
            author_user_id,
            query,
            limit,
...
impl From<web_common::database::nested_variants::NestedTeamsUsersRoleInvitation>
    for crate::database::nested_variants::NestedTeamsUsersRoleInvitation
{
    fn from(item: web_common::database::nested_variants::NestedTeamsUsersRoleInvitation) -> Self {
        Self {
            inner: crate::database::flat_variants::TeamsUsersRoleInvitation::from(item.inner),
            table: crate::database::nested_variants::NestedTeam::from(item.table.as_ref().clone()),
...
impl From<crate::database::nested_variants::NestedTeamsUsersRoleInvitation>
    for web_common::database::nested_variants::NestedTeamsUsersRoleInvitation
{
    fn from(item: crate::database::nested_variants::NestedTeamsUsersRoleInvitation) -> Self {
        Self {
            inner: web_common::database::flat_variants::TeamsUsersRoleInvitation::from(item.inner),
            table: Rc::from(web_common::database::nested_variants::NestedTeam::from(
                item.table,
            )),
