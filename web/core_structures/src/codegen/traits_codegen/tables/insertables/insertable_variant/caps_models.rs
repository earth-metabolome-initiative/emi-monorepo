...
for crate::codegen::structs_codegen::tables::insertables::InsertableCapsModelBuilder<
    PhysicalAssetModel,
>
where
    <C as diesel::Connection>::Backend: diesel::backend::DieselReserveSpecialization,
    diesel::query_builder::InsertStatement<
        <crate::codegen::structs_codegen::tables::caps_models::CapsModel as diesel::associations::HasTable>::Table,
        <crate::codegen::structs_codegen::tables::insertables::InsertableCapsModel as diesel::Insertable<
            <crate::codegen::structs_codegen::tables::caps_models::CapsModel as diesel::associations::HasTable>::Table,
        >>::Values,
    ...
    >,
{
    ...
    type Error = web_common_traits::database::InsertError<
        crate::codegen::structs_codegen::tables::insertables::InsertableCapsModelAttributes,
    >;
    type UserId = i32;
    fn insert(
        mut self,
    ...
    fn try_insert(
        ...
        let id = self
            ...
            .map_err(|err| {
                err.into_field_name(|_| crate::codegen::structs_codegen::tables::insertables::InsertableCapsModelAttributes::Extension(
                    crate::codegen::structs_codegen::tables::insertables::InsertableCapsModelExtensionAttributes::PhysicalAssetModel(
