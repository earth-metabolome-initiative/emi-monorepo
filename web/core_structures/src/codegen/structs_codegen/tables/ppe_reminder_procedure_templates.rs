...
pub struct PpeReminderProcedureTemplate {
    pub procedure_template: i32,
    pub ppe_asset_model: i32,
    pub procedure_template_ppe_asset_model: i32,
}
impl web_common_traits::prelude::TableName for PpeReminderProcedureTemplate {
    const TABLE_NAME: &'static str = "ppe_reminder_procedure_templates";
}
impl<'a> From<&'a PpeReminderProcedureTemplate>
for web_common_traits::database::IdOrBuilder<
    i32,
    crate::codegen::structs_codegen::tables::insertables::InsertablePpeReminderProcedureTemplateBuilder,
> {
    fn from(value: &'a PpeReminderProcedureTemplate) -> Self {
...
impl
    ...
    > for PpeReminderProcedureTemplate
where
...
where
    for<'a> &'a Self: diesel::Identifiable<Id = &'a i32>,
{}
impl diesel::Identifiable for PpeReminderProcedureTemplate {
    type Id = i32;
    fn id(self) -> Self::Id {
        self.procedure_template
    }
}
impl web_common_traits::database::PrimaryKeyLike for PpeReminderProcedureTemplate {
    type PrimaryKey = i32;
    fn primary_key(&self) -> Self::PrimaryKey {
        self.procedure_template
    }
}
impl PpeReminderProcedureTemplate {
    ...
    #[cfg(feature = "postgres")]
    pub fn from_procedure_template_ppe_asset_model_and_ppe_asset_model(
        ...
        Self::table()
            .filter(
                ppe_reminder_procedure_templates::procedure_template_ppe_asset_model
                    ...
                    .and(ppe_reminder_procedure_templates::ppe_asset_model.eq(ppe_asset_model)),
            )
            .order_by(ppe_reminder_procedure_templates::procedure_template.asc())
            .load::<Self>(conn)
    }
    pub fn from_procedure_template_ppe_asset_model<C>(
        procedure_template_ppe_asset_model: i32,
        conn: &mut C,
    ) -> Result<Vec<Self>, diesel::result::Error>
    where
        ...
        <Self as diesel::associations::HasTable>::Table: diesel::query_dsl::methods::FilterDsl<
            <crate::codegen::diesel_codegen::tables::ppe_reminder_procedure_templates::ppe_reminder_procedure_templates::procedure_template_ppe_asset_model as diesel::expression_methods::EqAll<
                i32,
            >>::Output,
        >,
        ...
        >>::Output: diesel::query_dsl::methods::OrderDsl<
            diesel::helper_types::Asc<
                crate::codegen::diesel_codegen::tables::ppe_reminder_procedure_templates::ppe_reminder_procedure_templates::procedure_template,
            >,
        >,
        <<<Self as diesel::associations::HasTable>::Table as diesel::query_dsl::methods::FilterDsl<
            <crate::codegen::diesel_codegen::tables::ppe_reminder_procedure_templates::ppe_reminder_procedure_templates::procedure_template_ppe_asset_model as diesel::expression_methods::EqAll<
    ...
    pub fn from_name(
        ...
        Self::table()
            .inner_join(
                procedure_templates::table.on(ppe_reminder_procedure_templates::procedure_template
...
impl AsRef<PpeReminderProcedureTemplate> for PpeReminderProcedureTemplate {
    fn as_ref(&self) -> &PpeReminderProcedureTemplate {
        self
    }
}
