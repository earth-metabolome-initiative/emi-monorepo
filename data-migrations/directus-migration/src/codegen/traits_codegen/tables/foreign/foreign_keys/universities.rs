...
pub struct UniversityForeignKeys {
    pub user_created:
...
impl web_common_traits::prelude::HasForeignKeys
    for crate::codegen::structs_codegen::tables::universities::University
{
    type ForeignKeys = UniversityForeignKeys;
...
impl web_common_traits::prelude::ForeignKeys for UniversityForeignKeys {}
