-- Drop the `can_update_organism_bio_ott_taxon_items` function and trigger on the organism_bio_ott_taxon_items table.

DROP FUNCTION IF EXISTS can_update_organism_bio_ott_taxon_items(INTEGER, UUID, INTEGER);
