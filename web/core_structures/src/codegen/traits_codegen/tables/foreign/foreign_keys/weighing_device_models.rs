...
pub struct WeighingDeviceModelForeignKeys {
    pub id: Option<crate::PhysicalAssetModel>,
}
impl web_common_traits::prelude::HasForeignKeys for crate::WeighingDeviceModel {
    type ForeignKeys = WeighingDeviceModelForeignKeys;
...
impl web_common_traits::prelude::ForeignKeys for WeighingDeviceModelForeignKeys {}
