...
impl crate::database::Tabular for NestedProjectsTeamsRoleInvitation {
    const TABLE: crate::database::Table = crate::database::Table::ProjectsTeamsRoleInvitations;
}
impl crate::database::Filtrable for NestedProjectsTeamsRoleInvitation {
    type Filter = crate::database::filter_variants::ProjectsTeamsRoleInvitationFilter;
}
impl crate::database::Describable for NestedProjectsTeamsRoleInvitation {
    fn description(&self) -> Option<&str> {
        self.inner.description()
    }
}
impl crate::database::Colorable for NestedProjectsTeamsRoleInvitation {
    fn color(&self) -> Option<&str> {
        None
    }
}
#[cfg(feature = "frontend")]
impl crate::database::AllRecords for NestedProjectsTeamsRoleInvitation {
...
impl NestedProjectsTeamsRoleInvitation {
    ...
    pub(crate) async fn from_flat(
        flat_variant: crate::database::flat_variants::ProjectsTeamsRoleInvitation,
    ...
    /// Get the ProjectsTeamsRoleInvitation from the database by its ID.
    ///
    ...
    pub async fn get<C: gluesql::core::store::GStore + gluesql::core::store::GStoreMut>(
        ...
        if let Some(flat_variant) =
            crate::database::flat_variants::ProjectsTeamsRoleInvitation::get(
                (table_id, team_id),
                connection,
            )
            .await?
    ...
    /// Delete the ProjectsTeamsRoleInvitation from the database.
    ///
    /// * `connection` - The connection to the database.
    ...
    /// Delete the ProjectsTeamsRoleInvitation from the database by its ID.
    ///
    ...
    >(
        ...
        crate::database::flat_variants::ProjectsTeamsRoleInvitation::delete_from_id(
            (table_id, team_id),
            connection,
        )
        .await
    ...
    pub async fn all<C: gluesql::core::store::GStore + gluesql::core::store::GStoreMut>(
        filter: Option<&crate::database::filter_variants::ProjectsTeamsRoleInvitationFilter>,
        limit: Option<i64>,
        offset: Option<i64>,
        connection: &mut gluesql::prelude::Glue<C>,
    ) -> Result<Vec<Self>, crate::api::ApiError> {
        let mut projects_teams_role_invitations = Vec::new();
        for flat_variant in crate::database::flat_variants::ProjectsTeamsRoleInvitation::all(
            filter, limit, offset, connection,
        )
        .await?
        .into_iter()
        {
            projects_teams_role_invitations.push(Self::from_flat(flat_variant, connection).await?);
        }
        Ok(projects_teams_role_invitations)
    }
    ...
    >(
        ...
        .await?;
        crate::database::flat_variants::ProjectsTeamsRoleInvitation::update_or_insert(
            &self.inner,
            connection,
        )
        .await
