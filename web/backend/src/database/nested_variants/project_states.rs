...
pub struct NestedProjectState {
    pub inner: crate::database::flat_variants::ProjectState,
...
impl NestedProjectState {
    ...
    pub fn all_viewable(
        filter: Option<&web_common::database::filter_variants::ProjectStateFilter>,
        limit: Option<i64>,
        offset: Option<i64>,
        connection: &mut diesel::r2d2::PooledConnection<
        ...
        ProjectState::all_viewable(filter, limit, offset, connection)?
            .into_iter()
    ...
    pub fn all_viewable_sorted(
        ...
        ProjectState::all_viewable_sorted(filter, limit, offset, connection)?
            .into_iter()
            .map(|flat_variant| Self::from_flat(flat_variant, connection))
            .collect()
    }
    ...
    pub fn get(
        ...
        ProjectState::get(id, connection)
    ...
    pub fn from_color_id(
        ...
        ProjectState::from_color_id(color_id, connection)
            .and_then(|flat_variant| Self::from_flat(flat_variant, connection))
    }
    ...
    pub fn from_icon_id(
        ...
        ProjectState::from_icon_id(icon_id, connection)
            .and_then(|flat_variant| Self::from_flat(flat_variant, connection))
    }
    ...
    pub fn from_name(
        ...
        ProjectState::from_name(name, connection)
            .and_then(|flat_variant| Self::from_flat(flat_variant, connection))
    }
    ...
    pub fn strict_word_similarity_search_viewable(
        ...
        ProjectState::strict_word_similarity_search_viewable(
    ...
    pub fn strict_word_similarity_search_with_score_viewable(
        ...
        ProjectState::strict_word_similarity_search_with_score_viewable(
...
impl From<web_common::database::nested_variants::NestedProjectState>
    for crate::database::nested_variants::NestedProjectState
{
    fn from(item: web_common::database::nested_variants::NestedProjectState) -> Self {
        Self {
            inner: crate::database::flat_variants::ProjectState::from(item.inner.as_ref().clone()),
...
impl From<crate::database::nested_variants::NestedProjectState>
    for web_common::database::nested_variants::NestedProjectState
{
    fn from(item: crate::database::nested_variants::NestedProjectState) -> Self {
        Self {
            inner: Rc::from(web_common::database::flat_variants::ProjectState::from(
                item.inner,
            )),
