diesel::table! {
    ...
    diesel::sql_types::Uuid, instrument_id -> diesel::sql_types::Text,
    instrument_location -> diesel::sql_types::Nullable < diesel::sql_types::Integer >,
    instrument_model -> diesel::sql_types::Integer }
}
