...
impl web_common_traits::prelude::TableName for Reagent {
    const TABLE_NAME: &'static str = "reagents";
}
impl
...
impl Reagent {
    ...
    pub fn from_name(
        ...
        Self::table()
            .inner_join(trackables::table.on(reagents::id.eq(trackables::id)))
...
impl AsRef<Reagent> for Reagent {
    fn as_ref(&self) -> &Reagent {
        self
    }
}
