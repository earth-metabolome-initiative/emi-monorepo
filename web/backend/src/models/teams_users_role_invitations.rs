...
impl TeamsUsersRoleInvitation {
    ...
    pub fn can_view_by_id(
        ...
        diesel::select(can_view_teams_users_role_invitations(
            author_user_id,
            table_id,
            user_id,
        ))
    ...
    pub fn all_viewable(
        ...
        let mut query =
            teams_users_role_invitations::dsl::teams_users_role_invitations.into_boxed();
        ...
        query
            .filter(can_view_teams_users_role_invitations(
                author_user_id,
    ...
    pub fn similarity_search_viewable(
        ...
        if let Some(table_id) = filter.and_then(|f| f.table_id) {
            return teams_users_role_invitations::dsl::teams_users_role_invitations
                .filter(teams_users_role_invitations::dsl::table_id.eq(table_id))
                ...
                .inner_join(
                    roles::dsl::roles
                        .on(teams_users_role_invitations::dsl::role_id.eq(roles::dsl::id)),
                )
                .filter(can_view_teams_users_role_invitations(
                    author_user_id,
                    teams_users_role_invitations::dsl::table_id,
        ...
        if let Some(role_id) = filter.and_then(|f| f.role_id) {
            return teams_users_role_invitations::dsl::teams_users_role_invitations
                .filter(teams_users_role_invitations::dsl::role_id.eq(role_id))
                .select(TeamsUsersRoleInvitation::as_select())
                // This operation is defined by a first order index linking teams_users_role_invitations.table_id to teams.
                .inner_join(
                    teams::dsl::teams
        ...
        if let Some(created_by) = filter.and_then(|f| f.created_by) {
            return teams_users_role_invitations::dsl::teams_users_role_invitations
                .filter(teams_users_role_invitations::dsl::created_by.eq(created_by))
                .select(TeamsUsersRoleInvitation::as_select())
                // This operation is defined by a first order index linking teams_users_role_invitations.table_id to teams.
                .inner_join(
                    teams::dsl::teams
    ...
    pub fn can_update_by_id(
        ...
        diesel::select(can_update_teams_users_role_invitations(
            author_user_id,
            table_id,
            user_id,
        ))
    ...
    pub fn all_updatable(
        ...
        query
            .filter(can_update_teams_users_role_invitations(
                author_user_id,
                teams_users_role_invitations::dsl::table_id,
                teams_users_role_invitations::dsl::user_id,
            ))
    ...
    pub fn can_admin_by_id(
        ...
        diesel::select(can_admin_teams_users_role_invitations(
            author_user_id,
            table_id,
            user_id,
        ))
    ...
    pub fn all_administrable(
        ...
        query
            .filter(can_admin_teams_users_role_invitations(
                author_user_id,
                teams_users_role_invitations::dsl::table_id,
                teams_users_role_invitations::dsl::user_id,
            ))
