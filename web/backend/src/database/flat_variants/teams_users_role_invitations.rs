...
impl From<web_common::database::flat_variants::TeamsUsersRoleInvitation>
    for crate::database::flat_variants::TeamsUsersRoleInvitation
{
    fn from(item: web_common::database::flat_variants::TeamsUsersRoleInvitation) -> Self {
        Self {
...
impl From<crate::database::flat_variants::TeamsUsersRoleInvitation>
    for web_common::database::flat_variants::TeamsUsersRoleInvitation
{
    fn from(item: crate::database::flat_variants::TeamsUsersRoleInvitation) -> Self {
        Self {
            table_id: item.table_id,
            user_id: item.user_id,
            role_id: item.role_id,
...
impl TeamsUsersRoleInvitation {
    ...
    pub fn can_view_by_id(
        ...
        diesel::select(
            crate::database::sql_function_bindings::can_view_teams_users_role_invitations(
                author_user_id,
                table_id,
                user_id,
            ),
    ...
    pub fn all_viewable(
        ...
        let query = teams_users_role_invitations::dsl::teams_users_role_invitations
            .select(TeamsUsersRoleInvitation::as_select())
            .filter(
                crate::database::sql_function_bindings::can_view_teams_users_role_invitations(
                    author_user_id,
                    teams_users_role_invitations::dsl::table_id,
                    teams_users_role_invitations::dsl::user_id,
                ),
            )
            .order_by(teams_users_role_invitations::dsl::table_id);
    ...
    pub fn strict_word_similarity_search_viewable(
        ...
        let mut query = teams_users_role_invitations::dsl::teams_users_role_invitations
            // This operation is defined by a first order index linking teams_users_role_invitations.table_id to teams.
            .inner_join(
                teams::dsl::teams
                    .on(teams_users_role_invitations::dsl::table_id.eq(teams::dsl::id)),
            )
            // This operation is defined by a first order index linking teams_users_role_invitations.role_id to roles.
            .inner_join(
                roles::dsl::roles.on(teams_users_role_invitations::dsl::role_id.eq(roles::dsl::id)),
            )
            .select(TeamsUsersRoleInvitation::as_select())
            .filter(
                crate::database::sql_function_bindings::can_view_teams_users_role_invitations(
    ...
    pub fn strict_word_similarity_search_with_score_viewable(
        ...
        teams_users_role_invitations::dsl::teams_users_role_invitations
            ...
            .select((
                TeamsUsersRoleInvitation::as_select(),
                crate::database::sql_function_bindings::strict_word_similarity_dist_op(
                    crate::database::sql_function_bindings::concat_teams_name_description(
                        teams::dsl::name,
                        teams::dsl::description,
    ...
    pub fn can_update_by_id(
        ...
        diesel::select(
            crate::database::sql_function_bindings::can_update_teams_users_role_invitations(
                author_user_id,
                table_id,
                user_id,
            ),
    ...
    pub fn can_admin_by_id(
        ...
        diesel::select(
            crate::database::sql_function_bindings::can_admin_teams_users_role_invitations(
                author_user_id,
                table_id,
                user_id,
            ),
    ...
    pub fn delete_by_id(
        ...
        diesel::delete(
            crate::database::teams_users_role_invitations::dsl::teams_users_role_invitations
                .filter(crate::database::teams_users_role_invitations::dsl::table_id.eq(table_id))
                .filter(crate::database::teams_users_role_invitations::dsl::user_id.eq(user_id)),
        )
        .execute(connection)
        .map_err(web_common::api::ApiError::from)
    }
