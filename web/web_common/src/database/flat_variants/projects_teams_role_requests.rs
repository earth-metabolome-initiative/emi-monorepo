...
impl Filtrable for crate::database::flat_variants::ProjectsTeamsRoleRequest {
    type Filter = crate::database::filter_variants::ProjectsTeamsRoleRequestFilter;
}
#[cfg(feature = "frontend")]
impl AllRecords for ProjectsTeamsRoleRequest {
...
impl ProjectsTeamsRoleRequest {
    ...
    pub async fn insert<C: gluesql::core::store::GStore + gluesql::core::store::GStoreMut>(
        ...
        Ok(table("projects_teams_role_requests")
            .insert()
