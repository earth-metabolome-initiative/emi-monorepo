...
pub struct ContainerTypeForeignKeys {
    pub user_created:
...
impl web_common_traits::prelude::HasForeignKeys
    for crate::codegen::structs_codegen::tables::container_types::ContainerType
{
    type ForeignKeys = ContainerTypeForeignKeys;
...
impl web_common_traits::prelude::ForeignKeys for ContainerTypeForeignKeys {}
