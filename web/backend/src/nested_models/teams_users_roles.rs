...
impl NestedTeamsUsersRole {
    ...
    pub fn similarity_search_viewable(
        ...
        TeamsUsersRole::similarity_search_viewable(filter, query, limit, offset, connection)?
            .into_iter()
            .map(|flat_variant| Self::from_flat(flat_variant, connection))
            .collect()
    }
    ...
    pub fn word_similarity_search_viewable(
        ...
        TeamsUsersRole::word_similarity_search_viewable(filter, query, limit, offset, connection)?
            .into_iter()
            .map(|flat_variant| Self::from_flat(flat_variant, connection))
            .collect()
    }
    ...
    pub fn similarity_search_updatable(
        ...
        TeamsUsersRole::similarity_search_updatable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn word_similarity_search_updatable(
        ...
        TeamsUsersRole::word_similarity_search_updatable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn similarity_search_administrable(
        ...
        TeamsUsersRole::similarity_search_administrable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn word_similarity_search_administrable(
        ...
        TeamsUsersRole::word_similarity_search_administrable(
            filter,
            author_user_id,
            query,
            limit,
