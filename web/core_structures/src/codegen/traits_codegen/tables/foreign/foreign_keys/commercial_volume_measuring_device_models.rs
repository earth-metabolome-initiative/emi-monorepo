    ...
    fn update(
        ...
        match (row, crud) {
            ...
            (
                ...
                if self.id == commercial_products.id {
                    foreign_keys.commercial_volume_measuring_device_models_id_fkey1 = None;
                    updated = true;
                }
            }
            (
            ...
            (
                ...
                if self.id == volume_measuring_device_models.id {
                    foreign_keys.commercial_volume_measuring_device_models_id_fkey = None;
                    updated = true;
                }
            }
            (_, crud) => {
...
impl web_common_traits::prelude::ForeignKeys for CommercialVolumeMeasuringDeviceModelForeignKeys {}
