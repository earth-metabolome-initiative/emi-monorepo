...
impl NestedTeamsUsersRoleInvitation {
    ...
    pub fn similarity_search_viewable(
        ...
        TeamsUsersRoleInvitation::similarity_search_viewable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn word_similarity_search_viewable(
        ...
        TeamsUsersRoleInvitation::word_similarity_search_viewable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn similarity_search_updatable(
        ...
        TeamsUsersRoleInvitation::similarity_search_updatable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn word_similarity_search_updatable(
        ...
        TeamsUsersRoleInvitation::word_similarity_search_updatable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn similarity_search_administrable(
        ...
        TeamsUsersRoleInvitation::similarity_search_administrable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn word_similarity_search_administrable(
        ...
        TeamsUsersRoleInvitation::word_similarity_search_administrable(
            filter,
            author_user_id,
            query,
            limit,
...
impl From<web_common::database::nested_models::NestedTeamsUsersRoleInvitation>
    for NestedTeamsUsersRoleInvitation
{
    fn from(item: web_common::database::nested_models::NestedTeamsUsersRoleInvitation) -> Self {
        Self {
            inner: TeamsUsersRoleInvitation::from(item.inner),
...
impl From<NestedTeamsUsersRoleInvitation>
    for web_common::database::nested_models::NestedTeamsUsersRoleInvitation
{
    fn from(item: NestedTeamsUsersRoleInvitation) -> Self {
        Self {
            inner: web_common::database::TeamsUsersRoleInvitation::from(item.inner),
