...
impl NestedProject {
    ...
    pub fn all_viewable(
        ...
        Project::all_viewable(filter, author_user_id, limit, offset, connection)?
            .into_iter()
    ...
    pub fn all_viewable_sorted(
        ...
        Project::all_viewable_sorted(filter, author_user_id, limit, offset, connection)?
            .into_iter()
            .map(|flat_variant| Self::from_flat(flat_variant, author_user_id, connection))
            .collect()
    }
    ...
    pub fn get(
        ...
        Project::get(id, author_user_id, connection)
    ...
    pub fn strict_word_similarity_search_viewable(
        ...
        Project::strict_word_similarity_search_viewable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn all_updatable(
        ...
        Project::all_updatable(filter, author_user_id, limit, offset, connection)?
            .into_iter()
    ...
    pub fn all_updatable_sorted(
        ...
        Project::all_updatable_sorted(filter, author_user_id, limit, offset, connection)?
            .into_iter()
            .map(|flat_variant| Self::from_flat(flat_variant, Some(author_user_id), connection))
            .collect()
    }
    ...
    pub fn strict_word_similarity_search_updatable(
        ...
        Project::strict_word_similarity_search_updatable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn all_administrable(
        ...
        Project::all_administrable(filter, author_user_id, limit, offset, connection)?
            .into_iter()
            .map(|flat_variant| Self::from_flat(flat_variant, Some(author_user_id), connection))
            .collect()
    }
    ...
    pub fn all_administrable_sorted(
        ...
        Project::all_administrable_sorted(filter, author_user_id, limit, offset, connection)?
            .into_iter()
            .map(|flat_variant| Self::from_flat(flat_variant, Some(author_user_id), connection))
            .collect()
    }
    ...
    pub fn strict_word_similarity_search_administrable(
        ...
        Project::strict_word_similarity_search_administrable(
            filter,
            author_user_id,
            query,
            limit,
