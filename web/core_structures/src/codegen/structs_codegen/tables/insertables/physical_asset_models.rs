...
impl core::fmt::Display for PhysicalAssetModelExtensionAttribute {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            Self::AssetModel(e) => write!(f, "physical_asset_models({e})"),
        }
    }
}
...
/// [`PhysicalAssetModel`](crate::codegen::structs_codegen::tables::physical_asset_models::PhysicalAssetModel).
///
///
...
///
/// ```rust,ignore
/// use core_structures::PhysicalAssetModel;
...
impl<AssetModel> diesel::associations::HasTable
    for InsertablePhysicalAssetModelBuilder<AssetModel>
{
    type Table =
        crate::codegen::diesel_codegen::tables::physical_asset_models::physical_asset_models::table;
    fn table() -> Self::Table {
        crate::codegen::diesel_codegen::tables::physical_asset_models::physical_asset_models::table
    }
}
