...
impl core::fmt::Display for CommercialCentrifugeLotExtensionAttribute {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            Self::CommercialProductLot(e) => write!(f, "commercial_centrifuge_lots({e})"),
            Self::CentrifugeModel(e) => write!(f, "commercial_centrifuge_lots({e})"),
        }
    }
}
...
impl web_common_traits::database::TableField for CommercialCentrifugeLotAttribute {}
impl web_common_traits::database::HasTableType for CommercialCentrifugeLotAttribute {
    ...
    > for CommercialCentrifugeLotAttribute
{
    fn from_extension(
        ...
        CommercialCentrifugeLotAttribute::Extension(From::from(attribute))
    }
}
impl
    web_common_traits::database::FromExtension<
...
impl<CommercialProductLot, CentrifugeModel> diesel::associations::HasTable
    for InsertableCommercialCentrifugeLotBuilder<CommercialProductLot, CentrifugeModel>
{
    type Table = crate::codegen::diesel_codegen::tables::commercial_centrifuge_lots::commercial_centrifuge_lots::table;
    fn table() -> Self::Table {
        crate::codegen::diesel_codegen::tables::commercial_centrifuge_lots::commercial_centrifuge_lots::table
    }
}
...
where
    Self: common_traits::builder::Attributed<
        Attribute = crate::codegen::structs_codegen::tables::insertables::CommercialCentrifugeLotAttribute,
    >,
{
        ...
        PM: web_common_traits::database::PrimaryKeyLike<PrimaryKey = i32>,
    {
        ...
        self.commercial_centrifuge_lots_id_fkey = <CommercialProductLot as crate::codegen::structs_codegen::tables::insertables::PhysicalAssetModelSettable>::parent_model(
                self.commercial_centrifuge_lots_id_fkey,
                product_model,
            )
            .map_err(|err| {
    ...
    >,
{
    ...
    {
        self.commercial_centrifuge_lots_id_fkey = <CommercialProductLot as crate::codegen::structs_codegen::tables::insertables::AssetModelSettable>::name(
                self.commercial_centrifuge_lots_id_fkey,
                name,
            )
            .map_err(|e| {
    ...
    {
        self.commercial_centrifuge_lots_id_fkey = <CommercialProductLot as crate::codegen::structs_codegen::tables::insertables::AssetModelSettable>::description(
                self.commercial_centrifuge_lots_id_fkey,
                description,
            )
            .map_err(|e| {
    ...
    {
        self.commercial_centrifuge_lots_id_fkey = <CommercialProductLot as crate::codegen::structs_codegen::tables::insertables::AssetModelSettable>::created_by(
                self.commercial_centrifuge_lots_id_fkey,
                created_by,
            )
            .map_err(|e| {
    ...
    where
        ...
        >,
    {
        self.commercial_centrifuge_lots_id_fkey = <CommercialProductLot as crate::codegen::structs_codegen::tables::insertables::AssetModelSettable>::created_at(
                self.commercial_centrifuge_lots_id_fkey,
                created_at,
            )
            .map_err(|e| {
    ...
    {
        self.commercial_centrifuge_lots_id_fkey = <CommercialProductLot as crate::codegen::structs_codegen::tables::insertables::AssetModelSettable>::updated_by(
                self.commercial_centrifuge_lots_id_fkey,
                updated_by,
            )
            .map_err(|e| {
    ...
    where
        ...
        >,
    {
        self.commercial_centrifuge_lots_id_fkey = <CommercialProductLot as crate::codegen::structs_codegen::tables::insertables::AssetModelSettable>::updated_at(
                self.commercial_centrifuge_lots_id_fkey,
                updated_at,
            )
            .map_err(|e| {
