...
pub trait CommercialCameraModelBuildable:
...
impl CommercialCameraModelBuildable for Option<i32> {}
impl<
...
for InsertableCommercialCameraModelBuilder<CameraModel, CommercialProduct> {
    ...
    {
        self.commercial_camera_models_id_fkey = <CameraModel as crate::codegen::structs_codegen::tables::insertables::AssetModelBuildable>::most_concrete_table(
