...
impl Tabular for Taxon {
    const TABLE: crate::database::Table = crate::database::Table::Taxa;
}
impl Describable for Taxon {
    fn description(&self) -> Option<&str> {
        None
    }
}
impl Colorable for Taxon {
    fn color(&self) -> Option<&str> {
        None
    }
}

impl Filtrable for crate::database::flat_variants::Taxon {
    type Filter = crate::database::filter_variants::TaxonFilter;
}
#[cfg(feature = "frontend")]
impl AllRecords for Taxon {
...
impl Taxon {
    ...
    /// Insert the Taxon into the database.
    ///
