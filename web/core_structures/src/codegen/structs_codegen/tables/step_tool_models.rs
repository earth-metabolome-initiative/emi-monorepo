...
impl diesel::Identifiable for StepToolModel {
...
impl StepToolModel {
    ...
    pub async fn from_created_at(
        ...
        use crate::codegen::diesel_codegen::tables::step_tool_models::step_tool_models;
        Self::table()
            .filter(step_tool_models::created_at.eq(created_at))
            .order_by(step_tool_models::id.asc())
            .load::<Self>(conn)
            .await
    }
}
