...
pub enum AppRoute {
    ...
    #[at("/nameplate_categories")]
    NameplateCategories,
    #[at("/nameplate_categories/:id")]
    NameplateCategoriesView{id: i32},
    #[at("/nameplates")]
    Nameplates,
    #[at("/nameplates/:id")]
    ...
    #[at("/permanence_categories")]
    PermanenceCategories,
    #[at("/permanence_categories/:id")]
    PermanenceCategoriesView{id: i32},
    #[at("/projects")]
    Projects,
    #[at("/projects/:id")]
    ProjectsView{id: i32},
...
pub fn switch(route: AppRoute) -> Html {
    match route {
        ...
        AppRoute::NameplateCategories => {
            html! { <BasicList<NestedNameplateCategory> /> }
        }
        AppRoute::NameplateCategoriesView{id} => {
            html! { <NameplateCategoryPage id = {id} /> }
        }
        AppRoute::Nameplates => {
        ...
        AppRoute::PermanenceCategories => {
            html! { <BasicList<NestedPermanenceCategory> /> }
        }
        AppRoute::PermanenceCategoriesView{id} => {
            html! { <PermanenceCategoryPage id = {id} /> }
        }
        AppRoute::Projects => {
