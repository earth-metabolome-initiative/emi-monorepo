...
pub enum InsertableBeadsModelExtensionAttributes {
    PhysicalAssetModel(
        crate::codegen::structs_codegen::tables::insertables::InsertablePhysicalAssetModelAttributes,
    ),
}
impl core::fmt::Display for InsertableBeadsModelExtensionAttributes {
...
impl From<
    crate::codegen::structs_codegen::tables::insertables::InsertablePhysicalAssetModelAttributes,
> for InsertableBeadsModelExtensionAttributes {
    fn from(
...
#[derive(Copy, Clone, PartialEq, Eq, PartialOrd, Ord, Hash, core::fmt::Debug)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub enum InsertableBeadsModelAttributes {
    Extension(InsertableBeadsModelExtensionAttributes),
    Id,
    DiameterMillimeters,
}
impl From<
    crate::codegen::structs_codegen::tables::insertables::InsertablePhysicalAssetModelAttributes,
> for InsertableBeadsModelAttributes {
    fn from(
        physical_asset_models: crate::codegen::structs_codegen::tables::insertables::InsertablePhysicalAssetModelAttributes,
    ) -> Self {
        Self::Extension(
            InsertableBeadsModelExtensionAttributes::PhysicalAssetModel(
                physical_asset_models,
            ),
        )
    }
}
impl core::str::FromStr for InsertableBeadsModelAttributes {
...
impl core::fmt::Display for InsertableBeadsModelAttributes {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            Self::Extension(e) => write!(f, "{e}"),
            Self::Id => write!(f, "id"),
            Self::DiameterMillimeters => write!(f, "diameter_millimeters"),
        }
    }
}
...
#[cfg_attr(
    ...
    diesel(
        table_name = crate::codegen::diesel_codegen::tables::beads_models::beads_models
    )
)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct InsertableBeadsModel {
    pub(crate) id: i32,
    pub(crate) diameter_millimeters: f32,
}
impl InsertableBeadsModel {
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct InsertableBeadsModelBuilder<
    PhysicalAssetModel
    ...
    crate::codegen::structs_codegen::tables::insertables::PhysicalAssetModelBuildable
{
    ...
    ///   `public.beads_models.diameter_millimeters` column.
    ///
...
where
    Self: web_common_traits::database::InsertableVariant<
            C,
            UserId = i32,
            Row = crate::codegen::structs_codegen::tables::beads_models::BeadsModel,
            Error = web_common_traits::database::InsertError<InsertableBeadsModelAttributes>,
        >,
    PhysicalAssetModel: web_common_traits::database::TryInsertGeneric<C, PrimaryKey = i32>,
{
    type Attributes = InsertableBeadsModelAttributes;
    ...
    fn mint_primary_key(
        ...
        let insertable: crate::codegen::structs_codegen::tables::beads_models::BeadsModel =
