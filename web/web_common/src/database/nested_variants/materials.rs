...
impl crate::database::Tabular for NestedMaterial {
    const TABLE: crate::database::Table = crate::database::Table::Materials;
}
impl crate::database::Filtrable for NestedMaterial {
    type Filter = crate::database::filter_variants::MaterialFilter;
}
impl crate::database::Describable for NestedMaterial {
    fn description(&self) -> Option<&str> {
        self.inner.description()
    }
}
impl crate::database::Colorable for NestedMaterial {
    fn color(&self) -> Option<&str> {
        Some(self.color.name.as_str())
    }
}
#[cfg(feature = "frontend")]
impl crate::database::AllRecords for NestedMaterial {
...
impl NestedMaterial {
    ...
    pub(crate) async fn from_flat(
        flat_variant: crate::database::flat_variants::Material,
    ...
    pub async fn get<C: gluesql::core::store::GStore + gluesql::core::store::GStoreMut>(
        ...
        if let Some(flat_variant) =
            crate::database::flat_variants::Material::get(id, connection).await?
        {
    ...
    /// Delete the Material from the database by its ID.
    ///
    ...
    pub async fn all<C: gluesql::core::store::GStore + gluesql::core::store::GStoreMut>(
        filter: Option<&crate::database::filter_variants::MaterialFilter>,
        limit: Option<i64>,
        offset: Option<i64>,
        connection: &mut gluesql::prelude::Glue<C>,
        ...
        for flat_variant in
            crate::database::flat_variants::Material::all(filter, limit, offset, connection)
                .await?
                .into_iter()
        {
