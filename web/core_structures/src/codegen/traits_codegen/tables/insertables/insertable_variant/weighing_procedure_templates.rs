...
where
    ...
    Self: web_common_traits::database::InsertableVariant<
        C,
        InsertableVariant = crate::codegen::structs_codegen::tables::insertables::InsertableWeighingProcedureTemplate,
    ...
    crate::codegen::structs_codegen::tables::insertables::WeighingProcedureTemplateExtensionAttribute: From<
        ...
        let procedure_template = self
            ...
            .map_err(|err| {
                err.into_field_name(|attribute| {
                    crate::codegen::structs_codegen::tables::insertables::WeighingProcedureTemplateAttribute::Extension(
                        From::from(attribute),
                    )
                })
            })?;
