...
pub struct StepModelCategoryForeignKeys {
...
for crate::codegen::structs_codegen::tables::step_model_categories::StepModelCategory {
    type ForeignKeys = StepModelCategoryForeignKeys;
...
impl web_common_traits::prelude::ForeignKeys for StepModelCategoryForeignKeys {}
