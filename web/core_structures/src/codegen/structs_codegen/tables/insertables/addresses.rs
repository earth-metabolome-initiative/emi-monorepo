...
impl web_common_traits::database::TableField for AddressAttribute {}
impl web_common_traits::database::HasTableType for AddressAttribute {
...
{
    type Error = web_common_traits::database::InsertError<AddressAttribute>;
