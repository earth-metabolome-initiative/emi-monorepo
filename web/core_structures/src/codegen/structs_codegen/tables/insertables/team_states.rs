...
impl web_common_traits::database::ExtendableBuilder for InsertableTeamStateBuilder {
...
impl crate::codegen::structs_codegen::tables::insertables::InsertableTeamStateBuilder {
    /// Sets the value of the `team_states.description` column from table
    /// `team_states`.
...
impl crate::codegen::structs_codegen::tables::insertables::InsertableTeamStateBuilder {
    /// Sets the value of the `team_states.icon` column from table
    /// `team_states`.
    pub fn icon<P>(
        mut self,
        icon: P,
