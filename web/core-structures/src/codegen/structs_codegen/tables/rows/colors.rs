...
impl From<std::rc::Rc<crate::codegen::structs_codegen::tables::colors::Color>> for super::Rows {
...
impl From<Vec<std::rc::Rc<crate::codegen::structs_codegen::tables::colors::Color>>>
    for super::Rows
{
    fn from(
        value: Vec<std::rc::Rc<crate::codegen::structs_codegen::tables::colors::Color>>,
    ) -> Self {
        Self::from(std::rc::Rc::new(value))
    }
}
impl From<std::rc::Rc<Vec<crate::codegen::structs_codegen::tables::colors::Color>>>
    for super::Rows
{
    fn from(
        value: std::rc::Rc<Vec<crate::codegen::structs_codegen::tables::colors::Color>>,
    ) -> Self {
...
impl From<std::rc::Rc<Vec<std::rc::Rc<crate::codegen::structs_codegen::tables::colors::Color>>>>
    for super::Rows
{
    fn from(
        value: std::rc::Rc<
...
impl TryFrom<super::Rows>
    for std::rc::Rc<Vec<std::rc::Rc<crate::codegen::structs_codegen::tables::colors::Color>>>
{
