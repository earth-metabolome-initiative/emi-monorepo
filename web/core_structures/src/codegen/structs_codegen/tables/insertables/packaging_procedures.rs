...
impl core::fmt::Display for PackagingProcedureExtensionAttribute {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            Self::Procedure(e) => write!(f, "packaging_procedures({e})"),
        }
    }
}
...
impl web_common_traits::database::TableField for PackagingProcedureAttribute {}
impl web_common_traits::database::HasTableType for PackagingProcedureAttribute {
    type Table = crate::codegen::tables::table_names::TableName;
}
impl
    web_common_traits::database::FromExtension<
        crate::codegen::structs_codegen::tables::insertables::ProcedureAttribute,
    > for PackagingProcedureAttribute
{
    fn from_extension(
        attribute: crate::codegen::structs_codegen::tables::insertables::ProcedureAttribute,
    ) -> Self {
        PackagingProcedureAttribute::Extension(From::from(attribute))
    }
}
...
impl<Procedure> diesel::associations::HasTable for InsertablePackagingProcedureBuilder<Procedure> {
    type Table =
        crate::codegen::diesel_codegen::tables::packaging_procedures::packaging_procedures::table;
    fn table() -> Self::Table {
        crate::codegen::diesel_codegen::tables::packaging_procedures::packaging_procedures::table
    }
}
...
where
    Self: common_traits::builder::Attributed<
        Attribute = crate::codegen::structs_codegen::tables::insertables::PackagingProcedureAttribute,
    >,
{
    ...
    ///Sets the value of the `public.packaging_procedures.procedure_template_sample_model` column.
    ///
    ///# Implementation notes
    ///This method also set the values of other columns, due to
    ///same-as relationships or inferred values.
    ...
    ///Sets the value of the `public.packaging_procedures.procedure_sample` column.
    ///
    ///# Implementation notes
    ///This method also set the values of other columns, due to
    ///same-as relationships or inferred values.
        ...
        PWM: web_common_traits::database::PrimaryKeyLike<PrimaryKey = i32>,
    {
        ...
        ) = self.procedure_packaged_with
        {
            self.procedure_packaged_with = <crate::codegen::structs_codegen::tables::insertables::InsertableProcedureAssetBuilder as crate::codegen::structs_codegen::tables::insertables::ProcedureAssetSettable>::asset_model(
                ...
                .map_err(|e| {
                    e.into_field_name(|attribute| {
                        <Self as common_traits::builder::Attributed>::Attribute::ProcedurePackagedWith(
                            attribute,
                        )
                    })
                })?
    ...
    ///Sets the value of the `public.packaging_procedures.procedure_template_packaged_with_model` column.
    ///
    ///# Implementation notes
    ///This method also set the values of other columns, due to
    ///same-as relationships or inferred values.
    ...
    where
        PTPWM: web_common_traits::database::PrimaryKeyLike<PrimaryKey = i32>,
    {
        let procedure_template_packaged_with_model = <PTPWM as web_common_traits::database::PrimaryKeyLike>::primary_key(
            &procedure_template_packaged_with_model,
        );
        if let web_common_traits::database::IdOrBuilder::Builder(
            procedure_packaged_with,
    ...
    ///Sets the value of the `public.packaging_procedures.procedure_packaged_with` column.
    ///
    ///# Implementation notes
    ///This method also set the values of other columns, due to
    ///same-as relationships or inferred values.
...
where
    Self: web_common_traits::database::DispatchableInsertableVariant<
            ...
            Error = web_common_traits::database::InsertError<PackagingProcedureAttribute>,
        > + web_common_traits::database::SetPrimaryKey<PrimaryKey = ::rosetta_uuid::Uuid>
        + common_traits::builder::IsCompleteBuilder,
{
    type Error = web_common_traits::database::InsertError<PackagingProcedureAttribute>;
