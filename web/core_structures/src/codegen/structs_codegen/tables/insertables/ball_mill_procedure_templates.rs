...
impl From<common_traits::builder::EmptyTuple> for BallMillProcedureTemplateExtensionAttribute {
...
///
/// ```rust,ignore
/// use core_structures::BallMillProcedureTemplate;
/// use core_structures::tables::insertables::BallMillProcedureTemplateSettable;
