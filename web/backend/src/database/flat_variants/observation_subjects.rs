...
#[diesel(table_name = crate::database::schema::observation_subjects)]
...
impl ObservationSubject {
    ...
    pub fn all_viewable(
        ...
        use crate::database::schema::observation_subjects;
...
crate::database::sql_function_bindings::concat_observation_subjects_name_description(observation_subjects::dsl::name, observation_subjects::dsl::description).strict_word_similarity_commutator_op(query).or(
    crate::database::sql_function_bindings::concat_observation_subjects_name_description(observation_subjects::dsl::name, observation_subjects::dsl::description).ilike(format!("%{}%", query))
            ...
            .order(crate::database::sql_function_bindings::strict_word_similarity_dist_op(crate::database::sql_function_bindings::concat_observation_subjects_name_description(observation_subjects::dsl::name, observation_subjects::dsl::description), query))
            .into_boxed();
        if let Some(icon_id) = filter.and_then(|f| f.icon_id) {
            query = query.filter(observation_subjects::dsl::icon_id.eq(icon_id));
        }
