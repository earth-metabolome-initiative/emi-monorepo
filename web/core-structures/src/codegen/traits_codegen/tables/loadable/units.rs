...
impl web_common_traits::prelude::Loadable for crate::codegen::structs_codegen::tables::units::Unit {
    ...
    async fn load_all(conn: &mut Self::Conn) -> Result<Vec<Self>, diesel::result::Error> {
        ...
        use diesel_async::RunQueryDsl;
        crate::codegen::structs_codegen::tables::units::Unit::table().load::<Self>(conn).await
    }
}
