...
impl NestedProjectsTeamsRole {
    ...
    pub fn similarity_search_viewable(
        ...
        ProjectsTeamsRole::similarity_search_viewable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn word_similarity_search_viewable(
        ...
        ProjectsTeamsRole::word_similarity_search_viewable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn similarity_search_updatable(
        ...
        ProjectsTeamsRole::similarity_search_updatable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn word_similarity_search_updatable(
        ...
        ProjectsTeamsRole::word_similarity_search_updatable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn similarity_search_administrable(
        ...
        ProjectsTeamsRole::similarity_search_administrable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn word_similarity_search_administrable(
        ...
        ProjectsTeamsRole::word_similarity_search_administrable(
            filter,
            author_user_id,
            query,
            limit,
...
impl From<web_common::database::nested_models::NestedProjectsTeamsRole>
    for NestedProjectsTeamsRole
{
    fn from(item: web_common::database::nested_models::NestedProjectsTeamsRole) -> Self {
        Self {
            inner: ProjectsTeamsRole::from(item.inner),
...
impl From<NestedProjectsTeamsRole>
    for web_common::database::nested_models::NestedProjectsTeamsRole
{
    fn from(item: NestedProjectsTeamsRole) -> Self {
        Self {
            inner: web_common::database::ProjectsTeamsRole::from(item.inner),
