...
pub struct FreezingProcedureTemplateForeignKeys {
    ...
    pub procedure_template_frozen_container_model: Option<
        crate::codegen::structs_codegen::tables::procedure_template_asset_models::ProcedureTemplateAssetModel,
    >,
    pub freezing_pm_compatibility_rules: Option<
...
for crate::codegen::structs_codegen::tables::freezing_procedure_templates::FreezingProcedureTemplate {
    ...
    fn foreign_keys_loaded(&self, foreign_keys: &Self::ForeignKeys) -> bool {
        foreign_keys.procedure_template.is_some()
            ...
            && foreign_keys.freezing_pm_compatibility_rules.is_some()
    }
    fn update(
        &self,
        ...
        match (row, crud) {
            (
                ...
                {
                    foreign_keys.freezing_pm_compatibility_rules = Some(
                        asset_compatibility_rules,
                    );
                    updated = true;
                }
            ...
            (
                ...
                if self.frozen_with_model == asset_compatibility_rules.left_asset_model
                    && self.frozen_container_model
                        == asset_compatibility_rules.right_asset_model
                {
                    foreign_keys.freezing_pm_compatibility_rules = None;
                    updated = true;
                }
            }
            (
                ...
                if self.frozen_container_model == container_models.id {
                    foreign_keys.frozen_container_model = Some(container_models);
                    updated = true;
                }
            }
            (
