...
for InsertableCommercialPipetteTipLotBuilder<CommercialProductLot, PipetteTipModel> {
    ...
    {
        self.commercial_pipette_tip_lots_id_fkey = <CommercialProductLot as crate::codegen::structs_codegen::tables::insertables::AssetModelBuildable>::most_concrete_table(
