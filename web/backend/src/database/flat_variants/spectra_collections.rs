...
impl SpectraCollection {
    ...
    pub fn can_view_by_id(
        ...
        diesel::select(
            crate::database::sql_function_bindings::can_view_spectra_collections(
                author_user_id,
                id,
            ),
        )
    ...
    pub fn all_viewable(
        ...
        let query = spectra_collections::dsl::spectra_collections
            ...
            .order_by(spectra_collections::dsl::id);
...
.inner_join(
   samples0.on(
       spectra_collections::dsl::sample_id.eq(
   ...
   sample_states::dsl::sample_states.on(
       samples2.field(samples::dsl::state_id).eq(
           sample_states::dsl::id
            ...
            .select(SpectraCollection::as_select())
            .filter(crate::database::sql_function_bindings::can_view_spectra_collections(author_user_id, spectra_collections::dsl::id))
            .filter(
...
.map_err(web_common::api::ApiError::from)
    ...
    pub fn can_update_by_id(
        ...
        diesel::select(
            crate::database::sql_function_bindings::can_update_spectra_collections(
                author_user_id,
                id,
            ),
        )
   ...
   sample_states::dsl::sample_states.on(
       samples2.field(samples::dsl::state_id).eq(
           sample_states::dsl::id
            ...
            .select(SpectraCollection::as_select())
            .filter(crate::database::sql_function_bindings::can_update_spectra_collections(author_user_id, spectra_collections::dsl::id))
            .filter(
sample_containers::dsl::barcode.strict_word_similarity_commutator_op(query).or(
    sample_containers::dsl::barcode.ilike(format!("%{}%", query))
)
...
crate::database::sql_function_bindings::strict_word_similarity_dist_op(crate::database::sql_function_bindings::concat_sample_states_name_description(sample_states::dsl::name, sample_states::dsl::description), query))
    ...
    pub fn can_admin_by_id(
        ...
        diesel::select(
            crate::database::sql_function_bindings::can_admin_spectra_collections(
                author_user_id,
                id,
            ),
        )
   ...
   sample_states::dsl::sample_states.on(
       samples2.field(samples::dsl::state_id).eq(
           sample_states::dsl::id
            ...
            .select(SpectraCollection::as_select())
            .filter(crate::database::sql_function_bindings::can_admin_spectra_collections(author_user_id, spectra_collections::dsl::id))
            .filter(
sample_containers::dsl::barcode.strict_word_similarity_commutator_op(query).or(
    sample_containers::dsl::barcode.ilike(format!("%{}%", query))
)
...
crate::database::sql_function_bindings::strict_word_similarity_dist_op(crate::database::sql_function_bindings::concat_sample_states_name_description(sample_states::dsl::name, sample_states::dsl::description), query))
    ...
    pub fn delete_by_id(
        ...
        diesel::delete(
            crate::database::spectra_collections::dsl::spectra_collections
                .filter(crate::database::spectra_collections::dsl::id.eq(id)),
        )
        .execute(connection)
        .map_err(web_common::api::ApiError::from)
    }
