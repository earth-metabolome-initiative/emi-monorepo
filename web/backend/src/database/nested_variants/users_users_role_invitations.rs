...
impl NestedUsersUsersRoleInvitation {
    ...
    /// * `connection` - The connection to the database.
    pub fn all_viewable(
        filter: Option<&web_common::database::filter_variants::UsersUsersRoleInvitationFilter>,
        author_user_id: Option<i32>,
        limit: Option<i64>,
        offset: Option<i64>,
        connection: &mut diesel::r2d2::PooledConnection<
        ...
        UsersUsersRoleInvitation::all_viewable(filter, author_user_id, limit, offset, connection)?
            .into_iter()
    ...
    pub fn all_viewable_sorted(
        ...
        UsersUsersRoleInvitation::all_viewable_sorted(
            filter,
            author_user_id,
            limit,
            offset,
    ...
    pub fn get(
        ...
        UsersUsersRoleInvitation::get((table_id, user_id), author_user_id, connection)
    ...
    pub fn strict_word_similarity_search_viewable(
        ...
        UsersUsersRoleInvitation::strict_word_similarity_search_viewable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn strict_word_similarity_search_with_score_viewable(
        ...
        UsersUsersRoleInvitation::strict_word_similarity_search_with_score_viewable(
            author_user_id,
            query,
            limit,
            offset,
    ...
    pub fn can_update_by_id() -> Result<bool, web_common::api::ApiError> {
        UsersUsersRoleInvitation::can_update_by_id()
    }
    ...
    pub fn all_updatable(
        ...
        UsersUsersRoleInvitation::all_updatable(filter, author_user_id, limit, offset, connection)?
            .into_iter()
            .map(|flat_variant| Self::from_flat(flat_variant, connection))
            .collect()
    }
    ...
    pub fn all_updatable_sorted(
        ...
        UsersUsersRoleInvitation::all_updatable_sorted(
            filter,
            author_user_id,
            limit,
            offset,
    ...
    pub fn strict_word_similarity_search_updatable(
        ...
        UsersUsersRoleInvitation::strict_word_similarity_search_updatable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn all_administrable(
        ...
        UsersUsersRoleInvitation::all_administrable(
            filter,
            author_user_id,
            limit,
            offset,
    ...
    pub fn all_administrable_sorted(
        ...
        UsersUsersRoleInvitation::all_administrable_sorted(
            filter,
            author_user_id,
            limit,
            offset,
    ...
    pub fn strict_word_similarity_search_administrable(
        ...
        UsersUsersRoleInvitation::strict_word_similarity_search_administrable(
            filter,
            author_user_id,
            query,
            limit,
...
impl From<web_common::database::nested_variants::NestedUsersUsersRoleInvitation>
    for crate::database::nested_variants::NestedUsersUsersRoleInvitation
{
    fn from(item: web_common::database::nested_variants::NestedUsersUsersRoleInvitation) -> Self {
        Self {
            inner: crate::database::flat_variants::UsersUsersRoleInvitation::from(item.inner),
...
impl From<crate::database::nested_variants::NestedUsersUsersRoleInvitation>
    for web_common::database::nested_variants::NestedUsersUsersRoleInvitation
{
    fn from(item: crate::database::nested_variants::NestedUsersUsersRoleInvitation) -> Self {
        Self {
            inner: web_common::database::flat_variants::UsersUsersRoleInvitation::from(item.inner),
