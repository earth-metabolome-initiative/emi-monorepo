...
pub struct ContainerCategoryForeignKeys {
...
for crate::codegen::structs_codegen::tables::container_categories::ContainerCategory {
    type ForeignKeys = ContainerCategoryForeignKeys;
...
impl web_common_traits::prelude::ForeignKeys for ContainerCategoryForeignKeys {}
