...
impl From<web_common::database::flat_variants::Sample> for crate::database::flat_variants::Sample {
    fn from(item: web_common::database::flat_variants::Sample) -> Self {
        Self {
            id: item.id,
...
impl From<crate::database::flat_variants::Sample> for web_common::database::flat_variants::Sample {
    fn from(item: crate::database::flat_variants::Sample) -> Self {
        Self {
            id: item.id,
            container_id: item.container_id,
            notes: item.notes,
...
impl Sample {
    ...
    pub fn can_view_by_id(
        ...
        diesel::select(crate::database::sql_function_bindings::can_view_samples(
            author_user_id,
            id,
        ))
    ...
    pub fn all_viewable(
        ...
        let query = samples::dsl::samples
            ...
            .filter(crate::database::sql_function_bindings::can_view_samples(
                author_user_id,
                samples::dsl::id,
            ))
   ...
   sample_states::dsl::sample_states.on(
       samples::dsl::state_id.eq(
           sample_states::dsl::id
            ...
            .select(Sample::as_select())
            .filter(crate::database::sql_function_bindings::can_view_samples(author_user_id, samples::dsl::id))
            .filter(
...
crate::database::sql_function_bindings::concat_sample_states_name_description(sample_states::dsl::name, sample_states::dsl::description).strict_word_similarity_commutator_op(query).or(
    crate::database::sql_function_bindings::concat_sample_states_name_description(sample_states::dsl::name, sample_states::dsl::description).ilike(format!("%{}%", query))
            ...
            .order(crate::database::sql_function_bindings::strict_word_similarity_dist_op(sample_containers::dsl::barcode, query)    +
...
.map_err(web_common::api::ApiError::from)
    ...
    pub fn can_update_by_id(
        ...
        diesel::select(crate::database::sql_function_bindings::can_update_samples(
            author_user_id,
            id,
        ))
        .get_result(connection)
    ...
    pub fn all_updatable(
        ...
        let query = samples::dsl::samples
            .select(Sample::as_select())
            .filter(crate::database::sql_function_bindings::can_update_samples(
                author_user_id,
                samples::dsl::id,
            ))
            .order_by(samples::dsl::id);
   ...
   sample_states::dsl::sample_states.on(
       samples::dsl::state_id.eq(
           sample_states::dsl::id
            ...
            .select(Sample::as_select())
            .filter(crate::database::sql_function_bindings::can_update_samples(author_user_id, samples::dsl::id))
            .filter(
sample_containers::dsl::barcode.strict_word_similarity_commutator_op(query).or(
    sample_containers::dsl::barcode.ilike(format!("%{}%", query))
)
...
crate::database::sql_function_bindings::strict_word_similarity_dist_op(crate::database::sql_function_bindings::concat_sample_states_name_description(sample_states::dsl::name, sample_states::dsl::description), query))
    ...
    pub fn can_admin_by_id(
        ...
        diesel::select(crate::database::sql_function_bindings::can_admin_samples(
            author_user_id,
            id,
        ))
        .get_result(connection)
    ...
    pub fn all_administrable(
        ...
        let query = samples::dsl::samples
            .select(Sample::as_select())
            .filter(crate::database::sql_function_bindings::can_admin_samples(
                author_user_id,
                samples::dsl::id,
            ))
            .order_by(samples::dsl::id);
   ...
   sample_states::dsl::sample_states.on(
       samples::dsl::state_id.eq(
           sample_states::dsl::id
            ...
            .select(Sample::as_select())
            .filter(crate::database::sql_function_bindings::can_admin_samples(author_user_id, samples::dsl::id))
            .filter(
sample_containers::dsl::barcode.strict_word_similarity_commutator_op(query).or(
    sample_containers::dsl::barcode.ilike(format!("%{}%", query))
)
...
crate::database::sql_function_bindings::strict_word_similarity_dist_op(crate::database::sql_function_bindings::concat_sample_states_name_description(sample_states::dsl::name, sample_states::dsl::description), query))
    ...
    pub fn delete_by_id(
        ...
        diesel::delete(
            crate::database::samples::dsl::samples.filter(crate::database::samples::dsl::id.eq(id)),
        )
        .execute(connection)
        .map_err(web_common::api::ApiError::from)
    }
