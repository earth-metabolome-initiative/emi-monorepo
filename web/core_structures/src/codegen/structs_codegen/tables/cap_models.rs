...
#[diesel(table_name = crate::codegen::diesel_codegen::tables::cap_models::cap_models)]
pub struct CapModel {
    pub id: i32,
}
...
impl web_common_traits::prelude::ExtensionTable<crate::PhysicalAssetModel> for CapModel where
    for<'a> &'a Self: diesel::Identifiable<Id = &'a i32>
{
}
impl web_common_traits::prelude::ExtensionTable<crate::CapModel> for CapModel where
    for<'a> &'a Self: diesel::Identifiable<Id = &'a i32>
{
}
impl diesel::Identifiable for CapModel {
    type Id = i32;
    fn id(self) -> Self::Id {
        self.id
    }
...
impl CapModel {
    ...
    where
        ...
        <Self as diesel::associations::HasTable>::Table: diesel::query_dsl::methods::FilterDsl<
            <crate::codegen::diesel_codegen::tables::cap_models::cap_models::id as diesel::expression_methods::EqAll<
                i32,
            >>::Output,
        >,
        ...
        >>::Output: diesel::query_dsl::methods::OrderDsl<
            diesel::helper_types::Asc<
                crate::codegen::diesel_codegen::tables::cap_models::cap_models::id,
            >,
        >,
        <<<Self as diesel::associations::HasTable>::Table as diesel::query_dsl::methods::FilterDsl<
            <crate::codegen::diesel_codegen::tables::cap_models::cap_models::id as diesel::expression_methods::EqAll<
            ...
            + for<'a> diesel::query_dsl::LoadQuery<'a, C, Self>,
    {
        ...
        Self::table()
            .filter(cap_models::id.eq(id))
            .order_by(cap_models::id.asc())
            .load::<Self>(conn)
    }
    ...
    pub fn from_parent_model(
        ...
        Self::table()
            .inner_join(
                physical_asset_models::table.on(cap_models::id.eq(physical_asset_models::id)),
            )
    ...
    pub fn from_name(
        ...
        use crate::codegen::diesel_codegen::tables::{
            asset_models::asset_models, cap_models::cap_models,
        };
        Self::table()
            .inner_join(asset_models::table.on(cap_models::id.eq(asset_models::id)))
...
impl AsRef<CapModel> for CapModel {
    fn as_ref(&self) -> &CapModel {
        self
    }
}
