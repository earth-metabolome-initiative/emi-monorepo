...
#[cached(result = true, key = "(u32, u32)", convert = r#"{ (index.indexrelid, index.indrelid) }"#)]
fn is_same_as_index(index: &PgIndex, conn: &mut PgConnection) -> Result<bool, WebCodeGenError> {
...
impl PgIndex {
    ...
    pub fn is_same_as(&self, conn: &mut PgConnection) -> Result<bool, WebCodeGenError> {
