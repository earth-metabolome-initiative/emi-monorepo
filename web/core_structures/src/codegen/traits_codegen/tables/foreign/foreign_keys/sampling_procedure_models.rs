...
pub struct SamplingProcedureModelForeignKeys {
...
{
    type ForeignKeys = SamplingProcedureModelForeignKeys;
...
impl web_common_traits::prelude::ForeignKeys for SamplingProcedureModelForeignKeys {}
