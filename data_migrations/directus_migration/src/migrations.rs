...
fn process_sample(
    ...
    if let Some(ExpectedVariant2(procedure_builder)) = raccolta_funghi_instance_builder.next() {
    ...
    if let Some(ExpectedVariant3(procedure_builder)) = raccolta_funghi_instance_builder.next() {
