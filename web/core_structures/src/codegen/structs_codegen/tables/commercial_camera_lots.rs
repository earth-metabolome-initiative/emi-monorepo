...
#[diesel(belongs_to(crate::CommercialCameraModel, foreign_key = product_model))]
...
impl web_common_traits::prelude::TableName for CommercialCameraLot {
    const TABLE_NAME: &'static str = "commercial_camera_lots";
}
impl<'a> From<&'a CommercialCameraLot>
    for web_common_traits::database::IdOrBuilder<
        i32,
        crate::codegen::structs_codegen::tables::insertables::InsertableCommercialCameraLotBuilder,
    >
{
    fn from(value: &'a CommercialCameraLot) -> Self {
        web_common_traits::database::IdOrBuilder::Id(value.id)
    }
}
impl web_common_traits::prelude::ExtensionTable<crate::AssetModel> for CommercialCameraLot where
    for<'a> &'a Self: diesel::Identifiable<Id = &'a i32>
{
}
impl web_common_traits::prelude::ExtensionTable<crate::CameraModel> for CommercialCameraLot where
    for<'a> &'a Self: diesel::Identifiable<Id = &'a i32>
{
}
impl web_common_traits::prelude::ExtensionTable<crate::CommercialProductLot> for CommercialCameraLot where
    for<'a> &'a Self: diesel::Identifiable<Id = &'a i32>
{
}
impl web_common_traits::prelude::ExtensionTable<crate::PhysicalAssetModel> for CommercialCameraLot where
    for<'a> &'a Self: diesel::Identifiable<Id = &'a i32>
{
}
impl web_common_traits::prelude::ExtensionTable<crate::CommercialCameraLot> for CommercialCameraLot where
    for<'a> &'a Self: diesel::Identifiable<Id = &'a i32>
{
}
impl diesel::Identifiable for CommercialCameraLot {
    type Id = i32;
    fn id(self) -> Self::Id {
        self.id
    }
}
impl CommercialCameraLot {
    ...
    pub fn product_model<C: diesel::connection::LoadConnection>(
        &self,
        conn: &mut C,
    ) -> Result<crate::CommercialCameraModel, diesel::result::Error>
    where
        crate::CommercialCameraModel: web_common_traits::database::Read<C>,
    {
        use web_common_traits::database::Read;
        crate::CommercialCameraModel::read(self.product_model, conn)
    }
    ...
    where
        ...
        <Self as diesel::associations::HasTable>::Table: diesel::query_dsl::methods::FilterDsl<
            <crate::codegen::diesel_codegen::tables::commercial_camera_lots::commercial_camera_lots::id as diesel::expression_methods::EqAll<
                i32,
            >>::Output,
        >,
        ...
        >>::Output: diesel::query_dsl::methods::OrderDsl<
            diesel::helper_types::Asc<
                crate::codegen::diesel_codegen::tables::commercial_camera_lots::commercial_camera_lots::id,
            >,
        >,
        <<<Self as diesel::associations::HasTable>::Table as diesel::query_dsl::methods::FilterDsl<
            <crate::codegen::diesel_codegen::tables::commercial_camera_lots::commercial_camera_lots::id as diesel::expression_methods::EqAll<
            ...
            + for<'a> diesel::query_dsl::LoadQuery<'a, C, Self>,
    {
        ...
        Self::table()
            .filter(commercial_camera_lots::id.eq(id))
            .order_by(commercial_camera_lots::id.asc())
            .load::<Self>(conn)
    }
    #[cfg(feature = "postgres")]
    pub fn from_id_and_product_model(
        ...
        Self::table()
            .filter(
                commercial_camera_lots::id
                    .eq(id)
                    .and(commercial_camera_lots::product_model.eq(product_model)),
            )
            .order_by(commercial_camera_lots::id.asc())
            .load::<Self>(conn)
    }
    ...
    pub fn from_lot_and_product_model(
        ...
        use crate::codegen::diesel_codegen::tables::{
            commercial_camera_lots::commercial_camera_lots,
            commercial_product_lots::commercial_product_lots,
        };
        Self::table()
            .inner_join(
                commercial_product_lots::table
                    .on(commercial_camera_lots::id.eq(commercial_product_lots::id)),
            )
            .filter(
        ...
        Self::table()
            .inner_join(
                physical_asset_models::table
                    .on(commercial_camera_lots::id.eq(physical_asset_models::id)),
            )
    ...
    pub fn from_name(
        ...
        Self::table()
            .inner_join(asset_models::table.on(commercial_camera_lots::id.eq(asset_models::id)))
...
impl AsRef<CommercialCameraLot> for CommercialCameraLot {
    fn as_ref(&self) -> &CommercialCameraLot {
        self
    }
}
