...
use core_structures::{
    ...
    FreezeDryingProcedureModel, FreezerModel, FreezingProcedureModel, PlacingProcedureModel,
    ProcedureModel, ProcedureModelTrackable, StorageProcedureModel, SupernatantProcedureModel,
    Trackable, VolumetricContainerModel, WeighingInstrumentModel,
...
pub(super) fn init_dbgi_sample_processing_procedures(
    ...
    let freezing_procedure = FreezingProcedureModel::new()
        ...
        .created_by(user.id)
        .unwrap()
        .procedure_frozen_container_id(procedure_conical_tubes_box_builder.clone())
        .unwrap()
    ...
    let freeze_dryer = ProcedureModelTrackable::new()
    ...
    let freeze_drying_procedure = FreezeDryingProcedureModel::new()
        ...
        .created_by(user.id)
        .unwrap()
        .procedure_freeze_dried_container_id(procedure_conical_tubes_box_builder)
        .unwrap()
        .procedure_freeze_dried_with(freeze_dryer)
        .unwrap()
        .insert(user.id, conn)
        .unwrap();
    ...
    let metal_beads_procedure = PlacingProcedureModel::new()
        ...
        .unwrap()
        .procedure_placed_into(procedure_safelock_tube_builder.clone())
        .unwrap()
        .quantity(3i16)
        .unwrap()
        .insert(user.id, conn)
    ...
    let first_ball_mill_procedure = BallMillProcedureModel::new()
        ...
        .created_by(user.id)
        .unwrap()
        .procedure_milled_container_id(procedure_safelock_tube_builder.clone())
        .unwrap()
    ...
    let centrifuge_procedure = CentrifugeProcedureModel::new()
        ...
        .created_by(user.id)
        .unwrap()
        .procedure_centrifuged_container_id(procedure_safelock_tube_builder.clone())
        .unwrap()
