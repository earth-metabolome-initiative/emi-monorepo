...
impl core::fmt::Display for OrganismModelExtensionAttribute {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            Self::SampleSourceModel(e) => write!(f, "organism_models({e})"),
        }
    }
}
...
impl From<common_traits::builder::EmptyTuple> for OrganismModelExtensionAttribute {
...
impl<T1> common_traits::builder::Attributed
    for crate::codegen::structs_codegen::tables::insertables::InsertableOrganismModelBuilder<T1>
{
    type Attribute = OrganismModelAttribute;
}
impl web_common_traits::database::TableField for OrganismModelAttribute {}
impl web_common_traits::database::HasTableType for OrganismModelAttribute {
    ...
    > for OrganismModelAttribute
{
    fn from_extension(
        ...
        OrganismModelAttribute::Extension(From::from(attribute))
    }
}
...
///
/// ```rust,ignore
/// use core_structures::OrganismModel;
...
///
/// let organism_model = OrganismModel::new()
...
{
    type Table = crate::codegen::diesel_codegen::tables::organism_models::organism_models::table;
    fn table() -> Self::Table {
        crate::codegen::diesel_codegen::tables::organism_models::organism_models::table
    }
}
...
where
    Self: common_traits::builder::Attributed<
        Attribute = crate::codegen::structs_codegen::tables::insertables::OrganismModelAttribute,
    >,
{
...
{
    type Error = web_common_traits::database::InsertError<OrganismModelAttribute>;
