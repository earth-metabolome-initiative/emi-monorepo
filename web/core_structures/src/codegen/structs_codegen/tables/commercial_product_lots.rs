...
#[diesel(belongs_to(crate::CommercialProduct, foreign_key = product_model))]
...
impl web_common_traits::prelude::ExtensionTable<crate::PhysicalAssetModel> for CommercialProductLot where
    for<'a> &'a Self: diesel::Identifiable<Id = &'a i32>
{
}
...
impl CommercialProductLot {
    ...
    where
        ...
        <Self as diesel::associations::HasTable>::Table: diesel::query_dsl::methods::FilterDsl<
            <crate::codegen::diesel_codegen::tables::commercial_product_lots::commercial_product_lots::id as diesel::expression_methods::EqAll<
                i32,
            >>::Output,
        >,
