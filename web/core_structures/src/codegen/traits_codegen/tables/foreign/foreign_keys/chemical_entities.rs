...
pub struct ChemicalEntityForeignKeys {
...
{
    type ForeignKeys = ChemicalEntityForeignKeys;
...
impl web_common_traits::prelude::ForeignKeys for ChemicalEntityForeignKeys {}
