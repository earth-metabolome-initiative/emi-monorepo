...
#[diesel(belongs_to(crate::models::teams::Team, foreign_key = team_id))]
...
impl ProjectsTeamsRoleRequest {
    ...
    pub fn can_view_by_id(
        ...
        diesel::select(can_view_projects_teams_role_requests(
            author_user_id,
            table_id,
            team_id,
        ))
    ...
    pub fn all_viewable(
        ...
        let mut query =
            projects_teams_role_requests::dsl::projects_teams_role_requests.into_boxed();
        ...
        query
            .filter(can_view_projects_teams_role_requests(
                author_user_id,
    ...
    pub fn similarity_search_viewable(
        ...
        if let Some(table_id) = filter.and_then(|f| f.table_id) {
            return projects_teams_role_requests::dsl::projects_teams_role_requests
                .filter(projects_teams_role_requests::dsl::table_id.eq(table_id))
                ...
                .inner_join(
                    teams::dsl::teams
                        .on(projects_teams_role_requests::dsl::team_id.eq(teams::dsl::id)),
                )
                // This operation is defined by a first order index linking projects_teams_role_requests.role_id to roles.
                .inner_join(
                    roles::dsl::roles
                        .on(projects_teams_role_requests::dsl::role_id.eq(roles::dsl::id)),
                )
                .filter(can_view_projects_teams_role_requests(
                    author_user_id,
                    projects_teams_role_requests::dsl::table_id,
        ...
        if let Some(role_id) = filter.and_then(|f| f.role_id) {
            return projects_teams_role_requests::dsl::projects_teams_role_requests
                .filter(projects_teams_role_requests::dsl::role_id.eq(role_id))
                .select(ProjectsTeamsRoleRequest::as_select())
                // This operation is defined by a first order index linking projects_teams_role_requests.table_id to projects.
                .inner_join(
                    projects::dsl::projects
        ...
        if let Some(created_by) = filter.and_then(|f| f.created_by) {
            return projects_teams_role_requests::dsl::projects_teams_role_requests
                .filter(projects_teams_role_requests::dsl::created_by.eq(created_by))
                .select(ProjectsTeamsRoleRequest::as_select())
                // This operation is defined by a first order index linking projects_teams_role_requests.table_id to projects.
                .inner_join(
                    projects::dsl::projects
    ...
    pub fn can_update_by_id(
        ...
        diesel::select(can_update_projects_teams_role_requests(
            author_user_id,
            table_id,
            team_id,
        ))
    ...
    pub fn all_updatable(
        ...
        query
            .filter(can_update_projects_teams_role_requests(
                author_user_id,
                projects_teams_role_requests::dsl::table_id,
                projects_teams_role_requests::dsl::team_id,
            ))
    ...
    pub fn can_admin_by_id(
        ...
        diesel::select(can_admin_projects_teams_role_requests(
            author_user_id,
            table_id,
            team_id,
        ))
    ...
    pub fn all_administrable(
        ...
        query
            .filter(can_admin_projects_teams_role_requests(
                author_user_id,
                projects_teams_role_requests::dsl::table_id,
                projects_teams_role_requests::dsl::team_id,
            ))
