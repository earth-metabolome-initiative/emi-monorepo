...
connection: &mut PooledConnection<ConnectionManager<diesel::prelude::PgConnection>>,
        ...
        units::dsl::units
            .filter(
similarity_op(concat_units_name_description_symbol(units::dsl::name, units::dsl::description, units::dsl::symbol), query))
            .order(
similarity_dist(concat_units_name_description_symbol(units::dsl::name, units::dsl::description, units::dsl::symbol), query))
            .limit(limit.unwrap_or(10))
            .offset(offset.unwrap_or(0))
            .load::<Self>(connection).map_err(web_common::api::ApiError::from)
}
...
connection: &mut PooledConnection<ConnectionManager<diesel::prelude::PgConnection>>,
        ...
        units::dsl::units
            .filter(
word_similarity_op(concat_units_name_description_symbol(units::dsl::name, units::dsl::description, units::dsl::symbol), query))
            .order(
word_similarity_dist_op(concat_units_name_description_symbol(units::dsl::name, units::dsl::description, units::dsl::symbol), query))
            .limit(limit.unwrap_or(10))
            .offset(offset.unwrap_or(0))
            .load::<Self>(connection).map_err(web_common::api::ApiError::from)
}
...
connection: &mut PooledConnection<ConnectionManager<diesel::prelude::PgConnection>>,
        ...
        units::dsl::units
            .filter(
strict_word_similarity_op(concat_units_name_description_symbol(units::dsl::name, units::dsl::description, units::dsl::symbol), query))
            .order(
strict_word_similarity_dist_op(concat_units_name_description_symbol(units::dsl::name, units::dsl::description, units::dsl::symbol), query))
            .limit(limit.unwrap_or(10))
            .offset(offset.unwrap_or(0))
            .load::<Self>(connection).map_err(web_common::api::ApiError::from)
}
