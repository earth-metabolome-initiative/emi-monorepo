...
where
    ...
    crate::codegen::structs_codegen::tables::insertables::CappingProcedureTemplateAttribute: web_common_traits::database::FromExtensionAttribute<
        ...
        let procedure_template = self
            ...
            .map_err(|err| {
                err.into_field_name(|attribute| {
                    <crate::codegen::structs_codegen::tables::insertables::CappingProcedureTemplateAttribute as web_common_traits::database::FromExtensionAttribute<
                        crate::codegen::structs_codegen::tables::insertables::ProcedureTemplateAttribute,
                        ProcedureTemplate,
