diesel::table! {
    ...
    ::rosetta_uuid::diesel_impls::Uuid, procedure_template_poured_from_model ->
    diesel::sql_types::Integer, procedure_poured_from ->
    ::rosetta_uuid::diesel_impls::Uuid, measured_with -> diesel::sql_types::Nullable <
    ::rosetta_uuid::diesel_impls::Uuid >, procedure_template_measured_with_model ->
    diesel::sql_types::Integer, procedure_measured_with ->
