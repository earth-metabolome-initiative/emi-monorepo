...
impl From<
    crate::codegen::structs_codegen::tables::insertables::InsertablePhysicalAssetModelAttributes,
> for InsertablePipetteTipModelExtensionAttributes {
    fn from(
...
> for InsertablePipetteTipModelAttributes {
    fn from(
        ...
        Self::Extension(
            InsertablePipetteTipModelExtensionAttributes::PhysicalAssetModel(
...
/// descendant tables.
pub trait PipetteTipModelBuildable:
    crate::codegen::structs_codegen::tables::insertables::PhysicalAssetModelBuildable
{
}
impl PipetteTipModelBuildable for Option<i32> {}
impl<
    PhysicalAssetModel: crate::codegen::structs_codegen::tables::insertables::PhysicalAssetModelBuildable<
        ...
        >,
> PipetteTipModelBuildable for InsertablePipetteTipModelBuilder<PhysicalAssetModel> {}
impl<
    PhysicalAssetModel: crate::codegen::structs_codegen::tables::insertables::PhysicalAssetModelBuildable<
            Attributes = crate::codegen::structs_codegen::tables::insertables::InsertablePhysicalAssetModelAttributes,
        >,
...
for InsertablePipetteTipModelBuilder<PhysicalAssetModel> {
    type Attributes = crate::codegen::structs_codegen::tables::insertables::InsertablePipetteTipModelAttributes;
    #[inline]
