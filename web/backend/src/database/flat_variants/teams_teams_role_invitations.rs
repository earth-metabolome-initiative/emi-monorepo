...
impl TeamsTeamsRoleInvitation {
    ...
    pub fn can_view_by_id(
        ...
        diesel::select(
            crate::database::sql_function_bindings::can_view_teams_teams_role_invitations(
                author_user_id,
                table_id,
                team_id,
            ),
    ...
    pub fn all_viewable(
        ...
        let query = teams_teams_role_invitations::dsl::teams_teams_role_invitations
            ...
            .order_by(teams_teams_role_invitations::dsl::table_id);
    ...
    pub fn strict_word_similarity_search_viewable(
        ...
        let (teams0, teams1) = diesel::alias!(
            crate::database::schema::teams as teams0,
            crate::database::schema::teams as teams1
        );
        let mut query =
            teams_teams_role_invitations::dsl::teams_teams_role_invitations
...
.inner_join(
   roles::dsl::roles.on(
    ...
    crate::database::sql_function_bindings::strict_word_similarity_dist_op(crate::database::sql_function_bindings::concat_teams_name_description(teams0.field(teams::dsl::name), teams0.field(teams::dsl::description)), query)    +
crate::database::sql_function_bindings::strict_word_similarity_dist_op(crate::database::sql_function_bindings::concat_teams_name_description(teams1.field(teams::dsl::name), teams1.field(teams::dsl::description)), query)    +
crate::database::sql_function_bindings::strict_word_similarity_dist_op(crate::database::sql_function_bindings::concat_roles_name(roles::dsl::name, roles::dsl::description), query)
))
            .filter(crate::database::sql_function_bindings::can_view_teams_teams_role_invitations(author_user_id, teams_teams_role_invitations::dsl::table_id, teams_teams_role_invitations::dsl::team_id))
            .filter(
crate::database::sql_function_bindings::concat_teams_name_description(teams0.field(teams::dsl::name), teams0.field(teams::dsl::description)).strict_word_similarity_commutator_op(query).or(
    crate::database::sql_function_bindings::concat_teams_name_description(teams0.field(teams::dsl::name), teams0.field(teams::dsl::description)).ilike(format!("%{}%", query))
)
    .or(
crate::database::sql_function_bindings::concat_teams_name_description(teams1.field(teams::dsl::name), teams1.field(teams::dsl::description)).strict_word_similarity_commutator_op(query).or(
    crate::database::sql_function_bindings::concat_teams_name_description(teams1.field(teams::dsl::name), teams1.field(teams::dsl::description)).ilike(format!("%{}%", query))
)
    )
    .or(
crate::database::sql_function_bindings::concat_roles_name(roles::dsl::name, roles::dsl::description).strict_word_similarity_commutator_op(query).or(
    crate::database::sql_function_bindings::concat_roles_name(roles::dsl::name, roles::dsl::description).ilike(format!("%{}%", query))
)
    )
)
            .order(crate::database::sql_function_bindings::strict_word_similarity_dist_op(crate::database::sql_function_bindings::concat_teams_name_description(teams0.field(teams::dsl::name), teams0.field(teams::dsl::description)), query)    +
crate::database::sql_function_bindings::strict_word_similarity_dist_op(crate::database::sql_function_bindings::concat_teams_name_description(teams1.field(teams::dsl::name), teams1.field(teams::dsl::description)), query)    +
crate::database::sql_function_bindings::strict_word_similarity_dist_op(crate::database::sql_function_bindings::concat_roles_name(roles::dsl::name, roles::dsl::description), query))
            .limit(limit.unwrap_or(10))
            .offset(offset.unwrap_or(0))
...
.map_err(web_common::api::ApiError::from)
    ...
    pub fn can_update_by_id(
        ...
        diesel::select(
            crate::database::sql_function_bindings::can_update_teams_teams_role_invitations(
                author_user_id,
                table_id,
                team_id,
            ),
    ...
    pub fn can_admin_by_id(
        ...
        diesel::select(
            crate::database::sql_function_bindings::can_admin_teams_teams_role_invitations(
                author_user_id,
                table_id,
                team_id,
            ),
    ...
    pub fn delete_by_id(
        ...
        diesel::delete(
            crate::database::teams_teams_role_invitations::dsl::teams_teams_role_invitations
                .filter(crate::database::teams_teams_role_invitations::dsl::table_id.eq(table_id))
                .filter(crate::database::teams_teams_role_invitations::dsl::team_id.eq(team_id)),
        )
        .execute(connection)
        .map_err(web_common::api::ApiError::from)
    }
