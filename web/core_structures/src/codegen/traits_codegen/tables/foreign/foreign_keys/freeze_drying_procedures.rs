    ...
    fn update(
        ...
        match (row, crud) {
            ...
            (
                ...
                if self.procedure_freeze_dried_container == procedure_asset_models.id {
                    foreign_keys.procedure_freeze_dried_container = Some(procedure_asset_models);
                    updated = true;
                }
                if self.procedure_freeze_dried_with == procedure_asset_models.id {
                    foreign_keys.procedure_freeze_dried_with = Some(procedure_asset_models);
                    updated = true;
                }
            }
            (
