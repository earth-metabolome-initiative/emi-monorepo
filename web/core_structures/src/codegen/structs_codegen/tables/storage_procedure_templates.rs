...
impl web_common_traits::prelude::ExtensionTable<crate::StorageProcedureTemplate>
    for StorageProcedureTemplate
where
    for<'a> &'a Self: diesel::Identifiable<Id = &'a i32>,
{
...
impl StorageProcedureTemplate {
    ...
    where
        ...
        <Self as diesel::associations::HasTable>::Table: diesel::query_dsl::methods::FilterDsl<
            <crate::codegen::diesel_codegen::tables::storage_procedure_templates::storage_procedure_templates::procedure_template as diesel::expression_methods::EqAll<
                i32,
            >>::Output,
        >,
            ...
            + for<'a> diesel::query_dsl::LoadQuery<'a, C, Self>,
    {
        ...
        use crate::codegen::diesel_codegen::tables::storage_procedure_templates::storage_procedure_templates;
        Self::table()
            .filter(storage_procedure_templates::procedure_template.eq(procedure_template))
            .order_by(storage_procedure_templates::procedure_template.asc())
            .load::<Self>(conn)
    }
    #[cfg(feature = "postgres")]
