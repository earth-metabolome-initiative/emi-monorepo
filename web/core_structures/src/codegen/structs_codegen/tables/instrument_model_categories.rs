...
pub struct InstrumentModelCategory {
    pub id: i32,
...
impl diesel::Identifiable for InstrumentModelCategory {
    type Id = i32;
    fn id(self) -> Self::Id {
        self.id
    }
}
impl InstrumentModelCategory {
    ...
    pub async fn from_instrument_model_id(
        ...
        Self::table()
            .filter(
                crate::codegen::diesel_codegen::tables::instrument_model_categories::instrument_model_categories::dsl::instrument_model_id
    ...
    pub async fn from_created_by(
        ...
        Self::table()
            .filter(
                crate::codegen::diesel_codegen::tables::instrument_model_categories::instrument_model_categories::dsl::created_by
                    .eq(created_by.id),
            )
            .load::<Self>(conn)
            .await
    ...
    pub async fn from_updated_by(
        ...
        Self::table()
            .filter(
                crate::codegen::diesel_codegen::tables::instrument_model_categories::instrument_model_categories::dsl::updated_by
                    .eq(updated_by.id),
            )
            .load::<Self>(conn)
            .await
    ...
    pub async fn from_instrument_category(
        ...
        use crate::codegen::diesel_codegen::tables::instrument_model_categories::instrument_model_categories;
        Self::table()
            .filter(instrument_model_categories::instrument_category.eq(instrument_category))
            .order_by(instrument_model_categories::id.asc())
            .load::<Self>(conn)
            .await
    }
    #[cfg(feature = "postgres")]
    pub async fn from_created_at(
        ...
        use crate::codegen::diesel_codegen::tables::instrument_model_categories::instrument_model_categories;
        Self::table()
            .filter(instrument_model_categories::created_at.eq(created_at))
            .order_by(instrument_model_categories::id.asc())
            .load::<Self>(conn)
            .await
    }
    ...
    pub async fn from_updated_at(
        ...
        use crate::codegen::diesel_codegen::tables::instrument_model_categories::instrument_model_categories;
        Self::table()
            .filter(instrument_model_categories::updated_at.eq(updated_at))
            .order_by(instrument_model_categories::id.asc())
            .load::<Self>(conn)
            .await
    }
