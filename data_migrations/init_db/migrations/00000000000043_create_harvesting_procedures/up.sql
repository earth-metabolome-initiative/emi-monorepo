...
CREATE TABLE IF NOT EXISTS harvesting_procedures (
	...
	harvesting_procedure_template INTEGER NOT NULL REFERENCES harvesting_procedure_templates(id),
	...
	FOREIGN KEY (id, harvesting_procedure_template) REFERENCES procedures(id, procedure_template),
