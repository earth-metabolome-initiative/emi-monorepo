...
bincode::serialize(&NestedSampledIndividualBioOttTaxonItem::all_viewable(
filter.map(|filter| bincode::deserialize::<SampledIndividualBioOttTaxonItemFilter>(&filter)).transpose()?.as_ref(),
author_user_id,
limit,
offset,
connection)?)?
...
bincode::serialize(&NestedSampledIndividual::all_viewable(
filter.map(|filter| bincode::deserialize::<SampledIndividualFilter>(&filter)).transpose()?.as_ref(),
author_user_id,
limit,
offset,
connection)?)?
...
connection)?)?
            ...
            web_common::database::Table::SampledIndividualBioOttTaxonItems => {
bincode::serialize(&NestedSampledIndividualBioOttTaxonItem::get(
primary_key.into(),
author_user_id,
connection)?)?
            },
            web_common::database::Table::SampledIndividuals => {
bincode::serialize(&NestedSampledIndividual::get(
primary_key.into(),
author_user_id,
connection)?)?
            },
...
connection)?)?
            ...
            web_common::database::Table::SampledIndividualBioOttTaxonItems => unimplemented!("Method similarity_search_viewable not implemented for table sampled_individual_bio_ott_taxon_items."),
            web_common::database::Table::SampledIndividuals => {
bincode::serialize(&NestedSampledIndividual::similarity_search_viewable(
filter.map(|filter| bincode::deserialize::<SampledIndividualFilter>(&filter)).transpose()?.as_ref(),
author_user_id,
query,
limit,
...
connection)?)?
            ...
            web_common::database::Table::SampledIndividualBioOttTaxonItems => unimplemented!("Method word_similarity_search_viewable not implemented for table sampled_individual_bio_ott_taxon_items."),
            web_common::database::Table::SampledIndividuals => {
bincode::serialize(&NestedSampledIndividual::word_similarity_search_viewable(
filter.map(|filter| bincode::deserialize::<SampledIndividualFilter>(&filter)).transpose()?.as_ref(),
author_user_id,
query,
limit,
...
connection)?)?
            ...
            web_common::database::Table::SampledIndividualBioOttTaxonItems => unimplemented!("Method strict_word_similarity_search_viewable not implemented for table sampled_individual_bio_ott_taxon_items."),
            web_common::database::Table::SampledIndividuals => {
bincode::serialize(&NestedSampledIndividual::strict_word_similarity_search_viewable(
filter.map(|filter| bincode::deserialize::<SampledIndividualFilter>(&filter)).transpose()?.as_ref(),
author_user_id,
query,
limit,
...
connection: &mut PooledConnection<ConnectionManager<diesel::prelude::PgConnection>>,
        ...
        Ok(match self {
            web_common::database::Table::BioOttRanks => unimplemented!("Method can_view_by_id not implemented for table bio_ott_ranks."),
            web_common::database::Table::BioOttTaxonItems => unimplemented!("Method can_view_by_id not implemented for table bio_ott_taxon_items."),
            web_common::database::Table::Colors => unimplemented!("Method can_view_by_id not implemented for table colors."),
            web_common::database::Table::Countries => unimplemented!("Method can_view_by_id not implemented for table countries."),
            web_common::database::Table::DerivedSamples => {
NestedDerivedSample::can_view_by_id(
primary_key.into(),
author_user_id,
connection)?            },
            web_common::database::Table::DocumentFormats => unimplemented!("Method can_view_by_id not implemented for table document_formats."),
            web_common::database::Table::FontAwesomeIcons => unimplemented!("Method can_view_by_id not implemented for table font_awesome_icons."),
            web_common::database::Table::LoginProviders => unimplemented!("Method can_view_by_id not implemented for table login_providers."),
            web_common::database::Table::Materials => unimplemented!("Method can_view_by_id not implemented for table materials."),
            web_common::database::Table::Notifications => unimplemented!("Method can_view_by_id not implemented for table notifications."),
            web_common::database::Table::Observations => {
NestedObservation::can_view_by_id(
primary_key.into(),
author_user_id,
connection)?            },
            web_common::database::Table::Organizations => unimplemented!("Method can_view_by_id not implemented for table organizations."),
            web_common::database::Table::ProjectStates => unimplemented!("Method can_view_by_id not implemented for table project_states."),
            web_common::database::Table::Projects => {
...
author_user_id,
connection)?            },
            web_common::database::Table::Roles => unimplemented!("Method can_view_by_id not implemented for table roles."),
            web_common::database::Table::SampleBioOttTaxonItems => {
NestedSampleBioOttTaxonItem::can_view_by_id(
primary_key.into(),
author_user_id,
connection)?            },
            web_common::database::Table::SampleContainerCategories => unimplemented!("Method can_view_by_id not implemented for table sample_container_categories."),
            web_common::database::Table::SampleContainers => {
NestedSampleContainer::can_view_by_id(
primary_key.into(),
author_user_id,
connection)?            },
            web_common::database::Table::SampleStates => unimplemented!("Method can_view_by_id not implemented for table sample_states."),
            web_common::database::Table::SampledIndividualBioOttTaxonItems => {
NestedSampledIndividualBioOttTaxonItem::can_view_by_id(
primary_key.into(),
author_user_id,
connection)?            },
            web_common::database::Table::SampledIndividuals => {
NestedSampledIndividual::can_view_by_id(
primary_key.into(),
author_user_id,
connection)?            },
            web_common::database::Table::Samples => {
...
author_user_id,
connection)?            },
            web_common::database::Table::TeamStates => unimplemented!("Method can_view_by_id not implemented for table team_states."),
            web_common::database::Table::Teams => unimplemented!("Method can_view_by_id not implemented for table teams."),
            web_common::database::Table::TeamsTeamsRoleInvitations => {
...
author_user_id,
connection)?            },
            web_common::database::Table::TeamsUsersRoles => unimplemented!("Method can_view_by_id not implemented for table teams_users_roles."),
            web_common::database::Table::Units => unimplemented!("Method can_view_by_id not implemented for table units."),
            web_common::database::Table::UserEmails => {
NestedUserEmail::can_view_by_id(
primary_key.into(),
author_user_id,
connection)?            },
            web_common::database::Table::Users => unimplemented!("Method can_view_by_id not implemented for table users."),
            web_common::database::Table::UsersUsersRoleInvitations => {
...
author_user_id,
connection)?            },
            web_common::database::Table::UsersUsersRoles => unimplemented!("Method can_view_by_id not implemented for table users_users_roles."),
        })
    }
...
connection: &mut PooledConnection<ConnectionManager<diesel::prelude::PgConnection>>,
        ...
        Ok(match self {
            web_common::database::Table::BioOttRanks => unimplemented!("Method all_viewable_sorted not implemented for table bio_ott_ranks."),
            web_common::database::Table::BioOttTaxonItems => unimplemented!("Method all_viewable_sorted not implemented for table bio_ott_taxon_items."),
            web_common::database::Table::Colors => unimplemented!("Method all_viewable_sorted not implemented for table colors."),
            web_common::database::Table::Countries => unimplemented!("Method all_viewable_sorted not implemented for table countries."),
            web_common::database::Table::DerivedSamples => {
...
connection)?)?
            ...
            web_common::database::Table::DocumentFormats => unimplemented!("Method all_viewable_sorted not implemented for table document_formats."),
            web_common::database::Table::FontAwesomeIcons => unimplemented!("Method all_viewable_sorted not implemented for table font_awesome_icons."),
            web_common::database::Table::LoginProviders => unimplemented!("Method all_viewable_sorted not implemented for table login_providers."),
            web_common::database::Table::Materials => unimplemented!("Method all_viewable_sorted not implemented for table materials."),
            web_common::database::Table::Notifications => unimplemented!("Method all_viewable_sorted not implemented for table notifications."),
            web_common::database::Table::Observations => {
...
connection)?)?
            ...
            web_common::database::Table::Organizations => unimplemented!("Method all_viewable_sorted not implemented for table organizations."),
            web_common::database::Table::ProjectStates => unimplemented!("Method all_viewable_sorted not implemented for table project_states."),
            web_common::database::Table::Projects => {
...
connection)?)?
            ...
            web_common::database::Table::Roles => unimplemented!("Method all_viewable_sorted not implemented for table roles."),
            web_common::database::Table::SampleBioOttTaxonItems => {
...
connection)?)?
            ...
            web_common::database::Table::SampleContainerCategories => unimplemented!("Method all_viewable_sorted not implemented for table sample_container_categories."),
            web_common::database::Table::SampleContainers => {
...
connection)?)?
            ...
            web_common::database::Table::SampleStates => unimplemented!("Method all_viewable_sorted not implemented for table sample_states."),
            web_common::database::Table::SampledIndividualBioOttTaxonItems => {
bincode::serialize(&NestedSampledIndividualBioOttTaxonItem::all_viewable_sorted(
filter.map(|filter| bincode::deserialize::<SampledIndividualBioOttTaxonItemFilter>(&filter)).transpose()?.as_ref(),
author_user_id,
limit,
offset,
connection)?)?
            ...
            web_common::database::Table::SampledIndividuals => {
bincode::serialize(&NestedSampledIndividual::all_viewable_sorted(
filter.map(|filter| bincode::deserialize::<SampledIndividualFilter>(&filter)).transpose()?.as_ref(),
author_user_id,
limit,
offset,
...
connection)?)?
            ...
            web_common::database::Table::Spectra => unimplemented!("Method all_viewable_sorted not implemented for table spectra."),
            web_common::database::Table::SpectraCollections => {
...
connection)?)?
            ...
            web_common::database::Table::TeamStates => unimplemented!("Method all_viewable_sorted not implemented for table team_states."),
            web_common::database::Table::Teams => {
...
connection)?)?
            ...
            web_common::database::Table::Units => unimplemented!("Method all_viewable_sorted not implemented for table units."),
            web_common::database::Table::UserEmails => {
...
connection)?            },
            ...
            web_common::database::Table::SampledIndividualBioOttTaxonItems => {
NestedSampledIndividualBioOttTaxonItem::can_admin_by_id(
primary_key.into(),
author_user_id,
connection)?            },
            web_common::database::Table::SampledIndividuals => {
NestedSampledIndividual::can_admin_by_id(
primary_key.into(),
author_user_id,
connection)?            },
            web_common::database::Table::Samples => {
...
connection)?)?
            ...
            web_common::database::Table::SampledIndividualBioOttTaxonItems => {
bincode::serialize(&NestedSampledIndividualBioOttTaxonItem::all_administrable(
filter.map(|filter| bincode::deserialize::<SampledIndividualBioOttTaxonItemFilter>(&filter)).transpose()?.as_ref(),
author_user_id,
limit,
offset,
connection)?)?
            ...
            web_common::database::Table::SampledIndividuals => {
bincode::serialize(&NestedSampledIndividual::all_administrable(
filter.map(|filter| bincode::deserialize::<SampledIndividualFilter>(&filter)).transpose()?.as_ref(),
author_user_id,
limit,
offset,
...
connection)?)?
            ...
            web_common::database::Table::SampledIndividualBioOttTaxonItems => {
bincode::serialize(&NestedSampledIndividualBioOttTaxonItem::all_administrable_sorted(
filter.map(|filter| bincode::deserialize::<SampledIndividualBioOttTaxonItemFilter>(&filter)).transpose()?.as_ref(),
author_user_id,
limit,
offset,
connection)?)?
            ...
            web_common::database::Table::SampledIndividuals => {
bincode::serialize(&NestedSampledIndividual::all_administrable_sorted(
filter.map(|filter| bincode::deserialize::<SampledIndividualFilter>(&filter)).transpose()?.as_ref(),
author_user_id,
limit,
offset,
...
connection)?            },
            ...
            web_common::database::Table::SampledIndividualBioOttTaxonItems => {
NestedSampledIndividualBioOttTaxonItem::delete_by_id(
primary_key.into(),
author_user_id,
connection)?            },
            web_common::database::Table::SampledIndividuals => {
NestedSampledIndividual::delete_by_id(
primary_key.into(),
author_user_id,
connection)?            },
            web_common::database::Table::Samples => {
...
connection: &mut PooledConnection<ConnectionManager<diesel::prelude::PgConnection>>,
        ...
        Ok(match self {
            ...
            web_common::database::Table::DerivedSamples => unimplemented!("Method can_update_by_id not implemented for table derived_samples."),
...
author_user_id,
connection)?            },
            web_common::database::Table::ProjectsTeamsRoleInvitations => unimplemented!("Method can_update_by_id not implemented for table projects_teams_role_invitations."),
            web_common::database::Table::ProjectsTeamsRoleRequests => unimplemented!("Method can_update_by_id not implemented for table projects_teams_role_requests."),
            web_common::database::Table::ProjectsTeamsRoles => unimplemented!("Method can_update_by_id not implemented for table projects_teams_roles."),
            web_common::database::Table::ProjectsUsersRoleInvitations => unimplemented!("Method can_update_by_id not implemented for table projects_users_role_invitations."),
            web_common::database::Table::ProjectsUsersRoleRequests => unimplemented!("Method can_update_by_id not implemented for table projects_users_role_requests."),
            web_common::database::Table::ProjectsUsersRoles => unimplemented!("Method can_update_by_id not implemented for table projects_users_roles."),
            web_common::database::Table::Roles => unimplemented!("Method can_update_by_id not implemented for table roles."),
            web_common::database::Table::SampleBioOttTaxonItems => unimplemented!("Method can_update_by_id not implemented for table sample_bio_ott_taxon_items."),
            ...
            web_common::database::Table::SampleContainers => unimplemented!("Method can_update_by_id not implemented for table sample_containers."),
            web_common::database::Table::SampleStates => unimplemented!("Method can_update_by_id not implemented for table sample_states."),
            web_common::database::Table::SampledIndividualBioOttTaxonItems => unimplemented!("Method can_update_by_id not implemented for table sampled_individual_bio_ott_taxon_items."),
            web_common::database::Table::SampledIndividuals => {
NestedSampledIndividual::can_update_by_id(
primary_key.into(),
author_user_id,
connection)?            },
            web_common::database::Table::Samples => {
...
author_user_id,
connection)?            },
            web_common::database::Table::TeamsTeamsRoleInvitations => unimplemented!("Method can_update_by_id not implemented for table teams_teams_role_invitations."),
            web_common::database::Table::TeamsUsersRoleInvitations => unimplemented!("Method can_update_by_id not implemented for table teams_users_role_invitations."),
            web_common::database::Table::TeamsUsersRoleRequests => unimplemented!("Method can_update_by_id not implemented for table teams_users_role_requests."),
            web_common::database::Table::TeamsUsersRoles => unimplemented!("Method can_update_by_id not implemented for table teams_users_roles."),
            web_common::database::Table::Units => unimplemented!("Method can_update_by_id not implemented for table units."),
            web_common::database::Table::UserEmails => unimplemented!("Method can_update_by_id not implemented for table user_emails."),
            web_common::database::Table::Users => {
User::can_update_by_id(
primary_key.into(),
author_user_id,
connection)?            },
            web_common::database::Table::UsersUsersRoleInvitations => unimplemented!("Method can_update_by_id not implemented for table users_users_role_invitations."),
            web_common::database::Table::UsersUsersRoleRequests => unimplemented!("Method can_update_by_id not implemented for table users_users_role_requests."),
            web_common::database::Table::UsersUsersRoles => unimplemented!("Method can_update_by_id not implemented for table users_users_roles."),
        })
    }
...
connection: &mut PooledConnection<ConnectionManager<diesel::prelude::PgConnection>>,
        ...
        Ok(match self {
            ...
            web_common::database::Table::DerivedSamples => unimplemented!("Method all_updatable not implemented for table derived_samples."),
...
connection)?)?
            ...
            web_common::database::Table::ProjectsTeamsRoleInvitations => unimplemented!("Method all_updatable not implemented for table projects_teams_role_invitations."),
            web_common::database::Table::ProjectsTeamsRoleRequests => unimplemented!("Method all_updatable not implemented for table projects_teams_role_requests."),
            web_common::database::Table::ProjectsTeamsRoles => unimplemented!("Method all_updatable not implemented for table projects_teams_roles."),
            web_common::database::Table::ProjectsUsersRoleInvitations => unimplemented!("Method all_updatable not implemented for table projects_users_role_invitations."),
            web_common::database::Table::ProjectsUsersRoleRequests => unimplemented!("Method all_updatable not implemented for table projects_users_role_requests."),
            web_common::database::Table::ProjectsUsersRoles => unimplemented!("Method all_updatable not implemented for table projects_users_roles."),
            web_common::database::Table::Roles => unimplemented!("Method all_updatable not implemented for table roles."),
            web_common::database::Table::SampleBioOttTaxonItems => unimplemented!("Method all_updatable not implemented for table sample_bio_ott_taxon_items."),
            ...
            web_common::database::Table::SampleContainers => unimplemented!("Method all_updatable not implemented for table sample_containers."),
            web_common::database::Table::SampleStates => unimplemented!("Method all_updatable not implemented for table sample_states."),
            web_common::database::Table::SampledIndividualBioOttTaxonItems => unimplemented!("Method all_updatable not implemented for table sampled_individual_bio_ott_taxon_items."),
            web_common::database::Table::SampledIndividuals => {
bincode::serialize(&NestedSampledIndividual::all_updatable(
filter.map(|filter| bincode::deserialize::<SampledIndividualFilter>(&filter)).transpose()?.as_ref(),
author_user_id,
limit,
offset,
...
connection)?)?
            ...
            web_common::database::Table::TeamsTeamsRoleInvitations => unimplemented!("Method all_updatable not implemented for table teams_teams_role_invitations."),
            web_common::database::Table::TeamsUsersRoleInvitations => unimplemented!("Method all_updatable not implemented for table teams_users_role_invitations."),
            web_common::database::Table::TeamsUsersRoleRequests => unimplemented!("Method all_updatable not implemented for table teams_users_role_requests."),
            web_common::database::Table::TeamsUsersRoles => unimplemented!("Method all_updatable not implemented for table teams_users_roles."),
            web_common::database::Table::Units => unimplemented!("Method all_updatable not implemented for table units."),
            web_common::database::Table::UserEmails => unimplemented!("Method all_updatable not implemented for table user_emails."),
            web_common::database::Table::Users => {
...
connection)?)?
            ...
            web_common::database::Table::UsersUsersRoleInvitations => unimplemented!("Method all_updatable not implemented for table users_users_role_invitations."),
            web_common::database::Table::UsersUsersRoleRequests => unimplemented!("Method all_updatable not implemented for table users_users_role_requests."),
            web_common::database::Table::UsersUsersRoles => unimplemented!("Method all_updatable not implemented for table users_users_roles."),
        })
    }
...
connection: &mut PooledConnection<ConnectionManager<diesel::prelude::PgConnection>>,
        ...
        Ok(match self {
            ...
            web_common::database::Table::DerivedSamples => unimplemented!("Method all_updatable_sorted not implemented for table derived_samples."),
...
connection)?)?
            ...
            web_common::database::Table::SampleContainers => unimplemented!("Method all_updatable_sorted not implemented for table sample_containers."),
            web_common::database::Table::SampleStates => unimplemented!("Method all_updatable_sorted not implemented for table sample_states."),
            web_common::database::Table::SampledIndividualBioOttTaxonItems => unimplemented!("Method all_updatable_sorted not implemented for table sampled_individual_bio_ott_taxon_items."),
            web_common::database::Table::SampledIndividuals => {
bincode::serialize(&NestedSampledIndividual::all_updatable_sorted(
filter.map(|filter| bincode::deserialize::<SampledIndividualFilter>(&filter)).transpose()?.as_ref(),
author_user_id,
limit,
offset,
...
connection)?)?
            ...
            web_common::database::Table::SampleContainers => unimplemented!("Method similarity_search_updatable not implemented for table sample_containers."),
            ...
            web_common::database::Table::SampledIndividualBioOttTaxonItems => unimplemented!("Method similarity_search_updatable not implemented for table sampled_individual_bio_ott_taxon_items."),
            web_common::database::Table::SampledIndividuals => {
bincode::serialize(&NestedSampledIndividual::similarity_search_updatable(
filter.map(|filter| bincode::deserialize::<SampledIndividualFilter>(&filter)).transpose()?.as_ref(),
author_user_id,
query,
limit,
...
connection)?)?
            ...
            web_common::database::Table::SampleContainers => unimplemented!("Method word_similarity_search_updatable not implemented for table sample_containers."),
            ...
            web_common::database::Table::SampledIndividualBioOttTaxonItems => unimplemented!("Method word_similarity_search_updatable not implemented for table sampled_individual_bio_ott_taxon_items."),
            web_common::database::Table::SampledIndividuals => {
bincode::serialize(&NestedSampledIndividual::word_similarity_search_updatable(
filter.map(|filter| bincode::deserialize::<SampledIndividualFilter>(&filter)).transpose()?.as_ref(),
author_user_id,
query,
limit,
...
connection)?)?
            ...
            web_common::database::Table::SampleContainers => unimplemented!("Method strict_word_similarity_search_updatable not implemented for table sample_containers."),
            ...
            web_common::database::Table::SampledIndividualBioOttTaxonItems => unimplemented!("Method strict_word_similarity_search_updatable not implemented for table sampled_individual_bio_ott_taxon_items."),
            web_common::database::Table::SampledIndividuals => {
bincode::serialize(&NestedSampledIndividual::strict_word_similarity_search_updatable(
filter.map(|filter| bincode::deserialize::<SampledIndividualFilter>(&filter)).transpose()?.as_ref(),
author_user_id,
query,
limit,
...
connection)?)?
            ...
            web_common::database::Table::SampledIndividualBioOttTaxonItems => unimplemented!("Method similarity_search_administrable not implemented for table sampled_individual_bio_ott_taxon_items."),
            web_common::database::Table::SampledIndividuals => {
bincode::serialize(&NestedSampledIndividual::similarity_search_administrable(
filter.map(|filter| bincode::deserialize::<SampledIndividualFilter>(&filter)).transpose()?.as_ref(),
author_user_id,
query,
limit,
...
connection)?)?
            ...
            web_common::database::Table::SampledIndividualBioOttTaxonItems => unimplemented!("Method word_similarity_search_administrable not implemented for table sampled_individual_bio_ott_taxon_items."),
            web_common::database::Table::SampledIndividuals => {
bincode::serialize(&NestedSampledIndividual::word_similarity_search_administrable(
filter.map(|filter| bincode::deserialize::<SampledIndividualFilter>(&filter)).transpose()?.as_ref(),
author_user_id,
query,
limit,
...
connection)?)?
            ...
            web_common::database::Table::SampledIndividualBioOttTaxonItems => unimplemented!("Method strict_word_similarity_search_administrable not implemented for table sampled_individual_bio_ott_taxon_items."),
            web_common::database::Table::SampledIndividuals => {
bincode::serialize(&NestedSampledIndividual::strict_word_similarity_search_administrable(
filter.map(|filter| bincode::deserialize::<SampledIndividualFilter>(&filter)).transpose()?.as_ref(),
author_user_id,
query,
limit,
...
impl InsertableTable for web_common::database::Table {
    ...
    fn insert(
        ...
        Ok(match self {
            ...
            web_common::database::Table::SampledIndividuals => {
                let row: web_common::database::NewSampledIndividual = bincode::deserialize::<web_common::database::NewSampledIndividual>(&row)?;
                ...
                let nested_row = crate::nested_models::NestedSampledIndividual::from_flat(inserted_row, Some(user_id), connection)?;
                 bincode::serialize(&nested_row)?
            },
            web_common::database::Table::Samples => {
    ...
    fn update(
        ...
        Ok(match self {
            ...
            web_common::database::Table::SampledIndividuals => {
                ...
                let nested_row = crate::nested_models::NestedSampledIndividual::from_flat(updated_row, Some(user_id), connection)?;
                 bincode::serialize(&nested_row)?
            },
            web_common::database::Table::Samples => {
                let row: web_common::database::NewSample = bincode::deserialize::<web_common::database::NewSample>(&row)?;
...
impl FromFlatStrTable for web_common::database::Table {
    ...
    fn from_flat_str(
        ...
        Ok(match self {
            ...
            web_common::database::Table::SampledIndividualBioOttTaxonItems => {
                let flat_row: crate::models::SampledIndividualBioOttTaxonItem = serde_json::from_str::<crate::models::SampledIndividualBioOttTaxonItem>(row)?;
                 let richest_row = crate::nested_models::NestedSampledIndividualBioOttTaxonItem::from_flat(flat_row, user_id, connection)?;
                 bincode::serialize(&richest_row)?
            },
            web_common::database::Table::SampledIndividuals => {
                let flat_row: crate::models::SampledIndividual = serde_json::from_str::<crate::models::SampledIndividual>(row)?;
                 let richest_row = crate::nested_models::NestedSampledIndividual::from_flat(flat_row, user_id, connection)?;
                 bincode::serialize(&richest_row)?
            },
            web_common::database::Table::Samples => {
