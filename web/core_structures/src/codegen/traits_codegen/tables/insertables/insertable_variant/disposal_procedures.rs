...
where
    ...
    crate::codegen::structs_codegen::tables::insertables::DisposalProcedureExtensionAttribute: From<
        ...
        let procedure = self
            ...
            .map_err(|err| {
                err.into_field_name(|attribute| {
                    crate::codegen::structs_codegen::tables::insertables::DisposalProcedureAttribute::Extension(
                        From::from(attribute),
                    )
                })
            })?;
