...
pub struct NestedUnit {
    pub inner: crate::database::flat_variants::Unit,
...
impl NestedUnit {
    ...
    pub fn all_viewable(
        filter: Option<&web_common::database::filter_variants::UnitFilter>,
        limit: Option<i64>,
        offset: Option<i64>,
        connection: &mut diesel::r2d2::PooledConnection<
...
impl From<web_common::database::nested_variants::NestedUnit>
    for crate::database::nested_variants::NestedUnit
{
    fn from(item: web_common::database::nested_variants::NestedUnit) -> Self {
        Self {
            inner: crate::database::flat_variants::Unit::from(item.inner.as_ref().clone()),
...
impl From<crate::database::nested_variants::NestedUnit>
    for web_common::database::nested_variants::NestedUnit
{
    fn from(item: crate::database::nested_variants::NestedUnit) -> Self {
        Self {
            inner: Rc::from(web_common::database::flat_variants::Unit::from(item.inner)),
