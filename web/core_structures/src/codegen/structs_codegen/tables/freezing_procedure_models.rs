...
pub struct FreezingProcedureModel {
    ...
    pub frozen_container_id: ::rosetta_uuid::Uuid,
    pub procedure_frozen_container_id: i32,
}
...
impl FreezingProcedureModel {
    ...
    #[cfg(feature = "postgres")]
    pub fn from_frozen_container_id(
        ...
        use crate::codegen::diesel_codegen::tables::freezing_procedure_models::freezing_procedure_models;
        Self::table()
            .filter(freezing_procedure_models::frozen_container_id.eq(frozen_container_id))
            .order_by(freezing_procedure_models::procedure_model_id.asc())
            .load::<Self>(conn)
    }
    #[cfg(feature = "postgres")]
    pub fn from_procedure_frozen_container_id(
        ...
        Self::table()
            .filter(
                freezing_procedure_models::procedure_frozen_container_id
                    .eq(procedure_frozen_container_id),
            )
            .order_by(freezing_procedure_models::procedure_model_id.asc())
            .load::<Self>(conn)
    }
    ...
    #[cfg(feature = "postgres")]
    pub fn from_procedure_frozen_container_id_and_procedure_model_id(
        procedure_frozen_container_id: &i32,
        procedure_model_id: &i32,
        conn: &mut diesel::PgConnection,
    ) -> Result<Vec<Self>, diesel::result::Error> {
    ...
    #[cfg(feature = "postgres")]
    pub fn from_procedure_frozen_container_id_and_frozen_container_id(
        procedure_frozen_container_id: &i32,
        frozen_container_id: &::rosetta_uuid::Uuid,
        conn: &mut diesel::PgConnection,
    ) -> Result<Vec<Self>, diesel::result::Error> {
        ...
        Self::table()
            .filter(
                freezing_procedure_models::procedure_frozen_container_id
                    .eq(procedure_frozen_container_id)
                    .and(freezing_procedure_models::frozen_container_id.eq(frozen_container_id)),
            )
            .order_by(freezing_procedure_models::procedure_model_id.asc())
            .load::<Self>(conn)
    }
    #[cfg(feature = "postgres")]
    pub fn from_frozen_with_and_frozen_container_id(
        frozen_with: &::rosetta_uuid::Uuid,
        frozen_container_id: &::rosetta_uuid::Uuid,
        conn: &mut diesel::PgConnection,
    ) -> Result<Vec<Self>, diesel::result::Error> {
