...
pub struct FreezeDryingStepModel {
    pub id: i32,
    pub expected_kelvin: f32,
    pub expected_pascal: f32,
...
impl diesel::Identifiable for FreezeDryingStepModel {
    type Id = i32;
    fn id(self) -> Self::Id {
        self.id
    }
}
impl FreezeDryingStepModel {
    ...
    pub async fn from_id(
        ...
        Self::table()
            .filter(
                crate::codegen::diesel_codegen::tables::freeze_drying_step_models::freeze_drying_step_models::dsl::id
                    .eq(id.id),
            )
            .first::<Self>(conn)
            .await
    ...
    pub async fn from_created_by(
        ...
        Self::table()
            .filter(
                crate::codegen::diesel_codegen::tables::freeze_drying_step_models::freeze_drying_step_models::dsl::created_by
                    .eq(created_by.id),
            )
            .load::<Self>(conn)
            .await
    ...
    pub async fn from_updated_by(
        ...
        Self::table()
            .filter(
                crate::codegen::diesel_codegen::tables::freeze_drying_step_models::freeze_drying_step_models::dsl::updated_by
                    .eq(updated_by.id),
            )
            .load::<Self>(conn)
            .await
    ...
    pub async fn from_created_at(
        ...
        Self::table()
            .filter(freeze_drying_step_models::created_at.eq(created_at))
            .order_by(freeze_drying_step_models::id.asc())
            .load::<Self>(conn)
            .await
    }
    #[cfg(feature = "postgres")]
    pub async fn from_updated_at(
        ...
        use crate::codegen::diesel_codegen::tables::freeze_drying_step_models::freeze_drying_step_models;
        Self::table()
            .filter(freeze_drying_step_models::updated_at.eq(updated_at))
            .order_by(freeze_drying_step_models::id.asc())
            .load::<Self>(conn)
            .await
    }
