...
{
    type Attribute = ProcedureAttribute;
}
impl web_common_traits::database::TableField for ProcedureAttribute {}
impl web_common_traits::database::HasTableType for ProcedureAttribute {
...
{
    type Error = web_common_traits::database::InsertError<ProcedureAttribute>;
