...
pub struct CommercialPipetteModel {
    pub id: i32,
    pub pipette_model: i32,
}
impl web_common_traits::prelude::TableName for CommercialPipetteModel {
    const TABLE_NAME: &'static str = "commercial_pipette_models";
}
impl<'a> From<&'a CommercialPipetteModel>
for web_common_traits::database::IdOrBuilder<
    i32,
    crate::codegen::structs_codegen::tables::insertables::InsertableCommercialPipetteModelBuilder,
> {
    fn from(value: &'a CommercialPipetteModel) -> Self {
        web_common_traits::database::IdOrBuilder::Id(value.id)
    }
}
impl web_common_traits::prelude::ExtensionTable<crate::AssetModel> for CommercialPipetteModel where
    for<'a> &'a Self: diesel::Identifiable<Id = &'a i32>
{
}
impl web_common_traits::prelude::ExtensionTable<crate::CommercialProduct> for CommercialPipetteModel where
    for<'a> &'a Self: diesel::Identifiable<Id = &'a i32>
{
}
impl web_common_traits::prelude::ExtensionTable<crate::PhysicalAssetModel>
    for CommercialPipetteModel
where
    for<'a> &'a Self: diesel::Identifiable<Id = &'a i32>,
{
}
impl web_common_traits::prelude::ExtensionTable<crate::PipetteModel> for CommercialPipetteModel where
    for<'a> &'a Self: diesel::Identifiable<Id = &'a i32>
{
}
impl web_common_traits::prelude::ExtensionTable<crate::CommercialPipetteModel>
    for CommercialPipetteModel
where
    for<'a> &'a Self: diesel::Identifiable<Id = &'a i32>,
{
}
impl diesel::Identifiable for CommercialPipetteModel {
    type Id = i32;
    fn id(self) -> Self::Id {
        self.id
    }
...
impl CommercialPipetteModel {
        ...
        crate::PipetteModel: web_common_traits::database::Read<C>,
    {
        ...
        crate::PipetteModel::read(self.pipette_model, conn)
    }
    ...
    where
        C: diesel::connection::LoadConnection,
        <Self as diesel::associations::HasTable>::Table: diesel::query_dsl::methods::FilterDsl<
            <crate::codegen::diesel_codegen::tables::commercial_pipette_models::commercial_pipette_models::id as diesel::expression_methods::EqAll<
                i32,
            >>::Output,
        >,
        <<Self as diesel::associations::HasTable>::Table as diesel::query_dsl::methods::FilterDsl<
            ...
            + for<'a> diesel::query_dsl::LoadQuery<'a, C, Self>,
    {
        ...
        use crate::codegen::diesel_codegen::tables::commercial_pipette_models::commercial_pipette_models;
        Self::table()
            .filter(commercial_pipette_models::id.eq(id))
            .order_by(commercial_pipette_models::id.asc())
            .load::<Self>(conn)
    }
    #[cfg(feature = "postgres")]
    pub fn from_id_and_pipette_model(
        id: i32,
        pipette_model: i32,
        conn: &mut diesel::PgConnection,
    ) -> Result<Vec<Self>, diesel::result::Error> {
    ...
    pub fn from_deprecation_date(
        ...
        use crate::codegen::diesel_codegen::tables::{
            commercial_pipette_models::commercial_pipette_models,
            commercial_products::commercial_products,
        };
        Self::table()
            .inner_join(
                commercial_products::table
                    .on(commercial_pipette_models::id.eq(commercial_products::id)),
            )
        ...
        Self::table()
            .inner_join(
                physical_asset_models::table
                    .on(commercial_pipette_models::id.eq(physical_asset_models::id)),
            )
    ...
    pub fn from_name(
        ...
        Self::table()
            .inner_join(asset_models::table.on(commercial_pipette_models::id.eq(asset_models::id)))
...
impl AsRef<CommercialPipetteModel> for CommercialPipetteModel {
    fn as_ref(&self) -> &CommercialPipetteModel {
        self
    }
}
