...
impl From<web_common::database::nested_variants::NestedTeamState> for NestedTeamState {
...
impl From<NestedTeamState> for web_common::database::nested_variants::NestedTeamState {
