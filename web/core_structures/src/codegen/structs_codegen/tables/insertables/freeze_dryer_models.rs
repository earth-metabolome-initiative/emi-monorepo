...
pub enum FreezeDryerModelExtensionAttribute {
    PhysicalAssetModel(
        crate::codegen::structs_codegen::tables::insertables::PhysicalAssetModelAttribute,
    ),
}
impl core::fmt::Display for FreezeDryerModelExtensionAttribute {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            Self::PhysicalAssetModel(e) => write!(f, "freeze_dryer_models({e})"),
        }
    }
}
impl From<crate::codegen::structs_codegen::tables::insertables::PhysicalAssetModelAttribute>
    for FreezeDryerModelExtensionAttribute
{
    fn from(
...
impl From<common_traits::builder::EmptyTuple> for FreezeDryerModelExtensionAttribute {
...
#[derive(Copy, Clone, PartialEq, Eq, PartialOrd, Ord, Hash, core::fmt::Debug)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub enum FreezeDryerModelAttribute {
    Extension(FreezeDryerModelExtensionAttribute),
    Id,
}
impl core::str::FromStr for FreezeDryerModelAttribute {
...
impl<T1> common_traits::builder::Attributed
    for crate::codegen::structs_codegen::tables::insertables::InsertableFreezeDryerModelBuilder<T1>
{
...
impl core::fmt::Display for FreezeDryerModelAttribute {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            ...
            Self::Id => write!(f, "freeze_dryer_models.id"),
        }
    }
}
#[derive(Debug)]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct InsertableFreezeDryerModel {
    pub(crate) id: i32,
}
impl InsertableFreezeDryerModel {}
#[derive(Clone, Debug, PartialEq, PartialOrd, Eq, Hash, Ord, Default)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
/// Builder for creating and inserting a new
/// [`FreezeDryerModel`](crate::codegen::structs_codegen::tables::freeze_dryer_models::FreezeDryerModel).
///
///
...
///
/// ```rust,ignore
/// use core_structures::FreezeDryerModel;
...
///
/// let freeze_dryer_model = FreezeDryerModel::new()
...
///    .insert(user.id, conn)?;
/// ```
pub struct InsertableFreezeDryerModelBuilder<
    PhysicalAssetModel
...
{
    type Table =
        crate::codegen::diesel_codegen::tables::freeze_dryer_models::freeze_dryer_models::table;
    fn table() -> Self::Table {
        crate::codegen::diesel_codegen::tables::freeze_dryer_models::freeze_dryer_models::table
    }
}
impl From<InsertableFreezeDryerModelBuilder>
    for web_common_traits::database::IdOrBuilder<i32, InsertableFreezeDryerModelBuilder>
{
    fn from(builder: InsertableFreezeDryerModelBuilder) -> Self {
