...
impl web_common_traits::database::TableField for SoilAttribute {}
impl web_common_traits::database::HasTableType for SoilAttribute {
    ...
    > for SoilAttribute
{
    fn from_extension(
        ...
        SoilAttribute::Extension(From::from(attribute))
    }
}
...
{
    type Error = web_common_traits::database::InsertError<SoilAttribute>;
