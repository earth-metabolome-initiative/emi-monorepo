...
{
    type ForeignKeys = CappingProcedureModelForeignKeys;
    ...
    fn update(
        ...
        match (row, crud) {
            (
                ...
                {
                    foreign_keys.capping_pm_compatibility_rules = Some(compatibility_rules);
                    updated = true;
                }
            }
            (
...
impl web_common_traits::prelude::ForeignKeys for CappingProcedureModelForeignKeys {}
