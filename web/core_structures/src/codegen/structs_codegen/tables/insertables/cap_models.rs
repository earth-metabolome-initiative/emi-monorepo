...
impl core::fmt::Display for CapModelExtensionAttribute {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            Self::PhysicalAssetModel(e) => write!(f, "cap_models({e})"),
        }
    }
}
...
impl web_common_traits::database::TableField for CapModelAttribute {}
impl web_common_traits::database::HasTableType for CapModelAttribute {
    ...
    > for CapModelAttribute
{
    fn from_extension(
        ...
        CapModelAttribute::Extension(From::from(attribute))
    }
}
...
///    .insert(user.id, conn)?;
/// ```
pub struct InsertableCapModelBuilder<
    PhysicalAssetModel
...
{
    type Table = crate::codegen::diesel_codegen::tables::cap_models::cap_models::table;
    fn table() -> Self::Table {
        crate::codegen::diesel_codegen::tables::cap_models::cap_models::table
    }
}
...
{
    type Error = web_common_traits::database::InsertError<CapModelAttribute>;
