...
impl Filtrable for crate::database::flat_variants::UsersUsersRoleInvitation {
    type Filter = crate::database::filter_variants::UsersUsersRoleInvitationFilter;
}
#[cfg(feature = "frontend")]
impl AllRecords for UsersUsersRoleInvitation {
...
impl UsersUsersRoleInvitation {
    ...
    async fn insert<C: gluesql::core::store::GStore + gluesql::core::store::GStoreMut>(
        ...
        Ok(table("users_users_role_invitations")
            .insert()
