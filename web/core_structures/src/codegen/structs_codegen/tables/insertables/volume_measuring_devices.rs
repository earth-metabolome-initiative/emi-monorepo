...
impl core::fmt::Display for VolumeMeasuringDeviceExtensionAttribute {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            Self::PhysicalAsset(e) => write!(f, "volume_measuring_devices({e})"),
        }
    }
}
...
impl From<common_traits::builder::EmptyTuple> for VolumeMeasuringDeviceExtensionAttribute {
...
impl<T1> common_traits::builder::Attributed
    ...
    >
{
    type Attribute = VolumeMeasuringDeviceAttribute;
}
impl web_common_traits::database::TableField for VolumeMeasuringDeviceAttribute {}
impl web_common_traits::database::HasTableType for VolumeMeasuringDeviceAttribute {
    type Table = crate::codegen::tables::table_names::TableName;
}
impl
    web_common_traits::database::FromExtension<
        crate::codegen::structs_codegen::tables::insertables::PhysicalAssetAttribute,
    > for VolumeMeasuringDeviceAttribute
{
    fn from_extension(
        attribute: crate::codegen::structs_codegen::tables::insertables::PhysicalAssetAttribute,
    ) -> Self {
        VolumeMeasuringDeviceAttribute::Extension(From::from(attribute))
    }
}
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct InsertableVolumeMeasuringDevice {
    pub(crate) id: ::rosetta_uuid::Uuid,
    pub(crate) model: i32,
}
impl InsertableVolumeMeasuringDevice {
...
///
/// ```rust,ignore
/// use core_structures::VolumeMeasuringDevice;
/// use core_structures::tables::insertables::AssetSettable;
/// use core_structures::tables::insertables::VolumeMeasuringDeviceSettable;
/// use web_common_traits::database::Insertable;
/// use web_common_traits::database::InsertableVariant;
///
/// let volume_measuring_device = VolumeMeasuringDevice::new()
...
///    .insert(user.id, conn)?;
/// ```
pub struct InsertableVolumeMeasuringDeviceBuilder<
    PhysicalAsset
...
{
    type Table = crate::codegen::diesel_codegen::tables::volume_measuring_devices::volume_measuring_devices::table;
    fn table() -> Self::Table {
        crate::codegen::diesel_codegen::tables::volume_measuring_devices::volume_measuring_devices::table
    }
}
...
pub trait VolumeMeasuringDeviceSettable: Sized {
    ...
    ///
    /// # Arguments
    /// * `model`: The value to set for the
    ///   `public.volume_measuring_devices.model` column.
    ///
    /// # Implementation details
...
impl<
    PhysicalAsset: crate::codegen::structs_codegen::tables::insertables::PhysicalAssetSettable<
            ...
            >,
        >,
> VolumeMeasuringDeviceSettable for InsertableVolumeMeasuringDeviceBuilder<PhysicalAsset>
where
    Self: common_traits::builder::Attributed<
        Attribute = crate::codegen::structs_codegen::tables::insertables::VolumeMeasuringDeviceAttribute,
    >,
{
    ...
    ///end
    ///subgraph v5 ["`volume_measuring_devices`"]
    ...
    >,
{
    ...
    where
        M: web_common_traits::database::PrimaryKeyLike<PrimaryKey = i32>,
    {
        <Self as VolumeMeasuringDeviceSettable>::model(self, model)
    }
}
...
where
    Self: web_common_traits::database::DispatchableInsertableVariant<
            ...
            Error = web_common_traits::database::InsertError<
                VolumeMeasuringDeviceAttribute,
            >,
