...
impl From<web_common::database::flat_variants::ProjectsTeamsRoleInvitation>
    for crate::database::flat_variants::ProjectsTeamsRoleInvitation
{
    fn from(item: web_common::database::flat_variants::ProjectsTeamsRoleInvitation) -> Self {
        Self {
...
impl From<crate::database::flat_variants::ProjectsTeamsRoleInvitation>
    for web_common::database::flat_variants::ProjectsTeamsRoleInvitation
{
    fn from(item: crate::database::flat_variants::ProjectsTeamsRoleInvitation) -> Self {
        Self {
            table_id: item.table_id,
            team_id: item.team_id,
            role_id: item.role_id,
...
impl ProjectsTeamsRoleInvitation {
    ...
    pub fn can_view_by_id(
        ...
        diesel::select(
            crate::database::sql_function_bindings::can_view_projects_teams_role_invitations(
                author_user_id,
                table_id,
                team_id,
            ),
    ...
    pub fn strict_word_similarity_search_viewable(
        ...
        let mut query = projects_teams_role_invitations::dsl::projects_teams_role_invitations
            // This operation is defined by a first order index linking projects_teams_role_invitations.table_id to projects.
            .inner_join(
                projects::dsl::projects
                    .on(projects_teams_role_invitations::dsl::table_id.eq(projects::dsl::id)),
            )
            // This operation is defined by a first order index linking projects_teams_role_invitations.team_id to teams.
            .inner_join(
                teams::dsl::teams
                    .on(projects_teams_role_invitations::dsl::team_id.eq(teams::dsl::id)),
            )
            // This operation is defined by a first order index linking projects_teams_role_invitations.role_id to roles.
            .inner_join(
                roles::dsl::roles
    ...
    pub fn strict_word_similarity_search_with_score_viewable(
        ...
        projects_teams_role_invitations::dsl::projects_teams_role_invitations
            ...
            .select((
                ProjectsTeamsRoleInvitation::as_select(),
                crate::database::sql_function_bindings::strict_word_similarity_dist_op(
                    crate::database::sql_function_bindings::concat_projects_name_description(
                        projects::dsl::name,
                        projects::dsl::description,
    ...
    pub fn can_admin_by_id(
        ...
        diesel::select(
            crate::database::sql_function_bindings::can_admin_projects_teams_role_invitations(
                author_user_id,
                table_id,
                team_id,
            ),
    ...
    pub fn delete_by_id(
        ...
        diesel::delete(
            crate::database::projects_teams_role_invitations::dsl::projects_teams_role_invitations
                .filter(
                    crate::database::projects_teams_role_invitations::dsl::table_id.eq(table_id),
                )
                .filter(crate::database::projects_teams_role_invitations::dsl::team_id.eq(team_id)),
        )
        .execute(connection)
        .map_err(web_common::api::ApiError::from)
    }
