//! Submodule for the `pg_catalog.pg_statio_user_tables` view schema.

diesel::table! {
    /// `pg_catalog.pg_statio_user_tables` — view showing I/O statistics for user-defined tables.
    /// Each row represents one user-defined table showing statistics about I/O operations on that table.
