impl From<crate::codegen::structs_codegen::tables::step_tool_models::StepToolModel>
    for super::Rows
{
    fn from(
...
impl
    From<Vec<std::rc::Rc<crate::codegen::structs_codegen::tables::step_tool_models::StepToolModel>>>
    for super::Rows
{
    fn from(
        value: Vec<
            std::rc::Rc<crate::codegen::structs_codegen::tables::step_tool_models::StepToolModel>,
        >,
    ) -> Self {
        Self::from(std::rc::Rc::new(value))
    }
...
impl
    From<std::rc::Rc<Vec<crate::codegen::structs_codegen::tables::step_tool_models::StepToolModel>>>
    for super::Rows
{
    fn from(
        value: std::rc::Rc<
    ...
    > for super::Rows
{
    fn from(
        ...
        super::Rows::StepToolModel(value)
    }
}
impl TryFrom<super::Rows>
    for std::rc::Rc<
        Vec<std::rc::Rc<crate::codegen::structs_codegen::tables::step_tool_models::StepToolModel>>,
    >
{
    type Error = std::convert::Infallible;
    fn try_from(value: super::Rows) -> Result<Self, Self::Error> {
        match value {
            super::Rows::StepToolModel(v) => Ok(v),
