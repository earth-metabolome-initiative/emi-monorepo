...
pub struct ProcessingStepForeignKeys {
...
{
    type ForeignKeys = ProcessingStepForeignKeys;
...
impl web_common_traits::prelude::ForeignKeys for ProcessingStepForeignKeys {}
