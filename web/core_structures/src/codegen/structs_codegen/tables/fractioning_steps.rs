...
impl diesel::Identifiable for FractioningStep {
...
impl FractioningStep {
    ...
    pub async fn from_created_at(
        ...
        use crate::codegen::diesel_codegen::tables::fractioning_steps::fractioning_steps;
        Self::table()
            .filter(fractioning_steps::created_at.eq(created_at))
            .order_by(fractioning_steps::id.asc())
            .load::<Self>(conn)
            .await
    }
}
