...
pub struct Downloader {
    ...
    /// The user agent to use for the download.
...
impl Downloader {
    ...
    #[must_use]
    /// Sets the user agent to use for the download.
    ///
    /// # Arguments
    ///
    /// * `user_agent`: User agent to use for the download.
    ///
    /// # Returns
    ///
    /// * Self, with the user agent set.
    pub fn user_agent<S: ToString + ?Sized>(mut self, user_agent: &S) -> Self {
