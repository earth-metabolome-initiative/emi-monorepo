...
impl core::fmt::Display for CommercialBeadModelExtensionAttribute {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            Self::BeadModel(e) => write!(f, "commercial_bead_models({e})"),
            Self::CommercialProduct(e) => write!(f, "commercial_bead_models({e})"),
        }
    }
}
...
impl From<common_traits::builder::EmptyTuple> for CommercialBeadModelExtensionAttribute {
...
impl core::fmt::Display for CommercialBeadModelAttribute {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            ...
            Self::Id => write!(f, "commercial_bead_models.id"),
            Self::BeadModel => write!(f, "commercial_bead_models.bead_model"),
        }
    }
}
#[derive(Debug)]
...
#[cfg_attr(
    ...
    diesel(
        table_name = crate::codegen::diesel_codegen::tables::commercial_bead_models::commercial_bead_models
    )
)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct InsertableCommercialBeadModel {
    pub(crate) id: i32,
    pub(crate) bead_model: i32,
}
impl InsertableCommercialBeadModel {
...
/// [`CommercialBeadModel`](crate::codegen::structs_codegen::tables::commercial_bead_models::CommercialBeadModel).
///
///
...
impl<BeadModel, CommercialProduct> diesel::associations::HasTable
    for InsertableCommercialBeadModelBuilder<BeadModel, CommercialProduct>
{
    type Table = crate::codegen::diesel_codegen::tables::commercial_bead_models::commercial_bead_models::table;
    fn table() -> Self::Table {
        crate::codegen::diesel_codegen::tables::commercial_bead_models::commercial_bead_models::table
    }
}
...
pub trait CommercialBeadModelSettable: Sized {
    ...
    ///   `public.commercial_bead_models.bead_model` column.
    ///
    /// # Implementation details
...
where
    Self: common_traits::builder::Attributed<
        Attribute = crate::codegen::structs_codegen::tables::insertables::CommercialBeadModelAttribute,
    >,
{
    ...
    >,
{
    ...
    {
        self.commercial_bead_models_id_fkey = <BeadModel as crate::codegen::structs_codegen::tables::insertables::AssetModelSettable>::name(
                self.commercial_bead_models_id_fkey,
                name,
            )
            .map_err(|e| {
    ...
    {
        self.commercial_bead_models_id_fkey = <BeadModel as crate::codegen::structs_codegen::tables::insertables::AssetModelSettable>::description(
                self.commercial_bead_models_id_fkey,
                description,
            )
            .map_err(|e| {
    ...
    where
        ...
        >,
    {
        self.commercial_bead_models_id_fkey = <BeadModel as crate::codegen::structs_codegen::tables::insertables::AssetModelSettable>::created_at(
                self.commercial_bead_models_id_fkey,
                created_at,
            )
            .map_err(|e| {
    ...
    where
        ...
        >,
    {
        self.commercial_bead_models_id_fkey = <BeadModel as crate::codegen::structs_codegen::tables::insertables::AssetModelSettable>::updated_at(
                self.commercial_bead_models_id_fkey,
                updated_at,
            )
            .map_err(|e| {
    ...
    >,
{
    ...
    {
        self.commercial_bead_models_id_fkey = <BeadModel as crate::codegen::structs_codegen::tables::insertables::BeadModelSettable>::diameter_millimeters(
                self.commercial_bead_models_id_fkey,
    ...
    >,
{
    ...
    where
        ...
        >,
    {
        self.commercial_bead_models_id_fkey1 = <CommercialProduct as crate::codegen::structs_codegen::tables::insertables::CommercialProductSettable>::deprecation_date(
...
impl<BeadModel, CommercialProduct> web_common_traits::database::MostConcreteTable
    for InsertableCommercialBeadModelBuilder<BeadModel, CommercialProduct>
where
    ...
    CommercialProduct: web_common_traits::database::MostConcreteTable,
{
    fn set_most_concrete_table(&mut self, table_name: &str) {
        self.commercial_bead_models_id_fkey.set_most_concrete_table(table_name);
        self.commercial_bead_models_id_fkey1.set_most_concrete_table(table_name);
    }
}
impl<BeadModel, CommercialProduct> web_common_traits::prelude::SetPrimaryKey
    for InsertableCommercialBeadModelBuilder<BeadModel, CommercialProduct>
where
    ...
    CommercialProduct: web_common_traits::prelude::SetPrimaryKey<PrimaryKey = i32>,
{
    ...
    fn set_primary_key(mut self, primary_key: Self::PrimaryKey) -> Self {
        self.commercial_bead_models_id_fkey =
            self.commercial_bead_models_id_fkey.set_primary_key(primary_key);
        self.commercial_bead_models_id_fkey1 =
            self.commercial_bead_models_id_fkey1.set_primary_key(primary_key);
        self
    }
}
impl<BeadModel, CommercialProduct, C> web_common_traits::database::TryInsertGeneric<C>
for InsertableCommercialBeadModelBuilder<BeadModel, CommercialProduct>
where
