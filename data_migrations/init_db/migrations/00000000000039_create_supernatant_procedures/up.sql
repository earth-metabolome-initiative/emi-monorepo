CREATE TABLE IF NOT EXISTS procedure_templates.supernatant_procedure_templates (
	...
	-- `supernatant_procedure_templates.procedure_template` is associated with a given
...
CREATE TABLE IF NOT EXISTS procedures.supernatant_procedures (
	...
	procedure_template INTEGER NOT NULL REFERENCES procedure_templates.supernatant_procedure_templates(procedure_template),
	...
	FOREIGN KEY (procedure_template, foreign_procedure_template) REFERENCES procedure_templates.supernatant_procedure_templates(procedure_template, foreign_procedure_template)
);