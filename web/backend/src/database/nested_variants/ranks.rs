...
impl NestedRank {
    ...
    pub fn get(
        ...
        Rank::get(id, connection).and_then(|flat_variant| Self::from_flat(flat_variant, connection))
    }
    ...
    pub fn strict_word_similarity_search_viewable(
        ...
        Rank::strict_word_similarity_search_viewable(filter, query, limit, offset, connection)?
            .into_iter()
            .map(|flat_variant| Self::from_flat(flat_variant, connection))
            .collect()
    }
    ...
    pub fn strict_word_similarity_search_with_score_viewable(
        ...
        Rank::strict_word_similarity_search_with_score_viewable(query, limit, offset, connection)?
            .into_iter()
    ...
    for web_common::database::nested_variants::NestedRank
{
    fn from(item: crate::database::nested_variants::NestedRank) -> Self {
        Self {
            inner: Rc::from(web_common::database::flat_variants::Rank::from(item.inner)),
