...
pub struct MixingProcedureModel {
    pub procedure_model_id: i32,
    pub measured_with: ::rosetta_uuid::Uuid,
    pub procedure_measured_with: i32,
    pub source: i32,
    pub mixed_with: ::rosetta_uuid::Uuid,
    pub procedure_mixed_into: i32,
    pub kilograms: f32,
}
impl web_common_traits::prelude::TableName for MixingProcedureModel {
    const TABLE_NAME: &'static str = "mixing_procedure_models";
}
impl
    web_common_traits::prelude::ExtensionTable<
        crate::codegen::structs_codegen::tables::procedure_models::ProcedureModel,
    > for MixingProcedureModel
where
    for<'a> &'a Self: diesel::Identifiable<Id = &'a i32>,
{
}
impl diesel::Identifiable for MixingProcedureModel {
    type Id = i32;
    fn id(self) -> Self::Id {
        self.procedure_model_id
    }
}
impl MixingProcedureModel {
    ...
    pub fn from_measured_with(
        ...
        Self::table()
            .filter(mixing_procedure_models::measured_with.eq(measured_with))
            .order_by(mixing_procedure_models::procedure_model_id.asc())
            .load::<Self>(conn)
    }
    #[cfg(feature = "postgres")]
    pub fn from_procedure_measured_with(
        procedure_measured_with: &i32,
        conn: &mut diesel::PgConnection,
    ) -> Result<Vec<Self>, diesel::result::Error> {
        use diesel::{ExpressionMethods, QueryDsl, RunQueryDsl, associations::HasTable};
        ...
        use crate::codegen::diesel_codegen::tables::mixing_procedure_models::mixing_procedure_models;
        Self::table()
            .filter(mixing_procedure_models::procedure_measured_with.eq(procedure_measured_with))
            .order_by(mixing_procedure_models::procedure_model_id.asc())
            .load::<Self>(conn)
    }
    #[cfg(feature = "postgres")]
    pub fn from_source(
        ...
        use crate::codegen::diesel_codegen::tables::mixing_procedure_models::mixing_procedure_models;
        Self::table()
            .filter(mixing_procedure_models::source.eq(source))
            .order_by(mixing_procedure_models::procedure_model_id.asc())
            .load::<Self>(conn)
    }
    #[cfg(feature = "postgres")]
    pub fn from_mixed_with(
        ...
        use crate::codegen::diesel_codegen::tables::mixing_procedure_models::mixing_procedure_models;
        Self::table()
            .filter(mixing_procedure_models::mixed_with.eq(mixed_with))
            .order_by(mixing_procedure_models::procedure_model_id.asc())
            .load::<Self>(conn)
    }
    #[cfg(feature = "postgres")]
    pub fn from_procedure_mixed_into(
        procedure_mixed_into: &i32,
        conn: &mut diesel::PgConnection,
    ) -> Result<Vec<Self>, diesel::result::Error> {
        use diesel::{ExpressionMethods, QueryDsl, RunQueryDsl, associations::HasTable};
        ...
        use crate::codegen::diesel_codegen::tables::mixing_procedure_models::mixing_procedure_models;
        Self::table()
            .filter(mixing_procedure_models::procedure_mixed_into.eq(procedure_mixed_into))
            .order_by(mixing_procedure_models::procedure_model_id.asc())
            .load::<Self>(conn)
    }
    #[cfg(feature = "postgres")]
    pub fn from_procedure_measured_with_and_procedure_model_id(
        procedure_measured_with: &i32,
        ...
        Self::table()
            .filter(
                mixing_procedure_models::procedure_measured_with
                    .eq(procedure_measured_with)
                    .and(mixing_procedure_models::procedure_model_id.eq(procedure_model_id)),
            )
            .order_by(mixing_procedure_models::procedure_model_id.asc())
            .load::<Self>(conn)
    }
    ...
    pub fn from_procedure_measured_with_and_measured_with(
        ...
        Self::table()
            .filter(
                mixing_procedure_models::procedure_measured_with
                    .eq(procedure_measured_with)
                    .and(mixing_procedure_models::measured_with.eq(measured_with)),
            )
            .order_by(mixing_procedure_models::procedure_model_id.asc())
            .load::<Self>(conn)
    }
    ...
    pub fn from_source_and_procedure_model_id(
        ...
        Self::table()
            .filter(
                mixing_procedure_models::source
                    .eq(source)
                    .and(mixing_procedure_models::procedure_model_id.eq(procedure_model_id)),
            )
            .order_by(mixing_procedure_models::procedure_model_id.asc())
    ...
    #[cfg(feature = "postgres")]
    pub fn from_procedure_mixed_into_and_procedure_model_id(
        procedure_mixed_into: &i32,
        procedure_model_id: &i32,
        conn: &mut diesel::PgConnection,
    ) -> Result<Vec<Self>, diesel::result::Error> {
        ...
        Self::table()
            .filter(
                mixing_procedure_models::procedure_mixed_into
                    .eq(procedure_mixed_into)
                    .and(mixing_procedure_models::procedure_model_id.eq(procedure_model_id)),
            )
            .order_by(mixing_procedure_models::procedure_model_id.asc())
            .load::<Self>(conn)
    ...
    #[cfg(feature = "postgres")]
    pub fn from_procedure_mixed_into_and_mixed_with(
        procedure_mixed_into: &i32,
        mixed_with: &::rosetta_uuid::Uuid,
        conn: &mut diesel::PgConnection,
    ) -> Result<Vec<Self>, diesel::result::Error> {
        ...
        Self::table()
            .filter(
                mixing_procedure_models::procedure_mixed_into
                    .eq(procedure_mixed_into)
                    .and(mixing_procedure_models::mixed_with.eq(mixed_with)),
            )
            .order_by(mixing_procedure_models::procedure_model_id.asc())
            .load::<Self>(conn)
    }
    ...
    pub fn from_name(
        ...
        use crate::codegen::diesel_codegen::tables::{
            mixing_procedure_models::mixing_procedure_models, procedure_models::procedure_models,
        };
        Self::table()
            .inner_join(
                procedure_models::table
                    .on(mixing_procedure_models::procedure_model_id.eq(procedure_models::id)),
            )
...
impl AsRef<MixingProcedureModel> for MixingProcedureModel {
    fn as_ref(&self) -> &MixingProcedureModel {
        self
    }
}
