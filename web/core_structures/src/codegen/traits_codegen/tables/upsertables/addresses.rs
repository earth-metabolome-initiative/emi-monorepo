...
impl web_common_traits::prelude::Upsertable<diesel::PgConnection> for crate::Address {
    fn upsert(
        &self,
...
#[cfg(feature = "sqlite")]
impl web_common_traits::prelude::Upsertable<diesel::SqliteConnection> for crate::Address {
    fn upsert(
        &self,
