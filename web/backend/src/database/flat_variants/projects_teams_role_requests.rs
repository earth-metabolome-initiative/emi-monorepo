...
impl From<web_common::database::flat_variants::ProjectsTeamsRoleRequest>
    for crate::database::flat_variants::ProjectsTeamsRoleRequest
{
    fn from(item: web_common::database::flat_variants::ProjectsTeamsRoleRequest) -> Self {
        Self {
...
impl From<crate::database::flat_variants::ProjectsTeamsRoleRequest>
    for web_common::database::flat_variants::ProjectsTeamsRoleRequest
{
    fn from(item: crate::database::flat_variants::ProjectsTeamsRoleRequest) -> Self {
        Self {
            table_id: item.table_id,
            team_id: item.team_id,
            role_id: item.role_id,
...
impl ProjectsTeamsRoleRequest {
    ...
    pub fn can_view_by_id(
        ...
        diesel::select(
            crate::database::sql_function_bindings::can_view_projects_teams_role_requests(
                author_user_id,
                table_id,
                team_id,
            ),
    ...
    /// * `connection` - The connection to the database.
    pub fn all_viewable(
        filter: Option<&web_common::database::filter_variants::ProjectsTeamsRoleRequestFilter>,
        author_user_id: Option<i32>,
        limit: Option<i64>,
        offset: Option<i64>,
        connection: &mut diesel::r2d2::PooledConnection<
        ...
        let query = projects_teams_role_requests::dsl::projects_teams_role_requests
            .select(ProjectsTeamsRoleRequest::as_select())
            .filter(
                crate::database::sql_function_bindings::can_view_projects_teams_role_requests(
                    author_user_id,
                    projects_teams_role_requests::dsl::table_id,
                    projects_teams_role_requests::dsl::team_id,
                ),
            )
            .order_by(projects_teams_role_requests::dsl::table_id);
    ...
    pub fn strict_word_similarity_search_viewable(
        ...
        let mut query = projects_teams_role_requests::dsl::projects_teams_role_requests
            // This operation is defined by a first order index linking projects_teams_role_requests.table_id to projects.
            .inner_join(
                projects::dsl::projects
                    .on(projects_teams_role_requests::dsl::table_id.eq(projects::dsl::id)),
            )
            // This operation is defined by a first order index linking projects_teams_role_requests.team_id to teams.
            .inner_join(
                teams::dsl::teams.on(projects_teams_role_requests::dsl::team_id.eq(teams::dsl::id)),
            )
            // This operation is defined by a first order index linking projects_teams_role_requests.role_id to roles.
            .inner_join(
                roles::dsl::roles.on(projects_teams_role_requests::dsl::role_id.eq(roles::dsl::id)),
            )
            .select(ProjectsTeamsRoleRequest::as_select())
            .filter(
                crate::database::sql_function_bindings::can_view_projects_teams_role_requests(
    ...
    pub fn strict_word_similarity_search_with_score_viewable(
        ...
        projects_teams_role_requests::dsl::projects_teams_role_requests
            ...
            .select((
                ProjectsTeamsRoleRequest::as_select(),
                crate::database::sql_function_bindings::strict_word_similarity_dist_op(
                    crate::database::sql_function_bindings::concat_projects_name_description(
                        projects::dsl::name,
                        projects::dsl::description,
    ...
    pub fn can_update_by_id(
        ...
        diesel::select(
            crate::database::sql_function_bindings::can_update_projects_teams_role_requests(
                author_user_id,
                table_id,
                team_id,
            ),
    ...
    pub fn can_admin_by_id(
        ...
        diesel::select(
            crate::database::sql_function_bindings::can_admin_projects_teams_role_requests(
                author_user_id,
                table_id,
                team_id,
            ),
    ...
    pub fn delete_by_id(
        ...
        diesel::delete(
            crate::database::projects_teams_role_requests::dsl::projects_teams_role_requests
                .filter(crate::database::projects_teams_role_requests::dsl::table_id.eq(table_id))
                .filter(crate::database::projects_teams_role_requests::dsl::team_id.eq(team_id)),
        )
        .execute(connection)
        .map_err(web_common::api::ApiError::from)
    }
