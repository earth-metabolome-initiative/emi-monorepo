...
impl<CommercialProductLot, FreezerModel, C> web_common_traits::database::TryInsertGeneric<C>
    for InsertableCommercialFreezerLotBuilder<CommercialProductLot, FreezerModel>
where
    Self: web_common_traits::database::InsertableVariant<
            C,
            UserId = i32,
            Row = crate::CommercialFreezerLot,
    ...
    FreezerModel: web_common_traits::database::TryInsertGeneric<C, PrimaryKey = i32>,
{
    ...
    fn mint_primary_key(
        ...
        let insertable: crate::CommercialFreezerLot = self.insert(user_id, conn)?;
        Ok(insertable.id())
    }
}
