...
impl Project {
    ...
    pub fn can_view_by_id(
        ...
        diesel::select(crate::database::sql_function_bindings::can_view_projects(
            author_user_id,
            id,
        ))
    ...
    pub fn all_viewable(
        ...
        let query = projects::dsl::projects
            ...
            .filter(crate::database::sql_function_bindings::can_view_projects(
                author_user_id,
                projects::dsl::id,
            ))
    ...
    pub fn can_update_by_id(
        ...
        diesel::select(crate::database::sql_function_bindings::can_update_projects(
            author_user_id,
            id,
        ))
        .get_result(connection)
    ...
    pub fn all_updatable(
        ...
        let query = projects::dsl::projects
            .select(Project::as_select())
            .filter(crate::database::sql_function_bindings::can_update_projects(
                author_user_id,
                projects::dsl::id,
            ))
            .order_by(projects::dsl::id);
    ...
    pub fn can_admin_by_id(
        ...
        diesel::select(crate::database::sql_function_bindings::can_admin_projects(
            author_user_id,
            id,
        ))
        .get_result(connection)
    ...
    pub fn all_administrable(
        ...
        let query = projects::dsl::projects
            .select(Project::as_select())
            .filter(crate::database::sql_function_bindings::can_admin_projects(
                author_user_id,
                projects::dsl::id,
            ))
            .order_by(projects::dsl::id);
    ...
    pub fn delete_by_id(
        ...
        diesel::delete(
            crate::database::projects::dsl::projects
                .filter(crate::database::projects::dsl::id.eq(id)),
        )
        .execute(connection)
        .map_err(web_common::api::ApiError::from)
    }
