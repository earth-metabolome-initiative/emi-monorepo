...
impl crate::database::Tabular for NestedTeamsUsersRoleInvitation {
    const TABLE: crate::database::Table = crate::database::Table::TeamsUsersRoleInvitations;
}
impl crate::database::Filtrable for NestedTeamsUsersRoleInvitation {
    type Filter = crate::database::filter_variants::TeamsUsersRoleInvitationFilter;
}
impl crate::database::Describable for NestedTeamsUsersRoleInvitation {
    fn description(&self) -> Option<&str> {
        self.inner.description()
    }
}
impl crate::database::Colorable for NestedTeamsUsersRoleInvitation {
    fn color(&self) -> Option<&str> {
        None
    }
}
#[cfg(feature = "frontend")]
impl crate::database::AllRecords for NestedTeamsUsersRoleInvitation {
...
impl NestedTeamsUsersRoleInvitation {
    ...
    pub(crate) async fn from_flat(
        flat_variant: crate::database::flat_variants::TeamsUsersRoleInvitation,
    ...
    pub async fn get<C: gluesql::core::store::GStore + gluesql::core::store::GStoreMut>(
        ...
        if let Some(flat_variant) = crate::database::flat_variants::TeamsUsersRoleInvitation::get(
            (table_id, user_id),
            connection,
        )
        .await?
    ...
    >(
        ...
        crate::database::flat_variants::TeamsUsersRoleInvitation::delete_from_id(
            (table_id, user_id),
            connection,
        )
        .await
    ...
    pub async fn all<C: gluesql::core::store::GStore + gluesql::core::store::GStoreMut>(
        ...
        let mut teams_users_role_invitations = Vec::new();
        for flat_variant in crate::database::flat_variants::TeamsUsersRoleInvitation::all(
            filter, limit, offset, connection,
        )
        .await?
        .into_iter()
        {
            teams_users_role_invitations.push(Self::from_flat(flat_variant, connection).await?);
        }
        Ok(teams_users_role_invitations)
    }
    ...
    >(
        ...
        .await?;
        crate::database::flat_variants::TeamsUsersRoleInvitation::update_or_insert(
            &self.inner,
            connection,
        )
        .await
