...
impl diesel::Identifiable for BallMillStep {
...
impl BallMillStep {
    ...
    pub async fn from_id(
        ...
        Self::table()
            .filter(
                crate::codegen::diesel_codegen::tables::ball_mill_steps::ball_mill_steps::dsl::id
                    .eq(id.id),
            )
            .first::<Self>(conn)
            .await
    ...
    pub async fn from_processable_id(
        ...
        Self::table()
            .filter(
                crate::codegen::diesel_codegen::tables::ball_mill_steps::ball_mill_steps::dsl::processable_id
    ...
    pub async fn from_instrument_id(
        ...
        Self::table()
            .filter(
                crate::codegen::diesel_codegen::tables::ball_mill_steps::ball_mill_steps::dsl::instrument_id
                    .eq(instrument_id.id),
            )
            .load::<Self>(conn)
            .await
    ...
    pub async fn from_created_by(
        ...
        Self::table()
            .filter(
                crate::codegen::diesel_codegen::tables::ball_mill_steps::ball_mill_steps::dsl::created_by
                    .eq(created_by.id),
            )
            .load::<Self>(conn)
            .await
