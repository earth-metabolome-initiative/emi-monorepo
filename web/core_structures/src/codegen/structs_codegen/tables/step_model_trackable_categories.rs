...
pub struct StepModelTrackableCategory {
    pub id: i32,
...
impl diesel::Identifiable for StepModelTrackableCategory {
    type Id = i32;
    fn id(self) -> Self::Id {
        self.id
    }
}
impl StepModelTrackableCategory {
    ...
    pub async fn from_id(
        ...
        Self::table()
            .filter(
                crate::codegen::diesel_codegen::tables::step_model_trackable_categories::step_model_trackable_categories::dsl::id
                    .eq(id.id),
            )
            .first::<Self>(conn)
            .await
    ...
    pub async fn from_trackable_category_id(
        ...
        Self::table()
            .filter(
                crate::codegen::diesel_codegen::tables::step_model_trackable_categories::step_model_trackable_categories::dsl::trackable_category_id
    ...
    pub async fn from_created_by(
        ...
        Self::table()
            .filter(
                crate::codegen::diesel_codegen::tables::step_model_trackable_categories::step_model_trackable_categories::dsl::created_by
                    .eq(created_by.id),
            )
            .load::<Self>(conn)
            .await
    ...
    pub async fn from_updated_by(
        ...
        Self::table()
            .filter(
                crate::codegen::diesel_codegen::tables::step_model_trackable_categories::step_model_trackable_categories::dsl::updated_by
                    .eq(updated_by.id),
            )
            .load::<Self>(conn)
            .await
    ...
    pub async fn from_created_at(
        ...
        Self::table()
            .filter(step_model_trackable_categories::created_at.eq(created_at))
            .order_by(step_model_trackable_categories::id.asc())
            .load::<Self>(conn)
            .await
    }
    #[cfg(feature = "postgres")]
    pub async fn from_updated_at(
        ...
        use crate::codegen::diesel_codegen::tables::step_model_trackable_categories::step_model_trackable_categories;
        Self::table()
            .filter(step_model_trackable_categories::updated_at.eq(updated_at))
            .order_by(step_model_trackable_categories::id.asc())
            .load::<Self>(conn)
            .await
    }
