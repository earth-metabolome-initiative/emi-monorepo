...
pub struct CommercialBeadModel {
    pub id: i32,
    pub bead_model: i32,
}
impl web_common_traits::prelude::TableName for CommercialBeadModel {
    const TABLE_NAME: &'static str = "commercial_bead_models";
}
impl<'a> From<&'a CommercialBeadModel>
    for web_common_traits::database::IdOrBuilder<
        i32,
        crate::codegen::structs_codegen::tables::insertables::InsertableCommercialBeadModelBuilder,
    >
{
    fn from(value: &'a CommercialBeadModel) -> Self {
...
impl CommercialBeadModel {
    ...
    where
        ...
        >>::Output: diesel::query_dsl::methods::OrderDsl<
            diesel::helper_types::Asc<
                crate::codegen::diesel_codegen::tables::commercial_bead_models::commercial_bead_models::id,
            >,
        >,
        <<<Self as diesel::associations::HasTable>::Table as diesel::query_dsl::methods::FilterDsl<
            <crate::codegen::diesel_codegen::tables::commercial_bead_models::commercial_bead_models::bead_model as diesel::expression_methods::EqAll<
    ...
    where
        C: diesel::connection::LoadConnection,
        <Self as diesel::associations::HasTable>::Table: diesel::query_dsl::methods::FilterDsl<
            <crate::codegen::diesel_codegen::tables::commercial_bead_models::commercial_bead_models::id as diesel::expression_methods::EqAll<
                i32,
            >>::Output,
        >,
        <<Self as diesel::associations::HasTable>::Table as diesel::query_dsl::methods::FilterDsl<
    ...
    pub fn from_deprecation_date(
        ...
        use crate::codegen::diesel_codegen::tables::{
            commercial_bead_models::commercial_bead_models,
            commercial_products::commercial_products,
        };
        Self::table()
            .inner_join(
                commercial_products::table
                    .on(commercial_bead_models::id.eq(commercial_products::id)),
            )
        ...
        Self::table()
            .inner_join(
                physical_asset_models::table
                    .on(commercial_bead_models::id.eq(physical_asset_models::id)),
            )
    ...
    pub fn from_name(
        ...
        use crate::codegen::diesel_codegen::tables::{
            asset_models::asset_models, commercial_bead_models::commercial_bead_models,
        };
        Self::table()
            .inner_join(asset_models::table.on(commercial_bead_models::id.eq(asset_models::id)))
...
impl AsRef<CommercialBeadModel> for CommercialBeadModel {
    fn as_ref(&self) -> &CommercialBeadModel {
        self
    }
}
