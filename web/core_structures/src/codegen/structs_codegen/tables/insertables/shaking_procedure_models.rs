...
pub enum InsertableShakingProcedureModelAttributes {
...
impl core::fmt::Display for InsertableShakingProcedureModelAttributes {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            InsertableShakingProcedureModelAttributes::Id(id) => write!(f, "{}", id),
            InsertableShakingProcedureModelAttributes::Seconds => write!(f, "seconds"),
        }
    }
}
...
#[cfg_attr(
    ...
    diesel(
        table_name = crate::codegen::diesel_codegen::tables::shaking_procedure_models::shaking_procedure_models
    )
)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct InsertableShakingProcedureModel {
    id: i32,
    seconds: f32,
}
impl InsertableShakingProcedureModel {
...
impl InsertableShakingProcedureModelBuilder {
    pub fn seconds<P>(
        ...
        Self,
        web_common_traits::database::InsertError<InsertableShakingProcedureModelAttributes>,
    >
    where
        P: TryInto<f32>,
        <P as TryInto<f32>>::Error: Into<validation_errors::SingleFieldError>,
    {
        let seconds = seconds.try_into().map_err(|err: <P as TryInto<f32>>::Error| {
            Into::into(err).rename_field(InsertableShakingProcedureModelAttributes::Seconds)
        })?;
        pgrx_validation::must_be_strictly_positive_f32(seconds)
            .map_err(|e| e.rename_field(InsertableShakingProcedureModelAttributes::Seconds))?;
...
impl InsertableShakingProcedureModelBuilder {
    pub(crate) fn try_insert<C>(
        ...
        InsertableShakingProcedureModel,
        web_common_traits::database::InsertError<
            InsertableShakingProcedureModelAttributes,
        >,
    >
    where
