...
impl NestedTeamsUsersRoleRequest {
    ...
    pub fn all_viewable(
        ...
        TeamsUsersRoleRequest::all_viewable(filter, author_user_id, limit, offset, connection)?
            .into_iter()
    ...
    pub fn all_viewable_sorted(
        ...
        TeamsUsersRoleRequest::all_viewable_sorted(
            filter,
            author_user_id,
            limit,
            offset,
    ...
    pub fn get(
        ...
        TeamsUsersRoleRequest::get((table_id, user_id), author_user_id, connection)
    ...
    pub fn strict_word_similarity_search_viewable(
        ...
        TeamsUsersRoleRequest::strict_word_similarity_search_viewable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn strict_word_similarity_search_with_score_viewable(
        ...
        TeamsUsersRoleRequest::strict_word_similarity_search_with_score_viewable(
            author_user_id,
            query,
            limit,
            offset,
    ...
    pub fn can_update_by_id() -> Result<bool, web_common::api::ApiError> {
        TeamsUsersRoleRequest::can_update_by_id()
    }
    ...
    pub fn all_updatable(
        ...
        TeamsUsersRoleRequest::all_updatable(filter, author_user_id, limit, offset, connection)?
            .into_iter()
            .map(|flat_variant| Self::from_flat(flat_variant, connection))
            .collect()
    }
    ...
    pub fn all_updatable_sorted(
        ...
        TeamsUsersRoleRequest::all_updatable_sorted(
            filter,
            author_user_id,
            limit,
            offset,
    ...
    pub fn strict_word_similarity_search_updatable(
        ...
        TeamsUsersRoleRequest::strict_word_similarity_search_updatable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn all_administrable(
        ...
        TeamsUsersRoleRequest::all_administrable(filter, author_user_id, limit, offset, connection)?
            .into_iter()
            .map(|flat_variant| Self::from_flat(flat_variant, connection))
            .collect()
    }
    ...
    pub fn all_administrable_sorted(
        ...
        TeamsUsersRoleRequest::all_administrable_sorted(
            filter,
            author_user_id,
            limit,
            offset,
    ...
    pub fn strict_word_similarity_search_administrable(
        ...
        TeamsUsersRoleRequest::strict_word_similarity_search_administrable(
            filter,
            author_user_id,
            query,
            limit,
...
impl From<web_common::database::nested_variants::NestedTeamsUsersRoleRequest>
    for crate::database::nested_variants::NestedTeamsUsersRoleRequest
{
    fn from(item: web_common::database::nested_variants::NestedTeamsUsersRoleRequest) -> Self {
        Self {
            inner: crate::database::flat_variants::TeamsUsersRoleRequest::from(item.inner),
...
impl From<crate::database::nested_variants::NestedTeamsUsersRoleRequest>
    for web_common::database::nested_variants::NestedTeamsUsersRoleRequest
{
    fn from(item: crate::database::nested_variants::NestedTeamsUsersRoleRequest) -> Self {
        Self {
            inner: web_common::database::flat_variants::TeamsUsersRoleRequest::from(item.inner),
