impl super::Rows {
    pub fn len(&self) -> usize {
        match self {
            ...
            super::Rows::BallMillContainerModel(rows) => rows.len(),
            ...
            super::Rows::CappingRule(rows) => rows.len(),
            super::Rows::CentrifugableContainerModel(rows) => rows.len(),
            ...
            super::Rows::StorageRule(rows) => rows.len(),
