...
pub trait CommercialBeadsModelBuildable:
...
impl CommercialBeadsModelBuildable for Option<i32> {}
impl<
...
for InsertableCommercialBeadsModelBuilder<BeadsModel, CommercialProduct> {
    ...
    {
        self.commercial_beads_models_id_fkey = <BeadsModel as crate::codegen::structs_codegen::tables::insertables::AssetModelBuildable>::most_concrete_table(
