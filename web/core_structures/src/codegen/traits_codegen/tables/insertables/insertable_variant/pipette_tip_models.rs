...
where
    ...
    crate::codegen::structs_codegen::tables::insertables::PipetteTipModelExtensionAttribute: From<
        ...
        let id = self
            ...
            .map_err(|err| {
                err.into_field_name(|attribute| {
                    crate::codegen::structs_codegen::tables::insertables::PipetteTipModelAttribute::Extension(
                        From::from(attribute),
                    )
                })
            })?;
