...
pub struct WeighingInstrumentModelForeignKeys {
    pub id: Option<
...
{
    type ForeignKeys = WeighingInstrumentModelForeignKeys;
    ...
    fn update(
        ...
        match (row, crud) {
            ...
            (
                ...
                if instrument_models.id == self.id {
...
impl web_common_traits::prelude::ForeignKeys for WeighingInstrumentModelForeignKeys {}
