...
impl web_common_traits::database::TableField for DigitalAssetAttribute {}
impl web_common_traits::database::HasTableType for DigitalAssetAttribute {
    ...
    > for DigitalAssetAttribute
{
    fn from_extension(
        ...
        DigitalAssetAttribute::Extension(From::from(attribute))
    }
}
...
{
    type Error = web_common_traits::database::InsertError<DigitalAssetAttribute>;
