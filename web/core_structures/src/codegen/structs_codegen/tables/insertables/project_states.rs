...
impl web_common_traits::database::TableField for ProjectStateAttribute {}
impl web_common_traits::database::HasTableType for ProjectStateAttribute {
...
///
/// ```rust,ignore
/// use core_structures::ProjectState;
/// use core_structures::tables::insertables::ProjectStateSettable;
...
impl diesel::associations::HasTable for InsertableProjectStateBuilder {
    type Table = crate::codegen::diesel_codegen::tables::project_states::project_states::table;
    fn table() -> Self::Table {
...
where
    Self: common_traits::builder::Attributed<
            Attribute = crate::codegen::structs_codegen::tables::insertables::ProjectStateAttribute,
        >,
{
        ...
        validation_errors::prelude::SingleFieldError: From<<N as TryInto<String>>::Error>,
    {
        let name = name.try_into().map_err(|err| {
            validation_errors::prelude::SingleFieldError::from(err)
                .rename_field(ProjectStateAttribute::Name)
        })?;
        self.name = Some(name);
        Ok(self)
    }
        ...
        validation_errors::prelude::SingleFieldError: From<<I as TryInto<String>>::Error>,
    {
        let icon = icon.try_into().map_err(|err| {
            validation_errors::prelude::SingleFieldError::from(err)
                .rename_field(ProjectStateAttribute::Icon)
        })?;
        self.icon = Some(icon);
        Ok(self)
    }
...
{
    type Error = web_common_traits::database::InsertError<ProjectStateAttribute>;
