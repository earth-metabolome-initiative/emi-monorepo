...
pub enum CommercialPackagingLotExtensionAttribute {
...
impl core::fmt::Display for CommercialPackagingLotExtensionAttribute {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            Self::CommercialProductLot(e) => write!(f, "commercial_packaging_lots({e})"),
            Self::PackagingModel(e) => write!(f, "commercial_packaging_lots({e})"),
        }
    }
}
impl From<crate::codegen::structs_codegen::tables::insertables::CommercialProductLotAttribute>
    for CommercialPackagingLotExtensionAttribute
{
    fn from(
...
pub enum CommercialPackagingLotAttribute {
    Extension(CommercialPackagingLotExtensionAttribute),
    Id,
    ProductModel,
}
impl core::str::FromStr for CommercialPackagingLotAttribute {
...
impl web_common_traits::database::TableField for CommercialPackagingLotAttribute {}
impl web_common_traits::database::HasTableType for CommercialPackagingLotAttribute {
    ...
    > for CommercialPackagingLotAttribute
{
    fn from_extension(
        ...
        CommercialPackagingLotAttribute::Extension(From::from(attribute))
    }
}
impl
    web_common_traits::database::FromExtension<
...
impl core::fmt::Display for CommercialPackagingLotAttribute {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            ...
            Self::Id => write!(f, "commercial_packaging_lots.id"),
            Self::ProductModel => write!(f, "commercial_packaging_lots.product_model"),
        }
    }
}
#[derive(Debug)]
...
/// [`CommercialPackagingLot`](crate::codegen::structs_codegen::tables::commercial_packaging_lots::CommercialPackagingLot).
///
///
...
///
/// ```rust,ignore
/// use core_structures::CommercialPackagingLot;
/// use core_structures::tables::insertables::AssetModelSettable;
/// use core_structures::tables::insertables::CommercialPackagingLotSettable;
/// use core_structures::tables::insertables::CommercialProductLotSettable;
/// use web_common_traits::database::Insertable;
/// use web_common_traits::database::InsertableVariant;
///
/// let commercial_packaging_lot = CommercialPackagingLot::new()
...
impl<CommercialProductLot, PackagingModel> diesel::associations::HasTable
    for InsertableCommercialPackagingLotBuilder<CommercialProductLot, PackagingModel>
{
    type Table = crate::codegen::diesel_codegen::tables::commercial_packaging_lots::commercial_packaging_lots::table;
    fn table() -> Self::Table {
        crate::codegen::diesel_codegen::tables::commercial_packaging_lots::commercial_packaging_lots::table
    }
}
impl From<InsertableCommercialPackagingLotBuilder>
    for web_common_traits::database::IdOrBuilder<i32, InsertableCommercialPackagingLotBuilder>
{
    fn from(builder: InsertableCommercialPackagingLotBuilder) -> Self {
        Self::Builder(builder)
    }
}
impl<CommercialProductLot, PackagingModel> common_traits::builder::IsCompleteBuilder
for crate::codegen::structs_codegen::tables::insertables::InsertableCommercialPackagingLotBuilder<
    CommercialProductLot,
    PackagingModel,
>
...
pub trait CommercialPackagingLotSettable: Sized {
    /// Error type returned when setting attributes.
    type Error;
    /// Sets the value of the `public.commercial_packaging_lots.product_model`
    /// column.
    ///
    /// # Arguments
    /// * `product_model`: The value to set for the
    ///   `public.commercial_packaging_lots.product_model` column.
    ///
    /// # Implementation details
...
impl<
    CommercialProductLot: crate::codegen::structs_codegen::tables::insertables::CommercialProductLotSettable<
        ...
        >,
    PackagingModel,
> CommercialPackagingLotSettable
for InsertableCommercialPackagingLotBuilder<CommercialProductLot, PackagingModel>
where
    Self: common_traits::builder::Attributed<
        Attribute = crate::codegen::structs_codegen::tables::insertables::CommercialPackagingLotAttribute,
    >,
{
    type Error = web_common_traits::database::InsertError<
        <Self as common_traits::builder::Attributed>::Attribute,
    >;
    ///Sets the value of the `public.commercial_packaging_lots.product_model` column.
    ///
    ...
    ///end
    ///subgraph v5 ["`commercial_packaging_lots`"]
        ...
        PM: web_common_traits::database::PrimaryKeyLike<PrimaryKey = i32>,
    {
        ...
        self.commercial_packaging_lots_id_fkey = <CommercialProductLot as crate::codegen::structs_codegen::tables::insertables::CommercialProductLotSettable>::product_model(
        ...
        self.commercial_packaging_lots_id_fkey = <CommercialProductLot as crate::codegen::structs_codegen::tables::insertables::PhysicalAssetModelSettable>::parent_model(
                self.commercial_packaging_lots_id_fkey,
                product_model,
            )
            .map_err(|err| {
    ...
    >,
{
    ...
    {
        self.commercial_packaging_lots_id_fkey = <CommercialProductLot as crate::codegen::structs_codegen::tables::insertables::AssetModelSettable>::name(
                self.commercial_packaging_lots_id_fkey,
                name,
            )
            .map_err(|e| {
    ...
    {
        self.commercial_packaging_lots_id_fkey = <CommercialProductLot as crate::codegen::structs_codegen::tables::insertables::AssetModelSettable>::description(
                self.commercial_packaging_lots_id_fkey,
                description,
            )
            .map_err(|e| {
    ...
    {
        self.commercial_packaging_lots_id_fkey = <CommercialProductLot as crate::codegen::structs_codegen::tables::insertables::AssetModelSettable>::created_by(
                self.commercial_packaging_lots_id_fkey,
                created_by,
            )
            .map_err(|e| {
    ...
    where
        ...
        >,
    {
        self.commercial_packaging_lots_id_fkey = <CommercialProductLot as crate::codegen::structs_codegen::tables::insertables::AssetModelSettable>::created_at(
                self.commercial_packaging_lots_id_fkey,
                created_at,
            )
            .map_err(|e| {
    ...
    {
        self.commercial_packaging_lots_id_fkey = <CommercialProductLot as crate::codegen::structs_codegen::tables::insertables::AssetModelSettable>::updated_by(
                self.commercial_packaging_lots_id_fkey,
                updated_by,
            )
            .map_err(|e| {
    ...
    where
        ...
        >,
    {
        self.commercial_packaging_lots_id_fkey = <CommercialProductLot as crate::codegen::structs_codegen::tables::insertables::AssetModelSettable>::updated_at(
                self.commercial_packaging_lots_id_fkey,
                updated_at,
            )
            .map_err(|e| {
...
where
    Self: common_traits::builder::Attributed<
        Attribute = crate::codegen::structs_codegen::tables::insertables::CommercialPackagingLotAttribute,
    >,
    Self: crate::codegen::structs_codegen::tables::insertables::CommercialPackagingLotSettable<
        Error = web_common_traits::database::InsertError<
            crate::codegen::structs_codegen::tables::insertables::CommercialPackagingLotAttribute,
        >,
    >,
{
    ...
    {
        self.commercial_packaging_lots_id_fkey = <CommercialProductLot as crate::codegen::structs_codegen::tables::insertables::CommercialProductLotSettable>::lot(
                self.commercial_packaging_lots_id_fkey,
                lot,
            )
            .map_err(|e| {
    ...
    where
        PM: web_common_traits::database::PrimaryKeyLike<PrimaryKey = i32>,
    {
        <Self as CommercialPackagingLotSettable>::product_model(self, product_model)
    }
}
impl<
    CommercialProductLot,
    ...
    >,
{
    ...
    where
        PM: web_common_traits::database::MaybePrimaryKeyLike<PrimaryKey = i32>,
    {
        <Self as CommercialPackagingLotSettable>::product_model(
            self,
...
impl<CommercialProductLot, PackagingModel> web_common_traits::database::MostConcreteTable
    for InsertableCommercialPackagingLotBuilder<CommercialProductLot, PackagingModel>
where
    ...
    PackagingModel: web_common_traits::database::MostConcreteTable,
{
    fn set_most_concrete_table(&mut self, table_name: &str) {
        self.commercial_packaging_lots_id_fkey.set_most_concrete_table(table_name);
        self.commercial_packaging_lots_id_fkey1.set_most_concrete_table(table_name);
    }
}
...
where
    Self: web_common_traits::database::DispatchableInsertableVariant<
            ...
            Error = web_common_traits::database::InsertError<
                CommercialPackagingLotAttribute,
            >,
