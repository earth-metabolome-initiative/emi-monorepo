...
where
    ...
    crate::codegen::structs_codegen::tables::insertables::PouringProcedureExtensionAttribute: From<
        ...
        let procedure = self
            ...
            .map_err(|err| {
                err.into_field_name(|attribute| {
                    crate::codegen::structs_codegen::tables::insertables::PouringProcedureAttribute::Extension(
                        From::from(attribute),
                    )
                })
            })?;
