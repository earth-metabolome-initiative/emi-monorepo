...
impl NestedProjectsUsersRole {
    ...
    /// * `connection` - The connection to the database.
    pub fn all_viewable(
        filter: Option<&web_common::database::filter_variants::ProjectsUsersRoleFilter>,
        author_user_id: Option<i32>,
        limit: Option<i64>,
        offset: Option<i64>,
        connection: &mut diesel::r2d2::PooledConnection<
        ...
        ProjectsUsersRole::all_viewable(filter, author_user_id, limit, offset, connection)?
            .into_iter()
    ...
    pub fn all_viewable_sorted(
        ...
        ProjectsUsersRole::all_viewable_sorted(filter, author_user_id, limit, offset, connection)?
            .into_iter()
            .map(|flat_variant| Self::from_flat(flat_variant, author_user_id, connection))
            .collect()
    }
    ...
    pub fn get(
        ...
        ProjectsUsersRole::get((table_id, user_id), author_user_id, connection)
    ...
    pub fn strict_word_similarity_search_viewable(
        ...
        ProjectsUsersRole::strict_word_similarity_search_viewable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn strict_word_similarity_search_with_score_viewable(
        ...
        ProjectsUsersRole::strict_word_similarity_search_with_score_viewable(
            author_user_id,
            query,
            limit,
            offset,
    ...
    pub fn can_update_by_id() -> Result<bool, web_common::api::ApiError> {
        ProjectsUsersRole::can_update_by_id()
    }
    ...
    pub fn all_updatable(
        ...
        ProjectsUsersRole::all_updatable(filter, author_user_id, limit, offset, connection)?
            .into_iter()
    ...
    pub fn all_updatable_sorted(
        ...
        ProjectsUsersRole::all_updatable_sorted(filter, author_user_id, limit, offset, connection)?
            .into_iter()
            .map(|flat_variant| Self::from_flat(flat_variant, Some(author_user_id), connection))
            .collect()
    }
    ...
    pub fn strict_word_similarity_search_updatable(
        ...
        ProjectsUsersRole::strict_word_similarity_search_updatable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn all_administrable(
        ...
        ProjectsUsersRole::all_administrable(filter, author_user_id, limit, offset, connection)?
            .into_iter()
            .map(|flat_variant| Self::from_flat(flat_variant, Some(author_user_id), connection))
            .collect()
    }
    ...
    pub fn all_administrable_sorted(
        ...
        ProjectsUsersRole::all_administrable_sorted(
            filter,
            author_user_id,
            limit,
            offset,
    ...
    pub fn strict_word_similarity_search_administrable(
        ...
        ProjectsUsersRole::strict_word_similarity_search_administrable(
            filter,
            author_user_id,
            query,
            limit,
...
impl From<web_common::database::nested_variants::NestedProjectsUsersRole>
    for crate::database::nested_variants::NestedProjectsUsersRole
{
    fn from(item: web_common::database::nested_variants::NestedProjectsUsersRole) -> Self {
        Self {
            inner: crate::database::flat_variants::ProjectsUsersRole::from(item.inner),
...
impl From<crate::database::nested_variants::NestedProjectsUsersRole>
    for web_common::database::nested_variants::NestedProjectsUsersRole
{
    fn from(item: crate::database::nested_variants::NestedProjectsUsersRole) -> Self {
        Self {
            inner: web_common::database::flat_variants::ProjectsUsersRole::from(item.inner),
