...
impl diesel::Identifiable for ProcedureStepModel {
    type Id = i32;
    fn id(self) -> Self::Id {
        self.id
    }
...
impl ProcedureStepModel {
    ...
    pub async fn from_created_at(
        ...
        use crate::codegen::diesel_codegen::tables::procedure_step_models::procedure_step_models;
        Self::table()
            .filter(procedure_step_models::created_at.eq(created_at))
            .order_by(procedure_step_models::id.asc())
            .load::<Self>(conn)
            .await
    }
    #[cfg(feature = "postgres")]
    pub async fn from_updated_at(
        ...
        use crate::codegen::diesel_codegen::tables::procedure_step_models::procedure_step_models;
        Self::table()
            .filter(procedure_step_models::updated_at.eq(updated_at))
            .order_by(procedure_step_models::id.asc())
            .load::<Self>(conn)
            .await
    }
