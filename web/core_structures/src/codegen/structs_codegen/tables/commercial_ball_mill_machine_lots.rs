...
#[diesel(belongs_to(crate::CommercialBallMillMachineModel, foreign_key = product_model))]
...
impl web_common_traits::prelude::TableName for CommercialBallMillMachineLot {
    const TABLE_NAME: &'static str = "commercial_ball_mill_machine_lots";
}
impl<'a> From<&'a CommercialBallMillMachineLot>
for web_common_traits::database::IdOrBuilder<
    i32,
    crate::codegen::structs_codegen::tables::insertables::InsertableCommercialBallMillMachineLotBuilder,
> {
    fn from(value: &'a CommercialBallMillMachineLot) -> Self {
        web_common_traits::database::IdOrBuilder::Id(value.id)
    }
}
impl web_common_traits::prelude::ExtensionTable<crate::AssetModel> for CommercialBallMillMachineLot where
...
impl web_common_traits::prelude::ExtensionTable<crate::CommercialBallMillMachineLot>
    for CommercialBallMillMachineLot
where
    for<'a> &'a Self: diesel::Identifiable<Id = &'a i32>,
{
}
impl diesel::Identifiable for CommercialBallMillMachineLot {
    type Id = i32;
    fn id(self) -> Self::Id {
        self.id
    }
}
impl CommercialBallMillMachineLot {
    ...
    where
        ...
        <Self as diesel::associations::HasTable>::Table: diesel::query_dsl::methods::FilterDsl<
            <crate::codegen::diesel_codegen::tables::commercial_ball_mill_machine_lots::commercial_ball_mill_machine_lots::id as diesel::expression_methods::EqAll<
                i32,
            >>::Output,
        >,
        ...
        >>::Output: diesel::query_dsl::methods::OrderDsl<
            diesel::helper_types::Asc<
                crate::codegen::diesel_codegen::tables::commercial_ball_mill_machine_lots::commercial_ball_mill_machine_lots::id,
            >,
        >,
        <<<Self as diesel::associations::HasTable>::Table as diesel::query_dsl::methods::FilterDsl<
            <crate::codegen::diesel_codegen::tables::commercial_ball_mill_machine_lots::commercial_ball_mill_machine_lots::id as diesel::expression_methods::EqAll<
            ...
            + for<'a> diesel::query_dsl::LoadQuery<'a, C, Self>,
    {
        ...
        Self::table()
            .filter(commercial_ball_mill_machine_lots::id.eq(id))
            .order_by(commercial_ball_mill_machine_lots::id.asc())
            .load::<Self>(conn)
    }
    #[cfg(feature = "postgres")]
    pub fn from_id_and_product_model(
        ...
        Self::table()
            .filter(
                commercial_ball_mill_machine_lots::id
                    .eq(id)
                    .and(commercial_ball_mill_machine_lots::product_model.eq(product_model)),
            )
            .order_by(commercial_ball_mill_machine_lots::id.asc())
            .load::<Self>(conn)
    }
        ...
        Self::table()
            .inner_join(
                commercial_product_lots::table
                    .on(commercial_ball_mill_machine_lots::id.eq(commercial_product_lots::id)),
            )
            .filter(
        ...
        Self::table()
            .inner_join(
                physical_asset_models::table
                    .on(commercial_ball_mill_machine_lots::id.eq(physical_asset_models::id)),
            )
    ...
    pub fn from_name(
        ...
        Self::table()
            .inner_join(
                asset_models::table.on(commercial_ball_mill_machine_lots::id.eq(asset_models::id)),
            )
...
impl AsRef<CommercialBallMillMachineLot> for CommercialBallMillMachineLot {
    fn as_ref(&self) -> &CommercialBallMillMachineLot {
        self
    }
}
