...
{
    type ForeignKeys = StorageContainerForeignKeys;
    ...
    fn foreign_keys_loaded(&self, foreign_keys: &Self::ForeignKeys) -> bool {
        foreign_keys.container_model.is_some() && foreign_keys.created_by.is_some()
    }
    fn update(
        &self,
...
impl web_common_traits::prelude::ForeignKeys for StorageContainerForeignKeys {}
