...
impl crate::database::Tabular for NestedUsersUsersRoleRequest {
    const TABLE: crate::database::Table = crate::database::Table::UsersUsersRoleRequests;
}
impl crate::database::Filtrable for NestedUsersUsersRoleRequest {
    type Filter = crate::database::filter_variants::UsersUsersRoleRequestFilter;
}
impl crate::database::Describable for NestedUsersUsersRoleRequest {
    fn description(&self) -> Option<&str> {
        self.inner.description()
    }
}
impl crate::database::Colorable for NestedUsersUsersRoleRequest {
    fn color(&self) -> Option<&str> {
        None
    }
}
#[cfg(feature = "frontend")]
impl crate::database::AllRecords for NestedUsersUsersRoleRequest {
...
impl NestedUsersUsersRoleRequest {
    ...
    pub(crate) async fn from_flat(
        flat_variant: crate::database::flat_variants::UsersUsersRoleRequest,
    ...
    pub async fn get<C: gluesql::core::store::GStore + gluesql::core::store::GStoreMut>(
        ...
        if let Some(flat_variant) = crate::database::flat_variants::UsersUsersRoleRequest::get(
            (table_id, user_id),
            connection,
        )
        .await?
    ...
    >(
        ...
        crate::database::flat_variants::UsersUsersRoleRequest::delete_from_id(
            (table_id, user_id),
            connection,
        )
        .await
    ...
    pub async fn all<C: gluesql::core::store::GStore + gluesql::core::store::GStoreMut>(
        ...
        let mut users_users_role_requests = Vec::new();
        for flat_variant in crate::database::flat_variants::UsersUsersRoleRequest::all(
            filter, limit, offset, connection,
        )
        .await?
        .into_iter()
        {
            users_users_role_requests.push(Self::from_flat(flat_variant, connection).await?);
        }
        Ok(users_users_role_requests)
    }
    ...
    >(
        ...
        .await?;
        crate::database::flat_variants::UsersUsersRoleRequest::update_or_insert(
            &self.inner,
            connection,
        )
        .await
