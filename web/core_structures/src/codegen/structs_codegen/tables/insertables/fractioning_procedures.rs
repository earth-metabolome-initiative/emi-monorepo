...
impl web_common_traits::database::TableField for FractioningProcedureAttribute {}
impl web_common_traits::database::HasTableType for FractioningProcedureAttribute {
    ...
    > for FractioningProcedureAttribute
{
    fn from_extension(
        ...
        FractioningProcedureAttribute::Extension(From::from(attribute))
    }
}
...
///
/// ```rust,ignore
/// use core_structures::FractioningProcedure;
/// use core_structures::tables::insertables::FractioningProcedureSettable;
/// use core_structures::tables::insertables::ProcedureSettable;
/// use web_common_traits::database::Insertable;
/// use web_common_traits::database::InsertableVariant;
///
/// let fractioning_procedure = FractioningProcedure::new()
...
where
    Self: web_common_traits::database::DispatchableInsertableVariant<
            ...
            Error = web_common_traits::database::InsertError<
                FractioningProcedureAttribute,
            >,
        > + web_common_traits::database::SetPrimaryKey<PrimaryKey = ::rosetta_uuid::Uuid>
        + common_traits::builder::IsCompleteBuilder,
{
    type Error = web_common_traits::database::InsertError<FractioningProcedureAttribute>;
    fn mint_primary_key(
        self,
        user_id: i32,
        conn: &mut C,
