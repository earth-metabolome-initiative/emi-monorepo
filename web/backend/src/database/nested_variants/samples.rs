...
impl NestedSample {
    ...
    pub fn all_viewable(
        ...
        Sample::all_viewable(filter, author_user_id, limit, offset, connection)?
            .into_iter()
    ...
    pub fn all_viewable_sorted(
        ...
        Sample::all_viewable_sorted(filter, author_user_id, limit, offset, connection)?
            .into_iter()
            .map(|flat_variant| Self::from_flat(flat_variant, author_user_id, connection))
            .collect()
    }
    ...
    pub fn get(
        ...
        Sample::get(id, author_user_id, connection)
    ...
    pub fn from_container_id(
        ...
        Sample::from_container_id(container_id, author_user_id, connection)
            .and_then(|flat_variant| Self::from_flat(flat_variant, author_user_id, connection))
    }
    ...
    pub fn strict_word_similarity_search_viewable(
        ...
        Sample::strict_word_similarity_search_viewable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn strict_word_similarity_search_with_score_viewable(
        ...
        Sample::strict_word_similarity_search_with_score_viewable(
            author_user_id,
            query,
            limit,
            offset,
    ...
    pub fn all_updatable(
        ...
        Sample::all_updatable(filter, author_user_id, limit, offset, connection)?
            .into_iter()
    ...
    pub fn all_updatable_sorted(
        ...
        Sample::all_updatable_sorted(filter, author_user_id, limit, offset, connection)?
            .into_iter()
            .map(|flat_variant| Self::from_flat(flat_variant, Some(author_user_id), connection))
            .collect()
    }
    ...
    pub fn strict_word_similarity_search_updatable(
        ...
        Sample::strict_word_similarity_search_updatable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn all_administrable(
        ...
        Sample::all_administrable(filter, author_user_id, limit, offset, connection)?
            .into_iter()
            .map(|flat_variant| Self::from_flat(flat_variant, Some(author_user_id), connection))
            .collect()
    }
    ...
    pub fn all_administrable_sorted(
        ...
        Sample::all_administrable_sorted(filter, author_user_id, limit, offset, connection)?
            .into_iter()
            .map(|flat_variant| Self::from_flat(flat_variant, Some(author_user_id), connection))
            .collect()
    }
    ...
    pub fn strict_word_similarity_search_administrable(
        ...
        Sample::strict_word_similarity_search_administrable(
            filter,
            author_user_id,
            query,
            limit,
