...
pub struct InstrumentCategoryForeignKeys {
...
for crate::codegen::structs_codegen::tables::instrument_categories::InstrumentCategory {
    type ForeignKeys = InstrumentCategoryForeignKeys;
...
impl web_common_traits::prelude::ForeignKeys for InstrumentCategoryForeignKeys {}
