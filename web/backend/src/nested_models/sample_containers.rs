...
impl NestedSampleContainer {
    ...
    pub fn all_viewable(
        ...
        SampleContainer::all_viewable(filter, author_user_id, limit, offset, connection)?
            .into_iter()
    ...
    pub fn all_viewable_sorted(
        ...
        SampleContainer::all_viewable_sorted(filter, author_user_id, limit, offset, connection)?
            .into_iter()
            .map(|flat_variant| Self::from_flat(flat_variant, author_user_id, connection))
            .collect()
    }
    ...
    pub fn get(
        ...
        SampleContainer::get(id, author_user_id, connection)
    ...
    pub fn from_barcode(
        ...
        SampleContainer::from_barcode(barcode, author_user_id, connection)
            .and_then(|flat_variant| Self::from_flat(flat_variant, author_user_id, connection))
    }
    ...
    pub fn similarity_search_viewable(
        ...
        SampleContainer::similarity_search_viewable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn word_similarity_search_viewable(
        ...
        SampleContainer::word_similarity_search_viewable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn strict_word_similarity_search_viewable(
        ...
        SampleContainer::strict_word_similarity_search_viewable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn all_updatable(
        ...
        SampleContainer::all_updatable(filter, author_user_id, limit, offset, connection)?
            .into_iter()
    ...
    pub fn all_updatable_sorted(
        ...
        SampleContainer::all_updatable_sorted(filter, author_user_id, limit, offset, connection)?
            .into_iter()
            .map(|flat_variant| Self::from_flat(flat_variant, Some(author_user_id), connection))
            .collect()
    }
    ...
    pub fn similarity_search_updatable(
        ...
        SampleContainer::similarity_search_updatable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn word_similarity_search_updatable(
        ...
        SampleContainer::word_similarity_search_updatable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn strict_word_similarity_search_updatable(
        ...
        SampleContainer::strict_word_similarity_search_updatable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn all_administrable(
        ...
        SampleContainer::all_administrable(filter, author_user_id, limit, offset, connection)?
            .into_iter()
            .map(|flat_variant| Self::from_flat(flat_variant, Some(author_user_id), connection))
            .collect()
    }
    ...
    pub fn all_administrable_sorted(
        ...
        SampleContainer::all_administrable_sorted(
            filter,
            author_user_id,
            limit,
            offset,
    ...
    pub fn similarity_search_administrable(
        ...
        SampleContainer::similarity_search_administrable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn word_similarity_search_administrable(
        ...
        SampleContainer::word_similarity_search_administrable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn strict_word_similarity_search_administrable(
        ...
        SampleContainer::strict_word_similarity_search_administrable(
            filter,
            author_user_id,
            query,
            limit,
