...
where
    ...
    crate::codegen::structs_codegen::tables::insertables::FreezeDryingProcedureTemplateExtensionAttribute: From<
        ...
        let procedure_template = self
            ...
            .map_err(|err| {
                err.into_field_name(|attribute| {
                    crate::codegen::structs_codegen::tables::insertables::FreezeDryingProcedureTemplateAttribute::Extension(
                        From::from(attribute),
                    )
                })
            })?;
