-- Drop the `can_update_users_users_role_invitations` function and trigger on the users_users_role_invitations table.

DROP FUNCTION IF EXISTS can_update_users_users_role_invitations(INTEGER, INTEGER, INTEGER);
