...
CREATE TABLE organizations (
  ...
  description TEXT,
  state_id INTEGER DEFAULT NULL REFERENCES organization_states(id) ON DELETE SET NULL,
  parent_organization_id INTEGER DEFAULT NULL REFERENCES organizations(id) ON DELETE CASCADE,
