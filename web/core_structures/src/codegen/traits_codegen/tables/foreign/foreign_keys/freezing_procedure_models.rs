...
pub struct FreezingProcedureModelForeignKeys {
    ...
    pub procedure_frozen_container: Option<
        crate::codegen::structs_codegen::tables::procedure_model_trackables::ProcedureModelTrackable,
    >,
    pub freezing_procedure_compatibility_rule: Option<
    ...
    for crate::codegen::structs_codegen::tables::freezing_procedure_models::FreezingProcedureModel
{
    ...
    fn foreign_keys_loaded(&self, foreign_keys: &Self::ForeignKeys) -> bool {
        foreign_keys.procedure_model.is_some()
            ...
            && foreign_keys.freezing_procedure_compatibility_rule.is_some()
    }
    fn update(
        &self,
        ...
        match (row, crud) {
            (
                ...
                {
                    foreign_keys.freezing_procedure_compatibility_rule = Some(compatibility_rules);
                    updated = true;
                }
            }
            (
                ...
                if self.frozen_with == compatibility_rules.left_trackable_id
                    && self.frozen_container_id == compatibility_rules.right_trackable_id
                {
                    foreign_keys.freezing_procedure_compatibility_rule = None;
                    updated = true;
                }
            }
            (
            ...
            (
                ...
                if self.procedure_frozen_with == procedure_model_trackables.id {
                    foreign_keys.procedure_frozen_with = Some(procedure_model_trackables.clone());
                    updated = true;
                }
                if self.procedure_frozen_container_id == procedure_model_trackables.id {
                    foreign_keys.procedure_frozen_container =
