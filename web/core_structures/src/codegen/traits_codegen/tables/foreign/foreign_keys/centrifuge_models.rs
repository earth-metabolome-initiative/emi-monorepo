...
pub struct CentrifugeModelForeignKeys {
    pub id: Option<crate::PhysicalAssetModel>,
}
impl web_common_traits::prelude::HasForeignKeys for crate::CentrifugeModel {
    type ForeignKeys = CentrifugeModelForeignKeys;
...
impl web_common_traits::prelude::ForeignKeys for CentrifugeModelForeignKeys {}
