    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            Self::CommercialProductLot(e) => {
                write!(f, "commercial_positioning_device_lots({e})")
            }
...
impl From<common_traits::builder::EmptyTuple> for CommercialPositioningDeviceLotExtensionAttribute {
...
for crate::codegen::structs_codegen::tables::insertables::InsertableCommercialPositioningDeviceLotBuilder<
    ...
    T2,
> {
    type Attribute = CommercialPositioningDeviceLotAttribute;
}
impl web_common_traits::database::TableField for CommercialPositioningDeviceLotAttribute {}
impl web_common_traits::database::HasTableType for CommercialPositioningDeviceLotAttribute {
    type Table = crate::codegen::tables::table_names::TableName;
}
impl
    web_common_traits::database::FromExtension<
        crate::codegen::structs_codegen::tables::insertables::CommercialProductLotAttribute,
    > for CommercialPositioningDeviceLotAttribute
{
    fn from_extension(
        attribute: crate::codegen::structs_codegen::tables::insertables::CommercialProductLotAttribute,
    ) -> Self {
        CommercialPositioningDeviceLotAttribute::Extension(From::from(attribute))
    }
}
impl
    web_common_traits::database::FromExtension<
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct InsertableCommercialPositioningDeviceLot {
    pub(crate) id: i32,
    pub(crate) product_model: i32,
}
impl InsertableCommercialPositioningDeviceLot {
...
///
/// ```rust,ignore
/// use core_structures::CommercialPositioningDeviceLot;
/// use core_structures::tables::insertables::AssetModelSettable;
/// use core_structures::tables::insertables::CommercialPositioningDeviceLotSettable;
/// use core_structures::tables::insertables::CommercialProductLotSettable;
/// use web_common_traits::database::Insertable;
/// use web_common_traits::database::InsertableVariant;
///
/// let commercial_positioning_device_lot = CommercialPositioningDeviceLot::new()
...
impl<CommercialProductLot, PositioningDeviceModel> diesel::associations::HasTable
    for InsertableCommercialPositioningDeviceLotBuilder<
        CommercialProductLot,
        PositioningDeviceModel,
    >
{
    type Table = crate::codegen::diesel_codegen::tables::commercial_positioning_device_lots::commercial_positioning_device_lots::table;
    fn table() -> Self::Table {
        crate::codegen::diesel_codegen::tables::commercial_positioning_device_lots::commercial_positioning_device_lots::table
    }
}
...
pub trait CommercialPositioningDeviceLotSettable: Sized {
    /// Error type returned when setting attributes.
    type Error;
    /// Sets the value of the
    /// `public.commercial_positioning_device_lots.product_model` column.
    ///
    /// # Arguments
...
where
    Self: common_traits::builder::Attributed<
        Attribute = crate::codegen::structs_codegen::tables::insertables::CommercialPositioningDeviceLotAttribute,
    >,
{
    ...
    ///end
    ///subgraph v5 ["`commercial_positioning_device_lots`"]
        ...
        PM: web_common_traits::database::PrimaryKeyLike<PrimaryKey = i32>,
    {
        ...
        self.commercial_positioning_device_lots_id_fkey = <CommercialProductLot as crate::codegen::structs_codegen::tables::insertables::CommercialProductLotSettable>::product_model(
                self.commercial_positioning_device_lots_id_fkey,
                product_model,
            )
            .map_err(|err| {
        ...
        self.commercial_positioning_device_lots_id_fkey = <CommercialProductLot as crate::codegen::structs_codegen::tables::insertables::PhysicalAssetModelSettable>::parent_model(
                self.commercial_positioning_device_lots_id_fkey,
                product_model,
            )
            .map_err(|err| {
    ...
    >,
{
    ...
    {
        self.commercial_positioning_device_lots_id_fkey = <CommercialProductLot as crate::codegen::structs_codegen::tables::insertables::AssetModelSettable>::name(
                self.commercial_positioning_device_lots_id_fkey,
                name,
            )
            .map_err(|e| {
    ...
    {
        self.commercial_positioning_device_lots_id_fkey = <CommercialProductLot as crate::codegen::structs_codegen::tables::insertables::AssetModelSettable>::description(
                self.commercial_positioning_device_lots_id_fkey,
                description,
            )
            .map_err(|e| {
    ...
    {
        self.commercial_positioning_device_lots_id_fkey = <CommercialProductLot as crate::codegen::structs_codegen::tables::insertables::AssetModelSettable>::created_by(
                self.commercial_positioning_device_lots_id_fkey,
                created_by,
            )
            .map_err(|e| {
    ...
    where
        ...
        >,
    {
        self.commercial_positioning_device_lots_id_fkey = <CommercialProductLot as crate::codegen::structs_codegen::tables::insertables::AssetModelSettable>::created_at(
                self.commercial_positioning_device_lots_id_fkey,
                created_at,
            )
            .map_err(|e| {
    ...
    {
        self.commercial_positioning_device_lots_id_fkey = <CommercialProductLot as crate::codegen::structs_codegen::tables::insertables::AssetModelSettable>::updated_by(
                self.commercial_positioning_device_lots_id_fkey,
                updated_by,
            )
            .map_err(|e| {
    ...
    where
        ...
        >,
    {
        self.commercial_positioning_device_lots_id_fkey = <CommercialProductLot as crate::codegen::structs_codegen::tables::insertables::AssetModelSettable>::updated_at(
                self.commercial_positioning_device_lots_id_fkey,
                updated_at,
            )
            .map_err(|e| {
    ...
    >,
{
    ...
    {
        self.commercial_positioning_device_lots_id_fkey = <CommercialProductLot as crate::codegen::structs_codegen::tables::insertables::CommercialProductLotSettable>::lot(
                self.commercial_positioning_device_lots_id_fkey,
                lot,
            )
            .map_err(|e| {
    ...
    ///classDef directly-involved-column stroke: #6c74f0,fill: #9a9ff4
    ///classDef undirectly-involved-column stroke: #a7eff0,stroke-dasharray: 5, 5,fill: #d2f6f7
    ///subgraph v3 ["`commercial_positioning_device_lots`"]
    ///    v0@{shape: rounded, label: "product_model"}
    ...
    where
        PM: web_common_traits::database::PrimaryKeyLike<PrimaryKey = i32>,
    {
        <Self as CommercialPositioningDeviceLotSettable>::product_model(
            self,
            product_model,
        )
    }
    ...
    PositioningDeviceModel: web_common_traits::database::MostConcreteTable,
{
    fn set_most_concrete_table(&mut self, table_name: &str) {
        self.commercial_positioning_device_lots_id_fkey.set_most_concrete_table(table_name);
        self.commercial_positioning_device_lots_id_fkey1.set_most_concrete_table(table_name);
    }
}
impl<CommercialProductLot, PositioningDeviceModel> web_common_traits::prelude::SetPrimaryKey
    for InsertableCommercialPositioningDeviceLotBuilder<
        CommercialProductLot,
        PositioningDeviceModel,
    >
    ...
    PositioningDeviceModel: web_common_traits::prelude::SetPrimaryKey<PrimaryKey = i32>,
{
    ...
    fn set_primary_key(mut self, primary_key: Self::PrimaryKey) -> Self {
        self.commercial_positioning_device_lots_id_fkey =
            self.commercial_positioning_device_lots_id_fkey.set_primary_key(primary_key);
        self.commercial_positioning_device_lots_id_fkey1 =
            self.commercial_positioning_device_lots_id_fkey1.set_primary_key(primary_key);
        self
    }
}
impl<
