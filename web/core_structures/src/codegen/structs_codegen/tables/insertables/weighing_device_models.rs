    ...
    for InsertableWeighingDeviceModelAttributes
{
    fn from(
        ...
        Self::Extension(InsertableWeighingDeviceModelExtensionAttributes::Trackable(trackables))
    }
}
...
for InsertableWeighingDeviceModelBuilder<Trackable>
where
    ...
    >,
{
    ...
    fn extend_builder(
        ...
        self.id = self
            ...
            .map_err(|err| {
                err.into_field_name(|attribute| InsertableWeighingDeviceModelAttributes::Extension(
                    InsertableWeighingDeviceModelExtensionAttributes::Trackable(
                        attribute,
                    ),
                ))
            })?;
    ...
    >
{
    ...
    pub fn created_at<CreatedAt>(
        ...
        Self,
        web_common_traits::database::InsertError<InsertableWeighingDeviceModelAttributes>,
    >
    where
    ...
    >
{
    ...
    /// columns from table `weighing_device_models`.
    ...
    >
{
    ...
    /// from table `weighing_device_models`.
