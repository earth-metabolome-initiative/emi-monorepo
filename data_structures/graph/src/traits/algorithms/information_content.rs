...
use crate::traits::{edges::Edges, MonoplexMonopartiteGraph, RootNodes};
    ...
    fn information_content(
        ...
        let information_contents = propagated_occurrences
            ...
            .map(|propagated_occurrence| {
                ...
                if propagated_occurrence == 0 {
                    0.0
                } else {
                    let information_content = -(propagated_occurrence as f64/ total_occurrences as f64).ln();
        ...
        Ok(InformationContentResult { information_contents, max_information_content, root_nodes, graph:self})
    }
}
    ...
    G: MonoplexMonopartiteGraph + ?Sized,
{
    ...
    for successor in graph.successors(node) {
        propagated_occurrence =
            propagate_occurrences(graph, successor, occurrences, propagated_occurrences).saturating_add(propagated_occurrence);
    }
