...
impl CommercialFreezerModel {
    ...
    where
        ...
        <Self as diesel::associations::HasTable>::Table: diesel::query_dsl::methods::FilterDsl<
            <crate::codegen::diesel_codegen::tables::commercial_freezer_models::commercial_freezer_models::freezer_model as diesel::expression_methods::EqAll<
                i32,
            >>::Output,
        >,
        ...
        >>::Output: diesel::query_dsl::methods::OrderDsl<
            diesel::helper_types::Asc<
                crate::codegen::diesel_codegen::tables::commercial_freezer_models::commercial_freezer_models::id,
            >,
        >,
        <<<Self as diesel::associations::HasTable>::Table as diesel::query_dsl::methods::FilterDsl<
            <crate::codegen::diesel_codegen::tables::commercial_freezer_models::commercial_freezer_models::freezer_model as diesel::expression_methods::EqAll<
    ...
    where
        C: diesel::connection::LoadConnection,
        <Self as diesel::associations::HasTable>::Table: diesel::query_dsl::methods::FilterDsl<
            <crate::codegen::diesel_codegen::tables::commercial_freezer_models::commercial_freezer_models::id as diesel::expression_methods::EqAll<
                i32,
            >>::Output,
        >,
        <<Self as diesel::associations::HasTable>::Table as diesel::query_dsl::methods::FilterDsl<
            ...
            + for<'a> diesel::query_dsl::LoadQuery<'a, C, Self>,
    {
        ...
        use crate::codegen::diesel_codegen::tables::commercial_freezer_models::commercial_freezer_models;
        Self::table()
            .filter(commercial_freezer_models::id.eq(id))
            .order_by(commercial_freezer_models::id.asc())
            .load::<Self>(conn)
    }
    #[cfg(feature = "postgres")]
