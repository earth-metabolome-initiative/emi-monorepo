...
impl ProjectsTeamsRole {
    ...
    pub fn can_view_by_id(
        ...
        diesel::select(
            crate::database::sql_function_bindings::can_view_projects_teams_roles(
                author_user_id,
                table_id,
                team_id,
            ),
    ...
    pub fn all_viewable(
        ...
        let query = projects_teams_roles::dsl::projects_teams_roles
            ...
            .order_by(projects_teams_roles::dsl::table_id);
    ...
    pub fn can_update_by_id(
        ...
        diesel::select(
            crate::database::sql_function_bindings::can_update_projects_teams_roles(
                author_user_id,
                table_id,
                team_id,
            ),
    ...
    pub fn can_admin_by_id(
        ...
        diesel::select(
            crate::database::sql_function_bindings::can_admin_projects_teams_roles(
                author_user_id,
                table_id,
                team_id,
            ),
    ...
    pub fn delete_by_id(
        ...
        diesel::delete(
            crate::database::projects_teams_roles::dsl::projects_teams_roles
                .filter(crate::database::projects_teams_roles::dsl::table_id.eq(table_id))
                .filter(crate::database::projects_teams_roles::dsl::team_id.eq(team_id)),
        )
        .execute(connection)
        .map_err(web_common::api::ApiError::from)
    }
