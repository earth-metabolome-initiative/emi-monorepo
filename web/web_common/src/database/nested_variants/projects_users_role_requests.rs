...
impl crate::database::Tabular for NestedProjectsUsersRoleRequest {
    const TABLE: crate::database::Table = crate::database::Table::ProjectsUsersRoleRequests;
}
impl crate::database::Filtrable for NestedProjectsUsersRoleRequest {
    type Filter = crate::database::filter_variants::ProjectsUsersRoleRequestFilter;
}
impl crate::database::Describable for NestedProjectsUsersRoleRequest {
    fn description(&self) -> Option<&str> {
        self.inner.description()
    }
}
impl crate::database::Colorable for NestedProjectsUsersRoleRequest {
    fn color(&self) -> Option<&str> {
        None
    }
}
#[cfg(feature = "frontend")]
impl crate::database::AllRecords for NestedProjectsUsersRoleRequest {
...
impl NestedProjectsUsersRoleRequest {
    ...
    pub(crate) async fn from_flat(
        flat_variant: crate::database::flat_variants::ProjectsUsersRoleRequest,
    ...
    /// Get the ProjectsUsersRoleRequest from the database by its ID.
    ///
    ...
    pub async fn get<C: gluesql::core::store::GStore + gluesql::core::store::GStoreMut>(
        ...
        if let Some(flat_variant) = crate::database::flat_variants::ProjectsUsersRoleRequest::get(
            (table_id, user_id),
            connection,
        )
        .await?
    ...
    /// Delete the ProjectsUsersRoleRequest from the database.
    ///
    /// * `connection` - The connection to the database.
    ...
    /// Delete the ProjectsUsersRoleRequest from the database by its ID.
    ///
    ...
    >(
        ...
        crate::database::flat_variants::ProjectsUsersRoleRequest::delete_from_id(
            (table_id, user_id),
            connection,
        )
        .await
    ...
    pub async fn all<C: gluesql::core::store::GStore + gluesql::core::store::GStoreMut>(
        filter: Option<&crate::database::filter_variants::ProjectsUsersRoleRequestFilter>,
        limit: Option<i64>,
        offset: Option<i64>,
        connection: &mut gluesql::prelude::Glue<C>,
    ) -> Result<Vec<Self>, crate::api::ApiError> {
        let mut projects_users_role_requests = Vec::new();
        for flat_variant in crate::database::flat_variants::ProjectsUsersRoleRequest::all(
            filter, limit, offset, connection,
        )
        .await?
        .into_iter()
        {
            projects_users_role_requests.push(Self::from_flat(flat_variant, connection).await?);
        }
        Ok(projects_users_role_requests)
    }
    ...
    >(
        ...
        .await?;
        crate::database::flat_variants::ProjectsUsersRoleRequest::update_or_insert(
            &self.inner,
            connection,
        )
        .await
