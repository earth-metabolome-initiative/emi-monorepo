...
impl NestedProjectsUsersRole {
    ...
    pub fn similarity_search_viewable(
        ...
        ProjectsUsersRole::similarity_search_viewable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn word_similarity_search_viewable(
        ...
        ProjectsUsersRole::word_similarity_search_viewable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn similarity_search_updatable(
        ...
        ProjectsUsersRole::similarity_search_updatable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn word_similarity_search_updatable(
        ...
        ProjectsUsersRole::word_similarity_search_updatable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn similarity_search_administrable(
        ...
        ProjectsUsersRole::similarity_search_administrable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn word_similarity_search_administrable(
        ...
        ProjectsUsersRole::word_similarity_search_administrable(
            filter,
            author_user_id,
            query,
            limit,
...
impl From<web_common::database::nested_models::NestedProjectsUsersRole>
    for NestedProjectsUsersRole
{
    fn from(item: web_common::database::nested_models::NestedProjectsUsersRole) -> Self {
        Self {
            inner: ProjectsUsersRole::from(item.inner),
...
impl From<NestedProjectsUsersRole>
    for web_common::database::nested_models::NestedProjectsUsersRole
{
    fn from(item: NestedProjectsUsersRole) -> Self {
        Self {
            inner: web_common::database::ProjectsUsersRole::from(item.inner),
