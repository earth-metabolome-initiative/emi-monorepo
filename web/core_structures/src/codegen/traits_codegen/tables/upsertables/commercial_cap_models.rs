...
impl web_common_traits::prelude::Upsertable<diesel::PgConnection> for crate::CommercialCapModel {
    fn upsert(
        &self,
        ...
        diesel::insert_into(table)
            ...
            .do_update()
            .set(self)
            .filter(cap_model.ne(excluded(cap_model)))
            .get_results(conn)
