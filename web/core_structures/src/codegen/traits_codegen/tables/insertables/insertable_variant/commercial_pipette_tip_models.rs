...
where
    ...
    crate::codegen::structs_codegen::tables::insertables::CommercialPipetteTipModelExtensionAttribute: From<
        <PipetteTipModel as common_traits::builder::Attributed>::Attribute,
    >,
    crate::codegen::structs_codegen::tables::insertables::CommercialPipetteTipModelExtensionAttribute: From<
            ...
            let id = self
                ...
                .map_err(|err| {
                    err.into_field_name(|attribute| {
                        crate::codegen::structs_codegen::tables::insertables::CommercialPipetteTipModelAttribute::Extension(
                            From::from(attribute),
                        )
                    })
                })?;
