...
impl web_common_traits::prelude::Upsertable<diesel::PgConnection> for crate::PositioningDevice {
    fn upsert(
        &self,
...
#[cfg(feature = "sqlite")]
impl web_common_traits::prelude::Upsertable<diesel::SqliteConnection> for crate::PositioningDevice {
    fn upsert(
        &self,
