...
impl web_common_traits::database::PrimaryKeyLike for DirectusSetting {
    type PrimaryKey = i32;
...
impl DirectusSetting {
    ...
    >
    where
        crate::codegen::structs_codegen::tables::directus_files::DirectusFile: web_common_traits::database::Read<
            C,
        >,
    {
