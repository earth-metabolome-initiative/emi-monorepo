...
impl From<Vec<std::rc::Rc<crate::codegen::structs_codegen::tables::user_emails::UserEmail>>>
    for super::Rows
{
    fn from(
        value: Vec<std::rc::Rc<crate::codegen::structs_codegen::tables::user_emails::UserEmail>>,
    ) -> Self {
        Self::from(std::rc::Rc::new(value))
    }
}
impl From<std::rc::Rc<Vec<crate::codegen::structs_codegen::tables::user_emails::UserEmail>>>
    for super::Rows
{
    fn from(
        value: std::rc::Rc<Vec<crate::codegen::structs_codegen::tables::user_emails::UserEmail>>,
    ) -> Self {
...
impl
    From<
        std::rc::Rc<
            Vec<std::rc::Rc<crate::codegen::structs_codegen::tables::user_emails::UserEmail>>,
        >,
    > for super::Rows
{
    fn from(
