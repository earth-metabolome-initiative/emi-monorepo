-- Drop the `can_update_projects_users_role_requests` function and trigger on the projects_users_role_requests table.

DROP FUNCTION IF EXISTS can_update_projects_users_role_requests(INTEGER, INTEGER, INTEGER);
