    ...
    >
{
    type InsertableVariant =
        crate::codegen::structs_codegen::tables::insertables::InsertableFreezerModel;
}
#[cfg(feature = "backend")]
...
where
    ...
    Self: web_common_traits::database::InsertableVariant<
        C,
        InsertableVariant = crate::codegen::structs_codegen::tables::insertables::InsertableFreezerModel,
    ...
    crate::codegen::structs_codegen::tables::insertables::FreezerModelExtensionAttribute: From<
    ...
    >,
{
    fn insert(mut self, user_id: i32, conn: &mut C) -> Result<Self::Row, Self::Error> {
        ...
        self.set_most_concrete_table("freezer_models");
        let insertable_struct: crate::codegen::structs_codegen::tables::insertables::InsertableFreezerModel = self
        ...
        let id = self
            ...
            .map_err(|err| {
                err.into_field_name(|attribute| {
                    crate::codegen::structs_codegen::tables::insertables::FreezerModelAttribute::Extension(
                        From::from(attribute),
                    )
                })
            })?;
