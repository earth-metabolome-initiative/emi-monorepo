...
pub struct FreezeDrierModelForeignKeys {
...
{
    type ForeignKeys = FreezeDrierModelForeignKeys;
...
impl web_common_traits::prelude::ForeignKeys for FreezeDrierModelForeignKeys {}
