    ...
    fn update(
        ...
        match (row, crud) {
            ...
            (
                ...
                if self.procedure_capped_container == procedure_asset_models.id {
                    foreign_keys.procedure_capped_container = Some(procedure_asset_models);
                    updated = true;
                }
                if self.procedure_capped_with == procedure_asset_models.id {
                    foreign_keys.procedure_capped_with = Some(procedure_asset_models);
                    updated = true;
                }
            }
            (
