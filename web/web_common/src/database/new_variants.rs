...
impl NewObservation {
    ...
    ) -> Result<super::Observation, crate::api::ApiError>
    where
    ...
    ///
    /// * `user_id` - The user ID of the user who is updating the struct.
    /// * `connection` - The connection to the database.
...
impl NewOrganism {
    ...
    pub async fn insert<C>(
        ...
        created_by: i32,
        connection: &mut gluesql::prelude::Glue<C>,
    ) -> Result<super::Organism, crate::api::ApiError>
    where
        C: gluesql::core::store::GStore + gluesql::core::store::GStoreMut,
    {
        use gluesql::core::ast_builder::*;
...
impl NewSample {
    ...
    pub async fn insert<C>(
        ...
        created_by: i32,
        connection: &mut gluesql::prelude::Glue<C>,
    ) -> Result<super::Sample, crate::api::ApiError>
    where
        C: gluesql::core::store::GStore + gluesql::core::store::GStoreMut,
    {
        use gluesql::core::ast_builder::*;
