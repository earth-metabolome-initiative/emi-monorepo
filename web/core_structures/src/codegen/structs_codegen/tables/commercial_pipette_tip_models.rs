...
impl web_common_traits::prelude::ExtensionTable<crate::AssetModel> for CommercialPipetteTipModel where
...
impl web_common_traits::prelude::ExtensionTable<crate::PipetteTipModel>
    for CommercialPipetteTipModel
where
    for<'a> &'a Self: diesel::Identifiable<Id = &'a i32>,
{
}
impl web_common_traits::prelude::ExtensionTable<crate::CommercialPipetteTipModel>
    for CommercialPipetteTipModel
where
    for<'a> &'a Self: diesel::Identifiable<Id = &'a i32>,
{
...
impl CommercialPipetteTipModel {
    ...
    pub fn commercial_pipette_tip_models_id_pipette_tip_model_fkey(
        &self,
    ...
    where
        C: diesel::connection::LoadConnection,
        <Self as diesel::associations::HasTable>::Table: diesel::query_dsl::methods::FilterDsl<
            <crate::codegen::diesel_codegen::tables::commercial_pipette_tip_models::commercial_pipette_tip_models::id as diesel::expression_methods::EqAll<
                i32,
            >>::Output,
        >,
        <<Self as diesel::associations::HasTable>::Table as diesel::query_dsl::methods::FilterDsl<
            ...
            + for<'a> diesel::query_dsl::LoadQuery<'a, C, Self>,
    {
        ...
        use crate::codegen::diesel_codegen::tables::commercial_pipette_tip_models::commercial_pipette_tip_models;
        Self::table()
            .filter(commercial_pipette_tip_models::id.eq(id))
            .order_by(commercial_pipette_tip_models::id.asc())
            .load::<Self>(conn)
    }
    #[cfg(feature = "postgres")]
