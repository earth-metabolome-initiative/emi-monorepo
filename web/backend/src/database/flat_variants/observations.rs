...
impl Observation {
    ...
    pub fn can_view_by_id(
        ...
        diesel::select(
            crate::database::sql_function_bindings::can_view_observations(author_user_id, id),
        )
    ...
    pub fn all_viewable(
        ...
        let query = observations::dsl::observations
            ...
            .filter(
                crate::database::sql_function_bindings::can_view_observations(
                    author_user_id,
                    observations::dsl::id,
                ),
            )
    ...
    pub fn from_sample_id(
        ...
        use crate::database::schema::observations;
        let flat_variant = observations::dsl::observations
            .filter(observations::dsl::sample_id.eq(sample_id))
            .first::<Self>(connection)?;
    ...
    pub fn strict_word_similarity_search_viewable(
        ...
        let (projects0, projects1, projects2) = diesel::alias!(
            ...
            crate::database::schema::projects as projects2
        );
...
.inner_join(
   observation_subjects::dsl::observation_subjects.on(
       observations::dsl::subject_id.eq(
           observation_subjects::dsl::id
        )
    )
)
   ...
   sample_states::dsl::sample_states.on(
       samples2.field(samples::dsl::state_id).eq(
           sample_states::dsl::id
            ...
            .select(Observation::as_select())
            .filter(crate::database::sql_function_bindings::can_view_observations(author_user_id, observations::dsl::id))
            .filter(
crate::database::sql_function_bindings::concat_projects_name_description(projects0.field(projects::dsl::name), projects0.field(projects::dsl::description)).strict_word_similarity_commutator_op(query).or(
    ...
    .or(
crate::database::sql_function_bindings::concat_observation_subjects_name_description(observation_subjects::dsl::name, observation_subjects::dsl::description).strict_word_similarity_commutator_op(query).or(
    crate::database::sql_function_bindings::concat_observation_subjects_name_description(observation_subjects::dsl::name, observation_subjects::dsl::description).ilike(format!("%{}%", query))
)
    )
    .or(
...
sample_containers::dsl::barcode.strict_word_similarity_commutator_op(query).or(
    sample_containers::dsl::barcode.ilike(format!("%{}%", query))
)
    )
    .or(
crate::database::sql_function_bindings::concat_projects_name_description(projects2.field(projects::dsl::name), projects2.field(projects::dsl::description)).strict_word_similarity_commutator_op(query).or(
    crate::database::sql_function_bindings::concat_projects_name_description(projects2.field(projects::dsl::name), projects2.field(projects::dsl::description)).ilike(format!("%{}%", query))
)
    )
    .or(
crate::database::sql_function_bindings::concat_sample_states_name_description(sample_states::dsl::name, sample_states::dsl::description).strict_word_similarity_commutator_op(query).or(
    crate::database::sql_function_bindings::concat_sample_states_name_description(sample_states::dsl::name, sample_states::dsl::description).ilike(format!("%{}%", query))
)
    )
)
            .order(crate::database::sql_function_bindings::strict_word_similarity_dist_op(crate::database::sql_function_bindings::concat_projects_name_description(projects0.field(projects::dsl::name), projects0.field(projects::dsl::description)), query)    +
crate::database::sql_function_bindings::strict_word_similarity_dist_op(crate::database::sql_function_bindings::concat_observation_subjects_name_description(observation_subjects::dsl::name, observation_subjects::dsl::description), query)    +
...
crate::database::sql_function_bindings::strict_word_similarity_dist_op(crate::database::sql_function_bindings::concat_projects_name_description(projects2.field(projects::dsl::name), projects2.field(projects::dsl::description)), query)    +
...
.map_err(web_common::api::ApiError::from)
    ...
    pub fn can_update_by_id(
        ...
        diesel::select(
            crate::database::sql_function_bindings::can_update_observations(author_user_id, id),
        )
        .get_result(connection)
        .map_err(web_common::api::ApiError::from)
    }
    ...
    pub fn all_updatable(
        ...
        let query = observations::dsl::observations
            .select(Observation::as_select())
            .filter(
                crate::database::sql_function_bindings::can_update_observations(
                    author_user_id,
                    observations::dsl::id,
                ),
            )
   ...
   sample_states::dsl::sample_states.on(
       samples2.field(samples::dsl::state_id).eq(
           sample_states::dsl::id
            ...
            .select(Observation::as_select())
            .filter(crate::database::sql_function_bindings::can_update_observations(author_user_id, observations::dsl::id))
            .filter(
crate::database::sql_function_bindings::concat_projects_name_description(projects0.field(projects::dsl::name), projects0.field(projects::dsl::description)).strict_word_similarity_commutator_op(query).or(
    crate::database::sql_function_bindings::concat_projects_name_description(projects0.field(projects::dsl::name), projects0.field(projects::dsl::description)).ilike(format!("%{}%", query))
)
...
crate::database::sql_function_bindings::strict_word_similarity_dist_op(crate::database::sql_function_bindings::concat_sample_states_name_description(sample_states::dsl::name, sample_states::dsl::description), query))
    ...
    pub fn can_admin_by_id(
        ...
        diesel::select(
            crate::database::sql_function_bindings::can_admin_observations(author_user_id, id),
        )
        .get_result(connection)
        .map_err(web_common::api::ApiError::from)
    }
    ...
    pub fn all_administrable(
        ...
        let query = observations::dsl::observations
            .select(Observation::as_select())
            .filter(
                crate::database::sql_function_bindings::can_admin_observations(
                    author_user_id,
                    observations::dsl::id,
                ),
            )
   ...
   sample_states::dsl::sample_states.on(
       samples2.field(samples::dsl::state_id).eq(
           sample_states::dsl::id
            ...
            .select(Observation::as_select())
            .filter(crate::database::sql_function_bindings::can_admin_observations(author_user_id, observations::dsl::id))
            .filter(
crate::database::sql_function_bindings::concat_projects_name_description(projects0.field(projects::dsl::name), projects0.field(projects::dsl::description)).strict_word_similarity_commutator_op(query).or(
    crate::database::sql_function_bindings::concat_projects_name_description(projects0.field(projects::dsl::name), projects0.field(projects::dsl::description)).ilike(format!("%{}%", query))
)
...
crate::database::sql_function_bindings::strict_word_similarity_dist_op(crate::database::sql_function_bindings::concat_sample_states_name_description(sample_states::dsl::name, sample_states::dsl::description), query))
    ...
    pub fn delete_by_id(
        ...
        diesel::delete(
            crate::database::observations::dsl::observations
                .filter(crate::database::observations::dsl::id.eq(id)),
        )
        .execute(connection)
        .map_err(web_common::api::ApiError::from)
    }
