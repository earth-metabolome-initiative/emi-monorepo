...
impl TeamsUsersRoleRequest {
    ...
    pub fn can_view_by_id(
        ...
        diesel::select(
            crate::database::sql_function_bindings::can_view_teams_users_role_requests(
                author_user_id,
                table_id,
                user_id,
            ),
    ...
    pub fn can_update_by_id(
        ...
        diesel::select(
            crate::database::sql_function_bindings::can_update_teams_users_role_requests(
                author_user_id,
                table_id,
                user_id,
            ),
    ...
    pub fn can_admin_by_id(
        ...
        diesel::select(
            crate::database::sql_function_bindings::can_admin_teams_users_role_requests(
                author_user_id,
                table_id,
                user_id,
            ),
    ...
    pub fn delete_by_id(
        ...
        diesel::delete(
            crate::database::teams_users_role_requests::dsl::teams_users_role_requests
                .filter(crate::database::teams_users_role_requests::dsl::table_id.eq(table_id))
                .filter(crate::database::teams_users_role_requests::dsl::user_id.eq(user_id)),
        )
        .execute(connection)
        .map_err(web_common::api::ApiError::from)
    }
