...
impl Filtrable for crate::database::flat_variants::ProjectsTeamsRoleInvitation {
    type Filter = crate::database::filter_variants::ProjectsTeamsRoleInvitationFilter;
}
#[cfg(feature = "frontend")]
impl AllRecords for ProjectsTeamsRoleInvitation {
...
impl ProjectsTeamsRoleInvitation {
    ...
    async fn insert<C: gluesql::core::store::GStore + gluesql::core::store::GStoreMut>(
        ...
        Ok(table("projects_teams_role_invitations")
            .insert()
