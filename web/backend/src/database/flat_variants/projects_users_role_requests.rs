...
impl From<web_common::database::flat_variants::ProjectsUsersRoleRequest>
    for crate::database::flat_variants::ProjectsUsersRoleRequest
{
    fn from(item: web_common::database::flat_variants::ProjectsUsersRoleRequest) -> Self {
        Self {
...
impl From<crate::database::flat_variants::ProjectsUsersRoleRequest>
    for web_common::database::flat_variants::ProjectsUsersRoleRequest
{
    fn from(item: crate::database::flat_variants::ProjectsUsersRoleRequest) -> Self {
        Self {
            table_id: item.table_id,
            user_id: item.user_id,
            role_id: item.role_id,
...
impl ProjectsUsersRoleRequest {
    ...
    pub fn can_view_by_id(
        ...
        diesel::select(
            crate::database::sql_function_bindings::can_view_projects_users_role_requests(
                author_user_id,
                table_id,
                user_id,
            ),
    ...
    /// * `connection` - The connection to the database.
    pub fn all_viewable(
        filter: Option<&web_common::database::filter_variants::ProjectsUsersRoleRequestFilter>,
        author_user_id: Option<i32>,
        limit: Option<i64>,
        offset: Option<i64>,
        connection: &mut diesel::r2d2::PooledConnection<
    ...
    pub fn strict_word_similarity_search_with_score_viewable(
        ...
        projects_users_role_requests::dsl::projects_users_role_requests
            ...
            .select((
                ProjectsUsersRoleRequest::as_select(),
                crate::database::sql_function_bindings::strict_word_similarity_dist_op(
                    crate::database::sql_function_bindings::concat_projects_name_description(
                        projects::dsl::name,
                        projects::dsl::description,
    ...
    pub fn can_admin_by_id(
        ...
        diesel::select(
            crate::database::sql_function_bindings::can_admin_projects_users_role_requests(
                author_user_id,
                table_id,
                user_id,
            ),
    ...
    pub fn delete_by_id(
        ...
        diesel::delete(
            crate::database::projects_users_role_requests::dsl::projects_users_role_requests
                .filter(crate::database::projects_users_role_requests::dsl::table_id.eq(table_id))
                .filter(crate::database::projects_users_role_requests::dsl::user_id.eq(user_id)),
        )
        .execute(connection)
        .map_err(web_common::api::ApiError::from)
    }
