...
impl From<common_traits::builder::EmptyTuple> for CentrifugeExtensionAttribute {
...
#[derive(Copy, Clone, PartialEq, Eq, PartialOrd, Ord, Hash, core::fmt::Debug)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub enum CentrifugeAttribute {
    Extension(CentrifugeExtensionAttribute),
    Id,
    Model,
}
impl core::str::FromStr for CentrifugeAttribute {
...
impl<T1> common_traits::builder::Attributed
    for crate::codegen::structs_codegen::tables::insertables::InsertableCentrifugeBuilder<T1>
{
    type Attribute = CentrifugeAttribute;
}
impl web_common_traits::database::TableField for CentrifugeAttribute {}
impl web_common_traits::database::HasTableType for CentrifugeAttribute {
    type Table = crate::codegen::tables::table_names::TableName;
}
impl
    web_common_traits::database::FromExtension<
        crate::codegen::structs_codegen::tables::insertables::PhysicalAssetAttribute,
    > for CentrifugeAttribute
{
    fn from_extension(
        attribute: crate::codegen::structs_codegen::tables::insertables::PhysicalAssetAttribute,
    ) -> Self {
        CentrifugeAttribute::Extension(From::from(attribute))
    }
}
...
impl core::fmt::Display for CentrifugeAttribute {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            Self::Extension(e) => write!(f, "{e}"),
            Self::Id => write!(f, "centrifuges.id"),
            Self::Model => write!(f, "centrifuges.model"),
        }
    }
}
#[derive(Debug)]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct InsertableCentrifuge {
    pub(crate) id: ::rosetta_uuid::Uuid,
    pub(crate) model: i32,
}
impl InsertableCentrifuge {
...
///
/// ```rust,ignore
/// use core_structures::Centrifuge;
/// use core_structures::tables::insertables::AssetSettable;
/// use core_structures::tables::insertables::CentrifugeSettable;
/// use web_common_traits::database::Insertable;
/// use web_common_traits::database::InsertableVariant;
///
/// let centrifuge = Centrifuge::new()
...
///    .insert(user.id, conn)?;
/// ```
pub struct InsertableCentrifugeBuilder<
    PhysicalAsset
...
impl<PhysicalAsset> diesel::associations::HasTable for InsertableCentrifugeBuilder<PhysicalAsset> {
    type Table = crate::codegen::diesel_codegen::tables::centrifuges::centrifuges::table;
    fn table() -> Self::Table {
        crate::codegen::diesel_codegen::tables::centrifuges::centrifuges::table
    }
}
impl From<InsertableCentrifugeBuilder>
    for web_common_traits::database::IdOrBuilder<::rosetta_uuid::Uuid, InsertableCentrifugeBuilder>
{
    fn from(builder: InsertableCentrifugeBuilder) -> Self {
...
/// Trait defining setters for attributes of an instance of `Centrifuge` or
/// descendant tables.
pub trait CentrifugeSettable: Sized {
    /// Error type returned when setting attributes.
    type Error;
    /// Sets the value of the `public.centrifuges.model` column.
    ///
    /// # Arguments
    /// * `model`: The value to set for the `public.centrifuges.model` column.
    ///
    /// # Implementation details
...
impl<
    PhysicalAsset: crate::codegen::structs_codegen::tables::insertables::PhysicalAssetSettable<
            ...
            >,
        >,
> CentrifugeSettable for InsertableCentrifugeBuilder<PhysicalAsset>
where
    Self: common_traits::builder::Attributed<
            Attribute = crate::codegen::structs_codegen::tables::insertables::CentrifugeAttribute,
        >,
{
...
> crate::codegen::structs_codegen::tables::insertables::AssetSettable
    for InsertableCentrifugeBuilder<PhysicalAsset>
where
    Self: common_traits::builder::Attributed<
            Attribute = crate::codegen::structs_codegen::tables::insertables::CentrifugeAttribute,
        >,
...
where
    Self: common_traits::builder::Attributed<
            Attribute = crate::codegen::structs_codegen::tables::insertables::CentrifugeAttribute,
        >,
    Self: crate::codegen::structs_codegen::tables::insertables::CentrifugeSettable<
            Error = web_common_traits::database::InsertError<
                crate::codegen::structs_codegen::tables::insertables::CentrifugeAttribute,
            >,
        >,
...
where
    Self: web_common_traits::database::DispatchableInsertableVariant<
            ...
            Error = web_common_traits::database::InsertError<CentrifugeAttribute>,
        > + web_common_traits::database::SetPrimaryKey<PrimaryKey = ::rosetta_uuid::Uuid>
        + common_traits::builder::IsCompleteBuilder,
{
    type Error = web_common_traits::database::InsertError<CentrifugeAttribute>;
