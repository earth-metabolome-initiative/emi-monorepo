    ...
    for crate::codegen::structs_codegen::tables::volume_measuring_devices::VolumeMeasuringDevice
{
    ...
    fn update(
        ...
        match (row, crud) {
            (
                crate::codegen::tables::row::Row::CommercialVolumeMeasuringDeviceLot(
                ...
                if self.model_id == commercial_volume_measuring_device_lots.id {
                    foreign_keys.model = Some(commercial_volume_measuring_device_lots);
                    updated = true;
                }
            }
            (
...
impl web_common_traits::prelude::ForeignKeys for VolumeMeasuringDeviceForeignKeys {}
