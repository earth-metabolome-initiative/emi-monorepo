...
impl Filtrable for crate::database::flat_variants::TeamsTeamsRoleInvitation {
    type Filter = crate::database::filter_variants::TeamsTeamsRoleInvitationFilter;
}
#[cfg(feature = "frontend")]
impl AllRecords for TeamsTeamsRoleInvitation {
...
impl TeamsTeamsRoleInvitation {
    ...
    async fn insert<C: gluesql::core::store::GStore + gluesql::core::store::GStoreMut>(
        ...
        Ok(table("teams_teams_role_invitations")
            .insert()
