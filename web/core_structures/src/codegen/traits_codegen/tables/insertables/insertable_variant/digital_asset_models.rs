...
where
    ...
    crate::codegen::structs_codegen::tables::insertables::DigitalAssetModelExtensionAttribute: From<
        ...
        let id = self
            ...
            .map_err(|err| {
                err.into_field_name(|attribute| {
                    crate::codegen::structs_codegen::tables::insertables::DigitalAssetModelAttribute::Extension(
                        From::from(attribute),
                    )
                })
            })?;
