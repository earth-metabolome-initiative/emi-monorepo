...
impl NestedProjectsTeamsRoleInvitation {
    ...
    pub fn all_viewable(
        ...
        ProjectsTeamsRoleInvitation::all_viewable(
            filter,
            author_user_id,
            limit,
            offset,
    ...
    pub fn all_viewable_sorted(
        ...
        ProjectsTeamsRoleInvitation::all_viewable_sorted(
            filter,
            author_user_id,
            limit,
            offset,
    ...
    pub fn get(
        ...
        ProjectsTeamsRoleInvitation::get((table_id, team_id), author_user_id, connection)
    ...
    pub fn similarity_search_viewable(
        ...
        ProjectsTeamsRoleInvitation::similarity_search_viewable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn word_similarity_search_viewable(
        ...
        ProjectsTeamsRoleInvitation::word_similarity_search_viewable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn strict_word_similarity_search_viewable(
        ...
        ProjectsTeamsRoleInvitation::strict_word_similarity_search_viewable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn can_update_by_id(
        ...
        ProjectsTeamsRoleInvitation::can_update_by_id(
            (table_id, team_id),
            author_user_id,
            connection,
        )
    ...
    pub fn all_updatable(
        ...
        ProjectsTeamsRoleInvitation::all_updatable(
            filter,
            author_user_id,
            limit,
            offset,
    ...
    pub fn all_updatable_sorted(
        ...
        ProjectsTeamsRoleInvitation::all_updatable_sorted(
            filter,
            author_user_id,
            limit,
            offset,
    ...
    pub fn similarity_search_updatable(
        ...
        ProjectsTeamsRoleInvitation::similarity_search_updatable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn word_similarity_search_updatable(
        ...
        ProjectsTeamsRoleInvitation::word_similarity_search_updatable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn strict_word_similarity_search_updatable(
        ...
        ProjectsTeamsRoleInvitation::strict_word_similarity_search_updatable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn can_admin_by_id(
        ...
        ProjectsTeamsRoleInvitation::can_admin_by_id(
            (table_id, team_id),
            author_user_id,
            connection,
        )
    ...
    pub fn all_administrable(
        ...
        ProjectsTeamsRoleInvitation::all_administrable(
            filter,
            author_user_id,
            limit,
            offset,
    ...
    pub fn all_administrable_sorted(
        ...
        ProjectsTeamsRoleInvitation::all_administrable_sorted(
            filter,
            author_user_id,
            limit,
            offset,
    ...
    pub fn similarity_search_administrable(
        ...
        ProjectsTeamsRoleInvitation::similarity_search_administrable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn word_similarity_search_administrable(
        ...
        ProjectsTeamsRoleInvitation::word_similarity_search_administrable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn strict_word_similarity_search_administrable(
        ...
        ProjectsTeamsRoleInvitation::strict_word_similarity_search_administrable(
            filter,
            author_user_id,
            query,
            limit,
...
impl From<web_common::database::nested_models::NestedProjectsTeamsRoleInvitation>
...
impl From<NestedProjectsTeamsRoleInvitation>
    for web_common::database::nested_models::NestedProjectsTeamsRoleInvitation
{
