...
impl web_common_traits::prelude::ExtensionTable<crate::AssetModel> for PipetteTipModel where
    for<'a> &'a Self: diesel::Identifiable<Id = &'a i32>
{
}
impl web_common_traits::prelude::ExtensionTable<crate::PhysicalAssetModel> for PipetteTipModel where
    for<'a> &'a Self: diesel::Identifiable<Id = &'a i32>
{
}
impl web_common_traits::prelude::ExtensionTable<crate::PipetteTipModel> for PipetteTipModel where
    for<'a> &'a Self: diesel::Identifiable<Id = &'a i32>
{
}
...
impl PipetteTipModel {
    ...
    where
        ...
        <Self as diesel::associations::HasTable>::Table: diesel::query_dsl::methods::FilterDsl<
            <crate::codegen::diesel_codegen::tables::pipette_tip_models::pipette_tip_models::id as diesel::expression_methods::EqAll<
                i32,
            >>::Output,
        >,
        ...
        >>::Output: diesel::query_dsl::methods::OrderDsl<
            diesel::helper_types::Asc<
                crate::codegen::diesel_codegen::tables::pipette_tip_models::pipette_tip_models::id,
            >,
        >,
        <<<Self as diesel::associations::HasTable>::Table as diesel::query_dsl::methods::FilterDsl<
            <crate::codegen::diesel_codegen::tables::pipette_tip_models::pipette_tip_models::id as diesel::expression_methods::EqAll<
...
impl AsRef<PipetteTipModel> for PipetteTipModel {
    fn as_ref(&self) -> &PipetteTipModel {
        self
    }
}
