...
impl diesel::Identifiable for CommercialReagentModel {
    type Id = i32;
    fn id(self) -> Self::Id {
        self.id
    }
}
impl CommercialReagentModel {
    ...
    pub async fn from_id(
        ...
        Self::table()
            .filter(
                crate::codegen::diesel_codegen::tables::commercial_reagent_models::commercial_reagent_models::dsl::id
                    .eq(id.id),
            )
            .first::<Self>(conn)
            .await
    ...
    pub async fn from_created_by(
        ...
        Self::table()
            .filter(
                crate::codegen::diesel_codegen::tables::commercial_reagent_models::commercial_reagent_models::dsl::created_by
                    .eq(created_by.id),
            )
            .load::<Self>(conn)
            .await
