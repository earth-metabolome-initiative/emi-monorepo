...
impl crate::database::Tabular for NestedUsersUsersRole {
    const TABLE: crate::database::Table = crate::database::Table::UsersUsersRoles;
}
impl crate::database::Filtrable for NestedUsersUsersRole {
    type Filter = crate::database::filter_variants::UsersUsersRoleFilter;
}
impl crate::database::Describable for NestedUsersUsersRole {
    fn description(&self) -> Option<&str> {
        self.inner.description()
    }
}
impl crate::database::Colorable for NestedUsersUsersRole {
    fn color(&self) -> Option<&str> {
        None
    }
}
#[cfg(feature = "frontend")]
impl crate::database::AllRecords for NestedUsersUsersRole {
...
impl NestedUsersUsersRole {
    ...
    pub(crate) async fn from_flat(
        flat_variant: crate::database::flat_variants::UsersUsersRole,
    ...
    /// Get the UsersUsersRole from the database by its ID.
    ///
    ...
    pub async fn get<C: gluesql::core::store::GStore + gluesql::core::store::GStoreMut>(
        ...
        if let Some(flat_variant) =
            crate::database::flat_variants::UsersUsersRole::get((table_id, user_id), connection)
                .await?
        {
    ...
    /// Delete the UsersUsersRole from the database.
    ///
    /// * `connection` - The connection to the database.
    ...
    /// Delete the UsersUsersRole from the database by its ID.
    ///
    ...
    >(
        ...
        crate::database::flat_variants::UsersUsersRole::delete_from_id(
            (table_id, user_id),
            connection,
        )
        .await
    ...
    pub async fn all<C: gluesql::core::store::GStore + gluesql::core::store::GStoreMut>(
        filter: Option<&crate::database::filter_variants::UsersUsersRoleFilter>,
        limit: Option<i64>,
        offset: Option<i64>,
        connection: &mut gluesql::prelude::Glue<C>,
    ) -> Result<Vec<Self>, crate::api::ApiError> {
        let mut users_users_roles = Vec::new();
        for flat_variant in
            crate::database::flat_variants::UsersUsersRole::all(filter, limit, offset, connection)
                .await?
                .into_iter()
        {
            users_users_roles.push(Self::from_flat(flat_variant, connection).await?);
        }
        Ok(users_users_roles)
    }
    ...
    >(
        ...
        .await?;
        crate::database::flat_variants::UsersUsersRole::update_or_insert(&self.inner, connection)
            .await
    }
}
