...
impl Filtrable for crate::database::flat_variants::NameplateCategory {
    type Filter = crate::database::filter_variants::NameplateCategoryFilter;
}
#[cfg(feature = "frontend")]
impl AllRecords for NameplateCategory {
