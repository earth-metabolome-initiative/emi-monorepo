impl super::Rows {
    pub fn len(&self) -> usize {
        match self {
            ...
            super::Rows::CleaningProcedureTemplate(rows) => rows.len(),
            super::Rows::CleaningProcedure(rows) => rows.len(),
            ...
            super::Rows::PersonalProtectiveEquipmentModel(rows) => rows.len(),
            ...
            super::Rows::PpeReminderProcedureTemplate(rows) => rows.len(),
            super::Rows::PpeReminderProcedure(rows) => rows.len(),
