diesel::table! {
    ...
    procedure_template -> diesel::sql_types::Integer, bead_model_id ->
    ...
    ::rosetta_uuid::diesel_impls::Uuid, milled_container_model_id ->
    diesel::sql_types::Integer, procedure_template_milled_container_model_id ->
