...
pub trait CommercialVolumeMeasuringDeviceLotBuildable: Sized {
        ...
        let product_model = product_model
            ...
            .map_err(|err| {
                validation_errors::SingleFieldError::from(err)
                    .rename_field(
                        InsertableCommercialVolumeMeasuringDeviceLotAttributes::ProductModel,
                    )
            })?;
...
>
where
    Self: crate::codegen::structs_codegen::tables::insertables::CommercialVolumeMeasuringDeviceLotBuildable<
        Attributes = crate::codegen::structs_codegen::tables::insertables::InsertableCommercialVolumeMeasuringDeviceLotAttributes,
    >,
{
    type Attributes = crate::codegen::structs_codegen::tables::insertables::InsertableCommercialVolumeMeasuringDeviceLotAttributes;
