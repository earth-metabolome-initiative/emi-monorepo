...
impl UsersUsersRole {
    ...
    pub fn can_update_by_id(
        ...
        diesel::select(
            crate::database::sql_function_bindings::can_update_users_users_roles(
                author_user_id,
                table_id,
                user_id,
            ),
    ...
    pub fn can_admin_by_id(
        ...
        diesel::select(
            crate::database::sql_function_bindings::can_admin_users_users_roles(
                author_user_id,
                table_id,
                user_id,
            ),
    ...
    pub fn delete_by_id(
        ...
        diesel::delete(
            crate::database::users_users_roles::dsl::users_users_roles
                .filter(crate::database::users_users_roles::dsl::table_id.eq(table_id))
                .filter(crate::database::users_users_roles::dsl::user_id.eq(user_id)),
        )
        .execute(connection)
        .map_err(web_common::api::ApiError::from)
    }
