...
pub struct CentrifugeStepForeignKeys {
...
{
    type ForeignKeys = CentrifugeStepForeignKeys;
...
impl web_common_traits::prelude::ForeignKeys for CentrifugeStepForeignKeys {}
