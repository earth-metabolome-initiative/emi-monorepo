...
impl diesel::Identifiable for DisposalStep {
...
impl DisposalStep {
    ...
    pub async fn from_id(
        ...
        Self::table()
            .filter(
                crate::codegen::diesel_codegen::tables::disposal_steps::disposal_steps::dsl::id
                    .eq(id.id),
            )
            .first::<Self>(conn)
            .await
    ...
    pub async fn from_processable_id(
        ...
        Self::table()
            .filter(
                crate::codegen::diesel_codegen::tables::disposal_steps::disposal_steps::dsl::processable_id
    ...
    pub async fn from_created_by(
        ...
        Self::table()
            .filter(
                crate::codegen::diesel_codegen::tables::disposal_steps::disposal_steps::dsl::created_by
                    .eq(created_by.id),
            )
            .load::<Self>(conn)
            .await
    ...
    pub async fn from_created_at(
        ...
        use crate::codegen::diesel_codegen::tables::disposal_steps::disposal_steps;
        Self::table()
            .filter(disposal_steps::created_at.eq(created_at))
            .order_by(disposal_steps::id.asc())
            .load::<Self>(conn)
            .await
    }
}
