...
pub struct BallMillContainerModelForeignKeys {
...
{
    type ForeignKeys = BallMillContainerModelForeignKeys;
    ...
    fn foreign_keys_loaded(&self, foreign_keys: &Self::ForeignKeys) -> bool {
        foreign_keys.milled_with.is_some() && foreign_keys.container_model.is_some()
    }
    fn update(
        &self,
...
impl web_common_traits::prelude::ForeignKeys for BallMillContainerModelForeignKeys {}
