...
pub enum InsertableCommercialBeadsModelExtensionAttributes {
    BeadsModel(
...
impl core::fmt::Display for InsertableCommercialBeadsModelExtensionAttributes {
...
impl From<crate::codegen::structs_codegen::tables::insertables::InsertableBeadsModelAttributes>
    for InsertableCommercialBeadsModelExtensionAttributes
{
    fn from(
...
#[derive(Copy, Clone, PartialEq, Eq, PartialOrd, Ord, Hash, core::fmt::Debug)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub enum InsertableCommercialBeadsModelAttributes {
    Extension(InsertableCommercialBeadsModelExtensionAttributes),
    Id,
    ParentModel,
}
impl core::str::FromStr for InsertableCommercialBeadsModelAttributes {
...
impl core::fmt::Display for InsertableCommercialBeadsModelAttributes {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
...
#[cfg_attr(
    ...
    diesel(
        table_name = crate::codegen::diesel_codegen::tables::commercial_beads_models::commercial_beads_models
    )
)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct InsertableCommercialBeadsModel {
    pub(crate) id: i32,
    pub(crate) parent_model: i32,
}
impl InsertableCommercialBeadsModel {
    ...
    pub fn commercial_beads_models_id_fkey<C: diesel::connection::LoadConnection>(
        &self,
        conn: &mut C,
    ) -> Result<
        crate::codegen::structs_codegen::tables::beads_models::BeadsModel,
    ...
    pub fn commercial_beads_models_id_fkey1<C: diesel::connection::LoadConnection>(
        &self,
        conn: &mut C,
    ) -> Result<
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct InsertableCommercialBeadsModelBuilder<
    BeadsModel
...
> {
    ...
    pub(crate) commercial_beads_models_id_fkey: BeadsModel,
    pub(crate) commercial_beads_models_id_fkey1: CommercialProduct,
}
/// Trait defining setters for attributes of an instance of
/// `CommercialBeadsModel` or descendant tables.
pub trait CommercialBeadsModelBuildable: Sized {
    /// Attributes required to build the insertable.
    type Attributes;
    /// Sets the value of the `public.commercial_beads_models.parent_model`
    /// column.
    ///
    /// # Arguments
    /// * `parent_model`: The value to set for the
    ///   `public.commercial_beads_models.parent_model` column.
    ///
...
impl<
    BeadsModel: crate::codegen::structs_codegen::tables::insertables::PhysicalAssetModelBuildable<
        ...
        >,
    CommercialProduct,
> CommercialBeadsModelBuildable
for InsertableCommercialBeadsModelBuilder<BeadsModel, CommercialProduct> {
    type Attributes = crate::codegen::structs_codegen::tables::insertables::InsertableCommercialBeadsModelAttributes;
    ///Sets the value of the `public.commercial_beads_models.parent_model` column.
    ///
    ...
    ///end
    ///subgraph v4 ["`commercial_beads_models`"]
        ...
        let parent_model = parent_model
            ...
            .map_err(|err| {
                validation_errors::SingleFieldError::from(err)
                    .rename_field(InsertableCommercialBeadsModelAttributes::ParentModel)
            })?;
        self.commercial_beads_models_id_fkey = <BeadsModel as crate::codegen::structs_codegen::tables::insertables::PhysicalAssetModelBuildable>::parent_model(
                self.commercial_beads_models_id_fkey,
                Some(parent_model),
            )
            .map_err(|err| {
    ...
    >,
{
    ...
    {
        self.commercial_beads_models_id_fkey = <BeadsModel as crate::codegen::structs_codegen::tables::insertables::AssetModelBuildable>::name(
                self.commercial_beads_models_id_fkey,
                name,
            )
            .map_err(|e| {
    ...
    {
        self.commercial_beads_models_id_fkey = <BeadsModel as crate::codegen::structs_codegen::tables::insertables::AssetModelBuildable>::description(
                self.commercial_beads_models_id_fkey,
                description,
            )
            .map_err(|e| {
    ...
    fn created_by(
        ...
        self.commercial_beads_models_id_fkey = <BeadsModel as crate::codegen::structs_codegen::tables::insertables::AssetModelBuildable>::created_by(
                self.commercial_beads_models_id_fkey,
                created_by,
            )
            .map_err(|e| {
    ...
    where
        ...
        >,
    {
        self.commercial_beads_models_id_fkey = <BeadsModel as crate::codegen::structs_codegen::tables::insertables::AssetModelBuildable>::created_at(
                self.commercial_beads_models_id_fkey,
                created_at,
            )
            .map_err(|e| {
    ...
    fn updated_by(
        ...
        self.commercial_beads_models_id_fkey = <BeadsModel as crate::codegen::structs_codegen::tables::insertables::AssetModelBuildable>::updated_by(
                self.commercial_beads_models_id_fkey,
                updated_by,
            )
            .map_err(|e| {
    ...
    where
        ...
        >,
    {
        self.commercial_beads_models_id_fkey = <BeadsModel as crate::codegen::structs_codegen::tables::insertables::AssetModelBuildable>::updated_at(
                self.commercial_beads_models_id_fkey,
                updated_at,
            )
            .map_err(|e| {
...
for InsertableCommercialBeadsModelBuilder<BeadsModel, CommercialProduct> {
    ...
    {
        self.commercial_beads_models_id_fkey = <BeadsModel as crate::codegen::structs_codegen::tables::insertables::BeadsModelBuildable>::diameter_millimeters(
                self.commercial_beads_models_id_fkey,
...
for InsertableCommercialBeadsModelBuilder<BeadsModel, CommercialProduct> {
    ...
    where
        ...
        >,
    {
        self.commercial_beads_models_id_fkey1 = <CommercialProduct as crate::codegen::structs_codegen::tables::insertables::CommercialProductBuildable>::deprecation_date(
                self.commercial_beads_models_id_fkey1,
                deprecation_date,
            )
            .map_err(|e| {
                e
    ...
    fn brand(
        ...
        self.commercial_beads_models_id_fkey1 = <CommercialProduct as crate::codegen::structs_codegen::tables::insertables::CommercialProductBuildable>::brand(
                self.commercial_beads_models_id_fkey1,
                brand_id,
            )
            .map_err(|e| {
...
for InsertableCommercialBeadsModelBuilder<BeadsModel, CommercialProduct>
where
    Self: crate::codegen::structs_codegen::tables::insertables::CommercialBeadsModelBuildable<
        Attributes = crate::codegen::structs_codegen::tables::insertables::InsertableCommercialBeadsModelAttributes,
    >,
{
    type Attributes = crate::codegen::structs_codegen::tables::insertables::InsertableCommercialBeadsModelAttributes;
    ...
    fn parent_model(
        ...
        <Self as CommercialBeadsModelBuildable>::parent_model(
            self,
            parent_model
                .ok_or(
...
impl<BeadsModel, CommercialProduct> web_common_traits::database::MostConcreteTable
    for InsertableCommercialBeadsModelBuilder<BeadsModel, CommercialProduct>
where
    ...
    CommercialProduct: web_common_traits::database::MostConcreteTable,
{
    fn set_most_concrete_table(&mut self, table_name: &str) {
        self.commercial_beads_models_id_fkey.set_most_concrete_table(table_name);
        self.commercial_beads_models_id_fkey1.set_most_concrete_table(table_name);
    }
}
impl<BeadsModel, CommercialProduct> web_common_traits::prelude::SetPrimaryKey
    for InsertableCommercialBeadsModelBuilder<BeadsModel, CommercialProduct>
where
    ...
    CommercialProduct: web_common_traits::prelude::SetPrimaryKey<PrimaryKey = i32>,
{
    ...
    fn set_primary_key(mut self, primary_key: Self::PrimaryKey) -> Self {
        self.commercial_beads_models_id_fkey =
            self.commercial_beads_models_id_fkey.set_primary_key(primary_key);
        self.commercial_beads_models_id_fkey1 =
            self.commercial_beads_models_id_fkey1.set_primary_key(primary_key);
        self
    }
}
impl<BeadsModel, CommercialProduct, C> web_common_traits::database::TryInsertGeneric<C>
for InsertableCommercialBeadsModelBuilder<BeadsModel, CommercialProduct>
where
    Self: web_common_traits::database::InsertableVariant<
        C,
        UserId = i32,
        Row = crate::codegen::structs_codegen::tables::commercial_beads_models::CommercialBeadsModel,
        Error = web_common_traits::database::InsertError<
            InsertableCommercialBeadsModelAttributes,
        >,
    >,
    ...
    >,
{
    type Attributes = InsertableCommercialBeadsModelAttributes;
    fn is_complete(&self) -> bool {
        self.commercial_beads_models_id_fkey.is_complete()
            && self.commercial_beads_models_id_fkey1.is_complete()
    ...
    > {
        ...
        let insertable: crate::codegen::structs_codegen::tables::commercial_beads_models::CommercialBeadsModel = self
            .insert(user_id, conn)?;
        Ok(insertable.id())
    }
}
