...
pub struct ParentProcedureModelForeignKeys {
    pub parent_procedure_model:
        Option<crate::codegen::structs_codegen::tables::procedure_models::ProcedureModel>,
    pub child_procedure_model:
        Option<crate::codegen::structs_codegen::tables::procedure_models::ProcedureModel>,
...
{
    type ForeignKeys = ParentProcedureModelForeignKeys;
    ...
    fn update(
        ...
        match (row, crud) {
            (
                ...
                if procedure_models.id == self.parent_procedure_model_id {
                    foreign_keys.parent_procedure_model = Some(procedure_models.clone());
                    updated = true;
                }
                if procedure_models.id == self.child_procedure_model_id {
...
impl web_common_traits::prelude::ForeignKeys for ParentProcedureModelForeignKeys {}
