...
pub enum PersonalProtectiveEquipmentModelExtensionAttribute {
    PhysicalAssetModel(
        crate::codegen::structs_codegen::tables::insertables::PhysicalAssetModelAttribute,
    ),
}
impl core::fmt::Display for PersonalProtectiveEquipmentModelExtensionAttribute {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            Self::PhysicalAssetModel(e) => {
                write!(f, "personal_protective_equipment_models({e})")
            }
        }
    }
}
impl From<crate::codegen::structs_codegen::tables::insertables::PhysicalAssetModelAttribute>
    for PersonalProtectiveEquipmentModelExtensionAttribute
{
    fn from(
...
#[derive(Copy, Clone, PartialEq, Eq, PartialOrd, Ord, Hash, core::fmt::Debug)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub enum PersonalProtectiveEquipmentModelAttribute {
    Extension(PersonalProtectiveEquipmentModelExtensionAttribute),
    Id,
}
impl core::str::FromStr for PersonalProtectiveEquipmentModelAttribute {
...
for crate::codegen::structs_codegen::tables::insertables::InsertablePersonalProtectiveEquipmentModelBuilder<
    T1,
> {
    type Attribute = PersonalProtectiveEquipmentModelAttribute;
}
impl web_common_traits::database::TableField for PersonalProtectiveEquipmentModelAttribute {}
impl web_common_traits::database::HasTableType for PersonalProtectiveEquipmentModelAttribute {
    type Table = crate::codegen::tables::table_names::TableName;
}
impl
    web_common_traits::database::FromExtension<
        crate::codegen::structs_codegen::tables::insertables::PhysicalAssetModelAttribute,
    > for PersonalProtectiveEquipmentModelAttribute
{
    fn from_extension(
        attribute: crate::codegen::structs_codegen::tables::insertables::PhysicalAssetModelAttribute,
    ) -> Self {
        PersonalProtectiveEquipmentModelAttribute::Extension(From::from(attribute))
    }
}
...
impl core::fmt::Display for PersonalProtectiveEquipmentModelAttribute {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            Self::Extension(e) => write!(f, "{e}"),
            Self::Id => write!(f, "personal_protective_equipment_models.id"),
        }
    }
}
#[derive(Debug)]
...
#[cfg_attr(
    ...
    diesel(
        table_name = crate::codegen::diesel_codegen::tables::personal_protective_equipment_models::personal_protective_equipment_models
    )
)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct InsertablePersonalProtectiveEquipmentModel {
    pub(crate) id: i32,
}
impl InsertablePersonalProtectiveEquipmentModel {}
#[derive(Clone, Debug, PartialEq, PartialOrd, Eq, Hash, Ord, Default)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
/// Builder for creating and inserting a new
/// [`PersonalProtectiveEquipmentModel`](crate::codegen::structs_codegen::tables::personal_protective_equipment_models::PersonalProtectiveEquipmentModel).
///
///
...
///
/// ```rust,ignore
/// use core_structures::PersonalProtectiveEquipmentModel;
...
///
/// let personal_protective_equipment_model = PersonalProtectiveEquipmentModel::new()
...
///    .insert(user.id, conn)?;
/// ```
pub struct InsertablePersonalProtectiveEquipmentModelBuilder<
    PhysicalAssetModel
...
impl<PhysicalAssetModel> diesel::associations::HasTable
    for InsertablePersonalProtectiveEquipmentModelBuilder<PhysicalAssetModel>
{
    type Table = crate::codegen::diesel_codegen::tables::personal_protective_equipment_models::personal_protective_equipment_models::table;
    fn table() -> Self::Table {
        crate::codegen::diesel_codegen::tables::personal_protective_equipment_models::personal_protective_equipment_models::table
    }
}
impl From<InsertablePersonalProtectiveEquipmentModelBuilder>
    for web_common_traits::database::IdOrBuilder<
        i32,
        InsertablePersonalProtectiveEquipmentModelBuilder,
    >
{
    fn from(builder: InsertablePersonalProtectiveEquipmentModelBuilder) -> Self {
...
/// `PersonalProtectiveEquipmentModel` or descendant tables.
pub trait PersonalProtectiveEquipmentModelSettable: Sized {
    /// Error type returned when setting attributes.
    type Error;
}
impl<PhysicalAssetModel> PersonalProtectiveEquipmentModelSettable
for InsertablePersonalProtectiveEquipmentModelBuilder<PhysicalAssetModel>
where
    Self: common_traits::builder::Attributed<
        Attribute = crate::codegen::structs_codegen::tables::insertables::PersonalProtectiveEquipmentModelAttribute,
    >,
{
...
where
    Self: web_common_traits::database::DispatchableInsertableVariant<
            ...
            Error = web_common_traits::database::InsertError<
                PersonalProtectiveEquipmentModelAttribute,
            >,
