...
pub enum WeighingDeviceModelExtensionAttribute {
    PhysicalAssetModel(
        crate::codegen::structs_codegen::tables::insertables::PhysicalAssetModelAttribute,
    ),
}
impl core::fmt::Display for WeighingDeviceModelExtensionAttribute {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            Self::PhysicalAssetModel(e) => write!(f, "weighing_device_models({e})"),
        }
    }
}
impl From<crate::codegen::structs_codegen::tables::insertables::PhysicalAssetModelAttribute>
    for WeighingDeviceModelExtensionAttribute
{
    fn from(
...
impl From<common_traits::builder::EmptyTuple> for WeighingDeviceModelExtensionAttribute {
...
#[derive(Copy, Clone, PartialEq, Eq, PartialOrd, Ord, Hash, core::fmt::Debug)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub enum WeighingDeviceModelAttribute {
    Extension(WeighingDeviceModelExtensionAttribute),
    Id,
}
impl core::str::FromStr for WeighingDeviceModelAttribute {
...
impl<T1> common_traits::builder::Attributed
    ...
    >
{
    type Attribute = WeighingDeviceModelAttribute;
}
impl web_common_traits::database::TableField for WeighingDeviceModelAttribute {}
impl web_common_traits::database::HasTableType for WeighingDeviceModelAttribute {
    type Table = crate::codegen::tables::table_names::TableName;
}
impl
    web_common_traits::database::FromExtension<
        crate::codegen::structs_codegen::tables::insertables::PhysicalAssetModelAttribute,
    > for WeighingDeviceModelAttribute
{
    fn from_extension(
        attribute: crate::codegen::structs_codegen::tables::insertables::PhysicalAssetModelAttribute,
    ) -> Self {
        WeighingDeviceModelAttribute::Extension(From::from(attribute))
    }
}
...
impl core::fmt::Display for WeighingDeviceModelAttribute {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            Self::Extension(e) => write!(f, "{e}"),
            Self::Id => write!(f, "weighing_device_models.id"),
        }
    }
}
#[derive(Debug)]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct InsertableWeighingDeviceModel {
    pub(crate) id: i32,
}
impl InsertableWeighingDeviceModel {}
#[derive(Clone, Debug, PartialEq, PartialOrd, Eq, Hash, Ord, Default)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
/// Builder for creating and inserting a new
/// [`WeighingDeviceModel`](crate::codegen::structs_codegen::tables::weighing_device_models::WeighingDeviceModel).
///
///
...
///
/// ```rust,ignore
/// use core_structures::WeighingDeviceModel;
...
///
/// let weighing_device_model = WeighingDeviceModel::new()
...
///    .insert(user.id, conn)?;
/// ```
pub struct InsertableWeighingDeviceModelBuilder<
    PhysicalAssetModel
...
{
    type Table = crate::codegen::diesel_codegen::tables::weighing_device_models::weighing_device_models::table;
    fn table() -> Self::Table {
        crate::codegen::diesel_codegen::tables::weighing_device_models::weighing_device_models::table
    }
}
impl From<InsertableWeighingDeviceModelBuilder>
    for web_common_traits::database::IdOrBuilder<i32, InsertableWeighingDeviceModelBuilder>
{
    fn from(builder: InsertableWeighingDeviceModelBuilder) -> Self {
...
/// `WeighingDeviceModel` or descendant tables.
pub trait WeighingDeviceModelSettable: Sized {
    /// Error type returned when setting attributes.
    type Error;
}
impl<PhysicalAssetModel> WeighingDeviceModelSettable
for InsertableWeighingDeviceModelBuilder<PhysicalAssetModel>
where
...
where
    Self: web_common_traits::database::DispatchableInsertableVariant<
            ...
            Error = web_common_traits::database::InsertError<
                WeighingDeviceModelAttribute,
            >,
        > + web_common_traits::database::SetPrimaryKey<PrimaryKey = i32>
        + common_traits::builder::IsCompleteBuilder,
{
    type Error = web_common_traits::database::InsertError<WeighingDeviceModelAttribute>;
    fn mint_primary_key(
        self,
        user_id: i32,
        conn: &mut C,
