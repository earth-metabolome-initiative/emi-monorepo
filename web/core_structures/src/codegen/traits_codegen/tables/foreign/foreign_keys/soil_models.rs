...
pub struct SoilModelForeignKeys {
    pub id:
        Option<crate::codegen::structs_codegen::tables::sample_source_models::SampleSourceModel>,
}
impl web_common_traits::prelude::HasForeignKeys
    for crate::codegen::structs_codegen::tables::soil_models::SoilModel
{
    type ForeignKeys = SoilModelForeignKeys;
...
impl web_common_traits::prelude::ForeignKeys for SoilModelForeignKeys {}
