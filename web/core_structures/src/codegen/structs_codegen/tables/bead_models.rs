...
impl web_common_traits::prelude::ExtensionTable<crate::PhysicalAssetModel> for BeadModel where
    for<'a> &'a Self: diesel::Identifiable<Id = &'a i32>
{
}
impl web_common_traits::prelude::ExtensionTable<crate::BeadModel> for BeadModel where
    for<'a> &'a Self: diesel::Identifiable<Id = &'a i32>
{
}
...
impl BeadModel {
    ...
    where
        ...
        <Self as diesel::associations::HasTable>::Table: diesel::query_dsl::methods::FilterDsl<
            <crate::codegen::diesel_codegen::tables::bead_models::bead_models::id as diesel::expression_methods::EqAll<
                i32,
            >>::Output,
        >,
        ...
        >>::Output: diesel::query_dsl::methods::OrderDsl<
            diesel::helper_types::Asc<
                crate::codegen::diesel_codegen::tables::bead_models::bead_models::id,
            >,
        >,
        <<<Self as diesel::associations::HasTable>::Table as diesel::query_dsl::methods::FilterDsl<
            <crate::codegen::diesel_codegen::tables::bead_models::bead_models::id as diesel::expression_methods::EqAll<
