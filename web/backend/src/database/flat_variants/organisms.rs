...
impl From<web_common::database::flat_variants::Organism>
    for crate::database::flat_variants::Organism
{
    fn from(item: web_common::database::flat_variants::Organism) -> Self {
        Self {
            id: item.id,
...
impl From<crate::database::flat_variants::Organism>
    for web_common::database::flat_variants::Organism
{
    fn from(item: crate::database::flat_variants::Organism) -> Self {
        Self {
            id: item.id,
            host_organism_id: item.host_organism_id,
            sample_id: item.sample_id,
...
impl Organism {
    ...
    pub fn can_view_by_id(
        ...
        diesel::select(crate::database::sql_function_bindings::can_view_organisms(
            author_user_id,
            id,
        ))
    ...
    pub fn all_viewable(
        ...
        let query = organisms::dsl::organisms
            ...
            .filter(crate::database::sql_function_bindings::can_view_organisms(
                author_user_id,
                organisms::dsl::id,
            ))
   ...
   sample_states::dsl::sample_states.on(
       samples2.field(samples::dsl::state_id).eq(
           sample_states::dsl::id
            ...
            .select(Organism::as_select())
            .filter(crate::database::sql_function_bindings::can_view_organisms(author_user_id, organisms::dsl::id))
            .filter(
...
crate::database::sql_function_bindings::concat_sample_states_name_description(sample_states::dsl::name, sample_states::dsl::description).strict_word_similarity_commutator_op(query).or(
    crate::database::sql_function_bindings::concat_sample_states_name_description(sample_states::dsl::name, sample_states::dsl::description).ilike(format!("%{}%", query))
            ...
            .order(crate::database::sql_function_bindings::strict_word_similarity_dist_op(nameplates::dsl::barcode, query)    +
...
.map_err(web_common::api::ApiError::from)
    ...
    pub fn can_update_by_id(
        ...
        diesel::select(
            crate::database::sql_function_bindings::can_update_organisms(author_user_id, id),
        )
        .get_result(connection)
        .map_err(web_common::api::ApiError::from)
    }
    ...
    pub fn all_updatable(
        ...
        let query = organisms::dsl::organisms
            .select(Organism::as_select())
            .filter(
                crate::database::sql_function_bindings::can_update_organisms(
                    author_user_id,
                    organisms::dsl::id,
                ),
            )
   ...
   sample_states::dsl::sample_states.on(
       samples2.field(samples::dsl::state_id).eq(
           sample_states::dsl::id
            ...
            .select(Organism::as_select())
            .filter(crate::database::sql_function_bindings::can_update_organisms(author_user_id, organisms::dsl::id))
            .filter(
nameplates::dsl::barcode.strict_word_similarity_commutator_op(query).or(
    nameplates::dsl::barcode.ilike(format!("%{}%", query))
)
...
crate::database::sql_function_bindings::strict_word_similarity_dist_op(crate::database::sql_function_bindings::concat_sample_states_name_description(sample_states::dsl::name, sample_states::dsl::description), query))
    ...
    pub fn can_admin_by_id(
        ...
        diesel::select(crate::database::sql_function_bindings::can_admin_organisms(
            author_user_id,
            id,
        ))
        .get_result(connection)
    ...
    pub fn all_administrable(
        ...
        let query = organisms::dsl::organisms
            .select(Organism::as_select())
            .filter(crate::database::sql_function_bindings::can_admin_organisms(
                author_user_id,
                organisms::dsl::id,
            ))
            .order_by(organisms::dsl::id);
   ...
   sample_states::dsl::sample_states.on(
       samples2.field(samples::dsl::state_id).eq(
           sample_states::dsl::id
            ...
            .select(Organism::as_select())
            .filter(crate::database::sql_function_bindings::can_admin_organisms(author_user_id, organisms::dsl::id))
            .filter(
nameplates::dsl::barcode.strict_word_similarity_commutator_op(query).or(
    nameplates::dsl::barcode.ilike(format!("%{}%", query))
)
...
crate::database::sql_function_bindings::strict_word_similarity_dist_op(crate::database::sql_function_bindings::concat_sample_states_name_description(sample_states::dsl::name, sample_states::dsl::description), query))
    ...
    pub fn delete_by_id(
        ...
        diesel::delete(
            crate::database::organisms::dsl::organisms
                .filter(crate::database::organisms::dsl::id.eq(id)),
        )
        .execute(connection)
        .map_err(web_common::api::ApiError::from)
    }
