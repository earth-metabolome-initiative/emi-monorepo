CREATE TABLE IF NOT EXISTS taxa (
    ...
    -- This must NOT be unique because there are some taxa
    ...
    FOREIGN KEY (ott_rank_id) REFERENCES ranks(id) ON DELETE CASCADE,
    FOREIGN KEY (domain_id) REFERENCES taxa(id) ON DELETE CASCADE,
    FOREIGN KEY (kingdom_id) REFERENCES taxa(id) ON DELETE CASCADE,
    FOREIGN KEY (phylum_id) REFERENCES taxa(id) ON DELETE CASCADE,
    FOREIGN KEY (class_id) REFERENCES taxa(id) ON DELETE CASCADE,
    FOREIGN KEY (order_id) REFERENCES taxa(id) ON DELETE CASCADE,
    FOREIGN KEY (family_id) REFERENCES taxa(id) ON DELETE CASCADE,
    FOREIGN KEY (genus_id) REFERENCES taxa(id) ON DELETE CASCADE,
