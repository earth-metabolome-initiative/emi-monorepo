...
impl Filtrable for crate::database::flat_variants::ProjectsUsersRoleInvitation {
    type Filter = crate::database::filter_variants::ProjectsUsersRoleInvitationFilter;
}
#[cfg(feature = "frontend")]
impl AllRecords for ProjectsUsersRoleInvitation {
...
impl ProjectsUsersRoleInvitation {
    ...
    async fn insert<C: gluesql::core::store::GStore + gluesql::core::store::GStoreMut>(
        ...
        Ok(table("projects_users_role_invitations")
            .insert()
