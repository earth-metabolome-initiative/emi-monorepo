...
impl From<common_traits::builder::EmptyTuple> for SoilModelExtensionAttribute {
...
#[derive(Copy, Clone, PartialEq, Eq, PartialOrd, Ord, Hash, core::fmt::Debug)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub enum SoilModelAttribute {
    Extension(SoilModelExtensionAttribute),
    Id,
}
impl core::str::FromStr for SoilModelAttribute {
...
impl<T1> common_traits::builder::Attributed
    for crate::codegen::structs_codegen::tables::insertables::InsertableSoilModelBuilder<T1>
{
    type Attribute = SoilModelAttribute;
}
impl web_common_traits::database::TableField for SoilModelAttribute {}
impl web_common_traits::database::HasTableType for SoilModelAttribute {
    type Table = crate::codegen::tables::table_names::TableName;
}
impl
    web_common_traits::database::FromExtension<
        crate::codegen::structs_codegen::tables::insertables::SampleSourceModelAttribute,
    > for SoilModelAttribute
{
    fn from_extension(
        attribute: crate::codegen::structs_codegen::tables::insertables::SampleSourceModelAttribute,
    ) -> Self {
        SoilModelAttribute::Extension(From::from(attribute))
    }
}
...
impl core::fmt::Display for SoilModelAttribute {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            Self::Extension(e) => write!(f, "{e}"),
            Self::Id => write!(f, "soil_models.id"),
        }
    }
}
#[derive(Debug)]
...
#[cfg_attr(
    ...
    diesel(table_name = crate::codegen::diesel_codegen::tables::soil_models::soil_models)
)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct InsertableSoilModel {
    pub(crate) id: i32,
}
impl InsertableSoilModel {}
...
///    .insert(user.id, conn)?;
/// ```
pub struct InsertableSoilModelBuilder<
    SampleSourceModel
...
impl<SampleSourceModel> diesel::associations::HasTable
    for InsertableSoilModelBuilder<SampleSourceModel>
{
    type Table = crate::codegen::diesel_codegen::tables::soil_models::soil_models::table;
    fn table() -> Self::Table {
        crate::codegen::diesel_codegen::tables::soil_models::soil_models::table
    }
}
impl From<InsertableSoilModelBuilder>
    for web_common_traits::database::IdOrBuilder<i32, InsertableSoilModelBuilder>
{
    fn from(builder: InsertableSoilModelBuilder) -> Self {
...
/// Trait defining setters for attributes of an instance of `SoilModel` or
/// descendant tables.
pub trait SoilModelSettable: Sized {
    /// Error type returned when setting attributes.
    type Error;
}
impl<SampleSourceModel> SoilModelSettable for InsertableSoilModelBuilder<SampleSourceModel>
where
    Self: common_traits::builder::Attributed<
            Attribute = crate::codegen::structs_codegen::tables::insertables::SoilModelAttribute,
        >,
{
...
where
    Self: web_common_traits::database::DispatchableInsertableVariant<
            ...
            Error = web_common_traits::database::InsertError<SoilModelAttribute>,
        > + web_common_traits::database::SetPrimaryKey<PrimaryKey = i32>
        + common_traits::builder::IsCompleteBuilder,
{
    type Error = web_common_traits::database::InsertError<SoilModelAttribute>;
