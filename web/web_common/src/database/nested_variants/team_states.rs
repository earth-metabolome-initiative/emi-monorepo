...
impl crate::database::Tabular for NestedTeamState {
    const TABLE: crate::database::Table = crate::database::Table::TeamStates;
}
impl crate::database::Filtrable for NestedTeamState {
    type Filter = crate::database::filter_variants::TeamStateFilter;
}
impl crate::database::Describable for NestedTeamState {
    fn description(&self) -> Option<&str> {
        self.inner.description()
    }
}
impl crate::database::Colorable for NestedTeamState {
    fn color(&self) -> Option<&str> {
        Some(self.color.name.as_str())
    }
}
#[cfg(feature = "frontend")]
impl crate::database::AllRecords for NestedTeamState {
...
impl NestedTeamState {
    ...
    pub(crate) async fn from_flat(
        flat_variant: crate::database::flat_variants::TeamState,
    ...
    pub async fn get<C: gluesql::core::store::GStore + gluesql::core::store::GStoreMut>(
        ...
        if let Some(flat_variant) =
            crate::database::flat_variants::TeamState::get(id, connection).await?
        {
    ...
    >(
        ...
        crate::database::flat_variants::TeamState::delete_from_id(id, connection).await
    }
    ...
    pub async fn all<C: gluesql::core::store::GStore + gluesql::core::store::GStoreMut>(
        ...
        let mut team_states = Vec::new();
        for flat_variant in
            crate::database::flat_variants::TeamState::all(filter, limit, offset, connection)
                .await?
                .into_iter()
        {
            team_states.push(Self::from_flat(flat_variant, connection).await?);
        }
        Ok(team_states)
    }
    ...
    >(
        ...
        crate::database::flat_variants::Color::update_or_insert(self.color.as_ref(), connection)
            .await?;
        crate::database::flat_variants::TeamState::update_or_insert(self.inner.as_ref(), connection)
            .await
    }
}
