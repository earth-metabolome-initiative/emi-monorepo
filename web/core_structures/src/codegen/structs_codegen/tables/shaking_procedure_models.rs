...
pub struct ShakingProcedureModel {
    pub id: i32,
    pub seconds: f32,
}
impl web_common_traits::prelude::TableName for ShakingProcedureModel {
    const TABLE_NAME: &'static str = "shaking_procedure_models";
}
impl
    web_common_traits::prelude::ExtensionTable<
        crate::codegen::structs_codegen::tables::procedure_models::ProcedureModel,
    > for ShakingProcedureModel
where
    for<'a> &'a Self: diesel::Identifiable<Id = &'a i32>,
{
}
impl diesel::Identifiable for ShakingProcedureModel {
    type Id = i32;
    fn id(self) -> Self::Id {
        self.id
    }
}
impl ShakingProcedureModel {
    ...
    pub fn from_name(
        ...
        Self::table()
            ...
            .order_by(shaking_procedure_models::id.asc())
...
impl AsRef<ShakingProcedureModel> for ShakingProcedureModel {
    fn as_ref(&self) -> &ShakingProcedureModel {
        self
    }
}
