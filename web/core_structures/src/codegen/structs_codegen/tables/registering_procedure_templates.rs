...
pub struct RegisteringProcedureTemplate {
    pub procedure_template: i32,
    pub registered_asset_model: i32,
    pub procedure_template_registered_asset_model: i32,
}
impl web_common_traits::prelude::TableName for RegisteringProcedureTemplate {
    const TABLE_NAME: &'static str = "registering_procedure_templates";
}
impl
    web_common_traits::prelude::ExtensionTable<
        crate::codegen::structs_codegen::tables::procedure_templates::ProcedureTemplate,
    > for RegisteringProcedureTemplate
where
...
where
    for<'a> &'a Self: diesel::Identifiable<Id = &'a i32>,
{}
impl diesel::Identifiable for RegisteringProcedureTemplate {
    type Id = i32;
    fn id(self) -> Self::Id {
        self.procedure_template
    }
}
impl RegisteringProcedureTemplate {
    ...
    pub fn from_registered_asset_model(
        ...
        Self::table()
            .filter(
                registering_procedure_templates::registered_asset_model.eq(registered_asset_model),
            )
            .order_by(registering_procedure_templates::procedure_template.asc())
            .load::<Self>(conn)
    }
    #[cfg(feature = "postgres")]
    pub fn from_procedure_template_registered_asset_model(
        procedure_template_registered_asset_model: &i32,
        conn: &mut diesel::PgConnection,
    ) -> Result<Vec<Self>, diesel::result::Error> {
        use diesel::{ExpressionMethods, QueryDsl, RunQueryDsl, associations::HasTable};
        ...
        Self::table()
            .filter(
                registering_procedure_templates::procedure_template_registered_asset_model
                    .eq(procedure_template_registered_asset_model),
            )
            .order_by(registering_procedure_templates::procedure_template.asc())
            .load::<Self>(conn)
    }
    #[cfg(feature = "postgres")]
    pub fn from_procedure_template_registered_asset_model_and_procedure_template(
        procedure_template_registered_asset_model: &i32,
        ...
        Self::table()
            .filter(
                registering_procedure_templates::procedure_template_registered_asset_model
                    .eq(procedure_template_registered_asset_model)
                    .and(
                        registering_procedure_templates::procedure_template.eq(procedure_template),
                    ),
            )
            .order_by(registering_procedure_templates::procedure_template.asc())
            .load::<Self>(conn)
    ...
    #[cfg(feature = "postgres")]
    pub fn from_procedure_template_registered_asset_model_and_registered_asset_model(
        procedure_template_registered_asset_model: &i32,
        registered_asset_model: &i32,
        conn: &mut diesel::PgConnection,
    ) -> Result<Vec<Self>, diesel::result::Error> {
        ...
        Self::table()
            .filter(
                registering_procedure_templates::procedure_template_registered_asset_model
                    .eq(procedure_template_registered_asset_model)
                    .and(
                        registering_procedure_templates::registered_asset_model
                            .eq(registered_asset_model),
                    ),
            )
            .order_by(registering_procedure_templates::procedure_template.asc())
            .load::<Self>(conn)
    ...
    pub fn from_name(
        ...
        use crate::codegen::diesel_codegen::tables::{
            ...
            registering_procedure_templates::registering_procedure_templates,
        };
        Self::table()
            .inner_join(
                procedure_templates::table.on(registering_procedure_templates::procedure_template
...
impl AsRef<RegisteringProcedureTemplate> for RegisteringProcedureTemplate {
    fn as_ref(&self) -> &RegisteringProcedureTemplate {
        self
    }
}
