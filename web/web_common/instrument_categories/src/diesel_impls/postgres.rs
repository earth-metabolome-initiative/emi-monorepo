...
impl diesel::deserialize::FromSql<crate::diesel_impls::InstrumentCategory, diesel::pg::Pg>
...
impl diesel::serialize::ToSql<crate::diesel_impls::InstrumentCategory, diesel::pg::Pg>
    for crate::InstrumentCategory
{
    fn to_sql<'b>(
        &'b self,
