...
impl core::fmt::Display for CommercialPipetteLotExtensionAttribute {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            Self::CommercialProductLot(e) => write!(f, "commercial_pipette_lots({e})"),
            Self::PipetteModel(e) => write!(f, "commercial_pipette_lots({e})"),
        }
    }
}
...
impl From<common_traits::builder::EmptyTuple> for CommercialPipetteLotExtensionAttribute {
...
impl<T1, T2> common_traits::builder::Attributed
    ...
    >
{
    type Attribute = CommercialPipetteLotAttribute;
}
impl web_common_traits::database::TableField for CommercialPipetteLotAttribute {}
impl web_common_traits::database::HasTableType for CommercialPipetteLotAttribute {
    type Table = crate::codegen::tables::table_names::TableName;
}
impl
    web_common_traits::database::FromExtension<
        crate::codegen::structs_codegen::tables::insertables::CommercialProductLotAttribute,
    > for CommercialPipetteLotAttribute
{
    fn from_extension(
        attribute: crate::codegen::structs_codegen::tables::insertables::CommercialProductLotAttribute,
    ) -> Self {
        CommercialPipetteLotAttribute::Extension(From::from(attribute))
    }
}
impl
    web_common_traits::database::FromExtension<
...
impl core::fmt::Display for CommercialPipetteLotAttribute {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            ...
            Self::Id => write!(f, "commercial_pipette_lots.id"),
            Self::ProductModel => write!(f, "commercial_pipette_lots.product_model"),
        }
    }
}
#[derive(Debug)]
...
/// [`CommercialPipetteLot`](crate::codegen::structs_codegen::tables::commercial_pipette_lots::CommercialPipetteLot).
///
///
...
///
/// ```rust,ignore
/// use core_structures::CommercialPipetteLot;
/// use core_structures::tables::insertables::AssetModelSettable;
/// use core_structures::tables::insertables::CommercialPipetteLotSettable;
/// use core_structures::tables::insertables::CommercialProductLotSettable;
/// use web_common_traits::database::Insertable;
/// use web_common_traits::database::InsertableVariant;
///
/// let commercial_pipette_lot = CommercialPipetteLot::new()
...
impl<CommercialProductLot, PipetteModel> diesel::associations::HasTable
    for InsertableCommercialPipetteLotBuilder<CommercialProductLot, PipetteModel>
{
    type Table = crate::codegen::diesel_codegen::tables::commercial_pipette_lots::commercial_pipette_lots::table;
    fn table() -> Self::Table {
        crate::codegen::diesel_codegen::tables::commercial_pipette_lots::commercial_pipette_lots::table
    }
}
...
pub trait CommercialPipetteLotSettable: Sized {
...
where
    Self: common_traits::builder::Attributed<
        Attribute = crate::codegen::structs_codegen::tables::insertables::CommercialPipetteLotAttribute,
    >,
{
        ...
        PM: web_common_traits::database::PrimaryKeyLike<PrimaryKey = i32>,
    {
        ...
        self.commercial_pipette_lots_id_fkey = <CommercialProductLot as crate::codegen::structs_codegen::tables::insertables::CommercialProductLotSettable>::product_model(
        ...
        self.commercial_pipette_lots_id_fkey = <CommercialProductLot as crate::codegen::structs_codegen::tables::insertables::PhysicalAssetModelSettable>::parent_model(
                self.commercial_pipette_lots_id_fkey,
                product_model,
            )
            .map_err(|err| {
    ...
    >,
{
    ...
    {
        self.commercial_pipette_lots_id_fkey = <CommercialProductLot as crate::codegen::structs_codegen::tables::insertables::AssetModelSettable>::name(
                self.commercial_pipette_lots_id_fkey,
                name,
            )
            .map_err(|e| {
    ...
    {
        self.commercial_pipette_lots_id_fkey = <CommercialProductLot as crate::codegen::structs_codegen::tables::insertables::AssetModelSettable>::description(
                self.commercial_pipette_lots_id_fkey,
                description,
            )
            .map_err(|e| {
    ...
    {
        self.commercial_pipette_lots_id_fkey = <CommercialProductLot as crate::codegen::structs_codegen::tables::insertables::AssetModelSettable>::created_by(
                self.commercial_pipette_lots_id_fkey,
                created_by,
            )
            .map_err(|e| {
    ...
    where
        ...
        >,
    {
        self.commercial_pipette_lots_id_fkey = <CommercialProductLot as crate::codegen::structs_codegen::tables::insertables::AssetModelSettable>::created_at(
                self.commercial_pipette_lots_id_fkey,
                created_at,
            )
            .map_err(|e| {
    ...
    {
        self.commercial_pipette_lots_id_fkey = <CommercialProductLot as crate::codegen::structs_codegen::tables::insertables::AssetModelSettable>::updated_by(
                self.commercial_pipette_lots_id_fkey,
                updated_by,
            )
            .map_err(|e| {
    ...
    where
        ...
        >,
    {
        self.commercial_pipette_lots_id_fkey = <CommercialProductLot as crate::codegen::structs_codegen::tables::insertables::AssetModelSettable>::updated_at(
                self.commercial_pipette_lots_id_fkey,
                updated_at,
            )
            .map_err(|e| {
    ...
    >,
{
    ...
    {
        self.commercial_pipette_lots_id_fkey = <CommercialProductLot as crate::codegen::structs_codegen::tables::insertables::CommercialProductLotSettable>::lot(
                self.commercial_pipette_lots_id_fkey,
                lot,
            )
            .map_err(|e| {
    ...
    where
        PM: web_common_traits::database::PrimaryKeyLike<PrimaryKey = i32>,
    {
        <Self as CommercialPipetteLotSettable>::product_model(self, product_model)
    }
}
impl<
    CommercialProductLot,
    ...
    >,
{
    ...
    where
        PM: web_common_traits::database::MaybePrimaryKeyLike<PrimaryKey = i32>,
    {
        <Self as CommercialPipetteLotSettable>::product_model(
            self,
...
where
    Self: web_common_traits::database::DispatchableInsertableVariant<
            ...
            Error = web_common_traits::database::InsertError<
                CommercialPipetteLotAttribute,
            >,
        > + web_common_traits::database::SetPrimaryKey<PrimaryKey = i32>
        + common_traits::builder::IsCompleteBuilder,
{
    type Error = web_common_traits::database::InsertError<CommercialPipetteLotAttribute>;
    fn mint_primary_key(
        self,
        user_id: i32,
        conn: &mut C,
