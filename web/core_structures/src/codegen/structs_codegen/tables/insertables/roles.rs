...
impl web_common_traits::database::TableField for RoleAttribute {}
impl web_common_traits::database::HasTableType for RoleAttribute {
    type Table = crate::codegen::tables::table_names::TableName;
}
impl core::fmt::Display for RoleAttribute {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            Self::Name => write!(f, "roles.name"),
            Self::Description => write!(f, "roles.description"),
            Self::Icon => write!(f, "roles.icon"),
            Self::ColorId => write!(f, "roles.color_id"),
            Self::Id => write!(f, "roles.id"),
        }
    }
}
#[derive(Debug)]
...
///
/// ```rust,ignore
/// use core_structures::Role;
/// use core_structures::tables::insertables::RoleSettable;
...
impl diesel::associations::HasTable for InsertableRoleBuilder {
    type Table = crate::codegen::diesel_codegen::tables::roles::roles::table;
    fn table() -> Self::Table {
        crate::codegen::diesel_codegen::tables::roles::roles::table
    }
}
...
/// tables.
pub trait RoleSettable: Sized {
    /// Error type returned when setting attributes.
    type Error;
    /// Sets the value of the `public.roles.name` column.
    ///
    /// # Arguments
    /// * `name`: The value to set for the `public.roles.name` column.
    ///
    /// # Implementation details
    ...
    ///
    /// # Arguments
    /// * `description`: The value to set for the `public.roles.description`
    ///   column.
    ///
    /// # Implementation details
    /// This method accepts a reference to a generic value which can be
    ...
    ///
    /// # Arguments
    /// * `icon`: The value to set for the `public.roles.icon` column.
    ///
    /// # Implementation details
    /// This method accepts a reference to a generic value which can be
    /// converted to the required type for the column. This allows passing
    ...
    ///
    /// # Arguments
    /// * `color_id`: The value to set for the `public.roles.color_id` column.
    ///
    /// # Implementation details
    /// This method accepts a reference to a generic value which can be
    /// converted to the required type for the column. This allows passing
...
where
    Self: common_traits::builder::Attributed<
            Attribute = crate::codegen::structs_codegen::tables::insertables::RoleAttribute,
        >,
{
...
{
    type Error = web_common_traits::database::InsertError<RoleAttribute>;
