impl From<crate::codegen::structs_codegen::tables::grinding_step_models::GrindingStepModel>
    for super::Rows
{
    fn from(
        value: crate::codegen::structs_codegen::tables::grinding_step_models::GrindingStepModel,
    ) -> Self {
...
impl
    From<
        std::rc::Rc<
            Vec<crate::codegen::structs_codegen::tables::grinding_step_models::GrindingStepModel>,
        >,
    > for super::Rows
{
    fn from(
...
> for super::Rows {
    fn from(
        ...
        super::Rows::GrindingStepModel(value)
    }
}
    ...
    >
{
    ...
    fn try_from(value: super::Rows) -> Result<Self, Self::Error> {
        match value {
            super::Rows::GrindingStepModel(v) => Ok(v),
