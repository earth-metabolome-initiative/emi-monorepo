...
impl PackagingModel {
    ...
    pub async fn from_created_by(
        ...
        Self::table()
            .filter(
                crate::codegen::diesel_codegen::tables::packaging_models::packaging_models::dsl::created_by
                    .eq(created_by.id),
            )
            .load::<Self>(conn)
            .await
    ...
    pub async fn from_updated_by(
        ...
        Self::table()
            .filter(
                crate::codegen::diesel_codegen::tables::packaging_models::packaging_models::dsl::updated_by
                    .eq(updated_by.id),
            )
            .load::<Self>(conn)
            .await
    ...
    pub async fn from_created_at(
        ...
        Self::table()
            .filter(packaging_models::created_at.eq(created_at))
    ...
    pub async fn from_updated_at(
        ...
        use crate::codegen::diesel_codegen::tables::packaging_models::packaging_models;
        Self::table()
            .filter(packaging_models::updated_at.eq(updated_at))
            .order_by(packaging_models::id.asc())
            .load::<Self>(conn)
            .await
    }
