...
impl core::fmt::Display for CappingProcedureExtensionAttribute {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            Self::Procedure(e) => write!(f, "capping_procedures({e})"),
        }
    }
}
...
impl From<common_traits::builder::EmptyTuple> for CappingProcedureExtensionAttribute {
...
impl<T1> common_traits::builder::Attributed
    for crate::codegen::structs_codegen::tables::insertables::InsertableCappingProcedureBuilder<T1>
{
    type Attribute = CappingProcedureAttribute;
}
impl web_common_traits::database::TableField for CappingProcedureAttribute {}
impl web_common_traits::database::HasTableType for CappingProcedureAttribute {
    ...
    > for CappingProcedureAttribute
{
    fn from_extension(
        ...
        CappingProcedureAttribute::Extension(From::from(attribute))
    }
}
...
///
/// ```rust,ignore
/// use core_structures::CappingProcedure;
/// use core_structures::tables::insertables::CappingProcedureSettable;
/// use core_structures::tables::insertables::ProcedureSettable;
/// use web_common_traits::database::Insertable;
/// use web_common_traits::database::InsertableVariant;
///
/// let capping_procedure = CappingProcedure::new()
...
impl<Procedure> diesel::associations::HasTable for InsertableCappingProcedureBuilder<Procedure> {
    type Table =
        crate::codegen::diesel_codegen::tables::capping_procedures::capping_procedures::table;
    fn table() -> Self::Table {
        crate::codegen::diesel_codegen::tables::capping_procedures::capping_procedures::table
    }
}
...
pub trait CappingProcedureSettable: Sized {
    ...
    ///   `::rosetta_uuid::Uuid`.
    /// * If the provided value does not pass schema-defined validation.
    fn capped_container<CC>(self, capped_container: CC) -> Result<Self, Self::Error>
    where
...
where
    Self: common_traits::builder::Attributed<
        Attribute = crate::codegen::structs_codegen::tables::insertables::CappingProcedureAttribute,
    >,
{
    ...
    ///```
    fn capped_container<CC>(mut self, capped_container: CC) -> Result<Self, Self::Error>
    where
        CC: web_common_traits::database::PrimaryKeyLike<
            PrimaryKey = ::rosetta_uuid::Uuid,
        >,
    {
        let capped_container = <CC as web_common_traits::database::PrimaryKeyLike>::primary_key(
            &capped_container,
        );
            ...
            self.procedure_capped_container = <crate::codegen::structs_codegen::tables::insertables::InsertableProcedureAssetBuilder as crate::codegen::structs_codegen::tables::insertables::ProcedureAssetSettable>::asset(
                ...
                .map_err(|e| {
                    e.replace_field_name(|attribute| {
                        <Self as common_traits::builder::Attributed>::Attribute::ProcedureCappedContainer(
                            attribute,
                        )
                    })
                })?
    ...
    ///Sets the value of the `public.capping_procedures.capped_container_model` column.
    ///
    ///# Implementation notes
    ///This method also set the values of other columns, due to
    ///same-as relationships or inferred values.
    ...
    ///Sets the value of the `public.capping_procedures.procedure_template_capped_container_model` column.
    ///
    ///# Implementation notes
    ///This method also set the values of other columns, due to
    ///same-as relationships or inferred values.
    ...
    where
        PTCCM: web_common_traits::database::PrimaryKeyLike<PrimaryKey = i32>,
    {
        let procedure_template_capped_container_model = <PTCCM as web_common_traits::database::PrimaryKeyLike>::primary_key(
            &procedure_template_capped_container_model,
        );
        if let web_common_traits::database::IdOrBuilder::Builder(
            procedure_capped_container,
    ...
    ///Sets the value of the `public.capping_procedures.procedure_capped_container` column.
    ///
    ///# Implementation notes
    ///This method also set the values of other columns, due to
    ///same-as relationships or inferred values.
                    ...
                    return Err(
                        web_common_traits::database::InsertError::BuilderError(
                            web_common_traits::prelude::BuilderError::UnexpectedAttribute(
                                <Self as common_traits::builder::Attributed>::Attribute::CappedContainer,
                            ),
                        ),
                    );
                }
        ...
        CWM: web_common_traits::database::PrimaryKeyLike<PrimaryKey = i32>,
    {
        ...
        ) = self.procedure_capped_with
        {
            self.procedure_capped_with = <crate::codegen::structs_codegen::tables::insertables::InsertableProcedureAssetBuilder as crate::codegen::structs_codegen::tables::insertables::ProcedureAssetSettable>::asset_model(
                ...
                .map_err(|e| {
                    e.replace_field_name(|attribute| {
                        <Self as common_traits::builder::Attributed>::Attribute::ProcedureCappedWith(
                            attribute,
                        )
                    })
                })?
    ...
    ///Sets the value of the `public.capping_procedures.procedure_template_capped_with_model` column.
    ///
    ///# Implementation notes
    ///This method also set the values of other columns, due to
    ///same-as relationships or inferred values.
    ...
    where
        PTCWM: web_common_traits::database::PrimaryKeyLike<PrimaryKey = i32>,
    {
        let procedure_template_capped_with_model = <PTCWM as web_common_traits::database::PrimaryKeyLike>::primary_key(
    ...
    ///Sets the value of the `public.capping_procedures.procedure_capped_with` column.
    ///
    ///# Implementation notes
    ///This method also set the values of other columns, due to
    ///same-as relationships or inferred values.
...
where
    Self: web_common_traits::database::DispatchableInsertableVariant<
        ...
        + common_traits::builder::IsCompleteBuilder,
{
    type Error = web_common_traits::database::InsertError<CappingProcedureAttribute>;
