...
diesel::allow_tables_to_appear_in_same_query!(supernatant_procedure_models, compatibility_rules);
use crate::codegen::diesel_codegen::tables::pipette_models::pipette_models;
diesel::allow_tables_to_appear_in_same_query!(supernatant_procedure_models, pipette_models);
use crate::codegen::diesel_codegen::tables::pipette_tip_models::pipette_tip_models;
diesel::allow_tables_to_appear_in_same_query!(supernatant_procedure_models, pipette_tip_models);
