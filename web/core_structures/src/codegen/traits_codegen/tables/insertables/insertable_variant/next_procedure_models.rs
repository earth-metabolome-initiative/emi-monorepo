...
for crate::codegen::structs_codegen::tables::insertables::InsertableNextProcedureModelBuilder
where
    <C as diesel::Connection>::Backend: diesel::backend::DieselReserveSpecialization,
    diesel::query_builder::InsertStatement<
        <crate::codegen::structs_codegen::tables::next_procedure_models::NextProcedureModel as diesel::associations::HasTable>::Table,
        <crate::codegen::structs_codegen::tables::insertables::InsertableNextProcedureModel as diesel::Insertable<
            <crate::codegen::structs_codegen::tables::next_procedure_models::NextProcedureModel as diesel::associations::HasTable>::Table,
        >>::Values,
    ...
    C: diesel::connection::LoadConnection,
{
    ...
    type Error = web_common_traits::database::InsertError<
        crate::codegen::structs_codegen::tables::insertables::InsertableNextProcedureModelAttributes,
    >;
    type UserId = i32;
    fn insert(
        self,
