    ...
    Self: web_common_traits::database::MostConcreteTable,
{
    ...
    fn try_insert(
        ...
        let procedure_template = self
            ...
            .map_err(|err| {
                err.into_field_name(|_| crate::codegen::structs_codegen::tables::insertables::PhotographProcedureTemplateAttribute::Extension(
                    crate::codegen::structs_codegen::tables::insertables::PhotographProcedureTemplateExtensionAttribute::ProcedureTemplate(
