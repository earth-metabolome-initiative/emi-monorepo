...
where
    diesel::query_builder::InsertStatement<
        <crate::Pipette as diesel::associations::HasTable>::Table,
        <crate::codegen::structs_codegen::tables::insertables::InsertablePipette as diesel::Insertable<
            <crate::Pipette as diesel::associations::HasTable>::Table,
        >>::Values,
    >: for<'query> diesel::query_dsl::LoadQuery<'query, C, crate::Pipette>,
    C: diesel::connection::LoadConnection,
    ...
    Self: web_common_traits::database::MostConcreteTable,
{
    ...
    fn try_insert(
        ...
        let id = self
            ...
            .map_err(|err| {
                err.into_field_name(|_| crate::codegen::structs_codegen::tables::insertables::PipetteAttribute::Extension(
                    crate::codegen::structs_codegen::tables::insertables::PipetteExtensionAttribute::PhysicalAsset(
