...
impl core::fmt::Display for PipetteModelExtensionAttribute {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            Self::PhysicalAssetModel(e) => write!(f, "pipette_models({e})"),
        }
    }
}
...
impl From<common_traits::builder::EmptyTuple> for PipetteModelExtensionAttribute {
...
impl<T1> common_traits::builder::Attributed
    for crate::codegen::structs_codegen::tables::insertables::InsertablePipetteModelBuilder<T1>
{
    type Attribute = PipetteModelAttribute;
}
impl web_common_traits::database::TableField for PipetteModelAttribute {}
impl web_common_traits::database::HasTableType for PipetteModelAttribute {
    ...
    > for PipetteModelAttribute
{
    fn from_extension(
        ...
        PipetteModelAttribute::Extension(From::from(attribute))
    }
}
...
impl core::fmt::Display for PipetteModelAttribute {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            ...
            Self::Id => write!(f, "pipette_models.id"),
        }
    }
}
#[derive(Debug)]
...
///
/// ```rust,ignore
/// use core_structures::PipetteModel;
...
///
/// let pipette_model = PipetteModel::new()
...
{
    type Table = crate::codegen::diesel_codegen::tables::pipette_models::pipette_models::table;
    fn table() -> Self::Table {
        crate::codegen::diesel_codegen::tables::pipette_models::pipette_models::table
    }
}
...
impl<PhysicalAssetModel> PipetteModelSettable for InsertablePipetteModelBuilder<PhysicalAssetModel>
where
...
{
    type Error = web_common_traits::database::InsertError<PipetteModelAttribute>;
