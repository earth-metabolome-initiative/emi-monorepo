...
impl From<web_common::database::flat_variants::ProjectsUsersRole>
    for crate::database::flat_variants::ProjectsUsersRole
{
    fn from(item: web_common::database::flat_variants::ProjectsUsersRole) -> Self {
        Self {
...
impl From<crate::database::flat_variants::ProjectsUsersRole>
    for web_common::database::flat_variants::ProjectsUsersRole
{
    fn from(item: crate::database::flat_variants::ProjectsUsersRole) -> Self {
        Self {
            table_id: item.table_id,
            user_id: item.user_id,
            role_id: item.role_id,
...
impl ProjectsUsersRole {
    ...
    pub fn can_view_by_id(
        ...
        diesel::select(
            crate::database::sql_function_bindings::can_view_projects_users_roles(
                author_user_id,
                table_id,
                user_id,
            ),
    ...
    pub fn all_viewable(
        ...
        let query = projects_users_roles::dsl::projects_users_roles
            ...
            .order_by(projects_users_roles::dsl::table_id);
    ...
    pub fn can_update_by_id(
        ...
        diesel::select(
            crate::database::sql_function_bindings::can_update_projects_users_roles(
                author_user_id,
                table_id,
                user_id,
            ),
    ...
    pub fn can_admin_by_id(
        ...
        diesel::select(
            crate::database::sql_function_bindings::can_admin_projects_users_roles(
                author_user_id,
                table_id,
                user_id,
            ),
    ...
    pub fn delete_by_id(
        ...
        diesel::delete(
            crate::database::projects_users_roles::dsl::projects_users_roles
                .filter(crate::database::projects_users_roles::dsl::table_id.eq(table_id))
                .filter(crate::database::projects_users_roles::dsl::user_id.eq(user_id)),
        )
        .execute(connection)
        .map_err(web_common::api::ApiError::from)
    }
