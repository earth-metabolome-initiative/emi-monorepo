...
pub enum PositioningDeviceModelExtensionAttribute {
    PhysicalAssetModel(
        crate::codegen::structs_codegen::tables::insertables::PhysicalAssetModelAttribute,
    ),
}
impl core::fmt::Display for PositioningDeviceModelExtensionAttribute {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            Self::PhysicalAssetModel(e) => write!(f, "positioning_device_models({e})"),
        }
    }
}
impl From<crate::codegen::structs_codegen::tables::insertables::PhysicalAssetModelAttribute>
    for PositioningDeviceModelExtensionAttribute
{
    fn from(
...
impl From<common_traits::builder::EmptyTuple> for PositioningDeviceModelExtensionAttribute {
...
#[derive(Copy, Clone, PartialEq, Eq, PartialOrd, Ord, Hash, core::fmt::Debug)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub enum PositioningDeviceModelAttribute {
    Extension(PositioningDeviceModelExtensionAttribute),
    Id,
}
impl core::str::FromStr for PositioningDeviceModelAttribute {
...
for crate::codegen::structs_codegen::tables::insertables::InsertablePositioningDeviceModelBuilder<
    T1,
> {
    type Attribute = PositioningDeviceModelAttribute;
}
impl web_common_traits::database::TableField for PositioningDeviceModelAttribute {}
impl web_common_traits::database::HasTableType for PositioningDeviceModelAttribute {
    type Table = crate::codegen::tables::table_names::TableName;
}
impl
    web_common_traits::database::FromExtension<
        crate::codegen::structs_codegen::tables::insertables::PhysicalAssetModelAttribute,
    > for PositioningDeviceModelAttribute
{
    fn from_extension(
        attribute: crate::codegen::structs_codegen::tables::insertables::PhysicalAssetModelAttribute,
    ) -> Self {
        PositioningDeviceModelAttribute::Extension(From::from(attribute))
    }
}
...
impl core::fmt::Display for PositioningDeviceModelAttribute {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            Self::Extension(e) => write!(f, "{e}"),
            Self::Id => write!(f, "positioning_device_models.id"),
        }
    }
}
#[derive(Debug)]
...
///
/// ```rust,ignore
/// use core_structures::PositioningDeviceModel;
...
///
/// let positioning_device_model = PositioningDeviceModel::new()
...
impl<PhysicalAssetModel> diesel::associations::HasTable
    for InsertablePositioningDeviceModelBuilder<PhysicalAssetModel>
{
    type Table = crate::codegen::diesel_codegen::tables::positioning_device_models::positioning_device_models::table;
    fn table() -> Self::Table {
        crate::codegen::diesel_codegen::tables::positioning_device_models::positioning_device_models::table
    }
}
impl From<InsertablePositioningDeviceModelBuilder>
    for web_common_traits::database::IdOrBuilder<i32, InsertablePositioningDeviceModelBuilder>
{
    fn from(builder: InsertablePositioningDeviceModelBuilder) -> Self {
...
/// `PositioningDeviceModel` or descendant tables.
pub trait PositioningDeviceModelSettable: Sized {
    /// Error type returned when setting attributes.
    type Error;
}
impl<PhysicalAssetModel> PositioningDeviceModelSettable
for InsertablePositioningDeviceModelBuilder<PhysicalAssetModel>
where
...
where
    Self: web_common_traits::database::DispatchableInsertableVariant<
            ...
            Error = web_common_traits::database::InsertError<
                PositioningDeviceModelAttribute,
            >,
