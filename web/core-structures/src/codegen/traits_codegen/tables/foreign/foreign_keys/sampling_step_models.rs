...
pub struct SamplingStepModelForeignKeys {
    pub id: Option<std::rc::Rc<crate::codegen::structs_codegen::tables::step_models::StepModel>>,
...
{
    type ForeignKeys = SamplingStepModelForeignKeys;
...
impl web_common_traits::prelude::ForeignKeys for SamplingStepModelForeignKeys {}
