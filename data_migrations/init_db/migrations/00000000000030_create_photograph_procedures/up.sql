CREATE TABLE IF NOT EXISTS photograph_procedure_templates (
	...
	-- We define a same-as index to allow for foreign key references to check whether a `photograph_procedure_template`
	-- is associated with a given `photograph_foreign_procedure_template`.
