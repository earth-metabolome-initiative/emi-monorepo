...
for crate::codegen::structs_codegen::tables::insertables::InsertableRegisteringProcedureTemplateBuilder<
    ProcedureTemplate,
>
where
    <C as diesel::Connection>::Backend: diesel::backend::DieselReserveSpecialization,
    diesel::query_builder::InsertStatement<
        <crate::codegen::structs_codegen::tables::registering_procedure_templates::RegisteringProcedureTemplate as diesel::associations::HasTable>::Table,
        <crate::codegen::structs_codegen::tables::insertables::InsertableRegisteringProcedureTemplate as diesel::Insertable<
            <crate::codegen::structs_codegen::tables::registering_procedure_templates::RegisteringProcedureTemplate as diesel::associations::HasTable>::Table,
        >>::Values,
    ...
    Self: web_common_traits::database::MostConcreteTable,
{
    ...
    fn insert(
        ...
        self.set_most_concrete_table("registering_procedure_templates");
        let insertable_struct: crate::codegen::structs_codegen::tables::insertables::InsertableRegisteringProcedureTemplate = self
        ...
        if !insertable_struct
            .procedure_template_registered_asset_model(conn)?
    ...
    fn try_insert(
        ...
        let registered_asset_model = self
