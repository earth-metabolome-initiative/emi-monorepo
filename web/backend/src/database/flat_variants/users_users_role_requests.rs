...
impl From<web_common::database::flat_variants::UsersUsersRoleRequest>
    for crate::database::flat_variants::UsersUsersRoleRequest
{
    fn from(item: web_common::database::flat_variants::UsersUsersRoleRequest) -> Self {
        Self {
...
impl From<crate::database::flat_variants::UsersUsersRoleRequest>
    for web_common::database::flat_variants::UsersUsersRoleRequest
{
    fn from(item: crate::database::flat_variants::UsersUsersRoleRequest) -> Self {
        Self {
            table_id: item.table_id,
            user_id: item.user_id,
            role_id: item.role_id,
...
impl UsersUsersRoleRequest {
    ...
    pub fn can_view_by_id(
        ...
        diesel::select(
            crate::database::sql_function_bindings::can_view_users_users_role_requests(
                author_user_id,
                table_id,
                user_id,
            ),
    ...
    pub fn all_viewable(
        ...
        let query = users_users_role_requests::dsl::users_users_role_requests
            ...
            .order_by(users_users_role_requests::dsl::table_id);
    ...
    pub fn can_update_by_id(
        ...
        diesel::select(
            crate::database::sql_function_bindings::can_update_users_users_role_requests(
                author_user_id,
                table_id,
                user_id,
            ),
    ...
    pub fn can_admin_by_id(
        ...
        diesel::select(
            crate::database::sql_function_bindings::can_admin_users_users_role_requests(
                author_user_id,
                table_id,
                user_id,
            ),
    ...
    pub fn delete_by_id(
        ...
        diesel::delete(
            crate::database::users_users_role_requests::dsl::users_users_role_requests
                .filter(crate::database::users_users_role_requests::dsl::table_id.eq(table_id))
                .filter(crate::database::users_users_role_requests::dsl::user_id.eq(user_id)),
        )
        .execute(connection)
        .map_err(web_common::api::ApiError::from)
    }
