...
pub struct SamplingProcedureModel {
    pub id: i32,
}
impl web_common_traits::prelude::TableName for SamplingProcedureModel {
    const TABLE_NAME: &'static str = "sampling_procedure_models";
}
impl
    web_common_traits::prelude::ExtensionTable<
        crate::codegen::structs_codegen::tables::procedure_models::ProcedureModel,
    > for SamplingProcedureModel
where
    for<'a> &'a Self: diesel::Identifiable<Id = &'a i32>,
{
}
impl diesel::Identifiable for SamplingProcedureModel {
    type Id = i32;
    fn id(self) -> Self::Id {
        self.id
    }
}
impl SamplingProcedureModel {
    ...
    pub fn from_name(
        ...
        Self::table()
            ...
            .order_by(sampling_procedure_models::id.asc())
...
impl AsRef<SamplingProcedureModel> for SamplingProcedureModel {
    fn as_ref(&self) -> &SamplingProcedureModel {
        self
    }
}
