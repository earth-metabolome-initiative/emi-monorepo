-- Drop the `can_update_teams_teams_role_invitations` function and trigger on the teams_teams_role_invitations table.

DROP FUNCTION IF EXISTS can_update_teams_teams_role_invitations(INTEGER, INTEGER, INTEGER);
