...
pub struct ProjectWorkflowModelForeignKeys {
...
{
    type ForeignKeys = ProjectWorkflowModelForeignKeys;
...
impl web_common_traits::prelude::ForeignKeys for ProjectWorkflowModelForeignKeys {}
