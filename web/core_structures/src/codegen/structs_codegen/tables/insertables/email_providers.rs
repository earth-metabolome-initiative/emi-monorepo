...
impl web_common_traits::database::TableField for EmailProviderAttribute {}
impl web_common_traits::database::HasTableType for EmailProviderAttribute {
...
{
    type Error = web_common_traits::database::InsertError<EmailProviderAttribute>;
