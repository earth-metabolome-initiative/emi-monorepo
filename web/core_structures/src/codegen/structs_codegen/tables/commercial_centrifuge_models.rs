...
impl web_common_traits::database::PrimaryKeyLike for CommercialCentrifugeModel {
    type PrimaryKey = i32;
...
impl CommercialCentrifugeModel {
    ...
    pub fn from_name(
        ...
        use crate::codegen::diesel_codegen::tables::{
            asset_models::asset_models, commercial_centrifuge_models::commercial_centrifuge_models,
        };
        Self::table()
            .inner_join(
                asset_models::table.on(commercial_centrifuge_models::id.eq(asset_models::id)),
            )
...
impl AsRef<CommercialCentrifugeModel> for CommercialCentrifugeModel {
    fn as_ref(&self) -> &CommercialCentrifugeModel {
        self
    }
}
