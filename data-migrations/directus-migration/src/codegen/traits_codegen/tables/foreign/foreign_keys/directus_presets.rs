...
pub struct DirectusPresetForeignKeys {
    pub user:
...
impl web_common_traits::prelude::HasForeignKeys
    for crate::codegen::structs_codegen::tables::directus_presets::DirectusPreset
{
    type ForeignKeys = DirectusPresetForeignKeys;
...
impl web_common_traits::prelude::ForeignKeys for DirectusPresetForeignKeys {}
