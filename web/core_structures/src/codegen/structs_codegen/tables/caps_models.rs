...
pub struct CapsModel {
    pub id: i32,
}
impl web_common_traits::prelude::TableName for CapsModel {
    const TABLE_NAME: &'static str = "caps_models";
}
impl
...
impl diesel::Identifiable for CapsModel {
    type Id = i32;
    fn id(self) -> Self::Id {
        self.id
    }
...
impl CapsModel {
    ...
    pub fn from_parent_model_id(
        ...
        use crate::codegen::diesel_codegen::tables::{
            caps_models::caps_models, physical_asset_models::physical_asset_models,
        };
        Self::table()
            .inner_join(
                physical_asset_models::table.on(caps_models::id.eq(physical_asset_models::id)),
            )
            .filter(physical_asset_models::parent_model_id.eq(parent_model_id))
            .order_by(caps_models::id.asc())
    ...
    pub fn from_parent_model_id_and_id(
        ...
        use crate::codegen::diesel_codegen::tables::{
            asset_models::asset_models, caps_models::caps_models,
        };
        Self::table()
            .inner_join(asset_models::table.on(caps_models::id.eq(asset_models::id)))
...
impl AsRef<CapsModel> for CapsModel {
    fn as_ref(&self) -> &CapsModel {
        self
    }
}
