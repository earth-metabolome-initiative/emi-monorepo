...
impl From<crate::codegen::structs_codegen::tables::insertables::InsertableProcedureModelAttributes>
    for InsertableCappingProcedureModelAttributes
{
    fn from(
...
impl core::fmt::Display for InsertableCappingProcedureModelAttributes {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            ...
            InsertableCappingProcedureModelAttributes::ContainerId(container_id) => {
                write!(f, "{}", container_id)
            }
            InsertableCappingProcedureModelAttributes::CappedWith(capped_with) => {
                write!(f, "{}", capped_with)
            }
        }
    }
...
impl InsertableCappingProcedureModel {
    ...
    pub fn capping_procedure_models_capped_with_id_fkey(
        &self,
    ...
    #[cfg(feature = "postgres")]
    pub fn capping_procedure_models_container_id_id_fkey(
        &self,
        conn: &mut diesel::PgConnection,
    ) -> Result<
        crate::codegen::structs_codegen::tables::procedure_model_trackables::ProcedureModelTrackable,
...
pub struct InsertableCappingProcedureModelBuilder {
    ...
    pub(crate) capped_with: crate::codegen::structs_codegen::tables::insertables::InsertableProcedureModelTrackableBuilder,
}
impl InsertableCappingProcedureModelBuilder {
    pub fn capped_with(
        mut self,
        capped_with: crate::codegen::structs_codegen::tables::insertables::InsertableProcedureModelTrackableBuilder,
    ) -> Result<
        Self,
        ...
        >,
    >{
        if capped_with.procedure_model_id.is_some() {
            return Err(
...
impl InsertableCappingProcedureModelBuilder {
        ...
        >,
    {
        ...
        let container_id = self
            ...
            .map_err(|err| err.into_field_name())?
            .id();
        Ok(InsertableCappingProcedureModel { id, container_id, capped_with })
    }
}
