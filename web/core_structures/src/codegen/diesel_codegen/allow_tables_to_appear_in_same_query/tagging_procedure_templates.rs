...
diesel::allow_tables_to_appear_in_same_query!(tagging_procedure_templates, physical_asset_models);
...
diesel::allow_tables_to_appear_in_same_query!(tagging_procedure_templates, procedure_templates);
