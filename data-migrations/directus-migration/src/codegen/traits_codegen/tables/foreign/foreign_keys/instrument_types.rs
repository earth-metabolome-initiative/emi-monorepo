...
pub struct InstrumentTypeForeignKeys {
    pub user_created:
...
impl web_common_traits::prelude::HasForeignKeys
    for crate::codegen::structs_codegen::tables::instrument_types::InstrumentType
{
    type ForeignKeys = InstrumentTypeForeignKeys;
...
impl web_common_traits::prelude::ForeignKeys for InstrumentTypeForeignKeys {}
