...
where
    ...
    crate::codegen::structs_codegen::tables::insertables::CommercialCentrifugeLotExtensionAttribute: From<
            ...
            let id = self
                ...
                .map_err(|err| {
                    err.into_field_name(|attribute| {
                        crate::codegen::structs_codegen::tables::insertables::CommercialCentrifugeLotAttribute::Extension(
                            From::from(attribute),
                        )
                    })
                })?;
