...
impl ProjectsTeamsRole {
    ...
    pub fn can_view_by_id(
        ...
        diesel::select(crate::sql_function_bindings::can_view_projects_teams_roles(
            author_user_id,
            table_id,
            team_id,
        ))
    ...
    pub fn all_viewable(
        ...
        let mut query = projects_teams_roles::dsl::projects_teams_roles.into_boxed();
        ...
        query
            .filter(crate::sql_function_bindings::can_view_projects_teams_roles(
                author_user_id,
                projects_teams_roles::dsl::table_id,
                projects_teams_roles::dsl::team_id,
            ))
    ...
    pub fn similarity_search_viewable(
        ...
        if let Some(table_id) = filter.and_then(|f| f.table_id) {
            return projects_teams_roles::dsl::projects_teams_roles
                .filter(projects_teams_roles::dsl::table_id.eq(table_id))
                .select(ProjectsTeamsRole::as_select())
                // This operation is defined by a first order index linking projects_teams_roles.table_id to projects.
                .inner_join(
                    projects::dsl::projects
                        .on(projects_teams_roles::dsl::table_id.eq(projects::dsl::id)),
                )
                // This operation is defined by a first order index linking projects_teams_roles.team_id to teams.
                .inner_join(
                    teams::dsl::teams.on(projects_teams_roles::dsl::team_id.eq(teams::dsl::id)),
                )
                // This operation is defined by a first order index linking projects_teams_roles.role_id to roles.
                .inner_join(
                    roles::dsl::roles.on(projects_teams_roles::dsl::role_id.eq(roles::dsl::id)),
                )
                .filter(crate::sql_function_bindings::can_view_projects_teams_roles(
                    author_user_id,
                    projects_teams_roles::dsl::table_id,
        ...
        if let Some(created_by) = filter.and_then(|f| f.created_by) {
            return projects_teams_roles::dsl::projects_teams_roles
                .filter(projects_teams_roles::dsl::created_by.eq(created_by))
                .select(ProjectsTeamsRole::as_select())
                // This operation is defined by a first order index linking projects_teams_roles.table_id to projects.
                .inner_join(
                    projects::dsl::projects
        ...
        projects_teams_roles::dsl::projects_teams_roles
            ...
            // This operation is defined by a first order index linking projects_teams_roles.team_id to teams.
            .inner_join(teams::dsl::teams.on(projects_teams_roles::dsl::team_id.eq(teams::dsl::id)))
            // This operation is defined by a first order index linking projects_teams_roles.role_id to roles.
            .inner_join(roles::dsl::roles.on(projects_teams_roles::dsl::role_id.eq(roles::dsl::id)))
            .filter(crate::sql_function_bindings::can_view_projects_teams_roles(
                author_user_id,
                projects_teams_roles::dsl::table_id,
                projects_teams_roles::dsl::team_id,
    ...
    pub fn can_update_by_id(
        ...
        diesel::select(
            crate::sql_function_bindings::can_update_projects_teams_roles(
                author_user_id,
                table_id,
                team_id,
            ),
    ...
    pub fn can_admin_by_id(
        ...
        diesel::select(
            crate::sql_function_bindings::can_admin_projects_teams_roles(
                author_user_id,
                table_id,
                team_id,
            ),
