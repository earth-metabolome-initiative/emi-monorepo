...
where
    ...
    crate::codegen::structs_codegen::tables::insertables::CommercialPipetteLotAttribute: web_common_traits::database::FromExtensionAttribute<
    ...
    crate::codegen::structs_codegen::tables::insertables::CommercialPipetteLotAttribute: web_common_traits::database::FromExtensionAttribute<
        ...
        PipetteModel,
        EffectiveExtensionAttribute = <PipetteModel as web_common_traits::database::TryInsertGeneric<
            C,
        >>::Attribute,
    >,
{
    ...
    fn insert(
        ...
        if !insertable_struct
            .commercial_pipette_lots_id_fkey1(conn)?
            ...
            let id = self
                ...
                .map_err(|err| {
                    err.into_field_name(|attribute| {
                        <crate::codegen::structs_codegen::tables::insertables::CommercialPipetteLotAttribute as web_common_traits::database::FromExtensionAttribute<
                            crate::codegen::structs_codegen::tables::insertables::CommercialProductLotAttribute,
                            CommercialProductLot,
