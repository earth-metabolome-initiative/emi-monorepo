...
impl From<web_common::database::nested_variants::NestedBioOttRank> for NestedBioOttRank {
...
impl From<NestedBioOttRank> for web_common::database::nested_variants::NestedBioOttRank {
