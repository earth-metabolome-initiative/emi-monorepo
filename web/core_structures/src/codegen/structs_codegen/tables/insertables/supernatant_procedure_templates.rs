    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            ...
            Self::ProcedureTemplateSupernatantDestinationModel => {
                write!(f, "procedure_template_supernatant_destination_model")
            }
            Self::TransferredWithModel => write!(f, "transferred_with_model"),
            Self::ProcedureTemplateTransferredWithModel => {
                write!(f, "procedure_template_transferred_with_model")
            }
...
impl SupernatantProcedureTemplateBuildable for Option<i32> {
    ...
    fn procedure_template_stratified_source_model(
        self,
        _procedure_template_stratified_source_model: i32,
    ) -> Result<Self, web_common_traits::database::InsertError<Self::Attributes>> {
        Ok(self)
    }
    fn supernatant_destination_model(
        self,
        _supernatant_destination_model: i32,
    ) -> Result<Self, web_common_traits::database::InsertError<Self::Attributes>> {
        Ok(self)
    }
    fn procedure_template_supernatant_destination_model(
        self,
        _procedure_template_supernatant_destination_model: i32,
    ) -> Result<Self, web_common_traits::database::InsertError<Self::Attributes>> {
        Ok(self)
    }
    fn transferred_with_model(
        self,
        _transferred_with_model: i32,
    ) -> Result<Self, web_common_traits::database::InsertError<Self::Attributes>> {
        Ok(self)
    }
    fn procedure_template_transferred_with_model(
        self,
        _procedure_template_transferred_with_model: i32,
    ) -> Result<Self, web_common_traits::database::InsertError<Self::Attributes>> {
        Ok(self)
    }
    fn pipette_tip_model(
...
for InsertableSupernatantProcedureTemplateBuilder<ProcedureTemplate> {
        ...
        let liters = liters
            ...
            .map_err(|err| {
                validation_errors::SingleFieldError::from(err)
                    .rename_field(
                        InsertableSupernatantProcedureTemplateAttributes::Liters,
                    )
            })?;
    ...
    fn stratified_source_model(
        ...
        let stratified_source_model = stratified_source_model
            .try_into()
            .map_err(|err| {
                validation_errors::SingleFieldError::from(err)
                    .rename_field(
    ...
    fn supernatant_destination_model(
        ...
        let supernatant_destination_model = supernatant_destination_model
            .try_into()
            .map_err(|err| {
                validation_errors::SingleFieldError::from(err)
                    .rename_field(
    ...
    fn procedure_template_supernatant_destination_model(
        ...
        let procedure_template_supernatant_destination_model = procedure_template_supernatant_destination_model
            .try_into()
            .map_err(|err| {
                validation_errors::SingleFieldError::from(err)
                    .rename_field(
                        InsertableSupernatantProcedureTemplateAttributes::ProcedureTemplateSupernatantDestinationModel,
                    )
            })?;
    ...
    fn transferred_with_model(
        ...
        let transferred_with_model = transferred_with_model
            .try_into()
            .map_err(|err| {
                validation_errors::SingleFieldError::from(err)
                    .rename_field(
    ...
    fn procedure_template_transferred_with_model(
        ...
        let procedure_template_transferred_with_model = procedure_template_transferred_with_model
            .try_into()
            .map_err(|err| {
                validation_errors::SingleFieldError::from(err)
                    .rename_field(
                        InsertableSupernatantProcedureTemplateAttributes::ProcedureTemplateTransferredWithModel,
                    )
            })?;
    ...
    fn pipette_tip_model(
        ...
        let pipette_tip_model = pipette_tip_model
            ...
            .map_err(|err| {
                validation_errors::SingleFieldError::from(err)
                    .rename_field(
                        InsertableSupernatantProcedureTemplateAttributes::PipetteTipModel,
                    )
            })?;
    ...
    fn procedure_template_pipette_tip_model(
        ...
        let procedure_template_pipette_tip_model = procedure_template_pipette_tip_model
            ...
            .map_err(|err| {
                validation_errors::SingleFieldError::from(err)
                    .rename_field(
                        InsertableSupernatantProcedureTemplateAttributes::ProcedureTemplatePipetteTipModel,
                    )
            })?;
