...
pub enum InsertableCentrifugeProcedureExtensionAttributes {
    Procedure(crate::codegen::structs_codegen::tables::insertables::InsertableProcedureAttributes),
}
impl core::fmt::Display for InsertableCentrifugeProcedureExtensionAttributes {
...
impl From<crate::codegen::structs_codegen::tables::insertables::InsertableProcedureAttributes>
    for InsertableCentrifugeProcedureExtensionAttributes
{
    fn from(
...
#[derive(Copy, Clone, PartialEq, Eq, PartialOrd, Ord, Hash, core::fmt::Debug)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub enum InsertableCentrifugeProcedureAttributes {
    Extension(InsertableCentrifugeProcedureExtensionAttributes),
    Procedure,
    ProcedureTemplate,
...
impl core::str::FromStr for InsertableCentrifugeProcedureAttributes {
...
impl core::fmt::Display for InsertableCentrifugeProcedureAttributes {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
...
pub trait CentrifugeProcedureBuildable:
    crate::codegen::structs_codegen::tables::insertables::ProcedureBuildable
{
    /// Sets the value of the
    /// `procedures.centrifuge_procedures.procedure_template` column.
    ///
    /// # Arguments
    ...
    /// Sets the value of the
    /// `procedures.centrifuge_procedures.foreign_procedure_template` column.
    ///
    /// # Arguments
    ...
    /// Sets the value of the
    /// `procedures.centrifuge_procedures.foreign_procedure` column.
    ///
    /// # Arguments
    ...
    /// Sets the value of the
    /// `procedures.centrifuge_procedures.centrifuged_container` column.
    ///
    /// # Arguments
    ...
    /// Sets the value of the
    /// `procedures.centrifuge_procedures.centrifuged_with_model` column.
    ///
    /// # Arguments
    ...
    /// Sets the value of the
    /// `procedures.centrifuge_procedures.centrifuged_with` column.
    ///
    /// # Arguments
...
impl CentrifugeProcedureBuildable for Option<::rosetta_uuid::Uuid> {
    fn procedure_template(
        self,
    ...
    fn centrifuged_container(
        self,
        _centrifuged_container: ::rosetta_uuid::Uuid,
    ) -> Result<Self, web_common_traits::database::InsertError<Self::Attributes>> {
        Ok(self)
    }
    fn centrifuged_with_model(
    ...
    fn centrifuged_with(
        self,
        _centrifuged_with: Option<::rosetta_uuid::Uuid>,
    ) -> Result<Self, web_common_traits::database::InsertError<Self::Attributes>> {
        Ok(self)
    }
}
impl<
    Procedure: crate::codegen::structs_codegen::tables::insertables::ProcedureBuildable<
        ...
        >,
> CentrifugeProcedureBuildable for InsertableCentrifugeProcedureBuilder<Procedure> {
    ///Sets the value of the `procedures.centrifuge_procedures.procedure_template` column.
    ///
        ...
        let procedure_template = procedure_template
            ...
            .map_err(|err| {
                validation_errors::SingleFieldError::from(err)
                    .rename_field(
                        InsertableCentrifugeProcedureAttributes::ProcedureTemplate,
                    )
            })?;
        self.procedure = self
            .procedure
    ...
    ///Sets the value of the `procedures.centrifuge_procedures.foreign_procedure_template` column.
    fn foreign_procedure_template(
        mut self,
        foreign_procedure_template: i32,
    ) -> Result<Self, web_common_traits::database::InsertError<Self::Attributes>> {
        let foreign_procedure_template = foreign_procedure_template
            ...
            .map_err(|err| {
                validation_errors::SingleFieldError::from(err)
                    .rename_field(
                        InsertableCentrifugeProcedureAttributes::ForeignProcedureTemplate,
                    )
            })?;
    ...
    ///Sets the value of the `procedures.centrifuge_procedures.foreign_procedure` column.
    fn foreign_procedure(
        mut self,
        foreign_procedure: ::rosetta_uuid::Uuid,
    ) -> Result<Self, web_common_traits::database::InsertError<Self::Attributes>> {
        let foreign_procedure = foreign_procedure
            ...
            .map_err(|err| {
                validation_errors::SingleFieldError::from(err)
                    .rename_field(
                        InsertableCentrifugeProcedureAttributes::ForeignProcedure,
                    )
            })?;
        self.foreign_procedure = Some(foreign_procedure);
        Ok(self)
    }
    ///Sets the value of the `procedures.centrifuge_procedures.centrifuged_container` column.
    fn centrifuged_container(
        mut self,
        centrifuged_container: ::rosetta_uuid::Uuid,
    ) -> Result<Self, web_common_traits::database::InsertError<Self::Attributes>> {
        let centrifuged_container = centrifuged_container
            .try_into()
            .map_err(|err| {
                validation_errors::SingleFieldError::from(err)
                    .rename_field(
                        InsertableCentrifugeProcedureAttributes::CentrifugedContainer,
                    )
            })?;
        self.centrifuged_container = Some(centrifuged_container);
        Ok(self)
    }
    ///Sets the value of the `procedures.centrifuge_procedures.centrifuged_with_model` column.
    fn centrifuged_with_model(
        mut self,
        centrifuged_with_model: i32,
    ) -> Result<Self, web_common_traits::database::InsertError<Self::Attributes>> {
        let centrifuged_with_model = centrifuged_with_model
            ...
            .map_err(|err| {
                validation_errors::SingleFieldError::from(err)
                    .rename_field(
                        InsertableCentrifugeProcedureAttributes::CentrifugedWithModel,
                    )
            })?;
        self.centrifuged_with_model = Some(centrifuged_with_model);
        Ok(self)
    }
    ///Sets the value of the `procedures.centrifuge_procedures.centrifuged_with` column.
    fn centrifuged_with(
        mut self,
        centrifuged_with: Option<::rosetta_uuid::Uuid>,
    ) -> Result<Self, web_common_traits::database::InsertError<Self::Attributes>> {
        let centrifuged_with = centrifuged_with
            .try_into()
            .map_err(|err| {
                validation_errors::SingleFieldError::from(err)
                    .rename_field(
                        InsertableCentrifugeProcedureAttributes::CentrifugedWith,
                    )
            })?;
...
for InsertableCentrifugeProcedureBuilder<Procedure> {
    type Attributes = crate::codegen::structs_codegen::tables::insertables::InsertableCentrifugeProcedureAttributes;
    #[inline]
    ...
    fn procedure_template(
        ...
        <Self as CentrifugeProcedureBuildable>::procedure_template(
            self,
            procedure_template,
        )
    }
...
where
    Self: web_common_traits::database::InsertableVariant<
        ...
        Error = web_common_traits::database::InsertError<
            InsertableCentrifugeProcedureAttributes,
        >,
    >,
    ...
    >,
{
    type Attributes = InsertableCentrifugeProcedureAttributes;
