...
#[diesel(table_name = crate::database::schema::sample_container_categories)]
...
impl SampleContainerCategory {
    ...
    pub fn all_viewable(
        ...
        use crate::database::schema::sample_container_categories;
    ...
    pub fn strict_word_similarity_search_viewable(
        ...
        let mut query = sample_container_categories::dsl::sample_container_categories
            .select(SampleContainerCategory::as_select())
            .filter(
crate::database::sql_function_bindings::concat_sample_container_categories_brand(sample_container_categories::dsl::name, sample_container_categories::dsl::description).strict_word_similarity_commutator_op(query).or(
    crate::database::sql_function_bindings::concat_sample_container_categories_brand(sample_container_categories::dsl::name, sample_container_categories::dsl::description).ilike(format!("%{}%", query))
)
)
            .order(crate::database::sql_function_bindings::strict_word_similarity_dist_op(crate::database::sql_function_bindings::concat_sample_container_categories_brand(sample_container_categories::dsl::name, sample_container_categories::dsl::description), query))
            .into_boxed();
        if let Some(material_id) = filter.and_then(|f| f.material_id) {
            query = query.filter(sample_container_categories::dsl::material_id.eq(material_id));
        }
    ...
    crate::database::sql_function_bindings::strict_word_similarity_dist_op(crate::database::sql_function_bindings::concat_sample_container_categories_brand(sample_container_categories::dsl::name, sample_container_categories::dsl::description), query)
))
            .filter(
crate::database::sql_function_bindings::concat_sample_container_categories_brand(sample_container_categories::dsl::name, sample_container_categories::dsl::description).strict_word_similarity_commutator_op(query).or(
    crate::database::sql_function_bindings::concat_sample_container_categories_brand(sample_container_categories::dsl::name, sample_container_categories::dsl::description).ilike(format!("%{}%", query))
