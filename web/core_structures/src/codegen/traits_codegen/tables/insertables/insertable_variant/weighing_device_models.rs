    ...
    >
{
    type InsertableVariant =
        crate::codegen::structs_codegen::tables::insertables::InsertableWeighingDeviceModel;
}
#[cfg(feature = "backend")]
...
where
    ...
    Self: web_common_traits::database::InsertableVariant<
        C,
        InsertableVariant = crate::codegen::structs_codegen::tables::insertables::InsertableWeighingDeviceModel,
    ...
    crate::codegen::structs_codegen::tables::insertables::WeighingDeviceModelExtensionAttribute: From<
    ...
    >,
{
    fn insert(mut self, user_id: i32, conn: &mut C) -> Result<Self::Row, Self::Error> {
        ...
        self.set_most_concrete_table("weighing_device_models");
        ...
        let id = self
            ...
            .map_err(|err| {
                err.into_field_name(|attribute| {
                    crate::codegen::structs_codegen::tables::insertables::WeighingDeviceModelAttribute::Extension(
                        From::from(attribute),
                    )
                })
            })?;
