...
impl web_common_traits::database::TableField for CityAttribute {}
impl web_common_traits::database::HasTableType for CityAttribute {
...
{
    type Error = web_common_traits::database::InsertError<CityAttribute>;
