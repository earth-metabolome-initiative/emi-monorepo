...
impl Filtrable for crate::database::flat_variants::Organism {
    type Filter = crate::database::filter_variants::OrganismFilter;
}
#[cfg(feature = "frontend")]
impl AllRecords for Organism {
...
impl Organism {
    ...
    where
        uuid::Uuid: AsRef<E>,
    {
        self.host_organism_id.as_ref().map(|value| value.as_ref())
    }
