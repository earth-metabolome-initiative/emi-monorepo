    ...
    for crate::codegen::structs_codegen::tables::commercial_bead_models::CommercialBeadModel
{
    ...
    fn foreign_keys_loaded(&self, foreign_keys: &Self::ForeignKeys) -> bool {
        foreign_keys.bead_model.is_some()
            && foreign_keys.commercial_bead_models_id_fkey.is_some()
            && foreign_keys.commercial_bead_models_id_fkey1.is_some()
    }
    fn update(
        &self,
        ...
        match (row, crud) {
            (
                ...
                if self.id == bead_models.id {
                    foreign_keys.commercial_bead_models_id_fkey = Some(bead_models);
                    updated = true;
                }
            }
            (
                ...
                if self.id == bead_models.id {
                    foreign_keys.commercial_bead_models_id_fkey = None;
                    updated = true;
                }
            }
            (
                ...
                if self.id == commercial_products.id {
                    foreign_keys.commercial_bead_models_id_fkey1 = Some(commercial_products);
                    updated = true;
                }
            }
            (
                ...
                if self.id == commercial_products.id {
                    foreign_keys.commercial_bead_models_id_fkey1 = None;
                    updated = true;
                }
            }
            (_, crud) => {
...
impl web_common_traits::prelude::ForeignKeys for CommercialBeadModelForeignKeys {}
