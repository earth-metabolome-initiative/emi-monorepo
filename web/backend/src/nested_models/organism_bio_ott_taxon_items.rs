...
impl NestedOrganismBioOttTaxonItem {
    ...
    pub fn similarity_search_viewable(
        ...
        OrganismBioOttTaxonItem::similarity_search_viewable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn word_similarity_search_viewable(
        ...
        OrganismBioOttTaxonItem::word_similarity_search_viewable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn similarity_search_updatable(
        ...
        OrganismBioOttTaxonItem::similarity_search_updatable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn word_similarity_search_updatable(
        ...
        OrganismBioOttTaxonItem::word_similarity_search_updatable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn similarity_search_administrable(
        ...
        OrganismBioOttTaxonItem::similarity_search_administrable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn word_similarity_search_administrable(
        ...
        OrganismBioOttTaxonItem::word_similarity_search_administrable(
            filter,
            author_user_id,
            query,
            limit,
