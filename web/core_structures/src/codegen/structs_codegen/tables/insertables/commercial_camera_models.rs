...
impl From<common_traits::builder::EmptyTuple> for CommercialCameraModelExtensionAttribute {
...
impl web_common_traits::database::TableField for CommercialCameraModelAttribute {}
impl web_common_traits::database::HasTableType for CommercialCameraModelAttribute {
    ...
    > for CommercialCameraModelAttribute
{
    fn from_extension(
        ...
        CommercialCameraModelAttribute::Extension(From::from(attribute))
    }
}
impl
    web_common_traits::database::FromExtension<
...
/// [`CommercialCameraModel`](crate::codegen::structs_codegen::tables::commercial_camera_models::CommercialCameraModel).
///
///
...
where
    Self: web_common_traits::database::DispatchableInsertableVariant<
            ...
            Error = web_common_traits::database::InsertError<
                CommercialCameraModelAttribute,
            >,
