...
for InsertableCommercialPackagingLotBuilder<CommercialProductLot, PackagingModel> {
    ...
    {
        self.commercial_packaging_lots_id_fkey = <CommercialProductLot as crate::codegen::structs_codegen::tables::insertables::AssetModelBuildable>::most_concrete_table(
