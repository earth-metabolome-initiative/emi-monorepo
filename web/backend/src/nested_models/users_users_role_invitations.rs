...
impl NestedUsersUsersRoleInvitation {
    ...
    pub fn similarity_search_viewable(
        ...
        UsersUsersRoleInvitation::similarity_search_viewable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn word_similarity_search_viewable(
        ...
        UsersUsersRoleInvitation::word_similarity_search_viewable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn similarity_search_updatable(
        ...
        UsersUsersRoleInvitation::similarity_search_updatable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn word_similarity_search_updatable(
        ...
        UsersUsersRoleInvitation::word_similarity_search_updatable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn similarity_search_administrable(
        ...
        UsersUsersRoleInvitation::similarity_search_administrable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn word_similarity_search_administrable(
        ...
        UsersUsersRoleInvitation::word_similarity_search_administrable(
            filter,
            author_user_id,
            query,
            limit,
...
impl From<web_common::database::nested_models::NestedUsersUsersRoleInvitation>
    for NestedUsersUsersRoleInvitation
{
...
impl From<NestedUsersUsersRoleInvitation>
    for web_common::database::nested_models::NestedUsersUsersRoleInvitation
{
