...
pub struct AssetForeignKeys {
    pub model: Option<crate::AssetModel>,
    pub created_by: Option<crate::User>,
    pub updated_by: Option<crate::User>,
}
impl web_common_traits::prelude::HasForeignKeys for crate::Asset {
    type ForeignKeys = AssetForeignKeys;
...
impl web_common_traits::prelude::ForeignKeys for AssetForeignKeys {}
