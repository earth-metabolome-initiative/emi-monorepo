...
where
    ...
    crate::codegen::structs_codegen::tables::insertables::FreezeDryerModelExtensionAttribute: From<
        ...
        let id = self
            ...
            .map_err(|err| {
                err.into_field_name(|attribute| {
                    crate::codegen::structs_codegen::tables::insertables::FreezeDryerModelAttribute::Extension(
                        From::from(attribute),
                    )
                })
            })?;
