...
pub enum ContainerModelExtensionAttribute {
    PhysicalAssetModel(
        crate::codegen::structs_codegen::tables::insertables::PhysicalAssetModelAttribute,
    ),
}
impl core::fmt::Display for ContainerModelExtensionAttribute {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            Self::PhysicalAssetModel(e) => write!(f, "container_models({e})"),
        }
    }
}
impl From<crate::codegen::structs_codegen::tables::insertables::PhysicalAssetModelAttribute>
    for ContainerModelExtensionAttribute
{
    fn from(
...
impl From<common_traits::builder::EmptyTuple> for ContainerModelExtensionAttribute {
...
#[derive(Copy, Clone, PartialEq, Eq, PartialOrd, Ord, Hash, core::fmt::Debug)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub enum ContainerModelAttribute {
    Extension(ContainerModelExtensionAttribute),
    Id,
}
impl core::str::FromStr for ContainerModelAttribute {
...
impl<T1> common_traits::builder::Attributed
    for crate::codegen::structs_codegen::tables::insertables::InsertableContainerModelBuilder<T1>
{
    type Attribute = ContainerModelAttribute;
}
impl web_common_traits::database::TableField for ContainerModelAttribute {}
impl web_common_traits::database::HasTableType for ContainerModelAttribute {
    type Table = crate::codegen::tables::table_names::TableName;
}
impl
    web_common_traits::database::FromExtension<
        crate::codegen::structs_codegen::tables::insertables::PhysicalAssetModelAttribute,
    > for ContainerModelAttribute
{
    fn from_extension(
        attribute: crate::codegen::structs_codegen::tables::insertables::PhysicalAssetModelAttribute,
    ) -> Self {
        ContainerModelAttribute::Extension(From::from(attribute))
    }
}
...
impl core::fmt::Display for ContainerModelAttribute {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            Self::Extension(e) => write!(f, "{e}"),
            Self::Id => write!(f, "container_models.id"),
        }
    }
}
#[derive(Debug)]
...
/// [`ContainerModel`](crate::codegen::structs_codegen::tables::container_models::ContainerModel).
///
///
...
///
/// ```rust,ignore
/// use core_structures::ContainerModel;
...
///
/// let container_model = ContainerModel::new()
...
{
    type Table = crate::codegen::diesel_codegen::tables::container_models::container_models::table;
    fn table() -> Self::Table {
        crate::codegen::diesel_codegen::tables::container_models::container_models::table
    }
}
impl From<InsertableContainerModelBuilder>
    for web_common_traits::database::IdOrBuilder<i32, InsertableContainerModelBuilder>
{
    fn from(builder: InsertableContainerModelBuilder) -> Self {
...
/// descendant tables.
pub trait ContainerModelSettable: Sized {
    /// Error type returned when setting attributes.
    type Error;
}
impl<PhysicalAssetModel> ContainerModelSettable
for InsertableContainerModelBuilder<PhysicalAssetModel>
where
...
where
    Self: web_common_traits::database::DispatchableInsertableVariant<
            ...
            Error = web_common_traits::database::InsertError<ContainerModelAttribute>,
        > + web_common_traits::database::SetPrimaryKey<PrimaryKey = i32>
        + common_traits::builder::IsCompleteBuilder,
{
    type Error = web_common_traits::database::InsertError<ContainerModelAttribute>;
