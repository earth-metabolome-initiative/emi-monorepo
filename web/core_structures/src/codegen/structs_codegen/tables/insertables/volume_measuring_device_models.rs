...
pub enum InsertableVolumeMeasuringDeviceModelExtensionAttributes {
    PhysicalAssetModel(
        crate::codegen::structs_codegen::tables::insertables::InsertablePhysicalAssetModelAttributes,
    ),
}
impl core::fmt::Display for InsertableVolumeMeasuringDeviceModelExtensionAttributes {
...
impl From<
    crate::codegen::structs_codegen::tables::insertables::InsertablePhysicalAssetModelAttributes,
> for InsertableVolumeMeasuringDeviceModelExtensionAttributes {
    fn from(
...
#[derive(Copy, Clone, PartialEq, Eq, PartialOrd, Ord, Hash, core::fmt::Debug)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub enum InsertableVolumeMeasuringDeviceModelAttributes {
    Extension(InsertableVolumeMeasuringDeviceModelExtensionAttributes),
    Id,
}
impl From<
    crate::codegen::structs_codegen::tables::insertables::InsertablePhysicalAssetModelAttributes,
> for InsertableVolumeMeasuringDeviceModelAttributes {
    fn from(
        physical_asset_models: crate::codegen::structs_codegen::tables::insertables::InsertablePhysicalAssetModelAttributes,
    ) -> Self {
        Self::Extension(
            InsertableVolumeMeasuringDeviceModelExtensionAttributes::PhysicalAssetModel(
                physical_asset_models,
            ),
        )
    }
}
impl core::str::FromStr for InsertableVolumeMeasuringDeviceModelAttributes {
...
impl core::fmt::Display for InsertableVolumeMeasuringDeviceModelAttributes {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
...
pub trait VolumeMeasuringDeviceModelBuildable:
    crate::codegen::structs_codegen::tables::insertables::PhysicalAssetModelBuildable
{
}
impl VolumeMeasuringDeviceModelBuildable for Option<i32> {}
impl<
    PhysicalAssetModel: crate::codegen::structs_codegen::tables::insertables::PhysicalAssetModelBuildable<
        ...
        >,
> VolumeMeasuringDeviceModelBuildable
...
for InsertableVolumeMeasuringDeviceModelBuilder<PhysicalAssetModel> {
    type Attributes = crate::codegen::structs_codegen::tables::insertables::InsertableVolumeMeasuringDeviceModelAttributes;
    #[inline]
...
where
    Self: web_common_traits::database::InsertableVariant<
        ...
        Error = web_common_traits::database::InsertError<
            InsertableVolumeMeasuringDeviceModelAttributes,
        >,
    >,
    ...
    >,
{
    type Attributes = InsertableVolumeMeasuringDeviceModelAttributes;
