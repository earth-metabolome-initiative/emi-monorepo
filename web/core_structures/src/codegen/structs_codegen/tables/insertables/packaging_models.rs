...
pub enum InsertablePackagingModelExtensionAttributes {
    PhysicalAssetModel(
        crate::codegen::structs_codegen::tables::insertables::InsertablePhysicalAssetModelAttributes,
    ),
}
impl core::fmt::Display for InsertablePackagingModelExtensionAttributes {
...
impl From<
    crate::codegen::structs_codegen::tables::insertables::InsertablePhysicalAssetModelAttributes,
> for InsertablePackagingModelExtensionAttributes {
    fn from(
...
pub enum InsertablePackagingModelAttributes {
    Extension(InsertablePackagingModelExtensionAttributes),
    Id,
}
impl From<
    crate::codegen::structs_codegen::tables::insertables::InsertablePhysicalAssetModelAttributes,
> for InsertablePackagingModelAttributes {
    fn from(
        ...
        Self::Extension(
            InsertablePackagingModelExtensionAttributes::PhysicalAssetModel(
                physical_asset_models,
            ),
        )
    }
}
impl core::str::FromStr for InsertablePackagingModelAttributes {
...
/// descendant tables.
pub trait PackagingModelBuildable:
    crate::codegen::structs_codegen::tables::insertables::PhysicalAssetModelBuildable
{
}
impl PackagingModelBuildable for Option<i32> {}
impl<
    PhysicalAssetModel: crate::codegen::structs_codegen::tables::insertables::PhysicalAssetModelBuildable<
        ...
        >,
> PackagingModelBuildable for InsertablePackagingModelBuilder<PhysicalAssetModel> {}
impl<
    PhysicalAssetModel: crate::codegen::structs_codegen::tables::insertables::PhysicalAssetModelBuildable<
            Attributes = crate::codegen::structs_codegen::tables::insertables::InsertablePhysicalAssetModelAttributes,
        >,
...
for InsertablePackagingModelBuilder<PhysicalAssetModel> {
    type Attributes = crate::codegen::structs_codegen::tables::insertables::InsertablePackagingModelAttributes;
    #[inline]
...
where
    Self: web_common_traits::database::InsertableVariant<
            ...
            Error = web_common_traits::database::InsertError<InsertablePackagingModelAttributes>,
        >,
    PhysicalAssetModel: web_common_traits::database::TryInsertGeneric<C, PrimaryKey = i32>,
{
    type Attributes = InsertablePackagingModelAttributes;
    ...
    fn mint_primary_key(
        ...
        let insertable: crate::codegen::structs_codegen::tables::packaging_models::PackagingModel =
