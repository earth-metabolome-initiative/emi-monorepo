...
pub enum InsertableWeighingDeviceExtensionAttribute {
    PhysicalAsset(
        crate::codegen::structs_codegen::tables::insertables::InsertablePhysicalAssetAttribute,
    ),
}
impl core::fmt::Display for InsertableWeighingDeviceExtensionAttribute {
...
impl From<crate::codegen::structs_codegen::tables::insertables::InsertablePhysicalAssetAttribute>
    for InsertableWeighingDeviceExtensionAttribute
{
    fn from(
...
#[derive(Copy, Clone, PartialEq, Eq, PartialOrd, Ord, Hash, core::fmt::Debug)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub enum InsertableWeighingDeviceAttribute {
    Extension(InsertableWeighingDeviceExtensionAttribute),
    Id,
    Model,
}
impl core::str::FromStr for InsertableWeighingDeviceAttribute {
...
impl core::fmt::Display for InsertableWeighingDeviceAttribute {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
...
> WeighingDeviceSettable for InsertableWeighingDeviceBuilder<PhysicalAsset> {
    type Attributes = crate::codegen::structs_codegen::tables::insertables::InsertableWeighingDeviceAttribute;
    ///Sets the value of the `public.weighing_devices.model` column.
    ///
...
where
    Self: crate::codegen::structs_codegen::tables::insertables::PhysicalAssetSettable<
        Attributes = crate::codegen::structs_codegen::tables::insertables::InsertableWeighingDeviceAttribute,
    >,
{
    type Attributes = crate::codegen::structs_codegen::tables::insertables::InsertableWeighingDeviceAttribute;
    #[inline]
...
where
    Self: web_common_traits::database::InsertableVariant<
            ...
            Error = web_common_traits::database::InsertError<InsertableWeighingDeviceAttribute>,
        >,
    PhysicalAsset:
        web_common_traits::database::TryInsertGeneric<C, PrimaryKey = ::rosetta_uuid::Uuid>,
{
    type Attributes = InsertableWeighingDeviceAttribute;
