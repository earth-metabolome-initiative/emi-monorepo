...
#[diesel(table_name = crate::database::schema::team_states)]
...
impl TeamState {
    ...
    pub fn all_viewable(
        ...
        use crate::database::schema::team_states;
        let query = team_states::dsl::team_states
            .select(TeamState::as_select())
            .order_by(team_states::dsl::id);
    ...
    pub fn strict_word_similarity_search_viewable(
        ...
        let mut query = team_states::dsl::team_states
            .select(TeamState::as_select())
            .filter(
                crate::database::sql_function_bindings::concat_team_states_name_description(
                    team_states::dsl::name,
                    team_states::dsl::description,
                )
