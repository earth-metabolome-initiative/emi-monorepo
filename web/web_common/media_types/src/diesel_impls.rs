#![cfg(feature = "diesel")]
//! Submodule providing the diesel implementations for tool categories.

mod postgres;
mod sqlite;

/// The [`RootMediaType`] SQL type.
#[derive(
...
#[cfg_attr(
    ...
    diesel(postgres_type(name = "RootMediaType"))
)]
#[cfg_attr(feature = "sqlite", diesel(sqlite_type(name = "Text")))]
pub struct RootMediaType;
