...
impl web_common_traits::prelude::HasForeignKeys for crate::SpectraCollection {
    type ForeignKeys = SpectraCollectionForeignKeys;
...
impl web_common_traits::prelude::ForeignKeys for SpectraCollectionForeignKeys {}
