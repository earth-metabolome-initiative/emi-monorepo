//! Submodule defining the Transmute trait, which allows for unsafe
...
pub trait TransmuteFrom<Source> {
    ...
    /// # Safety
    ///
    /// This function is unsafe because it performs a transmutation between
    /// types without any checks. It is up to the caller to ensure that the
