...
impl Tabular for Rank {
    const TABLE: crate::database::Table = crate::database::Table::Ranks;
}
impl Describable for Rank {
    fn description(&self) -> Option<&str> {
        Some(self.description.as_str())
    }
}
impl Colorable for Rank {
    fn color(&self) -> Option<&str> {
        None
    }
}

impl Filtrable for crate::database::flat_variants::Rank {
    type Filter = crate::database::filter_variants::RankFilter;
}
#[cfg(feature = "frontend")]
impl AllRecords for Rank {
