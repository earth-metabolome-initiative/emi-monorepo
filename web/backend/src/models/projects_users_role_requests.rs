...
impl ProjectsUsersRoleRequest {
    ...
    pub fn can_view_by_id(
        ...
        diesel::select(can_view_projects_users_role_requests(
            author_user_id,
            table_id,
            user_id,
        ))
    ...
    pub fn all_viewable(
        ...
        query
            .filter(can_view_projects_users_role_requests(
                author_user_id,
    ...
    pub fn can_update_by_id(
        ...
        diesel::select(can_update_projects_users_role_requests(
            author_user_id,
            table_id,
            user_id,
        ))
    ...
    pub fn all_updatable(
        ...
        query
            .filter(can_update_projects_users_role_requests(
                author_user_id,
                projects_users_role_requests::dsl::table_id,
                projects_users_role_requests::dsl::user_id,
            ))
    ...
    pub fn can_admin_by_id(
        ...
        diesel::select(can_admin_projects_users_role_requests(
            author_user_id,
            table_id,
            user_id,
        ))
    ...
    pub fn all_administrable(
        ...
        query
            .filter(can_admin_projects_users_role_requests(
                author_user_id,
                projects_users_role_requests::dsl::table_id,
                projects_users_role_requests::dsl::user_id,
            ))
