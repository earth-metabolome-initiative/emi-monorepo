...
impl Nameplate {
    ...
    pub fn can_view_by_id(
        ...
        diesel::select(crate::database::sql_function_bindings::can_view_nameplates(
            author_user_id,
            id,
        ))
    ...
    pub fn all_viewable(
        ...
        let query = nameplates::dsl::nameplates
            ...
            .filter(crate::database::sql_function_bindings::can_view_nameplates(
                author_user_id,
                nameplates::dsl::id,
            ))
    ...
    pub fn can_update_by_id(
        ...
        diesel::select(
            crate::database::sql_function_bindings::can_update_nameplates(author_user_id, id),
        )
        .get_result(connection)
        .map_err(web_common::api::ApiError::from)
    }
    ...
    pub fn all_updatable(
        ...
        let query = nameplates::dsl::nameplates
            .select(Nameplate::as_select())
            .filter(
                crate::database::sql_function_bindings::can_update_nameplates(
                    author_user_id,
                    nameplates::dsl::id,
                ),
            )
    ...
    pub fn can_admin_by_id(
        ...
        diesel::select(
            crate::database::sql_function_bindings::can_admin_nameplates(author_user_id, id),
        )
        .get_result(connection)
        .map_err(web_common::api::ApiError::from)
    }
    ...
    pub fn all_administrable(
        ...
        let query = nameplates::dsl::nameplates
            .select(Nameplate::as_select())
            .filter(
                crate::database::sql_function_bindings::can_admin_nameplates(
                    author_user_id,
                    nameplates::dsl::id,
                ),
            )
    ...
    pub fn delete_by_id(
        ...
        diesel::delete(
            crate::database::nameplates::dsl::nameplates
                .filter(crate::database::nameplates::dsl::id.eq(id)),
        )
        .execute(connection)
        .map_err(web_common::api::ApiError::from)
    }
