...
mod photographs;
pub use photographs::{
    InsertablePhotograph, InsertablePhotographAttributes, InsertablePhotographBuilder,
};
...
pub use step_model_categories::{
    InsertableStepModelCategory, InsertableStepModelCategoryAttributes,
    InsertableStepModelCategoryBuilder,
};
