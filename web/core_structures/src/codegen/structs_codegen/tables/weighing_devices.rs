...
#[diesel(belongs_to(crate::CommercialWeighingDeviceLot, foreign_key = model))]
...
impl<'a> From<&'a WeighingDevice>
    for web_common_traits::database::IdOrBuilder<
        ::rosetta_uuid::Uuid,
        crate::codegen::structs_codegen::tables::insertables::InsertableWeighingDeviceBuilder,
    >
{
    fn from(value: &'a WeighingDevice) -> Self {
        web_common_traits::database::IdOrBuilder::Id(value.id)
    }
}
impl web_common_traits::prelude::ExtensionTable<crate::Asset> for WeighingDevice where
    for<'a> &'a Self: diesel::Identifiable<Id = &'a ::rosetta_uuid::Uuid>
{
}
impl web_common_traits::prelude::ExtensionTable<crate::PhysicalAsset> for WeighingDevice where
    for<'a> &'a Self: diesel::Identifiable<Id = &'a ::rosetta_uuid::Uuid>
{
}
impl web_common_traits::prelude::ExtensionTable<crate::WeighingDevice> for WeighingDevice where
    for<'a> &'a Self: diesel::Identifiable<Id = &'a ::rosetta_uuid::Uuid>
{
}
...
impl WeighingDevice {
    ...
    where
        ...
        <Self as diesel::associations::HasTable>::Table: diesel::query_dsl::methods::FilterDsl<
            <crate::codegen::diesel_codegen::tables::weighing_devices::weighing_devices::id as diesel::expression_methods::EqAll<
                ::rosetta_uuid::Uuid,
            >>::Output,
        >,
        ...
        >>::Output: diesel::query_dsl::methods::OrderDsl<
            diesel::helper_types::Asc<
                crate::codegen::diesel_codegen::tables::weighing_devices::weighing_devices::id,
            >,
        >,
        <<<Self as diesel::associations::HasTable>::Table as diesel::query_dsl::methods::FilterDsl<
            <crate::codegen::diesel_codegen::tables::weighing_devices::weighing_devices::id as diesel::expression_methods::EqAll<
            ...
            + for<'a> diesel::query_dsl::LoadQuery<'a, C, Self>,
    {
        ...
        Self::table()
            .filter(weighing_devices::id.eq(id))
    ...
    pub fn from_model(
        ...
        use crate::codegen::diesel_codegen::tables::{
            physical_assets::physical_assets, weighing_devices::weighing_devices,
        };
        Self::table()
            .inner_join(physical_assets::table.on(weighing_devices::id.eq(physical_assets::id)))
