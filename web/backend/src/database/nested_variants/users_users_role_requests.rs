...
impl NestedUsersUsersRoleRequest {
    ...
    /// * `connection` - The connection to the database.
    pub fn all_viewable(
        filter: Option<&web_common::database::filter_variants::UsersUsersRoleRequestFilter>,
        author_user_id: Option<i32>,
        limit: Option<i64>,
        offset: Option<i64>,
        connection: &mut diesel::r2d2::PooledConnection<
        ...
        UsersUsersRoleRequest::all_viewable(filter, author_user_id, limit, offset, connection)?
            .into_iter()
    ...
    pub fn all_viewable_sorted(
        ...
        UsersUsersRoleRequest::all_viewable_sorted(
            filter,
            author_user_id,
            limit,
            offset,
    ...
    pub fn strict_word_similarity_search_viewable(
        ...
        UsersUsersRoleRequest::strict_word_similarity_search_viewable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn can_update_by_id() -> Result<bool, web_common::api::ApiError> {
        UsersUsersRoleRequest::can_update_by_id()
    }
    ...
    pub fn all_updatable(
        ...
        UsersUsersRoleRequest::all_updatable(filter, author_user_id, limit, offset, connection)?
            .into_iter()
            .map(|flat_variant| Self::from_flat(flat_variant, connection))
            .collect()
    }
    ...
    pub fn strict_word_similarity_search_updatable(
        ...
        UsersUsersRoleRequest::strict_word_similarity_search_updatable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn all_administrable(
        ...
        UsersUsersRoleRequest::all_administrable(filter, author_user_id, limit, offset, connection)?
            .into_iter()
            .map(|flat_variant| Self::from_flat(flat_variant, connection))
            .collect()
    }
    ...
    pub fn strict_word_similarity_search_administrable(
        ...
        UsersUsersRoleRequest::strict_word_similarity_search_administrable(
            filter,
            author_user_id,
            query,
            limit,
...
impl From<web_common::database::nested_variants::NestedUsersUsersRoleRequest>
    for crate::database::nested_variants::NestedUsersUsersRoleRequest
{
    fn from(item: web_common::database::nested_variants::NestedUsersUsersRoleRequest) -> Self {
        Self {
            inner: crate::database::flat_variants::UsersUsersRoleRequest::from(item.inner),
...
impl From<crate::database::nested_variants::NestedUsersUsersRoleRequest>
    for web_common::database::nested_variants::NestedUsersUsersRoleRequest
{
    fn from(item: crate::database::nested_variants::NestedUsersUsersRoleRequest) -> Self {
        Self {
            inner: web_common::database::flat_variants::UsersUsersRoleRequest::from(item.inner),
