...
pub struct ContainerRuleForeignKeys {
    pub user_created:
...
impl web_common_traits::prelude::HasForeignKeys
    for crate::codegen::structs_codegen::tables::container_rules::ContainerRule
{
    type ForeignKeys = ContainerRuleForeignKeys;
    ...
    fn update(
        ...
        match (row, crud) {
            ...
            (
                ...
                if container_models.id == self.child_container {
                    foreign_keys.child_container = Some(container_models.clone());
                    updated = true;
                }
                if container_models.id == self.parent_container {
                    foreign_keys.parent_container = Some(container_models.clone());
                    updated = true;
                }
            }
            (
...
impl web_common_traits::prelude::ForeignKeys for ContainerRuleForeignKeys {}
