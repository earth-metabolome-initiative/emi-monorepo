...
pub enum CommercialPipetteTipLotExtensionAttribute {
...
impl core::fmt::Display for CommercialPipetteTipLotExtensionAttribute {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            Self::CommercialProductLot(e) => {
                write!(f, "commercial_pipette_tip_lots({e})")
            }
            Self::PipetteTipModel(e) => write!(f, "commercial_pipette_tip_lots({e})"),
        }
    }
}
impl From<crate::codegen::structs_codegen::tables::insertables::CommercialProductLotAttribute>
    for CommercialPipetteTipLotExtensionAttribute
{
    fn from(
...
pub enum CommercialPipetteTipLotAttribute {
    Extension(CommercialPipetteTipLotExtensionAttribute),
    Id,
    ProductModel,
}
impl core::str::FromStr for CommercialPipetteTipLotAttribute {
...
impl web_common_traits::database::TableField for CommercialPipetteTipLotAttribute {}
impl web_common_traits::database::HasTableType for CommercialPipetteTipLotAttribute {
    ...
    > for CommercialPipetteTipLotAttribute
{
    fn from_extension(
        ...
        CommercialPipetteTipLotAttribute::Extension(From::from(attribute))
    }
}
impl
    web_common_traits::database::FromExtension<
...
impl core::fmt::Display for CommercialPipetteTipLotAttribute {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            ...
            Self::Id => write!(f, "commercial_pipette_tip_lots.id"),
            Self::ProductModel => write!(f, "commercial_pipette_tip_lots.product_model"),
        }
    }
}
#[derive(Debug)]
...
/// [`CommercialPipetteTipLot`](crate::codegen::structs_codegen::tables::commercial_pipette_tip_lots::CommercialPipetteTipLot).
///
///
...
///
/// ```rust,ignore
/// use core_structures::CommercialPipetteTipLot;
/// use core_structures::tables::insertables::AssetModelSettable;
/// use core_structures::tables::insertables::CommercialPipetteTipLotSettable;
/// use core_structures::tables::insertables::CommercialProductLotSettable;
/// use web_common_traits::database::Insertable;
/// use web_common_traits::database::InsertableVariant;
///
/// let commercial_pipette_tip_lot = CommercialPipetteTipLot::new()
...
impl<CommercialProductLot, PipetteTipModel> diesel::associations::HasTable
    for InsertableCommercialPipetteTipLotBuilder<CommercialProductLot, PipetteTipModel>
{
    type Table = crate::codegen::diesel_codegen::tables::commercial_pipette_tip_lots::commercial_pipette_tip_lots::table;
    fn table() -> Self::Table {
        crate::codegen::diesel_codegen::tables::commercial_pipette_tip_lots::commercial_pipette_tip_lots::table
    }
}
impl From<InsertableCommercialPipetteTipLotBuilder>
    for web_common_traits::database::IdOrBuilder<i32, InsertableCommercialPipetteTipLotBuilder>
{
    fn from(builder: InsertableCommercialPipetteTipLotBuilder) -> Self {
        Self::Builder(builder)
    }
}
impl<CommercialProductLot, PipetteTipModel> common_traits::builder::IsCompleteBuilder
for crate::codegen::structs_codegen::tables::insertables::InsertableCommercialPipetteTipLotBuilder<
    CommercialProductLot,
    PipetteTipModel,
>
...
pub trait CommercialPipetteTipLotSettable: Sized {
    /// Error type returned when setting attributes.
    type Error;
    /// Sets the value of the `public.commercial_pipette_tip_lots.product_model`
    /// column.
    ///
    /// # Arguments
    /// * `product_model`: The value to set for the
    ///   `public.commercial_pipette_tip_lots.product_model` column.
    ///
    /// # Implementation details
...
impl<
    CommercialProductLot: crate::codegen::structs_codegen::tables::insertables::CommercialProductLotSettable<
        ...
        >,
    PipetteTipModel,
> CommercialPipetteTipLotSettable
for InsertableCommercialPipetteTipLotBuilder<CommercialProductLot, PipetteTipModel>
where
    Self: common_traits::builder::Attributed<
        Attribute = crate::codegen::structs_codegen::tables::insertables::CommercialPipetteTipLotAttribute,
    >,
{
    type Error = web_common_traits::database::InsertError<
        <Self as common_traits::builder::Attributed>::Attribute,
    >;
    ///Sets the value of the `public.commercial_pipette_tip_lots.product_model` column.
    ///
    ...
    ///end
    ///subgraph v5 ["`commercial_pipette_tip_lots`"]
        ...
        PM: web_common_traits::database::PrimaryKeyLike<PrimaryKey = i32>,
    {
        ...
        self.commercial_pipette_tip_lots_id_fkey = <CommercialProductLot as crate::codegen::structs_codegen::tables::insertables::CommercialProductLotSettable>::product_model(
        ...
        self.commercial_pipette_tip_lots_id_fkey = <CommercialProductLot as crate::codegen::structs_codegen::tables::insertables::PhysicalAssetModelSettable>::parent_model(
                self.commercial_pipette_tip_lots_id_fkey,
                product_model,
            )
            .map_err(|err| {
    ...
    >,
{
    ...
    {
        self.commercial_pipette_tip_lots_id_fkey = <CommercialProductLot as crate::codegen::structs_codegen::tables::insertables::AssetModelSettable>::name(
                self.commercial_pipette_tip_lots_id_fkey,
                name,
            )
            .map_err(|e| {
    ...
    {
        self.commercial_pipette_tip_lots_id_fkey = <CommercialProductLot as crate::codegen::structs_codegen::tables::insertables::AssetModelSettable>::description(
                self.commercial_pipette_tip_lots_id_fkey,
                description,
            )
            .map_err(|e| {
    ...
    {
        self.commercial_pipette_tip_lots_id_fkey = <CommercialProductLot as crate::codegen::structs_codegen::tables::insertables::AssetModelSettable>::created_by(
                self.commercial_pipette_tip_lots_id_fkey,
                created_by,
            )
            .map_err(|e| {
    ...
    where
        ...
        >,
    {
        self.commercial_pipette_tip_lots_id_fkey = <CommercialProductLot as crate::codegen::structs_codegen::tables::insertables::AssetModelSettable>::created_at(
                self.commercial_pipette_tip_lots_id_fkey,
                created_at,
            )
            .map_err(|e| {
    ...
    {
        self.commercial_pipette_tip_lots_id_fkey = <CommercialProductLot as crate::codegen::structs_codegen::tables::insertables::AssetModelSettable>::updated_by(
                self.commercial_pipette_tip_lots_id_fkey,
                updated_by,
            )
            .map_err(|e| {
    ...
    where
        ...
        >,
    {
        self.commercial_pipette_tip_lots_id_fkey = <CommercialProductLot as crate::codegen::structs_codegen::tables::insertables::AssetModelSettable>::updated_at(
                self.commercial_pipette_tip_lots_id_fkey,
                updated_at,
            )
            .map_err(|e| {
...
where
    Self: common_traits::builder::Attributed<
        Attribute = crate::codegen::structs_codegen::tables::insertables::CommercialPipetteTipLotAttribute,
    >,
    Self: crate::codegen::structs_codegen::tables::insertables::CommercialPipetteTipLotSettable<
        Error = web_common_traits::database::InsertError<
            crate::codegen::structs_codegen::tables::insertables::CommercialPipetteTipLotAttribute,
        >,
    >,
{
    ...
    {
        self.commercial_pipette_tip_lots_id_fkey = <CommercialProductLot as crate::codegen::structs_codegen::tables::insertables::CommercialProductLotSettable>::lot(
                self.commercial_pipette_tip_lots_id_fkey,
                lot,
            )
            .map_err(|e| {
    ...
    where
        PM: web_common_traits::database::PrimaryKeyLike<PrimaryKey = i32>,
    {
        <Self as CommercialPipetteTipLotSettable>::product_model(self, product_model)
    }
}
impl<
    CommercialProductLot,
    ...
    >,
{
    ...
    where
        PM: web_common_traits::database::MaybePrimaryKeyLike<PrimaryKey = i32>,
    {
        <Self as CommercialPipetteTipLotSettable>::product_model(
            self,
...
impl<CommercialProductLot, PipetteTipModel> web_common_traits::database::MostConcreteTable
    for InsertableCommercialPipetteTipLotBuilder<CommercialProductLot, PipetteTipModel>
where
    ...
    PipetteTipModel: web_common_traits::database::MostConcreteTable,
{
    fn set_most_concrete_table(&mut self, table_name: &str) {
        self.commercial_pipette_tip_lots_id_fkey.set_most_concrete_table(table_name);
        self.commercial_pipette_tip_lots_id_fkey1.set_most_concrete_table(table_name);
    }
}
