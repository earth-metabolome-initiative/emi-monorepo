...
pub struct CommercialFreezeDryerLotForeignKeys {
    pub commercial_freeze_dryer_lots_id_fkey: Option<crate::CommercialProductLot>,
    pub commercial_freeze_dryer_lots_id_fkey1: Option<crate::FreezeDryerModel>,
    pub product_model: Option<crate::CommercialFreezeDryerModel>,
}
impl web_common_traits::prelude::HasForeignKeys for crate::CommercialFreezeDryerLot {
    ...
    fn update(
        ...
        match (row, crud) {
            (
                ...
                if self.product_model == commercial_freeze_dryer_models.id {
            ...
            (
                ...
                if self.id == commercial_product_lots.id {
                    foreign_keys.commercial_freeze_dryer_lots_id_fkey =
            ...
            (
                ...
                if self.id == freeze_dryer_models.id {
                    foreign_keys.commercial_freeze_dryer_lots_id_fkey1 = Some(freeze_dryer_models);
                    updated = true;
                }
            }
            (
