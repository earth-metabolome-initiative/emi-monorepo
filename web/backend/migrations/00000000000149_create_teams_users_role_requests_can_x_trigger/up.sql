...
CREATE FUNCTION can_update_teams_users_role_requests(author_user_id INTEGER, this_teams_users_role_requests_table_id INTEGER, this_teams_users_role_requests_user_id INTEGER)
RETURNS BOOLEAN AS $$
DECLARE
