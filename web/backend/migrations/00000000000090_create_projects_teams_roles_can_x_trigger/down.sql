-- Drop the `can_update_projects_teams_roles` function and trigger on the projects_teams_roles table.

DROP FUNCTION IF EXISTS can_update_projects_teams_roles(INTEGER, INTEGER, INTEGER);
