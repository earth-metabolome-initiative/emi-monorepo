...
pub use tables::{
    ...
    FreezingProcedureModel, GeolocationProcedureModel, InstrumentModel, InstrumentState,
    LoginProvider, Material, MixingProcedureModel, NextProcedureModel, ObservationSubject,
    Organism, OrganismTaxon, Organization, PackagingProcedureModel, ParentProcedureModel,
    PermanenceCategory, PhoneModel, PhotographProcedureModel, PipetteModel, PipetteTipModel,
    PlacingProcedureModel, PositioningDeviceModel, PouringProcedureModel, Procedure,
