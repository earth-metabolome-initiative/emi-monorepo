diesel::table! {
    ...
    diesel::sql_types::SmallInt, icon -> font_awesome_icons::diesel_impls::FAIcon,
    color_id -> diesel::sql_types::SmallInt, parent_project_id ->
    diesel::sql_types::Nullable < diesel::sql_types::Integer >, budget ->
    diesel::sql_types::Nullable < diesel::sql_types::Double >, expenses ->
