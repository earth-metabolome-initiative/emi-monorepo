...
impl Filtrable for crate::database::flat_variants::ProjectsUsersRoleRequest {
    type Filter = crate::database::filter_variants::ProjectsUsersRoleRequestFilter;
}
#[cfg(feature = "frontend")]
impl AllRecords for ProjectsUsersRoleRequest {
...
impl ProjectsUsersRoleRequest {
    ...
    async fn insert<C: gluesql::core::store::GStore + gluesql::core::store::GStoreMut>(
        ...
        Ok(table("projects_users_role_requests")
            .insert()
