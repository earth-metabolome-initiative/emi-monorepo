...
impl From<common_traits::builder::EmptyTuple> for CameraExtensionAttribute {
...
pub enum CameraAttribute {
    Extension(CameraExtensionAttribute),
    Id,
    Model,
}
impl core::str::FromStr for CameraAttribute {
...
impl<T1> common_traits::builder::Attributed
    for crate::codegen::structs_codegen::tables::insertables::InsertableCameraBuilder<T1>
{
...
impl core::fmt::Display for CameraAttribute {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            ...
            Self::Id => write!(f, "cameras.id"),
            Self::Model => write!(f, "cameras.model"),
        }
    }
}
#[derive(Debug)]
...
///
/// ```rust,ignore
/// use core_structures::Camera;
/// use core_structures::tables::insertables::AssetSettable;
/// use core_structures::tables::insertables::CameraSettable;
...
impl<PhysicalAsset> diesel::associations::HasTable for InsertableCameraBuilder<PhysicalAsset> {
    type Table = crate::codegen::diesel_codegen::tables::cameras::cameras::table;
    fn table() -> Self::Table {
        crate::codegen::diesel_codegen::tables::cameras::cameras::table
    }
}
impl From<InsertableCameraBuilder>
    for web_common_traits::database::IdOrBuilder<::rosetta_uuid::Uuid, InsertableCameraBuilder>
{
...
/// descendant tables.
pub trait CameraSettable: Sized {
    /// Error type returned when setting attributes.
    type Error;
    /// Sets the value of the `public.cameras.model` column.
    ///
    /// # Arguments
    /// * `model`: The value to set for the `public.cameras.model` column.
    ///
    /// # Implementation details
...
impl<
    PhysicalAsset: crate::codegen::structs_codegen::tables::insertables::PhysicalAssetSettable<
            ...
            >,
        >,
> CameraSettable for InsertableCameraBuilder<PhysicalAsset>
where
    Self: common_traits::builder::Attributed<
            Attribute = crate::codegen::structs_codegen::tables::insertables::CameraAttribute,
        >,
{
...
> crate::codegen::structs_codegen::tables::insertables::AssetSettable
    for InsertableCameraBuilder<PhysicalAsset>
where
    Self: common_traits::builder::Attributed<
            Attribute = crate::codegen::structs_codegen::tables::insertables::CameraAttribute,
        >,
...
where
    Self: common_traits::builder::Attributed<
            Attribute = crate::codegen::structs_codegen::tables::insertables::CameraAttribute,
        >,
    Self: crate::codegen::structs_codegen::tables::insertables::CameraSettable<
            Error = web_common_traits::database::InsertError<
                crate::codegen::structs_codegen::tables::insertables::CameraAttribute,
            >,
        >,
{
    ...
    where
        M: web_common_traits::database::PrimaryKeyLike<PrimaryKey = i32>,
    {
        <Self as CameraSettable>::model(self, model)
    }
}
