...
pub struct PlacingProcedureModelForeignKeys {
    ...
    >,
    pub placed_into: Option<
        crate::codegen::structs_codegen::tables::volumetric_container_models::VolumetricContainerModel,
    >,
    pub procedure_placed_into: Option<
        crate::codegen::structs_codegen::tables::procedure_model_trackables::ProcedureModelTrackable,
    >,
}
...
{
    type ForeignKeys = PlacingProcedureModelForeignKeys;
    ...
    fn foreign_keys_loaded(&self, foreign_keys: &Self::ForeignKeys) -> bool {
        foreign_keys.procedure_model.is_some()
            ...
            && foreign_keys.placed_into.is_some()
            && foreign_keys.procedure_placed_into.is_some()
    }
    fn update(
        &self,
        ...
        match (row, crud) {
            (
                ...
                if self.procedure_placed_into == procedure_model_trackables.id {
                    foreign_keys.procedure_placed_into = Some(procedure_model_trackables.clone());
                    updated = true;
                }
            }
            (
                ...
                if self.procedure_placed_into == procedure_model_trackables.id {
                    foreign_keys.procedure_placed_into = None;
                    updated = true;
                }
            }
            (
            ...
            (
                ...
                if self.placed_into == volumetric_container_models.id {
                    foreign_keys.placed_into = Some(volumetric_container_models);
                    updated = true;
                }
            }
            (
...
impl web_common_traits::prelude::ForeignKeys for PlacingProcedureModelForeignKeys {}
