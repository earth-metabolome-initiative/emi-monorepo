...
CREATE TABLE IF NOT EXISTS derived_samples (
    ...
    parent_sample_id UUID NOT NULL REFERENCES samples(barcode_id) ON DELETE CASCADE,
    child_sample_id UUID NOT NULL REFERENCES samples(barcode_id) ON DELETE CASCADE,
