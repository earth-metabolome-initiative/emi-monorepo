...
pub enum InsertableGrindingStepModelAttributes {
    Id,
...
impl core::fmt::Display for InsertableGrindingStepModelAttributes {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            InsertableGrindingStepModelAttributes::Id => write!(f, "id"),
            InsertableGrindingStepModelAttributes::StepModelInstrumentCategoryId => {
                write!(f, "step_model_instrument_category_id")
            }
            InsertableGrindingStepModelAttributes::Seconds => write!(f, "seconds"),
            InsertableGrindingStepModelAttributes::Hertz => write!(f, "hertz"),
            InsertableGrindingStepModelAttributes::CreatedBy => write!(f, "created_by"),
            InsertableGrindingStepModelAttributes::CreatedAt => write!(f, "created_at"),
            InsertableGrindingStepModelAttributes::UpdatedBy => write!(f, "updated_by"),
            InsertableGrindingStepModelAttributes::UpdatedAt => write!(f, "updated_at"),
        }
    }
}
...
#[cfg_attr(
    ...
    diesel(
        table_name = crate::codegen::diesel_codegen::tables::grinding_step_models::grinding_step_models
    )
)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct InsertableGrindingStepModel {
    id: i32,
...
impl InsertableGrindingStepModel {
...
#[derive(Default)]
pub struct InsertableGrindingStepModelBuilder {
    id: Option<i32>,
...
impl InsertableGrindingStepModelBuilder {
    ...
    pub fn seconds(
        ...
        pgrx_validation::must_be_strictly_positive_f32(seconds)
            .map_err(|e| e.rename_field(InsertableGrindingStepModelAttributes::Seconds))?;
    ...
    pub fn hertz(
        ...
        pgrx_validation::must_be_strictly_positive_f32(hertz)
            .map_err(|e| e.rename_field(InsertableGrindingStepModelAttributes::Hertz))?;
...
impl common_traits::prelude::Builder for InsertableGrindingStepModelBuilder {
    type Error = web_common_traits::database::InsertError<InsertableGrindingStepModelAttributes>;
    type Object = InsertableGrindingStepModel;
