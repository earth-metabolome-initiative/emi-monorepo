...
impl diesel::Identifiable for ToolModel {
    type Id = i32;
    fn id(self) -> Self::Id {
        self.id
    }
...
impl ToolModel {
    ...
    pub async fn from_id(
        ...
        Self::table()
            .filter(
                crate::codegen::diesel_codegen::tables::tool_models::tool_models::dsl::id.eq(id.id),
            )
            .first::<Self>(conn)
            .await
    }
    ...
    pub async fn from_created_by(
        ...
        Self::table()
            .filter(
                crate::codegen::diesel_codegen::tables::tool_models::tool_models::dsl::created_by
                    .eq(created_by.id),
            )
            .load::<Self>(conn)
            .await
    ...
    pub async fn from_updated_by(
        ...
        Self::table()
            .filter(
                crate::codegen::diesel_codegen::tables::tool_models::tool_models::dsl::updated_by
                    .eq(updated_by.id),
            )
            .load::<Self>(conn)
            .await
    ...
    pub async fn from_tool_category(
        ...
        Self::table()
            .filter(tool_models::tool_category.eq(tool_category))
            .order_by(tool_models::id.asc())
            .load::<Self>(conn)
            .await
    }
    #[cfg(feature = "postgres")]
    pub async fn from_created_at(
        ...
        use crate::codegen::diesel_codegen::tables::tool_models::tool_models;
        Self::table()
            .filter(tool_models::created_at.eq(created_at))
            .order_by(tool_models::id.asc())
            .load::<Self>(conn)
            .await
    }
    ...
    pub async fn from_updated_at(
        ...
        use crate::codegen::diesel_codegen::tables::tool_models::tool_models;
        Self::table()
            .filter(tool_models::updated_at.eq(updated_at))
            .order_by(tool_models::id.asc())
            .load::<Self>(conn)
            .await
    }
