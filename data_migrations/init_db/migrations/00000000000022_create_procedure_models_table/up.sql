...
CREATE TABLE IF NOT EXISTS freeze_drying_procedure_models (
	...
	freeze_dried_with UUID NOT NULL REFERENCES ball_mill_machine_models(id) ON DELETE CASCADE,
	...
	freeze_dried_container_id UUID NOT NULL REFERENCES volumetric_container_models(id) ON DELETE CASCADE,
