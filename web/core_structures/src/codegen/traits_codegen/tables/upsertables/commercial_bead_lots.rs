...
impl web_common_traits::prelude::Upsertable<diesel::PgConnection> for crate::CommercialBeadLot {
    fn upsert(
        &self,
...
#[cfg(feature = "sqlite")]
impl web_common_traits::prelude::Upsertable<diesel::SqliteConnection> for crate::CommercialBeadLot {
    fn upsert(
        &self,
