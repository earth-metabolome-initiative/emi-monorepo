...
impl diesel::Identifiable for GrindingStepModel {
    type Id = i32;
    fn id(self) -> Self::Id {
        self.id
    }
}
impl GrindingStepModel {
    ...
    pub async fn from_id(
        ...
        Self::table()
            .filter(
                crate::codegen::diesel_codegen::tables::grinding_step_models::grinding_step_models::dsl::id
                    .eq(id.id),
            )
            .first::<Self>(conn)
            .await
    ...
    pub async fn from_step_model_instrument_category_id(
        ...
        Self::table()
            .filter(
                crate::codegen::diesel_codegen::tables::grinding_step_models::grinding_step_models::dsl::step_model_instrument_category_id
    ...
    pub async fn from_created_by(
        ...
        Self::table()
            .filter(
                crate::codegen::diesel_codegen::tables::grinding_step_models::grinding_step_models::dsl::created_by
                    .eq(created_by.id),
            )
            .load::<Self>(conn)
            .await
    ...
    pub async fn from_updated_by(
        ...
        Self::table()
            .filter(
                crate::codegen::diesel_codegen::tables::grinding_step_models::grinding_step_models::dsl::updated_by
                    .eq(updated_by.id),
            )
            .load::<Self>(conn)
            .await
