...
impl web_common_traits::prelude::Upsertable<diesel::PgConnection> for crate::ProcedureTemplate {
    fn upsert(
        &self,
...
#[cfg(feature = "sqlite")]
impl web_common_traits::prelude::Upsertable<diesel::SqliteConnection> for crate::ProcedureTemplate {
    fn upsert(
        &self,
