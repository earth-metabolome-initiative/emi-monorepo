...
unsafe impl Send for SampleTaxon {}
unsafe impl Sync for SampleTaxon {}
impl From<web_common::database::flat_variants::SampleTaxon>
    for crate::database::flat_variants::SampleTaxon
{
    fn from(item: web_common::database::flat_variants::SampleTaxon) -> Self {
        Self {
...
impl From<crate::database::flat_variants::SampleTaxon>
    for web_common::database::flat_variants::SampleTaxon
{
    fn from(item: crate::database::flat_variants::SampleTaxon) -> Self {
        Self {
            created_by: item.created_by,
            created_at: item.created_at,
            sample_id: item.sample_id,
