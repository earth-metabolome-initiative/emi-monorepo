...
where
    ...
    crate::codegen::structs_codegen::tables::insertables::WeighingDeviceExtensionAttribute: From<
        ...
        let id = self
            ...
            .map_err(|err| {
                err.into_field_name(|attribute| {
                    crate::codegen::structs_codegen::tables::insertables::WeighingDeviceAttribute::Extension(
                        From::from(attribute),
                    )
                })
            })?;
