...
impl From<std::rc::Rc<crate::codegen::structs_codegen::tables::aliquoting_steps::AliquotingStep>>
    for super::Rows
{
    fn from(
        value: std::rc::Rc<
...
impl
    From<
        Vec<std::rc::Rc<crate::codegen::structs_codegen::tables::aliquoting_steps::AliquotingStep>>,
    > for super::Rows
{
    fn from(
        value: Vec<
            std::rc::Rc<crate::codegen::structs_codegen::tables::aliquoting_steps::AliquotingStep>,
        >,
    ) -> Self {
        Self::from(std::rc::Rc::new(value))
    }
...
impl
    From<
        std::rc::Rc<Vec<crate::codegen::structs_codegen::tables::aliquoting_steps::AliquotingStep>>,
    > for super::Rows
{
    fn from(
        value: std::rc::Rc<
    ...
    > for super::Rows
{
    fn from(
        ...
        super::Rows::AliquotingStep(value)
    }
}
    ...
    >
{
    ...
    fn try_from(value: super::Rows) -> Result<Self, Self::Error> {
        match value {
            super::Rows::AliquotingStep(v) => Ok(v),
