...
impl diesel::deserialize::FromSql<crate::diesel_impls::InstrumentCategory, diesel::sqlite::Sqlite>
    for crate::InstrumentCategory
{
    fn from_sql(
...
impl diesel::serialize::ToSql<crate::diesel_impls::InstrumentCategory, diesel::sqlite::Sqlite>
    for crate::InstrumentCategory
{
    fn to_sql<'b>(
        &'b self,
