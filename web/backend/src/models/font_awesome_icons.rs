...
connection: &mut PooledConnection<ConnectionManager<diesel::prelude::PgConnection>>,
        ...
        font_awesome_icons::dsl::font_awesome_icons
            .filter(
similarity_op(concat_font_awesome_icons_name(font_awesome_icons::dsl::name, font_awesome_icons::dsl::description), query))
            .order(
similarity_dist(concat_font_awesome_icons_name(font_awesome_icons::dsl::name, font_awesome_icons::dsl::description), query))
            .limit(limit.unwrap_or(10))
            .offset(offset.unwrap_or(0))
            .load::<Self>(connection).map_err(web_common::api::ApiError::from)
}
...
connection: &mut PooledConnection<ConnectionManager<diesel::prelude::PgConnection>>,
        ...
        font_awesome_icons::dsl::font_awesome_icons
            .filter(
word_similarity_op(concat_font_awesome_icons_name(font_awesome_icons::dsl::name, font_awesome_icons::dsl::description), query))
            .order(
word_similarity_dist_op(concat_font_awesome_icons_name(font_awesome_icons::dsl::name, font_awesome_icons::dsl::description), query))
            .limit(limit.unwrap_or(10))
            .offset(offset.unwrap_or(0))
            .load::<Self>(connection).map_err(web_common::api::ApiError::from)
}
...
connection: &mut PooledConnection<ConnectionManager<diesel::prelude::PgConnection>>,
        ...
        font_awesome_icons::dsl::font_awesome_icons
            .filter(
strict_word_similarity_op(concat_font_awesome_icons_name(font_awesome_icons::dsl::name, font_awesome_icons::dsl::description), query))
            .order(
strict_word_similarity_dist_op(concat_font_awesome_icons_name(font_awesome_icons::dsl::name, font_awesome_icons::dsl::description), query))
            .limit(limit.unwrap_or(10))
            .offset(offset.unwrap_or(0))
            .load::<Self>(connection).map_err(web_common::api::ApiError::from)
}
