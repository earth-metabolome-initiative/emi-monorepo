...
impl NestedSampleBioOttTaxonItem {
    ...
    /// * `connection` - The connection to the database.
    pub fn all_viewable(
        filter: Option<&web_common::database::filter_variants::SampleBioOttTaxonItemFilter>,
        author_user_id: Option<i32>,
        limit: Option<i64>,
        offset: Option<i64>,
        connection: &mut diesel::r2d2::PooledConnection<
        ...
        SampleBioOttTaxonItem::all_viewable(filter, author_user_id, limit, offset, connection)?
            .into_iter()
    ...
    pub fn all_viewable_sorted(
        ...
        SampleBioOttTaxonItem::all_viewable_sorted(
            filter,
            author_user_id,
            limit,
            offset,
    ...
    pub fn get(
        ...
        SampleBioOttTaxonItem::get((sample_id, taxon_id), author_user_id, connection)
    ...
    pub fn strict_word_similarity_search_viewable(
        ...
        SampleBioOttTaxonItem::strict_word_similarity_search_viewable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn strict_word_similarity_search_with_score_viewable(
        ...
        SampleBioOttTaxonItem::strict_word_similarity_search_with_score_viewable(
            author_user_id,
            query,
            limit,
            offset,
    ...
    pub fn can_update_by_id() -> Result<bool, web_common::api::ApiError> {
        SampleBioOttTaxonItem::can_update_by_id()
    }
    ...
    pub fn all_updatable(
        ...
        SampleBioOttTaxonItem::all_updatable(filter, author_user_id, limit, offset, connection)?
            .into_iter()
    ...
    pub fn all_updatable_sorted(
        ...
        SampleBioOttTaxonItem::all_updatable_sorted(
            filter,
            author_user_id,
            limit,
            offset,
    ...
    pub fn strict_word_similarity_search_updatable(
        ...
        SampleBioOttTaxonItem::strict_word_similarity_search_updatable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn all_administrable(
        ...
        SampleBioOttTaxonItem::all_administrable(filter, author_user_id, limit, offset, connection)?
            .into_iter()
            .map(|flat_variant| Self::from_flat(flat_variant, Some(author_user_id), connection))
            .collect()
    }
    ...
    pub fn all_administrable_sorted(
        ...
        SampleBioOttTaxonItem::all_administrable_sorted(
            filter,
            author_user_id,
            limit,
            offset,
    ...
    pub fn strict_word_similarity_search_administrable(
        ...
        SampleBioOttTaxonItem::strict_word_similarity_search_administrable(
            filter,
            author_user_id,
            query,
            limit,
...
impl From<web_common::database::nested_variants::NestedSampleBioOttTaxonItem>
    for crate::database::nested_variants::NestedSampleBioOttTaxonItem
{
    fn from(item: web_common::database::nested_variants::NestedSampleBioOttTaxonItem) -> Self {
        Self {
            inner: crate::database::flat_variants::SampleBioOttTaxonItem::from(item.inner),
...
impl From<crate::database::nested_variants::NestedSampleBioOttTaxonItem>
    for web_common::database::nested_variants::NestedSampleBioOttTaxonItem
{
    fn from(item: crate::database::nested_variants::NestedSampleBioOttTaxonItem) -> Self {
        Self {
            inner: web_common::database::flat_variants::SampleBioOttTaxonItem::from(item.inner),
