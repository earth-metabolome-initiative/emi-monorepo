...
impl core::fmt::Display for OrganismExtensionAttribute {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            Self::SampleSource(e) => write!(f, "organisms({e})"),
        }
    }
}
...
impl From<common_traits::builder::EmptyTuple> for OrganismExtensionAttribute {
...
impl<T1> common_traits::builder::Attributed
    for crate::codegen::structs_codegen::tables::insertables::InsertableOrganismBuilder<T1>
{
...
///
/// ```rust,ignore
/// use core_structures::Organism;
/// use core_structures::tables::insertables::AssetSettable;
/// use core_structures::tables::insertables::OrganismSettable;
...
impl<SampleSource> diesel::associations::HasTable for InsertableOrganismBuilder<SampleSource> {
    type Table = crate::codegen::diesel_codegen::tables::organisms::organisms::table;
    fn table() -> Self::Table {
...
where
    Self: common_traits::builder::Attributed<
            Attribute = crate::codegen::structs_codegen::tables::insertables::OrganismAttribute,
        >,
{
