...
impl From<std::rc::Rc<crate::codegen::structs_codegen::tables::weighing_steps::WeighingStep>>
    for super::Rows
{
    fn from(
        value: std::rc::Rc<crate::codegen::structs_codegen::tables::weighing_steps::WeighingStep>,
    ) -> Self {
        Self::from(vec![value])
    }
}
...
impl From<Vec<std::rc::Rc<crate::codegen::structs_codegen::tables::weighing_steps::WeighingStep>>>
    for super::Rows
{
    fn from(
        value: Vec<
            std::rc::Rc<crate::codegen::structs_codegen::tables::weighing_steps::WeighingStep>,
        >,
    ) -> Self {
        Self::from(std::rc::Rc::new(value))
    }
}
impl From<std::rc::Rc<Vec<crate::codegen::structs_codegen::tables::weighing_steps::WeighingStep>>>
    for super::Rows
{
    fn from(
        value: std::rc::Rc<
...
impl
    From<
        std::rc::Rc<
            Vec<std::rc::Rc<crate::codegen::structs_codegen::tables::weighing_steps::WeighingStep>>,
        >,
    > for super::Rows
{
    fn from(
