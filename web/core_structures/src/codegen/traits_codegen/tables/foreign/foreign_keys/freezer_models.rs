...
pub struct FreezerModelForeignKeys {
    pub id: Option<crate::PhysicalAssetModel>,
}
impl web_common_traits::prelude::HasForeignKeys for crate::FreezerModel {
    type ForeignKeys = FreezerModelForeignKeys;
...
impl web_common_traits::prelude::ForeignKeys for FreezerModelForeignKeys {}
