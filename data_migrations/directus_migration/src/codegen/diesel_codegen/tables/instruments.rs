diesel::table! {
    #[sql_name = "Instruments"] instruments(id) { id -> diesel::sql_types::Integer,
    ...
    uuid_instrument -> ::rosetta_uuid::diesel_impls::Uuid, instrument_id ->
    diesel::sql_types::Text, instrument_model -> diesel::sql_types::Integer,
    instrument_location -> diesel::sql_types::Integer, grams ->
