...
impl From<crate::codegen::structs_codegen::tables::insertables::InsertableProcedureModelAttributes>
    for InsertableStorageProcedureModelAttributes
{
    fn from(
...
impl core::fmt::Display for InsertableStorageProcedureModelAttributes {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            ...
            InsertableStorageProcedureModelAttributes::ChildContainerId(child_container_id) => {
                write!(f, "{}", child_container_id)
            }
            InsertableStorageProcedureModelAttributes::ParentContainerId(parent_container_id) => {
...
pub struct InsertableStorageProcedureModelBuilder {
    ...
    pub(crate) child_container_id: crate::codegen::structs_codegen::tables::insertables::InsertableProcedureModelTrackableBuilder,
    pub(crate) parent_container_id: crate::codegen::structs_codegen::tables::insertables::InsertableProcedureModelTrackableBuilder,
}
impl InsertableStorageProcedureModelBuilder {
    pub fn child_container_id(
        mut self,
        child_container_id: crate::codegen::structs_codegen::tables::insertables::InsertableProcedureModelTrackableBuilder,
    ) -> Result<
        Self,
        ...
        >,
    >{
        if child_container_id.procedure_model_id.is_some() {
            return Err(
        ...
        self.child_container_id = child_container_id;
        Ok(self)
    }
    pub fn parent_container_id(
        mut self,
        parent_container_id: crate::codegen::structs_codegen::tables::insertables::InsertableProcedureModelTrackableBuilder,
    ) -> Result<
        Self,
        web_common_traits::database::InsertError<
            crate::codegen::structs_codegen::tables::insertables::InsertableProcedureModelTrackableAttributes,
        >,
    >{
        if parent_container_id.procedure_model_id.is_some() {
            return Err(
                web_common_traits::database::InsertError::BuilderError(
                    web_common_traits::prelude::BuilderError::UnexpectedAttribute(
                        crate::codegen::structs_codegen::tables::insertables::InsertableProcedureModelTrackableAttributes::ProcedureModelId,
...
impl InsertableStorageProcedureModelBuilder {
        ...
        >,
    {
        ...
        let parent_container_id = self
            ...
            .map_err(|err| err.into_field_name())?
            .id();
        Ok(InsertableStorageProcedureModel { id, child_container_id, parent_container_id })
    }
}
