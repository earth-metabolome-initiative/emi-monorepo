...
impl crate::database::Tabular for NestedTeamsUsersRoleRequest {
    const TABLE: crate::database::Table = crate::database::Table::TeamsUsersRoleRequests;
}
impl crate::database::Filtrable for NestedTeamsUsersRoleRequest {
    type Filter = crate::database::filter_variants::TeamsUsersRoleRequestFilter;
}
impl crate::database::Describable for NestedTeamsUsersRoleRequest {
    fn description(&self) -> Option<&str> {
        self.inner.description()
    }
}
impl crate::database::Colorable for NestedTeamsUsersRoleRequest {
    fn color(&self) -> Option<&str> {
        None
    }
}
#[cfg(feature = "frontend")]
impl crate::database::AllRecords for NestedTeamsUsersRoleRequest {
...
impl NestedTeamsUsersRoleRequest {
    ...
    pub(crate) async fn from_flat(
        flat_variant: crate::database::flat_variants::TeamsUsersRoleRequest,
    ...
    /// Get the TeamsUsersRoleRequest from the database by its ID.
    ///
    ...
    pub async fn get<C: gluesql::core::store::GStore + gluesql::core::store::GStoreMut>(
        ...
        if let Some(flat_variant) = crate::database::flat_variants::TeamsUsersRoleRequest::get(
            (table_id, user_id),
            connection,
        )
        .await?
    ...
    /// Delete the TeamsUsersRoleRequest from the database.
    ///
    /// * `connection` - The connection to the database.
    ...
    /// Delete the TeamsUsersRoleRequest from the database by its ID.
    ///
    ...
    >(
        ...
        crate::database::flat_variants::TeamsUsersRoleRequest::delete_from_id(
            (table_id, user_id),
            connection,
        )
        .await
    ...
    pub async fn all<C: gluesql::core::store::GStore + gluesql::core::store::GStoreMut>(
        filter: Option<&crate::database::filter_variants::TeamsUsersRoleRequestFilter>,
        limit: Option<i64>,
        offset: Option<i64>,
        connection: &mut gluesql::prelude::Glue<C>,
    ) -> Result<Vec<Self>, crate::api::ApiError> {
        let mut teams_users_role_requests = Vec::new();
        for flat_variant in crate::database::flat_variants::TeamsUsersRoleRequest::all(
            filter, limit, offset, connection,
        )
        .await?
        .into_iter()
        {
            teams_users_role_requests.push(Self::from_flat(flat_variant, connection).await?);
        }
        Ok(teams_users_role_requests)
    }
    ...
    >(
        ...
        .await?;
        crate::database::flat_variants::TeamsUsersRoleRequest::update_or_insert(
            &self.inner,
            connection,
        )
        .await
