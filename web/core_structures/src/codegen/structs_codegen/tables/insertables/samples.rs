...
impl From<common_traits::builder::EmptyTuple> for SampleExtensionAttribute {
...
impl<T1> common_traits::builder::Attributed
    for crate::codegen::structs_codegen::tables::insertables::InsertableSampleBuilder<T1>
{
    type Attribute = SampleAttribute;
}
impl web_common_traits::database::TableField for SampleAttribute {}
impl web_common_traits::database::HasTableType for SampleAttribute {
    ...
    > for SampleAttribute
{
    fn from_extension(
        ...
        SampleAttribute::Extension(From::from(attribute))
    }
}
...
{
    type Error = web_common_traits::database::InsertError<SampleAttribute>;
