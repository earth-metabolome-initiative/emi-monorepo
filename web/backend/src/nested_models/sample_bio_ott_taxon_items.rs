...
impl NestedSampleBioOttTaxonItem {
    ...
    pub fn similarity_search_viewable(
        ...
        SampleBioOttTaxonItem::similarity_search_viewable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn word_similarity_search_viewable(
        ...
        SampleBioOttTaxonItem::word_similarity_search_viewable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn similarity_search_updatable(
        ...
        SampleBioOttTaxonItem::similarity_search_updatable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn word_similarity_search_updatable(
        ...
        SampleBioOttTaxonItem::word_similarity_search_updatable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn similarity_search_administrable(
        ...
        SampleBioOttTaxonItem::similarity_search_administrable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn word_similarity_search_administrable(
        ...
        SampleBioOttTaxonItem::word_similarity_search_administrable(
            filter,
            author_user_id,
            query,
            limit,
...
impl From<web_common::database::nested_models::NestedSampleBioOttTaxonItem>
    for NestedSampleBioOttTaxonItem
{
...
impl From<NestedSampleBioOttTaxonItem>
    for web_common::database::nested_models::NestedSampleBioOttTaxonItem
{
