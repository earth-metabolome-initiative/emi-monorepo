    ...
    for InsertableFreezeDrierModelAttributes
{
    fn from(
        ...
        Self::Extension(InsertableFreezeDrierModelExtensionAttributes::Trackable(trackables))
    }
}
impl core::str::FromStr for InsertableFreezeDrierModelAttributes {
...
for InsertableFreezeDrierModelBuilder<Trackable>
where
        ...
        self.id = self
            ...
            .map_err(|err| {
                err.into_field_name(|attribute| InsertableFreezeDrierModelAttributes::Extension(
                    InsertableFreezeDrierModelExtensionAttributes::Trackable(attribute),
                ))
            })?;
        Ok(self)
    }
    ...
    >
{
    ...
    /// columns from table `freeze_drier_models`.
    ...
    >
{
    ...
    /// from table `freeze_drier_models`.
