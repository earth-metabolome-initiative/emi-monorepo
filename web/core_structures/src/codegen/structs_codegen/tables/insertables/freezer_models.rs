    ...
    for InsertableFreezerModelAttributes
{
    fn from(
        ...
        Self::Extension(InsertableFreezerModelExtensionAttributes::InstrumentModel(
            instrument_models,
        ))
    }
}
...
for InsertableFreezerModelBuilder<InstrumentModel>
where
        ...
        self.id = self
            ...
            .map_err(|err| {
                err.into_field_name(|attribute| InsertableFreezerModelAttributes::Extension(
                    InsertableFreezerModelExtensionAttributes::InstrumentModel(attribute),
                ))
            })?;
        Ok(self)
    }
