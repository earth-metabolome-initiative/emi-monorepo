    ...
    pub fn url(&self) -> &str {
        match self {
            CatalogOfLifeVersion::V2013 => {
                "https://download.checklistbank.org/col/annual/2013_dwca.zip"
            }
            CatalogOfLifeVersion::V2014 => {
                "https://download.checklistbank.org/col/annual/2014_dwca.zip"
            }
            CatalogOfLifeVersion::V2015 => {
                "https://download.checklistbank.org/col/annual/2015_dwca.zip"
            }
            CatalogOfLifeVersion::V2016 => {
                "https://download.checklistbank.org/col/annual/2016_dwca.zip"
            }
            CatalogOfLifeVersion::V2017 => {
                "https://download.checklistbank.org/col/annual/2017_dwca.zip"
            }
            CatalogOfLifeVersion::V2018 => {
                "https://download.checklistbank.org/col/annual/2018_dwca.zip"
            }
            CatalogOfLifeVersion::V2019 => {
                "https://download.checklistbank.org/col/annual/2019_dwca.zip"
            }
            CatalogOfLifeVersion::V2020 => {
                "https://download.checklistbank.org/col/annual/2020_dwca.zip"
            }
            CatalogOfLifeVersion::V2021 => {
                "https://download.checklistbank.org/col/annual/2021_dwca.zip"
            }
            CatalogOfLifeVersion::V2022 => {
                "https://download.checklistbank.org/col/annual/2022_dwca.zip"
            }
            CatalogOfLifeVersion::V2023 => {
                "https://download.checklistbank.org/col/annual/2023_dwca.zip"
            }
            CatalogOfLifeVersion::V2024 => {
                "https://download.checklistbank.org/col/annual/2024_dwca.zip"
            }
        }
    }
