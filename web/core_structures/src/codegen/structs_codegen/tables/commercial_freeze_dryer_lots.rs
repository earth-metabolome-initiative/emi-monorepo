...
#[diesel(belongs_to(crate::CommercialFreezeDryerModel, foreign_key = product_model))]
...
impl web_common_traits::prelude::ExtensionTable<crate::AssetModel> for CommercialFreezeDryerLot where
...
impl web_common_traits::prelude::ExtensionTable<crate::CommercialFreezeDryerLot>
    for CommercialFreezeDryerLot
where
    for<'a> &'a Self: diesel::Identifiable<Id = &'a i32>,
{
...
impl CommercialFreezeDryerLot {
    ...
    pub fn product_model<C: diesel::connection::LoadConnection>(
        &self,
        conn: &mut C,
    ) -> Result<crate::CommercialFreezeDryerModel, diesel::result::Error>
    where
        crate::CommercialFreezeDryerModel: web_common_traits::database::Read<C>,
    {
        use web_common_traits::database::Read;
        crate::CommercialFreezeDryerModel::read(self.product_model, conn)
    }
    ...
    where
        ...
        <Self as diesel::associations::HasTable>::Table: diesel::query_dsl::methods::FilterDsl<
            <crate::codegen::diesel_codegen::tables::commercial_freeze_dryer_lots::commercial_freeze_dryer_lots::id as diesel::expression_methods::EqAll<
                i32,
            >>::Output,
        >,
        ...
        >>::Output: diesel::query_dsl::methods::OrderDsl<
            diesel::helper_types::Asc<
                crate::codegen::diesel_codegen::tables::commercial_freeze_dryer_lots::commercial_freeze_dryer_lots::id,
            >,
        >,
        <<<Self as diesel::associations::HasTable>::Table as diesel::query_dsl::methods::FilterDsl<
            <crate::codegen::diesel_codegen::tables::commercial_freeze_dryer_lots::commercial_freeze_dryer_lots::id as diesel::expression_methods::EqAll<
            ...
            + for<'a> diesel::query_dsl::LoadQuery<'a, C, Self>,
    {
        ...
        Self::table()
            .filter(commercial_freeze_dryer_lots::id.eq(id))
    ...
    pub fn from_id_and_product_model(
        ...
        Self::table()
            .filter(
                commercial_freeze_dryer_lots::id
                    .eq(id)
                    .and(commercial_freeze_dryer_lots::product_model.eq(product_model)),
            )
            .order_by(commercial_freeze_dryer_lots::id.asc())
            .load::<Self>(conn)
    }
