diesel::table! {
    #[sql_name = "Universities"] universities(id) { id -> diesel::sql_types::Integer,
    ...
    rosetta_timestamp::diesel_impls::TimestampUTC >, uuid_university ->
    diesel::sql_types::Nullable < ::rosetta_uuid::diesel_impls::Uuid >, university_name
    -> diesel::sql_types::Text, country -> diesel::sql_types::Text, alpha_two ->
    diesel::sql_types::Text, web_pages -> diesel::sql_types::Text, state ->
