...
where
    ...
    crate::codegen::structs_codegen::tables::insertables::HarvestingProcedureAttribute: web_common_traits::database::FromExtensionAttribute<
    ...
    >,
{
    ...
    type InsertableVariant = crate::codegen::structs_codegen::tables::insertables::InsertableHarvestingProcedure;
        ...
        let procedure = self
            ...
            .map_err(|err| {
                err.into_field_name(|attribute| {
                    <crate::codegen::structs_codegen::tables::insertables::HarvestingProcedureAttribute as web_common_traits::database::FromExtensionAttribute<
                        crate::codegen::structs_codegen::tables::insertables::ProcedureAttribute,
                        Procedure,
