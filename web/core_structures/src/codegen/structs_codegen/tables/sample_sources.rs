...
impl SampleSource {
    ...
    where
        ...
        <Self as diesel::associations::HasTable>::Table: diesel::query_dsl::methods::FilterDsl<
            <crate::codegen::diesel_codegen::tables::sample_sources::sample_sources::id as diesel::expression_methods::EqAll<
                ::rosetta_uuid::Uuid,
            >>::Output,
        >,
        ...
        >>::Output: diesel::query_dsl::methods::OrderDsl<
            diesel::helper_types::Asc<
                crate::codegen::diesel_codegen::tables::sample_sources::sample_sources::id,
            >,
        >,
        <<<Self as diesel::associations::HasTable>::Table as diesel::query_dsl::methods::FilterDsl<
            <crate::codegen::diesel_codegen::tables::sample_sources::sample_sources::id as diesel::expression_methods::EqAll<
            ...
            + for<'a> diesel::query_dsl::LoadQuery<'a, C, Self>,
    {
        ...
        Self::table()
            .filter(sample_sources::id.eq(id))
    ...
    pub fn from_id_and_model(
        ...
        use crate::codegen::diesel_codegen::tables::sample_sources::sample_sources;
        Self::table()
            .filter(sample_sources::id.eq(id).and(sample_sources::model.eq(model)))
            .order_by(sample_sources::id.asc())
            .load::<Self>(conn)
    }
    #[cfg(feature = "postgres")]
