...
/// descendant tables.
pub trait WeighingDeviceBuildable: Sized {
        ...
        let model = model
            ...
            .map_err(|err| {
                validation_errors::SingleFieldError::from(err)
                    .rename_field(InsertableWeighingDeviceAttributes::Model)
            })?;
...
for InsertableWeighingDeviceBuilder<PhysicalAsset>
where
    Self: crate::codegen::structs_codegen::tables::insertables::WeighingDeviceBuildable<
        Attributes = crate::codegen::structs_codegen::tables::insertables::InsertableWeighingDeviceAttributes,
    >,
{
    type Attributes = crate::codegen::structs_codegen::tables::insertables::InsertableWeighingDeviceAttributes;
    ...
    fn model(
        ...
        <Self as WeighingDeviceBuildable>::model(self, model)
    }
}
