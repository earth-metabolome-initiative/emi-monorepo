    ...
    for crate::codegen::structs_codegen::tables::insertables::InsertableProcedureTemplateBuilder
{
    type InsertableVariant =
        crate::codegen::structs_codegen::tables::insertables::InsertableProcedureTemplate;
}
#[cfg(feature = "backend")]
...
where
    ...
    Self: web_common_traits::database::InsertableVariant<
        C,
        InsertableVariant = crate::codegen::structs_codegen::tables::insertables::InsertableProcedureTemplate,
    ...
    Self: web_common_traits::database::MostConcreteTable,
{
    fn try_insert(
        ...
        let most_concrete_table = self
            ...
            .ok_or(
                common_traits::prelude::BuilderError::IncompleteBuild(
                    crate::codegen::structs_codegen::tables::insertables::ProcedureTemplateAttribute::MostConcreteTable,
                ),
            )?;
        let name = self
            .name
        ...
        let created_by = self
            ...
            .ok_or(
                common_traits::prelude::BuilderError::IncompleteBuild(
                    crate::codegen::structs_codegen::tables::insertables::ProcedureTemplateAttribute::CreatedBy,
                ),
            )?;
        let created_at = self
            .created_at
        ...
        let updated_by = self
            ...
            .ok_or(
                common_traits::prelude::BuilderError::IncompleteBuild(
                    crate::codegen::structs_codegen::tables::insertables::ProcedureTemplateAttribute::UpdatedBy,
                ),
            )?;
        let updated_at = self
            .updated_at
