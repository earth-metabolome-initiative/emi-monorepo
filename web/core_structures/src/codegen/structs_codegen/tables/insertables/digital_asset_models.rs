...
impl core::fmt::Display for DigitalAssetModelExtensionAttribute {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            Self::AssetModel(e) => write!(f, "digital_asset_models({e})"),
        }
    }
}
...
impl From<common_traits::builder::EmptyTuple> for DigitalAssetModelExtensionAttribute {
...
impl<T1> common_traits::builder::Attributed
    for crate::codegen::structs_codegen::tables::insertables::InsertableDigitalAssetModelBuilder<T1>
{
    type Attribute = DigitalAssetModelAttribute;
}
impl web_common_traits::database::TableField for DigitalAssetModelAttribute {}
impl web_common_traits::database::HasTableType for DigitalAssetModelAttribute {
    type Table = crate::codegen::tables::table_names::TableName;
}
impl
    web_common_traits::database::FromExtension<
        crate::codegen::structs_codegen::tables::insertables::AssetModelAttribute,
    > for DigitalAssetModelAttribute
{
    fn from_extension(
        attribute: crate::codegen::structs_codegen::tables::insertables::AssetModelAttribute,
    ) -> Self {
        DigitalAssetModelAttribute::Extension(From::from(attribute))
    }
}
...
/// [`DigitalAssetModel`](crate::codegen::structs_codegen::tables::digital_asset_models::DigitalAssetModel).
///
///
...
///
/// ```rust,ignore
/// use core_structures::DigitalAssetModel;
/// use core_structures::tables::insertables::AssetModelSettable;
/// use core_structures::tables::insertables::DigitalAssetModelSettable;
...
impl<AssetModel> diesel::associations::HasTable for InsertableDigitalAssetModelBuilder<AssetModel> {
    type Table =
        crate::codegen::diesel_codegen::tables::digital_asset_models::digital_asset_models::table;
    fn table() -> Self::Table {
        crate::codegen::diesel_codegen::tables::digital_asset_models::digital_asset_models::table
    }
}
...
where
    Self: common_traits::builder::Attributed<
        Attribute = crate::codegen::structs_codegen::tables::insertables::DigitalAssetModelAttribute,
    >,
{
    ...
    where
        PM: web_common_traits::database::MaybePrimaryKeyLike<PrimaryKey = i32>,
    {
        let parent_model = <PM as web_common_traits::database::MaybePrimaryKeyLike>::maybe_primary_key(
            &parent_model,
        );
...
{
    type Error = web_common_traits::database::InsertError<DigitalAssetModelAttribute>;
