...
pub struct PhysicalAssetModelForeignKeys {
    pub id: Option<crate::AssetModel>,
    pub parent_model: Option<crate::PhysicalAssetModel>,
}
impl web_common_traits::prelude::HasForeignKeys for crate::PhysicalAssetModel {
    type ForeignKeys = PhysicalAssetModelForeignKeys;
...
impl web_common_traits::prelude::ForeignKeys for PhysicalAssetModelForeignKeys {}
