...
pub struct CapsModelForeignKeys {
    pub id:
        Option<crate::codegen::structs_codegen::tables::physical_asset_models::PhysicalAssetModel>,
}
impl web_common_traits::prelude::HasForeignKeys
    for crate::codegen::structs_codegen::tables::caps_models::CapsModel
{
    type ForeignKeys = CapsModelForeignKeys;
...
impl web_common_traits::prelude::ForeignKeys for CapsModelForeignKeys {}
