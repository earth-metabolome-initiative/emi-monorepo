    ...
    for crate::codegen::structs_codegen::tables::brands::Brand
{
    fn upsert(
        ...
        diesel::insert_into(crate::codegen::diesel_codegen::tables::brands::brands::table)
            .values(self)
            ...
            .filter(diesel::BoolExpressionMethods::and(
                diesel::BoolExpressionMethods::and(
                    diesel::BoolExpressionMethods::and(
                        diesel::BoolExpressionMethods::and(
                            crate::codegen::diesel_codegen::tables::brands::brands::name.ne(
                        ...
                        crate::codegen::diesel_codegen::tables::brands::brands::created_at.ne(
                            diesel::upsert::excluded(
                                crate::codegen::diesel_codegen::tables::brands::brands::created_at,
                            ),
                        ),
                    ),
                    crate::codegen::diesel_codegen::tables::brands::brands::updated_by.ne(
                        diesel::upsert::excluded(
                            crate::codegen::diesel_codegen::tables::brands::brands::updated_by,
                        ),
                    ),
                ),
                crate::codegen::diesel_codegen::tables::brands::brands::updated_at.ne(
                    diesel::upsert::excluded(
