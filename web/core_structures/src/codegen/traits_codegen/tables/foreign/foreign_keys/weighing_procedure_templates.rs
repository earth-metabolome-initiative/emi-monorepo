...
pub struct WeighingProcedureTemplateForeignKeys {
    ...
    pub weighed_container_model: Option<crate::VolumetricContainerModel>,
    pub weighed_with_model: Option<crate::WeighingDeviceModel>,
}
impl web_common_traits::prelude::HasForeignKeys for crate::WeighingProcedureTemplate {
    type ForeignKeys = WeighingProcedureTemplateForeignKeys;
    ...
    fn update(
        ...
        match (row, crud) {
            (
                ...
                if self.procedure_template_weighed_container_model
                    == procedure_template_asset_models.id
                {
                    foreign_keys.procedure_template_weighed_container_model =
            ...
            (
                ...
                if self.procedure_template_weighed_container_model
                    == procedure_template_asset_models.id
                {
                    foreign_keys.procedure_template_weighed_container_model = None;
                    updated = true;
                }
                if self.procedure_template_weighed_with_model == procedure_template_asset_models.id
                {
            ...
            (
                ...
                if self.weighed_container_model == volumetric_container_models.id {
                    foreign_keys.weighed_container_model = Some(volumetric_container_models);
                    updated = true;
                }
            }
            (
                ...
                if self.weighed_container_model == volumetric_container_models.id {
                    foreign_keys.weighed_container_model = None;
                    updated = true;
                }
            }
            (
...
impl web_common_traits::prelude::ForeignKeys for WeighingProcedureTemplateForeignKeys {}
