...
impl web_common_traits::prelude::HasForeignKeys for crate::CameraModel {
    type ForeignKeys = CameraModelForeignKeys;
...
impl web_common_traits::prelude::ForeignKeys for CameraModelForeignKeys {}
