...
pub struct ProjectForeignKeys {
    ...
    pub user_updated:
        Option<std::rc::Rc<crate::codegen::structs_codegen::tables::directus_users::DirectusUser>>,
    pub parent_project:
        Option<std::rc::Rc<crate::codegen::structs_codegen::tables::projects::Project>>,
    ...
    for crate::codegen::structs_codegen::tables::projects::Project
{
        ...
        C: web_common_traits::crud::Connector<Row = Self::Row>,
    {
        ...
        connector.send(web_common_traits::crud::CrudPrimaryKeyOperation::Read(
            crate::codegen::tables::table_primary_keys::TablePrimaryKey::Batch(self.batch),
        ));
    }
    fn foreign_keys_loaded(&self, foreign_keys: &Self::ForeignKeys) -> bool {
        (foreign_keys.user_created.is_some() || self.user_created.is_none())
            ...
            && (foreign_keys.parent_project.is_some() || self.parent_project.is_none())
            && foreign_keys.batch.is_some()
    }
    fn update(
        &self,
