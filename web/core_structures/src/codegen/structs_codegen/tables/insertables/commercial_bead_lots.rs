...
pub enum InsertableCommercialBeadLotExtensionAttribute {
...
impl core::fmt::Display for InsertableCommercialBeadLotExtensionAttribute {
...
impl From<
    crate::codegen::structs_codegen::tables::insertables::InsertableCommercialProductLotAttribute,
> for InsertableCommercialBeadLotExtensionAttribute {
    fn from(
...
#[derive(Copy, Clone, PartialEq, Eq, PartialOrd, Ord, Hash, core::fmt::Debug)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub enum InsertableCommercialBeadLotAttribute {
    Extension(InsertableCommercialBeadLotExtensionAttribute),
    Id,
    ProductModel,
}
impl core::str::FromStr for InsertableCommercialBeadLotAttribute {
...
impl core::fmt::Display for InsertableCommercialBeadLotAttribute {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
...
impl InsertableCommercialBeadLot {
    pub fn commercial_bead_lots_id_fkey<C: diesel::connection::LoadConnection>(
        &self,
        conn: &mut C,
    ) -> Result<
    ...
    pub fn commercial_bead_lots_id_fkey1<C: diesel::connection::LoadConnection>(
        &self,
        conn: &mut C,
    ) -> Result<
    ...
    >
    where
        crate::codegen::structs_codegen::tables::commercial_bead_models::CommercialBeadModel: diesel::Identifiable,
        <crate::codegen::structs_codegen::tables::commercial_bead_models::CommercialBeadModel as diesel::associations::HasTable>::Table: diesel::query_dsl::methods::FindDsl<
            <crate::codegen::structs_codegen::tables::commercial_bead_models::CommercialBeadModel as diesel::Identifiable>::Id,
        >,
        <<crate::codegen::structs_codegen::tables::commercial_bead_models::CommercialBeadModel as diesel::associations::HasTable>::Table as diesel::query_dsl::methods::FindDsl<
            <crate::codegen::structs_codegen::tables::commercial_bead_models::CommercialBeadModel as diesel::Identifiable>::Id,
        >>::Output: diesel::query_dsl::methods::LimitDsl + diesel::RunQueryDsl<C>,
        <<<crate::codegen::structs_codegen::tables::commercial_bead_models::CommercialBeadModel as diesel::associations::HasTable>::Table as diesel::query_dsl::methods::FindDsl<
            <crate::codegen::structs_codegen::tables::commercial_bead_models::CommercialBeadModel as diesel::Identifiable>::Id,
        ...
        >,
    {
        ...
        RunQueryDsl::first(
            QueryDsl::find(
                crate::codegen::structs_codegen::tables::commercial_bead_models::CommercialBeadModel::table(),
                self.product_model,
            ),
            conn,
        )
...
for InsertableCommercialBeadLotBuilder<BeadModel, CommercialProductLot> {
    type Attributes = crate::codegen::structs_codegen::tables::insertables::InsertableCommercialBeadLotAttribute;
...
where
    Self: crate::codegen::structs_codegen::tables::insertables::PhysicalAssetModelSettable<
        Attributes = crate::codegen::structs_codegen::tables::insertables::InsertableCommercialBeadLotAttribute,
    >,
{
    type Attributes = crate::codegen::structs_codegen::tables::insertables::InsertableCommercialBeadLotAttribute;
    #[inline]
...
where
    Self: web_common_traits::database::InsertableVariant<
            ...
            Error = web_common_traits::database::InsertError<InsertableCommercialBeadLotAttribute>,
        >,
...
{
    type Attributes = InsertableCommercialBeadLotAttribute;
