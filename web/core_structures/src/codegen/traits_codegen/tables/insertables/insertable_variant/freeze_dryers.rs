...
where
    ...
    crate::codegen::structs_codegen::tables::insertables::FreezeDryerExtensionAttribute: From<
        ...
        let id = self
            ...
            .map_err(|err| {
                err.into_field_name(|attribute| {
                    crate::codegen::structs_codegen::tables::insertables::FreezeDryerAttribute::Extension(
                        From::from(attribute),
                    )
                })
            })?;
