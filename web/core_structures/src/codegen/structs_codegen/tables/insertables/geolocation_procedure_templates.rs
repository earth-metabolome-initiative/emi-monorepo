...
impl core::fmt::Display for GeolocationProcedureTemplateAttribute {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            ...
            Self::ProcedureTemplateGeolocatedAssetModel(e) => write!(f, "{e}"),
        }
    }
}
...
impl InsertableGeolocationProcedureTemplate {
    ...
    {
        use web_common_traits::database::Read;
        crate::PhysicalAssetModel::read(self.geolocated_asset_model, conn)
    }
    ...
    {
        use web_common_traits::database::Read;
        crate::PositioningDeviceModel::read(self.geolocated_with_model, conn)
    }
    ...
    for InsertableGeolocationProcedureTemplateBuilder<ProcedureTemplate>
{
    ...
    where
        ...
        >,
    {
        let mut procedure_template_geolocated_with_model =
            procedure_template_geolocated_with_model.into();
    ...
    where
        ...
        >,
    {
        let mut procedure_template_geolocated_asset_model =
            procedure_template_geolocated_asset_model.into();
        if let web_common_traits::database::IdOrBuilder::Builder(builder) =
            procedure_template_geolocated_asset_model
        {
                ...
                (self.geolocated_asset_model, builder.asset_model)
            {
                if geolocated_asset_model != asset_model {
                    return Err(web_common_traits::database::InsertError::BuilderError(
                        web_common_traits::prelude::BuilderError::UnexpectedAttribute(
                            Self::Attributes::GeolocatedAssetModel,
                        ),
                    ));
                }
                builder.into()
...
for InsertableGeolocationProcedureTemplateBuilder<ProcedureTemplate> {
    type Attributes = crate::codegen::structs_codegen::tables::insertables::GeolocationProcedureTemplateAttribute;
    #[inline]
...
where
    Self: web_common_traits::database::InsertableVariant<
        C,
        UserId = i32,
        Row = crate::GeolocationProcedureTemplate,
    ...
    >,
{
    ...
    > {
        ...
        let insertable: crate::GeolocationProcedureTemplate = self
            .insert(user_id, conn)?;
        Ok(insertable.id())
    }
}
