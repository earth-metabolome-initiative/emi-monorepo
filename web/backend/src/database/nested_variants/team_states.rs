...
pub struct NestedTeamState {
    pub inner: crate::database::flat_variants::TeamState,
...
impl NestedTeamState {
    ...
    pub fn strict_word_similarity_search_with_score_viewable(
        ...
        TeamState::strict_word_similarity_search_with_score_viewable(
...
impl From<web_common::database::nested_variants::NestedTeamState>
    for crate::database::nested_variants::NestedTeamState
{
    fn from(item: web_common::database::nested_variants::NestedTeamState) -> Self {
        Self {
            inner: crate::database::flat_variants::TeamState::from(item.inner.as_ref().clone()),
...
impl From<crate::database::nested_variants::NestedTeamState>
    for web_common::database::nested_variants::NestedTeamState
{
    fn from(item: crate::database::nested_variants::NestedTeamState) -> Self {
        Self {
            inner: Rc::from(web_common::database::flat_variants::TeamState::from(
                item.inner,
            )),
