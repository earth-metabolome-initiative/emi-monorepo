...
pub enum InsertableFreezingProcedureExtensionAttributes {
    Procedure(crate::codegen::structs_codegen::tables::insertables::InsertableProcedureAttributes),
}
impl core::fmt::Display for InsertableFreezingProcedureExtensionAttributes {
...
impl From<crate::codegen::structs_codegen::tables::insertables::InsertableProcedureAttributes>
    for InsertableFreezingProcedureExtensionAttributes
{
    fn from(
...
#[derive(Copy, Clone, PartialEq, Eq, PartialOrd, Ord, Hash, core::fmt::Debug)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub enum InsertableFreezingProcedureAttributes {
    Extension(InsertableFreezingProcedureExtensionAttributes),
    Procedure,
    ProcedureTemplate,
...
impl core::str::FromStr for InsertableFreezingProcedureAttributes {
...
impl core::fmt::Display for InsertableFreezingProcedureAttributes {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            ...
            Self::FrozenContainer => write!(f, "frozen_container"),
...
impl FreezingProcedureBuildable for Option<::rosetta_uuid::Uuid> {
    fn procedure_template(
        self,
    ...
    fn frozen_container(
        self,
        _frozen_container: ::rosetta_uuid::Uuid,
    ) -> Result<Self, web_common_traits::database::InsertError<Self::Attributes>> {
        Ok(self)
    }
    fn frozen_with(
        self,
        _frozen_with: Option<::rosetta_uuid::Uuid>,
    ) -> Result<Self, web_common_traits::database::InsertError<Self::Attributes>> {
        Ok(self)
    }
    fn frozen_with_model(
...
> FreezingProcedureBuildable for InsertableFreezingProcedureBuilder<Procedure> {
        ...
        let procedure_template = procedure_template
            ...
            .map_err(|err| {
                validation_errors::SingleFieldError::from(err)
                    .rename_field(
                        InsertableFreezingProcedureAttributes::ProcedureTemplate,
                    )
            })?;
        self.procedure = self
            .procedure
    ...
    fn foreign_procedure_template(
        ...
        let foreign_procedure_template = foreign_procedure_template
            ...
            .map_err(|err| {
                validation_errors::SingleFieldError::from(err)
                    .rename_field(
                        InsertableFreezingProcedureAttributes::ForeignProcedureTemplate,
                    )
            })?;
    ...
    fn foreign_procedure(
        ...
        let foreign_procedure = foreign_procedure
            ...
            .map_err(|err| {
                validation_errors::SingleFieldError::from(err)
                    .rename_field(
                        InsertableFreezingProcedureAttributes::ForeignProcedure,
                    )
            })?;
    ...
    fn frozen_container(
        ...
        let frozen_container = frozen_container
            .try_into()
            .map_err(|err| {
                validation_errors::SingleFieldError::from(err)
                    .rename_field(InsertableFreezingProcedureAttributes::FrozenContainer)
            })?;
    ...
    fn frozen_with(
        ...
        let frozen_with = frozen_with
            .try_into()
            .map_err(|err| {
                validation_errors::SingleFieldError::from(err)
                    .rename_field(InsertableFreezingProcedureAttributes::FrozenWith)
            })?;
    ...
    fn frozen_with_model(
        ...
        let frozen_with_model = frozen_with_model
            ...
            .map_err(|err| {
                validation_errors::SingleFieldError::from(err)
                    .rename_field(InsertableFreezingProcedureAttributes::FrozenWithModel)
            })?;
...
for InsertableFreezingProcedureBuilder<Procedure> {
    ...
    fn procedure_template(
        ...
        <Self as FreezingProcedureBuildable>::procedure_template(
            self,
            procedure_template,
        )
    }
...
where
    Self: web_common_traits::database::InsertableVariant<
            ...
            Error = web_common_traits::database::InsertError<InsertableFreezingProcedureAttributes>,
        >,
    Procedure: web_common_traits::database::TryInsertGeneric<C, PrimaryKey = ::rosetta_uuid::Uuid>,
{
    type Attributes = InsertableFreezingProcedureAttributes;
