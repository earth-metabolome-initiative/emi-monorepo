//! Submodule for the `pg_catalog.pg_statio_all_tables` view schema.

diesel::table! {
    /// `pg_catalog.pg_statio_all_tables` — view showing I/O statistics for all tables.
    /// Each row represents one table showing statistics about I/O operations on that table.
