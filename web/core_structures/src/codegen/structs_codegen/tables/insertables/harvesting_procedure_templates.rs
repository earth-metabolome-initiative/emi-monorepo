...
impl From<common_traits::builder::EmptyTuple> for HarvestingProcedureTemplateExtensionAttribute {
...
impl web_common_traits::database::TableField for HarvestingProcedureTemplateAttribute {}
impl web_common_traits::database::HasTableType for HarvestingProcedureTemplateAttribute {
    ...
    > for HarvestingProcedureTemplateAttribute
{
    fn from_extension(
        ...
        HarvestingProcedureTemplateAttribute::Extension(From::from(attribute))
    }
}
...
/// [`HarvestingProcedureTemplate`](crate::codegen::structs_codegen::tables::harvesting_procedure_templates::HarvestingProcedureTemplate).
///
///
...
///
/// ```rust,ignore
/// use core_structures::HarvestingProcedureTemplate;
/// use core_structures::tables::insertables::HarvestingProcedureTemplateSettable;
/// use core_structures::tables::insertables::ProcedureTemplateSettable;
/// use web_common_traits::database::Insertable;
/// use web_common_traits::database::InsertableVariant;
///
/// let harvesting_procedure_template = HarvestingProcedureTemplate::new()
///    // Set mandatory fields
///    .procedure_template_sample_model(procedure_template_sample_model)?
///    .procedure_template_sample_source_model(procedure_template_sample_source_model)?
        ...
        >,
    {
        ...
        if let web_common_traits::database::IdOrBuilder::Builder(builder) = procedure_template_sample_source_model {
            procedure_template_sample_source_model = if let (
                ...
                Some(asset_model_id),
            ) = (self.sample_source_model, builder.asset_model_id) {
                if sample_source_model != asset_model_id {
                    return Err(
                ...
                self.sample_source_model = Some(asset_model_id);
                builder.into()
        ...
        >,
    {
        ...
        if let web_common_traits::database::IdOrBuilder::Builder(builder) = procedure_template_sample_model {
            procedure_template_sample_model = if let (
                Some(sample_model),
                Some(asset_model_id),
            ) = (self.sample_model, builder.asset_model_id) {
