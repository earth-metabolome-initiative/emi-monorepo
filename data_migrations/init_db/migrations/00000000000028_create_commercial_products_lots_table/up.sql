...
CREATE TABLE IF NOT EXISTS commercial_weighing_device_lots (
	...
	product_model_id INTEGER NOT NULL REFERENCES commercial_weighing_device_models(id),
	FOREIGN KEY (id, product_model_id) REFERENCES asset_models(id, parent_model_id)
);
CREATE TABLE IF NOT EXISTS commercial_volume_measuring_device_lots (
	...
	product_model_id INTEGER NOT NULL REFERENCES commercial_volume_measuring_device_models(id),
	FOREIGN KEY (id, product_model_id) REFERENCES asset_models(id, parent_model_id)
);
CREATE TABLE IF NOT EXISTS commercial_pipette_lots (
	...
	product_model_id INTEGER NOT NULL REFERENCES commercial_pipette_models(id),
	FOREIGN KEY (id, product_model_id) REFERENCES asset_models(id, parent_model_id)
);
CREATE TABLE IF NOT EXISTS commercial_pipette_tip_lots (
	...
	product_model_id INTEGER NOT NULL REFERENCES commercial_pipette_tip_models(id),
	FOREIGN KEY (id, product_model_id) REFERENCES asset_models(id, parent_model_id)
);
CREATE TABLE IF NOT EXISTS commercial_packaging_lots (
	...
	product_model_id INTEGER NOT NULL REFERENCES commercial_packaging_models(id),
	FOREIGN KEY (id, product_model_id) REFERENCES asset_models(id, parent_model_id)
);
CREATE TABLE IF NOT EXISTS commercial_beads_lots (
	...
	product_model_id INTEGER NOT NULL REFERENCES commercial_beads_models(id),
	FOREIGN KEY (id, product_model_id) REFERENCES asset_models(id, parent_model_id)
);
CREATE TABLE IF NOT EXISTS commercial_ball_mill_machine_lots (
	...
	product_model_id INTEGER NOT NULL REFERENCES commercial_ball_mill_machine_models(id),
	FOREIGN KEY (id, product_model_id) REFERENCES asset_models(id, parent_model_id)
);
CREATE TABLE IF NOT EXISTS commercial_centrifuge_lots (
	...
	product_model_id INTEGER NOT NULL REFERENCES commercial_centrifuge_models(id),
	FOREIGN KEY (id, product_model_id) REFERENCES asset_models(id, parent_model_id)
);
CREATE TABLE IF NOT EXISTS commercial_freezer_lots (
	...
	product_model_id INTEGER NOT NULL REFERENCES commercial_freezer_models(id),
	FOREIGN KEY (id, product_model_id) REFERENCES asset_models(id, parent_model_id)
);
CREATE TABLE IF NOT EXISTS commercial_freeze_dryer_lots (
	...
	product_model_id INTEGER NOT NULL REFERENCES commercial_freeze_dryer_models(id),
	FOREIGN KEY (id, product_model_id) REFERENCES asset_models(id, parent_model_id)
);
CREATE TABLE IF NOT EXISTS commercial_positioning_device_lots (
	...
	product_model_id INTEGER NOT NULL REFERENCES commercial_positioning_device_models(id),
	FOREIGN KEY (id, product_model_id) REFERENCES asset_models(id, parent_model_id)
);
CREATE TABLE IF NOT EXISTS commercial_camera_lots (
	...
	product_model_id INTEGER NOT NULL REFERENCES commercial_camera_models(id),
	FOREIGN KEY (id, product_model_id) REFERENCES asset_models(id, parent_model_id)
);