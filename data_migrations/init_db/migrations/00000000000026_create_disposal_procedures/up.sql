CREATE TABLE IF NOT EXISTS disposal_procedure_templates (
	...
	-- We create a same-as index to allow for foreign key references to check whether a `disposal_procedure_template`
	-- is associated with a given `disposal_foreign_procedure_template`.
...
CREATE TABLE IF NOT EXISTS disposal_procedures (
	...
	FOREIGN KEY (procedure_template, foreign_procedure_template) REFERENCES disposal_procedure_templates(procedure_template, foreign_procedure_template)
);