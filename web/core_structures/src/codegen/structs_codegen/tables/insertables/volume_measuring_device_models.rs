...
pub enum VolumeMeasuringDeviceModelExtensionAttribute {
    PhysicalAssetModel(
        crate::codegen::structs_codegen::tables::insertables::PhysicalAssetModelAttribute,
    ),
}
impl core::fmt::Display for VolumeMeasuringDeviceModelExtensionAttribute {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            Self::PhysicalAssetModel(e) => {
                write!(f, "volume_measuring_device_models({e})")
            }
        }
    }
}
impl From<crate::codegen::structs_codegen::tables::insertables::PhysicalAssetModelAttribute>
    for VolumeMeasuringDeviceModelExtensionAttribute
{
    fn from(
...
impl From<common_traits::builder::EmptyTuple> for VolumeMeasuringDeviceModelExtensionAttribute {
...
#[derive(Copy, Clone, PartialEq, Eq, PartialOrd, Ord, Hash, core::fmt::Debug)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub enum VolumeMeasuringDeviceModelAttribute {
    Extension(VolumeMeasuringDeviceModelExtensionAttribute),
    Id,
}
impl core::str::FromStr for VolumeMeasuringDeviceModelAttribute {
...
impl web_common_traits::database::TableField for VolumeMeasuringDeviceModelAttribute {}
impl web_common_traits::database::HasTableType for VolumeMeasuringDeviceModelAttribute {
    ...
    > for VolumeMeasuringDeviceModelAttribute
{
    fn from_extension(
        ...
        VolumeMeasuringDeviceModelAttribute::Extension(From::from(attribute))
    }
}
...
#[cfg_attr(
    ...
    diesel(
        table_name = crate::codegen::diesel_codegen::tables::volume_measuring_device_models::volume_measuring_device_models
    )
)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct InsertableVolumeMeasuringDeviceModel {
    pub(crate) id: i32,
}
impl InsertableVolumeMeasuringDeviceModel {}
#[derive(Clone, Debug, PartialEq, PartialOrd, Eq, Hash, Ord, Default)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
/// Builder for creating and inserting a new
/// [`VolumeMeasuringDeviceModel`](crate::codegen::structs_codegen::tables::volume_measuring_device_models::VolumeMeasuringDeviceModel).
///
///
...
///
/// ```rust,ignore
/// use core_structures::VolumeMeasuringDeviceModel;
...
///
/// let volume_measuring_device_model = VolumeMeasuringDeviceModel::new()
...
///    .insert(user.id, conn)?;
/// ```
pub struct InsertableVolumeMeasuringDeviceModelBuilder<
    PhysicalAssetModel
...
{
    type Table = crate::codegen::diesel_codegen::tables::volume_measuring_device_models::volume_measuring_device_models::table;
    fn table() -> Self::Table {
        crate::codegen::diesel_codegen::tables::volume_measuring_device_models::volume_measuring_device_models::table
    }
}
impl From<InsertableVolumeMeasuringDeviceModelBuilder>
    for web_common_traits::database::IdOrBuilder<i32, InsertableVolumeMeasuringDeviceModelBuilder>
{
    fn from(builder: InsertableVolumeMeasuringDeviceModelBuilder) -> Self {
...
/// `VolumeMeasuringDeviceModel` or descendant tables.
pub trait VolumeMeasuringDeviceModelSettable: Sized {
    /// Error type returned when setting attributes.
    type Error;
}
impl<PhysicalAssetModel> VolumeMeasuringDeviceModelSettable
for InsertableVolumeMeasuringDeviceModelBuilder<PhysicalAssetModel>
where
