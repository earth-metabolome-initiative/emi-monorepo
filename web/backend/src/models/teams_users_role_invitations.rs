...
.inner_join(
   teams::dsl::teams.on(
       teams_users_role_invitations::dsl::table_id.eq(
           teams::dsl::id
        )
    )
)
...
.inner_join(
   roles::dsl::roles.on(
       teams_users_role_invitations::dsl::role_id.eq(
           roles::dsl::id
        )
    )
)
            ...
            .filter(can_view_teams_users_role_invitations(author_user_id, teams_users_role_invitations::dsl::table_id, teams_users_role_invitations::dsl::user_id))
            .filter(
similarity_op(concat_teams_name_description(teams::dsl::name, teams::dsl::description), query)    .or(
   ...
   roles::dsl::roles.on(
       teams_users_role_invitations::dsl::role_id.eq(
           roles::dsl::id
            ...
            .filter(can_view_teams_users_role_invitations(author_user_id, teams_users_role_invitations::dsl::table_id, teams_users_role_invitations::dsl::user_id))
            .filter(
word_similarity_op(concat_teams_name_description(teams::dsl::name, teams::dsl::description), query)    .or(
   ...
   roles::dsl::roles.on(
       teams_users_role_invitations::dsl::role_id.eq(
           roles::dsl::id
            ...
            .filter(can_view_teams_users_role_invitations(author_user_id, teams_users_role_invitations::dsl::table_id, teams_users_role_invitations::dsl::user_id))
            .filter(
strict_word_similarity_op(concat_teams_name_description(teams::dsl::name, teams::dsl::description), query)    .or(
