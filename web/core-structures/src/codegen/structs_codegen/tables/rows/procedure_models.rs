...
impl From<std::rc::Rc<crate::codegen::structs_codegen::tables::procedure_models::ProcedureModel>>
    for super::Rows
{
    fn from(
        value: std::rc::Rc<
...
impl
    From<
        Vec<std::rc::Rc<crate::codegen::structs_codegen::tables::procedure_models::ProcedureModel>>,
    > for super::Rows
{
    fn from(
        value: Vec<
...
impl
    From<
        std::rc::Rc<Vec<crate::codegen::structs_codegen::tables::procedure_models::ProcedureModel>>,
    > for super::Rows
{
    fn from(
        value: std::rc::Rc<
