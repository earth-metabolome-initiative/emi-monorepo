...
pub enum InsertableCommercialPackagingModelExtensionAttributes {
    PackagingModel(
...
impl core::fmt::Display for InsertableCommercialPackagingModelExtensionAttributes {
...
impl From<crate::codegen::structs_codegen::tables::insertables::InsertablePackagingModelAttributes>
    for InsertableCommercialPackagingModelExtensionAttributes
{
    fn from(
...
#[derive(Copy, Clone, PartialEq, Eq, PartialOrd, Ord, Hash, core::fmt::Debug)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub enum InsertableCommercialPackagingModelAttributes {
    Extension(InsertableCommercialPackagingModelExtensionAttributes),
    Id,
    ParentModel,
}
impl core::str::FromStr for InsertableCommercialPackagingModelAttributes {
...
impl core::fmt::Display for InsertableCommercialPackagingModelAttributes {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
...
pub trait CommercialPackagingModelBuildable: Sized {
    /// Attributes required to build the insertable.
    type Attributes;
    /// Sets the value of the `public.commercial_packaging_models.parent_model`
    /// column.
    ///
    /// # Arguments
    /// * `parent_model`: The value to set for the
    ///   `public.commercial_packaging_models.parent_model` column.
    ///
...
impl<
    CommercialProduct: crate::codegen::structs_codegen::tables::insertables::PhysicalAssetModelBuildable<
        ...
        >,
    PackagingModel,
> CommercialPackagingModelBuildable
for InsertableCommercialPackagingModelBuilder<CommercialProduct, PackagingModel> {
    type Attributes = crate::codegen::structs_codegen::tables::insertables::InsertableCommercialPackagingModelAttributes;
    ///Sets the value of the `public.commercial_packaging_models.parent_model` column.
    ///
        ...
        let parent_model = parent_model
            ...
            .map_err(|err| {
                validation_errors::SingleFieldError::from(err)
                    .rename_field(
                        InsertableCommercialPackagingModelAttributes::ParentModel,
                    )
            })?;
        self.commercial_packaging_models_id_fkey1 = <CommercialProduct as crate::codegen::structs_codegen::tables::insertables::PhysicalAssetModelBuildable>::parent_model(
    ...
    >,
{
    ...
    {
        self.commercial_packaging_models_id_fkey1 = <CommercialProduct as crate::codegen::structs_codegen::tables::insertables::AssetModelBuildable>::name(
                self.commercial_packaging_models_id_fkey1,
                name,
            )
            .map_err(|e| {
    ...
    {
        self.commercial_packaging_models_id_fkey1 = <CommercialProduct as crate::codegen::structs_codegen::tables::insertables::AssetModelBuildable>::description(
                self.commercial_packaging_models_id_fkey1,
                description,
            )
            .map_err(|e| {
    ...
    fn created_by(
        ...
        self.commercial_packaging_models_id_fkey1 = <CommercialProduct as crate::codegen::structs_codegen::tables::insertables::AssetModelBuildable>::created_by(
                self.commercial_packaging_models_id_fkey1,
                created_by,
            )
            .map_err(|e| {
    ...
    where
        ...
        >,
    {
        self.commercial_packaging_models_id_fkey1 = <CommercialProduct as crate::codegen::structs_codegen::tables::insertables::AssetModelBuildable>::created_at(
                self.commercial_packaging_models_id_fkey1,
                created_at,
            )
            .map_err(|e| {
    ...
    fn updated_by(
        ...
        self.commercial_packaging_models_id_fkey1 = <CommercialProduct as crate::codegen::structs_codegen::tables::insertables::AssetModelBuildable>::updated_by(
                self.commercial_packaging_models_id_fkey1,
                updated_by,
            )
            .map_err(|e| {
    ...
    where
        ...
        >,
    {
        self.commercial_packaging_models_id_fkey1 = <CommercialProduct as crate::codegen::structs_codegen::tables::insertables::AssetModelBuildable>::updated_at(
                self.commercial_packaging_models_id_fkey1,
                updated_at,
            )
            .map_err(|e| {
...
for InsertableCommercialPackagingModelBuilder<CommercialProduct, PackagingModel> {
    ...
    where
        ...
        >,
    {
        self.commercial_packaging_models_id_fkey1 = <CommercialProduct as crate::codegen::structs_codegen::tables::insertables::CommercialProductBuildable>::deprecation_date(
                self.commercial_packaging_models_id_fkey1,
                deprecation_date,
            )
            .map_err(|e| {
    ...
    fn brand(
        ...
        self.commercial_packaging_models_id_fkey1 = <CommercialProduct as crate::codegen::structs_codegen::tables::insertables::CommercialProductBuildable>::brand(
                self.commercial_packaging_models_id_fkey1,
                brand_id,
            )
            .map_err(|e| {
...
for InsertableCommercialPackagingModelBuilder<CommercialProduct, PackagingModel>
where
    Self: crate::codegen::structs_codegen::tables::insertables::CommercialPackagingModelBuildable<
        Attributes = crate::codegen::structs_codegen::tables::insertables::InsertableCommercialPackagingModelAttributes,
    >,
{
    type Attributes = crate::codegen::structs_codegen::tables::insertables::InsertableCommercialPackagingModelAttributes;
    ...
    fn parent_model(
        ...
        <Self as CommercialPackagingModelBuildable>::parent_model(
            self,
            parent_model
                .ok_or(
...
where
    Self: web_common_traits::database::InsertableVariant<
        ...
        Error = web_common_traits::database::InsertError<
            InsertableCommercialPackagingModelAttributes,
        >,
    >,
...
{
    type Attributes = InsertableCommercialPackagingModelAttributes;
