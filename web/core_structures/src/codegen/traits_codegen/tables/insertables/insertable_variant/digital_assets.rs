...
where
    ...
    Self: web_common_traits::database::InsertableVariant<
        C,
        InsertableVariant = crate::codegen::structs_codegen::tables::insertables::InsertableDigitalAsset,
    ...
    crate::codegen::structs_codegen::tables::insertables::DigitalAssetExtensionAttribute: From<
        ...
        let id = self
            ...
            .map_err(|err| {
                err.into_field_name(|attribute| {
                    crate::codegen::structs_codegen::tables::insertables::DigitalAssetAttribute::Extension(
                        From::from(attribute),
                    )
                })
            })?;
