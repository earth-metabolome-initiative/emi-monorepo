    ...
    fn update(
        ...
        match (row, crud) {
            ...
            (
                ...
                if self.procedure_geolocated_asset == procedure_asset_models.id {
                    foreign_keys.procedure_geolocated_asset = Some(procedure_asset_models);
                    updated = true;
                }
                if self.procedure_geolocated_with == procedure_asset_models.id {
                    foreign_keys.procedure_geolocated_with = Some(procedure_asset_models);
                    updated = true;
                }
            }
            (
            ...
            (
                ...
                {
                    foreign_keys.procedure_template_geolocated_asset_model_id =
