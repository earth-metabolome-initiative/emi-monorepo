...
impl VolumetricContainerModel {
    ...
    where
        ...
        <Self as diesel::associations::HasTable>::Table: diesel::query_dsl::methods::FilterDsl<
            <crate::codegen::diesel_codegen::tables::volumetric_container_models::volumetric_container_models::id as diesel::expression_methods::EqAll<
                i32,
            >>::Output,
        >,
        ...
        >>::Output: diesel::query_dsl::methods::OrderDsl<
            diesel::helper_types::Asc<
                crate::codegen::diesel_codegen::tables::volumetric_container_models::volumetric_container_models::id,
            >,
        >,
        <<<Self as diesel::associations::HasTable>::Table as diesel::query_dsl::methods::FilterDsl<
            <crate::codegen::diesel_codegen::tables::volumetric_container_models::volumetric_container_models::id as diesel::expression_methods::EqAll<
            ...
            + for<'a> diesel::query_dsl::LoadQuery<'a, C, Self>,
    {
        ...
        Self::table()
            .filter(volumetric_container_models::id.eq(id))
...
impl AsRef<VolumetricContainerModel> for VolumetricContainerModel {
    fn as_ref(&self) -> &VolumetricContainerModel {
        self
    }
}
