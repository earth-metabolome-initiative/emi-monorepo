...
pub enum InsertableFreezingProcedureExtensionAttribute {
    Procedure(crate::codegen::structs_codegen::tables::insertables::InsertableProcedureAttribute),
}
impl core::fmt::Display for InsertableFreezingProcedureExtensionAttribute {
...
impl From<crate::codegen::structs_codegen::tables::insertables::InsertableProcedureAttribute>
    for InsertableFreezingProcedureExtensionAttribute
{
    fn from(
...
#[derive(Copy, Clone, PartialEq, Eq, PartialOrd, Ord, Hash, core::fmt::Debug)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub enum InsertableFreezingProcedureAttribute {
    Extension(InsertableFreezingProcedureExtensionAttribute),
    Procedure,
    ProcedureTemplate,
...
impl core::str::FromStr for InsertableFreezingProcedureAttribute {
...
impl core::fmt::Display for InsertableFreezingProcedureAttribute {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
...
> FreezingProcedureSettable for InsertableFreezingProcedureBuilder<Procedure> {
    type Attributes = crate::codegen::structs_codegen::tables::insertables::InsertableFreezingProcedureAttribute;
    ...
    ///subgraph v3 ["`freezing_procedures`"]
...
where
    Self: web_common_traits::database::InsertableVariant<
            ...
            Error = web_common_traits::database::InsertError<InsertableFreezingProcedureAttribute>,
        >,
    Procedure: web_common_traits::database::TryInsertGeneric<C, PrimaryKey = ::rosetta_uuid::Uuid>,
{
    type Attributes = InsertableFreezingProcedureAttribute;
