CREATE TABLE IF NOT EXISTS teams (
    ...
    icon_id INTEGER NOT NULL DEFAULT 1387 REFERENCES font_awesome_icons(id),
    color_id INTEGER NOT NULL DEFAULT 15 REFERENCES colors(id),
    state_id INTEGER NOT NULL DEFAULT 1 REFERENCES team_states(id),
