...
pub enum BallMillMachineExtensionAttribute {
    PhysicalAsset(crate::codegen::structs_codegen::tables::insertables::PhysicalAssetAttribute),
}
impl core::fmt::Display for BallMillMachineExtensionAttribute {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            Self::PhysicalAsset(e) => write!(f, "ball_mill_machines({e})"),
        }
    }
}
impl From<crate::codegen::structs_codegen::tables::insertables::PhysicalAssetAttribute>
    for BallMillMachineExtensionAttribute
{
    fn from(
...
impl From<common_traits::builder::EmptyTuple> for BallMillMachineExtensionAttribute {
...
#[derive(Copy, Clone, PartialEq, Eq, PartialOrd, Ord, Hash, core::fmt::Debug)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub enum BallMillMachineAttribute {
    Extension(BallMillMachineExtensionAttribute),
    Id,
    Model,
}
impl core::str::FromStr for BallMillMachineAttribute {
...
impl<T1> common_traits::builder::Attributed
    for crate::codegen::structs_codegen::tables::insertables::InsertableBallMillMachineBuilder<T1>
{
    type Attribute = BallMillMachineAttribute;
}
impl web_common_traits::database::TableField for BallMillMachineAttribute {}
impl web_common_traits::database::HasTableType for BallMillMachineAttribute {
    type Table = crate::codegen::tables::table_names::TableName;
}
impl
    web_common_traits::database::FromExtension<
        crate::codegen::structs_codegen::tables::insertables::PhysicalAssetAttribute,
    > for BallMillMachineAttribute
{
    fn from_extension(
        attribute: crate::codegen::structs_codegen::tables::insertables::PhysicalAssetAttribute,
    ) -> Self {
        BallMillMachineAttribute::Extension(From::from(attribute))
    }
}
...
impl core::fmt::Display for BallMillMachineAttribute {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
...
///
/// ```rust,ignore
/// use core_structures::BallMillMachine;
/// use core_structures::tables::insertables::AssetSettable;
/// use core_structures::tables::insertables::BallMillMachineSettable;
/// use web_common_traits::database::Insertable;
/// use web_common_traits::database::InsertableVariant;
///
/// let ball_mill_machine = BallMillMachine::new()
...
{
    type Table =
        crate::codegen::diesel_codegen::tables::ball_mill_machines::ball_mill_machines::table;
    fn table() -> Self::Table {
        crate::codegen::diesel_codegen::tables::ball_mill_machines::ball_mill_machines::table
    }
}
impl From<InsertableBallMillMachineBuilder>
    for web_common_traits::database::IdOrBuilder<
        ::rosetta_uuid::Uuid,
        InsertableBallMillMachineBuilder,
    >
{
...
where
    Self: common_traits::builder::Attributed<
        Attribute = crate::codegen::structs_codegen::tables::insertables::BallMillMachineAttribute,
    >,
{
...
{
    type Error = web_common_traits::database::InsertError<BallMillMachineAttribute>;
