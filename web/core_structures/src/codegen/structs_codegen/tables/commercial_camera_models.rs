...
pub struct CommercialCameraModel {
    pub id: i32,
    pub camera_model: i32,
}
impl web_common_traits::prelude::TableName for CommercialCameraModel {
    const TABLE_NAME: &'static str = "commercial_camera_models";
}
impl<'a> From<&'a CommercialCameraModel>
for web_common_traits::database::IdOrBuilder<
    i32,
    crate::codegen::structs_codegen::tables::insertables::InsertableCommercialCameraModelBuilder,
> {
    fn from(value: &'a CommercialCameraModel) -> Self {
        web_common_traits::database::IdOrBuilder::Id(value.id)
    }
}
impl web_common_traits::prelude::ExtensionTable<crate::AssetModel> for CommercialCameraModel where
    for<'a> &'a Self: diesel::Identifiable<Id = &'a i32>
{
}
impl web_common_traits::prelude::ExtensionTable<crate::CameraModel> for CommercialCameraModel where
    for<'a> &'a Self: diesel::Identifiable<Id = &'a i32>
{
}
impl web_common_traits::prelude::ExtensionTable<crate::CommercialProduct> for CommercialCameraModel where
    for<'a> &'a Self: diesel::Identifiable<Id = &'a i32>
{
}
impl web_common_traits::prelude::ExtensionTable<crate::PhysicalAssetModel> for CommercialCameraModel where
    for<'a> &'a Self: diesel::Identifiable<Id = &'a i32>
{
}
impl web_common_traits::prelude::ExtensionTable<crate::CommercialCameraModel>
    for CommercialCameraModel
where
    for<'a> &'a Self: diesel::Identifiable<Id = &'a i32>,
{
}
impl diesel::Identifiable for CommercialCameraModel {
    type Id = i32;
    fn id(self) -> Self::Id {
        self.id
    }
...
impl CommercialCameraModel {
    ...
    where
        ...
        <Self as diesel::associations::HasTable>::Table: diesel::query_dsl::methods::FilterDsl<
            <crate::codegen::diesel_codegen::tables::commercial_camera_models::commercial_camera_models::camera_model as diesel::expression_methods::EqAll<
                i32,
            >>::Output,
        >,
        ...
        >>::Output: diesel::query_dsl::methods::OrderDsl<
            diesel::helper_types::Asc<
                crate::codegen::diesel_codegen::tables::commercial_camera_models::commercial_camera_models::id,
            >,
        >,
        <<<Self as diesel::associations::HasTable>::Table as diesel::query_dsl::methods::FilterDsl<
            <crate::codegen::diesel_codegen::tables::commercial_camera_models::commercial_camera_models::camera_model as diesel::expression_methods::EqAll<
            ...
            + for<'a> diesel::query_dsl::LoadQuery<'a, C, Self>,
    {
        ...
        Self::table()
            .filter(commercial_camera_models::camera_model.eq(camera_model))
    ...
    where
        C: diesel::connection::LoadConnection,
        <Self as diesel::associations::HasTable>::Table: diesel::query_dsl::methods::FilterDsl<
            <crate::codegen::diesel_codegen::tables::commercial_camera_models::commercial_camera_models::id as diesel::expression_methods::EqAll<
                i32,
            >>::Output,
        >,
        <<Self as diesel::associations::HasTable>::Table as diesel::query_dsl::methods::FilterDsl<
    ...
    pub fn from_deprecation_date(
        ...
        use crate::codegen::diesel_codegen::tables::{
            commercial_camera_models::commercial_camera_models,
            commercial_products::commercial_products,
        };
        Self::table()
            .inner_join(
                commercial_products::table
                    .on(commercial_camera_models::id.eq(commercial_products::id)),
            )
        ...
        Self::table()
            .inner_join(
                physical_asset_models::table
                    .on(commercial_camera_models::id.eq(physical_asset_models::id)),
            )
    ...
    pub fn from_name(
        ...
        use crate::codegen::diesel_codegen::tables::{
            asset_models::asset_models, commercial_camera_models::commercial_camera_models,
        };
        Self::table()
            .inner_join(asset_models::table.on(commercial_camera_models::id.eq(asset_models::id)))
...
impl AsRef<CommercialCameraModel> for CommercialCameraModel {
    fn as_ref(&self) -> &CommercialCameraModel {
        self
    }
}
