...
pub trait CommercialWeighingDeviceModelBuildable:
...
impl CommercialWeighingDeviceModelBuildable for Option<i32> {}
impl<
...
> {
    ...
    {
        self.commercial_weighing_device_models_id_fkey1 = <CommercialProduct as crate::codegen::structs_codegen::tables::insertables::AssetModelBuildable>::most_concrete_table(
