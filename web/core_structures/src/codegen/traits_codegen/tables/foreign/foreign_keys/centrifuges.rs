...
pub struct CentrifugeForeignKeys {
    pub id: Option<crate::PhysicalAsset>,
    pub model: Option<crate::CommercialCentrifugeLot>,
}
impl web_common_traits::prelude::HasForeignKeys for crate::Centrifuge {
    type ForeignKeys = CentrifugeForeignKeys;
    ...
    fn update(
        ...
        match (row, crud) {
            (
                crate::codegen::tables::row::Row::CommercialCentrifugeLot(
                ...
                if self.model == commercial_centrifuge_lots.id {
                    foreign_keys.model = Some(commercial_centrifuge_lots);
                    updated = true;
                }
            }
            (
...
impl web_common_traits::prelude::ForeignKeys for CentrifugeForeignKeys {}
