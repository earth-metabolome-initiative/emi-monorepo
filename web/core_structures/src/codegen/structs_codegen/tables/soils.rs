...
impl web_common_traits::prelude::TableName for Soil {
    const TABLE_NAME: &'static str = "soils";
}
impl<'a> From<&'a Soil>
...
impl
    web_common_traits::prelude::ExtensionTable<crate::codegen::structs_codegen::tables::soils::Soil>
    for Soil
where
    for<'a> &'a Self: diesel::Identifiable<Id = &'a ::rosetta_uuid::Uuid>,
{
}
impl diesel::Identifiable for Soil {
    type Id = ::rosetta_uuid::Uuid;
    fn id(self) -> Self::Id {
        self.id
    }
}
impl web_common_traits::database::PrimaryKeyLike for Soil {
...
impl Soil {
    ...
    where
        ...
        <Self as diesel::associations::HasTable>::Table: diesel::query_dsl::methods::FilterDsl<
            <crate::codegen::diesel_codegen::tables::soils::soils::id as diesel::expression_methods::EqAll<
                ::rosetta_uuid::Uuid,
            >>::Output,
        >,
        ...
        >>::Output: diesel::query_dsl::methods::OrderDsl<
            diesel::helper_types::Asc<
                crate::codegen::diesel_codegen::tables::soils::soils::id,
            >,
        >,
        <<<Self as diesel::associations::HasTable>::Table as diesel::query_dsl::methods::FilterDsl<
            <crate::codegen::diesel_codegen::tables::soils::soils::id as diesel::expression_methods::EqAll<
            ...
            + for<'a> diesel::query_dsl::LoadQuery<'a, C, Self>,
    {
        ...
        use crate::codegen::diesel_codegen::tables::soils::soils;
        Self::table().filter(soils::id.eq(id)).order_by(soils::id.asc()).load::<Self>(conn)
    }
    #[cfg(feature = "postgres")]
    pub fn from_id_and_model(
        ...
        use crate::codegen::diesel_codegen::tables::soils::soils;
        Self::table()
            .filter(soils::id.eq(id).and(soils::model.eq(model)))
            .order_by(soils::id.asc())
            .load::<Self>(conn)
    }
    #[cfg(feature = "postgres")]
    pub fn from_model(
        ...
        use crate::codegen::diesel_codegen::tables::{
            sample_sources::sample_sources, soils::soils,
        };
        Self::table()
            .inner_join(sample_sources::table.on(soils::id.eq(sample_sources::id)))
    ...
    pub fn from_model_and_id(
        ...
        Self::table()
            .inner_join(assets::table.on(soils::id.eq(assets::id)))
