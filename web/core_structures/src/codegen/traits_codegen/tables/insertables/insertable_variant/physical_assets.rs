...
where
    ...
    crate::codegen::structs_codegen::tables::insertables::PhysicalAssetAttribute: web_common_traits::database::FromExtensionAttribute<
        crate::codegen::structs_codegen::tables::insertables::AssetAttribute,
        Asset,
        EffectiveExtensionAttribute = <Asset as web_common_traits::database::TryInsertGeneric<
            C,
        >>::Attribute,
    >,
{
        ...
        let id = self
            ...
            .map_err(|err| {
                err.into_field_name(|attribute| {
                    <crate::codegen::structs_codegen::tables::insertables::PhysicalAssetAttribute as web_common_traits::database::FromExtensionAttribute<
                        crate::codegen::structs_codegen::tables::insertables::AssetAttribute,
                        Asset,
