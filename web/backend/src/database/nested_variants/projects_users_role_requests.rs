...
impl NestedProjectsUsersRoleRequest {
    ...
    pub fn can_update_by_id() -> Result<bool, web_common::api::ApiError> {
        ProjectsUsersRoleRequest::can_update_by_id()
    }
...
impl From<web_common::database::nested_variants::NestedProjectsUsersRoleRequest>
    for crate::database::nested_variants::NestedProjectsUsersRoleRequest
{
    fn from(item: web_common::database::nested_variants::NestedProjectsUsersRoleRequest) -> Self {
        Self {
            inner: crate::database::flat_variants::ProjectsUsersRoleRequest::from(item.inner),
...
impl From<crate::database::nested_variants::NestedProjectsUsersRoleRequest>
    for web_common::database::nested_variants::NestedProjectsUsersRoleRequest
{
    fn from(item: crate::database::nested_variants::NestedProjectsUsersRoleRequest) -> Self {
        Self {
            inner: web_common::database::flat_variants::ProjectsUsersRoleRequest::from(item.inner),
