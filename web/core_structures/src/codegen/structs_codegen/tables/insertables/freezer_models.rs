...
impl From<
    crate::codegen::structs_codegen::tables::insertables::InsertablePhysicalAssetModelAttributes,
> for InsertableFreezerModelExtensionAttributes {
    fn from(
...
> for InsertableFreezerModelAttributes {
    fn from(
        ...
        Self::Extension(
            InsertableFreezerModelExtensionAttributes::PhysicalAssetModel(
...
/// descendant tables.
pub trait FreezerModelBuildable: Sized {
    /// Attributes required to build the insertable.
    type Attributes;
}
impl<PhysicalAssetModel> FreezerModelBuildable
...
where
    ...
    >,
{
    type Attributes = crate::codegen::structs_codegen::tables::insertables::InsertableFreezerModelAttributes;
    #[inline]
