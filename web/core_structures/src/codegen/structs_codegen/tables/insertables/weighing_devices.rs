...
impl core::fmt::Display for WeighingDeviceExtensionAttribute {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            Self::PhysicalAsset(e) => write!(f, "weighing_devices({e})"),
        }
    }
}
...
impl web_common_traits::database::TableField for WeighingDeviceAttribute {}
impl web_common_traits::database::HasTableType for WeighingDeviceAttribute {
    ...
    > for WeighingDeviceAttribute
{
    fn from_extension(
        ...
        WeighingDeviceAttribute::Extension(From::from(attribute))
    }
}
...
impl core::fmt::Display for WeighingDeviceAttribute {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            ...
            Self::Id => write!(f, "weighing_devices.id"),
            Self::Model => write!(f, "weighing_devices.model"),
        }
    }
}
#[derive(Debug)]
...
///
/// ```rust,ignore
/// use core_structures::WeighingDevice;
/// use core_structures::tables::insertables::AssetSettable;
/// use core_structures::tables::insertables::WeighingDeviceSettable;
/// use web_common_traits::database::Insertable;
/// use web_common_traits::database::InsertableVariant;
///
/// let weighing_device = WeighingDevice::new()
...
{
    type Table = crate::codegen::diesel_codegen::tables::weighing_devices::weighing_devices::table;
    fn table() -> Self::Table {
        crate::codegen::diesel_codegen::tables::weighing_devices::weighing_devices::table
    }
}
...
where
    Self: common_traits::builder::Attributed<
        Attribute = crate::codegen::structs_codegen::tables::insertables::WeighingDeviceAttribute,
    >,
{
...
{
    type Error = web_common_traits::database::InsertError<WeighingDeviceAttribute>;
