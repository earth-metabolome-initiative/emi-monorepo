...
pub trait CommercialPositioningDeviceModelBuildable:
...
impl CommercialPositioningDeviceModelBuildable for Option<i32> {}
impl<
...
> {
    ...
    {
        self.commercial_positioning_device_models_id_fkey1 = <CommercialProduct as crate::codegen::structs_codegen::tables::insertables::AssetModelBuildable>::most_concrete_table(
