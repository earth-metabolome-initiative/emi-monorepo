...
impl web_common_traits::prelude::TableName for InstrumentType {
    const TABLE_NAME: &'static str = "Instrument_Types";
}
impl
...
impl web_common_traits::database::PrimaryKeyLike for InstrumentType {
    type PrimaryKey = i32;
...
impl InstrumentType {
    ...
    pub fn from_user_created(
        ...
        Self::table()
            .filter(instrument_types::user_created.eq(user_created))
            .order_by(instrument_types::id.asc())
            .load::<Self>(conn)
    }
    #[cfg(feature = "postgres")]
    pub fn from_user_updated(
        ...
        use crate::codegen::diesel_codegen::tables::instrument_types::instrument_types;
        Self::table()
            .filter(instrument_types::user_updated.eq(user_updated))
            .order_by(instrument_types::id.asc())
            .load::<Self>(conn)
    }
    #[cfg(feature = "postgres")]
    pub fn from_status(
        ...
        use crate::codegen::diesel_codegen::tables::instrument_types::instrument_types;
        Self::table()
            .filter(instrument_types::status.eq(status))
            .order_by(instrument_types::id.asc())
            .load::<Self>(conn)
    }
    #[cfg(feature = "postgres")]
    pub fn from_date_created(
        ...
        use crate::codegen::diesel_codegen::tables::instrument_types::instrument_types;
        Self::table()
            .filter(instrument_types::date_created.eq(date_created))
            .order_by(instrument_types::id.asc())
            .load::<Self>(conn)
    }
    #[cfg(feature = "postgres")]
    pub fn from_date_updated(
        ...
        use crate::codegen::diesel_codegen::tables::instrument_types::instrument_types;
        Self::table()
            .filter(instrument_types::date_updated.eq(date_updated))
            .order_by(instrument_types::id.asc())
            .load::<Self>(conn)
    }
    #[cfg(feature = "postgres")]
    pub fn from_instrument_type(
        ...
        use crate::codegen::diesel_codegen::tables::instrument_types::instrument_types;
        Self::table()
            .filter(instrument_types::instrument_type.eq(instrument_type))
            .order_by(instrument_types::id.asc())
            .load::<Self>(conn)
    }
}
impl AsRef<InstrumentType> for InstrumentType {
    fn as_ref(&self) -> &InstrumentType {
        self
    }
}
