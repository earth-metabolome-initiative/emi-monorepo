...
impl web_common_traits::database::TableField for LoginProviderAttribute {}
impl web_common_traits::database::HasTableType for LoginProviderAttribute {
...
impl diesel::associations::HasTable for InsertableLoginProviderBuilder {
    type Table = crate::codegen::diesel_codegen::tables::login_providers::login_providers::table;
    fn table() -> Self::Table {
...
where
    Self: common_traits::builder::Attributed<
        Attribute = crate::codegen::structs_codegen::tables::insertables::LoginProviderAttribute,
    >,
{
...
{
    type Error = web_common_traits::database::InsertError<LoginProviderAttribute>;
