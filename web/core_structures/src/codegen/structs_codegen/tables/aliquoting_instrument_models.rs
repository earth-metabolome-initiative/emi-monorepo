...
impl web_common_traits::prelude::TableName for AliquotingInstrumentModel {
    const TABLE_NAME: &'static str = "aliquoting_instrument_models";
}
impl
    web_common_traits::prelude::ExtensionTable<
        crate::codegen::structs_codegen::tables::trackables::Trackable,
    > for AliquotingInstrumentModel
where
        ...
        Self::table()
            .inner_join(
                commercial_products::table
                    .on(aliquoting_instrument_models::id.eq(commercial_products::id)),
            )
...
impl AsRef<AliquotingInstrumentModel> for AliquotingInstrumentModel {
    fn as_ref(&self) -> &AliquotingInstrumentModel {
        self
    }
}
