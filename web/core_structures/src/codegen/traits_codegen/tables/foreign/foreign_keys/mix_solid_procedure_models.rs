...
pub struct MixSolidProcedureModelForeignKeys {
    pub id: Option<
...
{
    type ForeignKeys = MixSolidProcedureModelForeignKeys;
...
impl web_common_traits::prelude::ForeignKeys for MixSolidProcedureModelForeignKeys {}
