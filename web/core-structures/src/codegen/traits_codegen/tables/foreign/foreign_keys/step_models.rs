...
pub struct StepModelForeignKeys {
    ...
    pub step_model_category:
        Option<crate::codegen::structs_codegen::tables::step_model_categories::StepModelCategory>,
...
{
    type ForeignKeys = StepModelForeignKeys;
    ...
    fn foreign_keys_loaded(&self, foreign_keys: &Self::ForeignKeys) -> bool {
        foreign_keys.photograph.is_some()
            && foreign_keys.step_model_category.is_some()
...
impl web_common_traits::prelude::ForeignKeys for StepModelForeignKeys {}
