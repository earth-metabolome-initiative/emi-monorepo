...
pub struct CentrifugeStepModelForeignKeys {
...
{
    type ForeignKeys = CentrifugeStepModelForeignKeys;
...
impl web_common_traits::prelude::ForeignKeys for CentrifugeStepModelForeignKeys {}
