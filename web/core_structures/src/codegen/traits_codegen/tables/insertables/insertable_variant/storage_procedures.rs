...
where
    ...
    crate::codegen::structs_codegen::tables::insertables::StorageProcedureAttribute: web_common_traits::database::FromExtensionAttribute<
        ...
        let procedure = self
            ...
            .map_err(|err| {
                err.into_field_name(|attribute| {
                    <crate::codegen::structs_codegen::tables::insertables::StorageProcedureAttribute as web_common_traits::database::FromExtensionAttribute<
                        crate::codegen::structs_codegen::tables::insertables::ProcedureAttribute,
                        Procedure,
