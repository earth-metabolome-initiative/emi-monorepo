...
pub struct ProcedureModelNameplateCategory {
    pub id: i32,
...
impl diesel::Identifiable for ProcedureModelNameplateCategory {
    type Id = i32;
    fn id(self) -> Self::Id {
        self.id
    }
}
impl ProcedureModelNameplateCategory {
    ...
    pub async fn from_procedure_model_id(
        ...
        Self::table()
            .filter(
                crate::codegen::diesel_codegen::tables::procedure_model_nameplate_categories::procedure_model_nameplate_categories::dsl::procedure_model_id
    ...
    pub async fn from_created_by(
        ...
        Self::table()
            .filter(
                crate::codegen::diesel_codegen::tables::procedure_model_nameplate_categories::procedure_model_nameplate_categories::dsl::created_by
                    .eq(created_by.id),
            )
            .load::<Self>(conn)
            .await
    ...
    pub async fn from_updated_by(
        ...
        Self::table()
            .filter(
                crate::codegen::diesel_codegen::tables::procedure_model_nameplate_categories::procedure_model_nameplate_categories::dsl::updated_by
                    .eq(updated_by.id),
            )
            .load::<Self>(conn)
            .await
    ...
    pub async fn from_nameplate_category(
        ...
        Self::table()
            .filter(procedure_model_nameplate_categories::nameplate_category.eq(nameplate_category))
            .order_by(procedure_model_nameplate_categories::id.asc())
            .load::<Self>(conn)
            .await
    }
    #[cfg(feature = "postgres")]
    pub async fn from_created_at(
        ...
        use crate::codegen::diesel_codegen::tables::procedure_model_nameplate_categories::procedure_model_nameplate_categories;
        Self::table()
            .filter(procedure_model_nameplate_categories::created_at.eq(created_at))
            .order_by(procedure_model_nameplate_categories::id.asc())
            .load::<Self>(conn)
            .await
    }
    ...
    pub async fn from_updated_at(
        ...
        use crate::codegen::diesel_codegen::tables::procedure_model_nameplate_categories::procedure_model_nameplate_categories;
        Self::table()
            .filter(procedure_model_nameplate_categories::updated_at.eq(updated_at))
            .order_by(procedure_model_nameplate_categories::id.asc())
            .load::<Self>(conn)
            .await
    }
