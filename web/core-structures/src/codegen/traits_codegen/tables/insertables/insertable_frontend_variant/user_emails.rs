...
for crate::codegen::structs_codegen::tables::insertables::InsertableUserEmail {
    type Row = crate::codegen::structs_codegen::tables::user_emails::UserEmail;
    type InsertableBuilder = crate::codegen::structs_codegen::tables::insertables::InsertableUserEmailBuilder;
