impl super::Rows {
    pub fn len(&self) -> usize {
        match self {
            ...
            super::Rows::BrandState(rows) => rows.len(),
            ...
            super::Rows::ContainerCategory(rows) => rows.len(),
            ...
            super::Rows::GrindingStepModel(rows) => rows.len(),
            super::Rows::InstrumentCategory(rows) => rows.len(),
            ...
            super::Rows::NameplateCategory(rows) => rows.len(),
            ...
            super::Rows::ToolCategory(rows) => rows.len(),
