CREATE TABLE IF NOT EXISTS weighing_with_device_model_procedure_models (
	procedure_model_id INTEGER PRIMARY KEY REFERENCES weighing_without_device_procedure_models(procedure_model_id),
...
CREATE TABLE IF NOT EXISTS weighing_with_device_procedure_models (
	procedure_model_id INTEGER PRIMARY KEY REFERENCES weighing_with_device_model_procedure_models(procedure_model_id),
);
CREATE TABLE IF NOT EXISTS weighing_with_devices(
	procedure_id UUID PRIMARY KEY REFERENCES weighing_with_device_models(id),
	-- We enforce that the model of this procedure must be a weighing procedure model.
	procedure_model_id INTEGER NOT NULL REFERENCES weighing_with_device_procedure_models(procedure_model_id),
