...
CREATE TABLE IF NOT EXISTS freeze_drying_procedures (
	...
	freeze_drying_procedure_template INTEGER NOT NULL REFERENCES freeze_drying_procedure_templates(id),
	...
	FOREIGN KEY (id, freeze_drying_procedure_template) REFERENCES procedures(id, procedure_template),
	...
	FOREIGN KEY (
		freeze_drying_procedure_template,
		procedure_template_freeze_dried_with_model
