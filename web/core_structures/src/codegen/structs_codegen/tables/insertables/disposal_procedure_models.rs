...
pub enum InsertableDisposalProcedureModelExtensionAttributes {
    ProcedureModel(
        crate::codegen::structs_codegen::tables::insertables::InsertableProcedureModelAttributes,
    ),
}
impl core::fmt::Display for InsertableDisposalProcedureModelExtensionAttributes {
...
pub enum InsertableDisposalProcedureModelAttributes {
    Extension(InsertableDisposalProcedureModelExtensionAttributes),
    ProcedureModelId,
    DisposedId(
...
for InsertableDisposalProcedureModelBuilder<ProcedureModel>
where
    ...
    >,
{
    type Attributes = InsertableDisposalProcedureModelAttributes;
    fn extend_builder(
        mut self,
        other: Self,
        ...
        self.procedure_model = self
            ...
            .map_err(|err| {
                err.into_field_name(|attribute| InsertableDisposalProcedureModelAttributes::Extension(
                    InsertableDisposalProcedureModelExtensionAttributes::ProcedureModel(
                        attribute,
                    ),
                ))
            })?;
        self = self.disposed(other.disposed_id)?;
        Ok(self)
    }
}
...
where
    Self: web_common_traits::database::InsertableVariant<
        C,
        UserId = i32,
        Row = crate::codegen::structs_codegen::tables::disposal_procedure_models::DisposalProcedureModel,
    ...
    >,
{
    ...
    fn is_complete(&self) -> bool {
        self.procedure_model.is_complete() && self.disposed_id.is_complete()
    }
    fn mint_primary_key(
        self,
        user_id: i32,
    ...
    > {
        ...
        let insertable: crate::codegen::structs_codegen::tables::disposal_procedure_models::DisposalProcedureModel = self
            .insert(user_id, conn)?;
        Ok(insertable.id())
    }
}
