...
impl SearchableTable for web_common::database::Table {
    fn similarity_search(&self, query: &str, limit: Option<i32>, connection: &mut PooledConnection<ConnectionManager<diesel::prelude::PgConnection>>) -> Result<Vec<Vec<u8>>, web_common::api::ApiError> {
        match self {
            ...
            web_common::database::Table::DocumentFormats => unimplemented!("Table `document_formats` does not have a GIN similarity index."),
            ...
            web_common::database::Table::ItemCategories => unimplemented!("Table `item_categories` does not have a GIN similarity index."),
            ...
            web_common::database::Table::ItemContinuousQuantities => unimplemented!("Table `item_continuous_quantities` does not have a GIN similarity index."),
            web_common::database::Table::ItemDiscreteQuantities => unimplemented!("Table `item_discrete_quantities` does not have a GIN similarity index."),
            ...
            web_common::database::Table::Organizations => unimplemented!("Table `organizations` does not have a GIN similarity index."),
            web_common::database::Table::PrimaryUserEmails => unimplemented!("Table `primary_user_emails` does not have a GIN similarity index."),
            web_common::database::Table::ProcedureContinuousRequirements => unimplemented!("Table `procedure_continuous_requirements` does not have a GIN similarity index."),
            web_common::database::Table::ProcedureDiscreteRequirements => unimplemented!("Table `procedure_discrete_requirements` does not have a GIN similarity index."),
            ...
            web_common::database::Table::SpectraCollection => unimplemented!("Table `spectra_collection` does not have a GIN similarity index."),
            ...
            web_common::database::Table::Units => unimplemented!("Table `units` does not have a GIN similarity index."),
...
impl IdentifiableTable for web_common::database::Table {
    ...
    fn get(
        ...
        Ok(match self {
            ...
            web_common::database::Table::ItemContinuousQuantities => bincode::serialize(&NestedItemContinuousQuantity::get(primary_key.into(), connection)?)?,
            web_common::database::Table::ItemDiscreteQuantities => bincode::serialize(&NestedItemDiscreteQuantity::get(primary_key.into(), connection)?)?,
            ...
            web_common::database::Table::ProcedureContinuousRequirements => bincode::serialize(&NestedProcedureContinuousRequirement::get(primary_key.into(), connection)?)?,
            web_common::database::Table::ProcedureDiscreteRequirements => bincode::serialize(&NestedProcedureDiscreteRequirement::get(primary_key.into(), connection)?)?,
            ...
            web_common::database::Table::SpectraCollection => bincode::serialize(&NestedSpectraCollection::get(primary_key.into(), connection)?)?,
...
impl DeletableTable for web_common::database::Table {
    ...
    fn delete(
        ...
        Ok(match self {
            ...
            web_common::database::Table::ItemContinuousQuantities => ItemContinuousQuantity::delete_by_id(primary_key.into(), connection)?,
            web_common::database::Table::ItemDiscreteQuantities => ItemDiscreteQuantity::delete_by_id(primary_key.into(), connection)?,
            ...
            web_common::database::Table::ProcedureContinuousRequirements => ProcedureContinuousRequirement::delete_by_id(primary_key.into(), connection)?,
            web_common::database::Table::ProcedureDiscreteRequirements => ProcedureDiscreteRequirement::delete_by_id(primary_key.into(), connection)?,
            ...
            web_common::database::Table::SpectraCollection => SpectraCollection::delete_by_id(primary_key.into(), connection)?,
...
impl AllTable for web_common::database::Table {
    ...
    fn all(
        ...
        match self {
            ...
            web_common::database::Table::ItemContinuousQuantities => NestedItemContinuousQuantity::all(limit, offset, connection)?.iter().map(|row| bincode::serialize(row).map_err(web_common::api::ApiError::from)).collect(),
            web_common::database::Table::ItemDiscreteQuantities => NestedItemDiscreteQuantity::all(limit, offset, connection)?.iter().map(|row| bincode::serialize(row).map_err(web_common::api::ApiError::from)).collect(),
            ...
            web_common::database::Table::ProcedureContinuousRequirements => NestedProcedureContinuousRequirement::all(limit, offset, connection)?.iter().map(|row| bincode::serialize(row).map_err(web_common::api::ApiError::from)).collect(),
            web_common::database::Table::ProcedureDiscreteRequirements => NestedProcedureDiscreteRequirement::all(limit, offset, connection)?.iter().map(|row| bincode::serialize(row).map_err(web_common::api::ApiError::from)).collect(),
            ...
            web_common::database::Table::SpectraCollection => NestedSpectraCollection::all(limit, offset, connection)?.iter().map(|row| bincode::serialize(row).map_err(web_common::api::ApiError::from)).collect(),
