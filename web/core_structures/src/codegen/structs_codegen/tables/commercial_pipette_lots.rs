...
#[diesel(belongs_to(crate::CommercialPipetteModel, foreign_key = product_model))]
...
impl<'a> From<&'a CommercialPipetteLot>
    for web_common_traits::database::IdOrBuilder<
        i32,
        crate::codegen::structs_codegen::tables::insertables::InsertableCommercialPipetteLotBuilder,
    >
{
    fn from(value: &'a CommercialPipetteLot) -> Self {
        web_common_traits::database::IdOrBuilder::Id(value.id)
    }
}
impl web_common_traits::prelude::ExtensionTable<crate::AssetModel> for CommercialPipetteLot where
...
impl web_common_traits::prelude::ExtensionTable<crate::PhysicalAssetModel> for CommercialPipetteLot where
    for<'a> &'a Self: diesel::Identifiable<Id = &'a i32>
{
}
impl web_common_traits::prelude::ExtensionTable<crate::PipetteModel> for CommercialPipetteLot where
    for<'a> &'a Self: diesel::Identifiable<Id = &'a i32>
{
}
impl web_common_traits::prelude::ExtensionTable<crate::CommercialPipetteLot>
    for CommercialPipetteLot
where
    for<'a> &'a Self: diesel::Identifiable<Id = &'a i32>,
{
...
impl CommercialPipetteLot {
    ...
    where
        ...
        <Self as diesel::associations::HasTable>::Table: diesel::query_dsl::methods::FilterDsl<
            <crate::codegen::diesel_codegen::tables::commercial_pipette_lots::commercial_pipette_lots::id as diesel::expression_methods::EqAll<
                i32,
            >>::Output,
        >,
        ...
        >>::Output: diesel::query_dsl::methods::OrderDsl<
            diesel::helper_types::Asc<
                crate::codegen::diesel_codegen::tables::commercial_pipette_lots::commercial_pipette_lots::id,
            >,
        >,
        <<<Self as diesel::associations::HasTable>::Table as diesel::query_dsl::methods::FilterDsl<
            <crate::codegen::diesel_codegen::tables::commercial_pipette_lots::commercial_pipette_lots::id as diesel::expression_methods::EqAll<
            ...
            + for<'a> diesel::query_dsl::LoadQuery<'a, C, Self>,
    {
        ...
        Self::table()
            .filter(commercial_pipette_lots::id.eq(id))
        ...
        Self::table()
            .filter(
                commercial_pipette_lots::id
                    .eq(id)
                    .and(commercial_pipette_lots::product_model.eq(product_model)),
            )
            .order_by(commercial_pipette_lots::id.asc())
            .load::<Self>(conn)
    }
