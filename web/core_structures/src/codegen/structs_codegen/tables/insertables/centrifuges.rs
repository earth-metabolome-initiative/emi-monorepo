...
pub enum InsertableCentrifugeExtensionAttributes {
    PhysicalAsset(
        crate::codegen::structs_codegen::tables::insertables::InsertablePhysicalAssetAttributes,
    ),
}
impl core::fmt::Display for InsertableCentrifugeExtensionAttributes {
...
impl From<crate::codegen::structs_codegen::tables::insertables::InsertablePhysicalAssetAttributes>
    for InsertableCentrifugeExtensionAttributes
{
    fn from(
...
#[derive(Copy, Clone, PartialEq, Eq, PartialOrd, Ord, Hash, core::fmt::Debug)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub enum InsertableCentrifugeAttributes {
    Extension(InsertableCentrifugeExtensionAttributes),
    Id,
    ModelId,
}
impl core::str::FromStr for InsertableCentrifugeAttributes {
...
impl core::fmt::Display for InsertableCentrifugeAttributes {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
...
impl InsertableCentrifuge {
    ...
    >
    where
        crate::codegen::structs_codegen::tables::commercial_centrifuge_lots::CommercialCentrifugeLot: diesel::Identifiable,
        <crate::codegen::structs_codegen::tables::commercial_centrifuge_lots::CommercialCentrifugeLot as diesel::associations::HasTable>::Table: diesel::query_dsl::methods::FindDsl<
            <crate::codegen::structs_codegen::tables::commercial_centrifuge_lots::CommercialCentrifugeLot as diesel::Identifiable>::Id,
        >,
        <<crate::codegen::structs_codegen::tables::commercial_centrifuge_lots::CommercialCentrifugeLot as diesel::associations::HasTable>::Table as diesel::query_dsl::methods::FindDsl<
            <crate::codegen::structs_codegen::tables::commercial_centrifuge_lots::CommercialCentrifugeLot as diesel::Identifiable>::Id,
        >>::Output: diesel::query_dsl::methods::LimitDsl + diesel::RunQueryDsl<C>,
        <<<crate::codegen::structs_codegen::tables::commercial_centrifuge_lots::CommercialCentrifugeLot as diesel::associations::HasTable>::Table as diesel::query_dsl::methods::FindDsl<
            <crate::codegen::structs_codegen::tables::commercial_centrifuge_lots::CommercialCentrifugeLot as diesel::Identifiable>::Id,
        ...
        >,
    {
        ...
        RunQueryDsl::first(
            QueryDsl::find(
                crate::codegen::structs_codegen::tables::commercial_centrifuge_lots::CommercialCentrifugeLot::table(),
                self.model_id,
            ),
            conn,
        )
...
/// descendant tables.
pub trait CentrifugeBuildable:
    crate::codegen::structs_codegen::tables::insertables::PhysicalAssetBuildable
{
    /// Sets the value of the `public.centrifuges.model_id` column.
    ///
    /// # Arguments
    /// * `model_id`: The value to set for the `public.centrifuges.model_id`
    ///   column.
    ///
...
impl CentrifugeBuildable for Option<::rosetta_uuid::Uuid> {
    fn model(
        self,
        _model_id: i32,
    ) -> Result<Self, web_common_traits::database::InsertError<Self::Attributes>> {
...
impl<
    PhysicalAsset: crate::codegen::structs_codegen::tables::insertables::PhysicalAssetBuildable<
        ...
        >,
> CentrifugeBuildable for InsertableCentrifugeBuilder<PhysicalAsset> {
    ///Sets the value of the `public.centrifuges.model_id` column.
    fn model(
        mut self,
        model_id: i32,
        ...
        let model_id = model_id
            ...
            .map_err(|err| {
                validation_errors::SingleFieldError::from(err)
                    .rename_field(InsertableCentrifugeAttributes::ModelId)
            })?;
...
for InsertableCentrifugeBuilder<PhysicalAsset> {
    type Attributes = crate::codegen::structs_codegen::tables::insertables::InsertableCentrifugeAttributes;
    #[inline]
    ...
    {
        self.id = <PhysicalAsset as crate::codegen::structs_codegen::tables::insertables::AssetBuildable>::most_concrete_table(
                self.id,
                most_concrete_table,
            )
            .map_err(|e| {
    ...
    fn model(
        ...
        <Self as CentrifugeBuildable>::model(self, model_id)
    }
    #[inline]
...
where
    Self: web_common_traits::database::InsertableVariant<
            ...
            Error = web_common_traits::database::InsertError<InsertableCentrifugeAttributes>,
        >,
    PhysicalAsset:
        web_common_traits::database::TryInsertGeneric<C, PrimaryKey = ::rosetta_uuid::Uuid>,
{
    type Attributes = InsertableCentrifugeAttributes;
    ...
    fn mint_primary_key(
        ...
        let insertable: crate::codegen::structs_codegen::tables::centrifuges::Centrifuge =
