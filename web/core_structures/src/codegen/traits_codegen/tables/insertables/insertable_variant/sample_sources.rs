    ...
    >
{
    type InsertableVariant =
        crate::codegen::structs_codegen::tables::insertables::InsertableSampleSource;
}
#[cfg(feature = "backend")]
...
where
    ...
    Self: web_common_traits::database::InsertableVariant<
        C,
        InsertableVariant = crate::codegen::structs_codegen::tables::insertables::InsertableSampleSource,
    ...
    crate::codegen::structs_codegen::tables::insertables::SampleSourceExtensionAttribute: From<
        ...
        let id = self
            ...
            .map_err(|err| {
                err.into_field_name(|attribute| {
                    crate::codegen::structs_codegen::tables::insertables::SampleSourceAttribute::Extension(
                        From::from(attribute),
                    )
                })
            })?;
