...
impl From<common_traits::builder::EmptyTuple> for FreezerExtensionAttribute {
...
#[derive(Copy, Clone, PartialEq, Eq, PartialOrd, Ord, Hash, core::fmt::Debug)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub enum FreezerAttribute {
    Extension(FreezerExtensionAttribute),
    Id,
    Model,
}
impl core::str::FromStr for FreezerAttribute {
...
impl<T1> common_traits::builder::Attributed
    for crate::codegen::structs_codegen::tables::insertables::InsertableFreezerBuilder<T1>
{
    type Attribute = FreezerAttribute;
}
impl web_common_traits::database::TableField for FreezerAttribute {}
impl web_common_traits::database::HasTableType for FreezerAttribute {
    type Table = crate::codegen::tables::table_names::TableName;
}
impl
    web_common_traits::database::FromExtension<
        crate::codegen::structs_codegen::tables::insertables::PhysicalAssetAttribute,
    > for FreezerAttribute
{
    fn from_extension(
        attribute: crate::codegen::structs_codegen::tables::insertables::PhysicalAssetAttribute,
    ) -> Self {
        FreezerAttribute::Extension(From::from(attribute))
    }
}
...
impl core::fmt::Display for FreezerAttribute {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
...
///
/// ```rust,ignore
/// use core_structures::Freezer;
/// use core_structures::tables::insertables::AssetSettable;
/// use core_structures::tables::insertables::FreezerSettable;
...
impl<PhysicalAsset> diesel::associations::HasTable for InsertableFreezerBuilder<PhysicalAsset> {
    type Table = crate::codegen::diesel_codegen::tables::freezers::freezers::table;
    fn table() -> Self::Table {
        crate::codegen::diesel_codegen::tables::freezers::freezers::table
    }
}
impl From<InsertableFreezerBuilder>
    for web_common_traits::database::IdOrBuilder<::rosetta_uuid::Uuid, InsertableFreezerBuilder>
{
    fn from(builder: InsertableFreezerBuilder) -> Self {
...
/// descendant tables.
pub trait FreezerSettable: Sized {
    /// Error type returned when setting attributes.
    type Error;
    /// Sets the value of the `public.freezers.model` column.
    ///
    /// # Arguments
    /// * `model`: The value to set for the `public.freezers.model` column.
    ///
    /// # Implementation details
...
impl<
    PhysicalAsset: crate::codegen::structs_codegen::tables::insertables::PhysicalAssetSettable<
            ...
            >,
        >,
> FreezerSettable for InsertableFreezerBuilder<PhysicalAsset>
where
    Self: common_traits::builder::Attributed<
            Attribute = crate::codegen::structs_codegen::tables::insertables::FreezerAttribute,
        >,
{
...
where
    Self: common_traits::builder::Attributed<
            Attribute = crate::codegen::structs_codegen::tables::insertables::FreezerAttribute,
        >,
    Self: crate::codegen::structs_codegen::tables::insertables::FreezerSettable<
            Error = web_common_traits::database::InsertError<
                crate::codegen::structs_codegen::tables::insertables::FreezerAttribute,
            >,
        >,
{
    ...
    where
        M: web_common_traits::database::PrimaryKeyLike<PrimaryKey = i32>,
    {
        <Self as FreezerSettable>::model(self, model)
    }
}
...
{
    type Error = web_common_traits::database::InsertError<FreezerAttribute>;
