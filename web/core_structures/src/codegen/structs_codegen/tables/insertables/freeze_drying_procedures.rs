...
pub enum InsertableFreezeDryingProcedureExtensionAttributes {
    Procedure(crate::codegen::structs_codegen::tables::insertables::InsertableProcedureAttributes),
}
impl core::fmt::Display for InsertableFreezeDryingProcedureExtensionAttributes {
...
impl From<crate::codegen::structs_codegen::tables::insertables::InsertableProcedureAttributes>
    for InsertableFreezeDryingProcedureExtensionAttributes
{
    fn from(
...
#[derive(Copy, Clone, PartialEq, Eq, PartialOrd, Ord, Hash, core::fmt::Debug)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub enum InsertableFreezeDryingProcedureAttributes {
    Extension(InsertableFreezeDryingProcedureExtensionAttributes),
    Procedure,
    ProcedureTemplate,
    ForeignProcedureTemplate,
    ForeignProcedure,
    FreezeDryedContainer,
    FreezeDryedWith,
    FreezeDryedWithModel,
}
impl core::str::FromStr for InsertableFreezeDryingProcedureAttributes {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            ...
            "FreezeDryedContainer" => Ok(Self::FreezeDryedContainer),
            "FreezeDryedWith" => Ok(Self::FreezeDryedWith),
            "FreezeDryedWithModel" => Ok(Self::FreezeDryedWithModel),
            "procedure_template" => Ok(Self::ProcedureTemplate),
            "foreign_procedure_template" => Ok(Self::ForeignProcedureTemplate),
            "foreign_procedure" => Ok(Self::ForeignProcedure),
            "freeze_dryed_container" => Ok(Self::FreezeDryedContainer),
            "freeze_dryed_with" => Ok(Self::FreezeDryedWith),
            "freeze_dryed_with_model" => Ok(Self::FreezeDryedWithModel),
            _ => Err(web_common_traits::database::InsertError::UnknownAttribute(s.to_owned())),
        }
    }
}
impl core::fmt::Display for InsertableFreezeDryingProcedureAttributes {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            ...
            Self::FreezeDryedContainer => write!(f, "freeze_dryed_container"),
            Self::FreezeDryedWith => write!(f, "freeze_dryed_with"),
            Self::FreezeDryedWithModel => write!(f, "freeze_dryed_with_model"),
        }
    }
}
...
pub struct InsertableFreezeDryingProcedure {
    ...
    pub(crate) freeze_dryed_container: ::rosetta_uuid::Uuid,
    pub(crate) freeze_dryed_with: Option<::rosetta_uuid::Uuid>,
    pub(crate) freeze_dryed_with_model: i32,
}
...
> {
    ...
    pub(crate) freeze_dryed_container: Option<::rosetta_uuid::Uuid>,
    pub(crate) freeze_dryed_with: Option<::rosetta_uuid::Uuid>,
    pub(crate) freeze_dryed_with_model: Option<i32>,
    pub(crate) procedure: Procedure,
}
/// Trait defining setters for attributes of an instance of
/// `FreezeDryingProcedure` or descendant tables.
pub trait FreezeDryingProcedureBuildable:
...
impl FreezeDryingProcedureBuildable for Option<::rosetta_uuid::Uuid> {
    fn procedure_template(
        self,
    ...
    fn freeze_dryed_container(
        self,
        _freeze_dryed_container: ::rosetta_uuid::Uuid,
    ) -> Result<Self, web_common_traits::database::InsertError<Self::Attributes>> {
        Ok(self)
    }
    fn freeze_dryed_with(
        self,
        _freeze_dryed_with: Option<::rosetta_uuid::Uuid>,
    ) -> Result<Self, web_common_traits::database::InsertError<Self::Attributes>> {
        Ok(self)
    }
    fn freeze_dryed_with_model(
        self,
        _freeze_dryed_with_model: i32,
    ) -> Result<Self, web_common_traits::database::InsertError<Self::Attributes>> {
        Ok(self)
    }
}
...
> FreezeDryingProcedureBuildable for InsertableFreezeDryingProcedureBuilder<Procedure> {
        ...
        let procedure_template = procedure_template
            ...
            .map_err(|err| {
                validation_errors::SingleFieldError::from(err)
                    .rename_field(
                        InsertableFreezeDryingProcedureAttributes::ProcedureTemplate,
                    )
            })?;
        self.procedure = self
            .procedure
    ...
    fn foreign_procedure_template(
        ...
        let foreign_procedure_template = foreign_procedure_template
            ...
            .map_err(|err| {
                validation_errors::SingleFieldError::from(err)
                    .rename_field(
                        InsertableFreezeDryingProcedureAttributes::ForeignProcedureTemplate,
                    )
            })?;
    ...
    fn foreign_procedure(
        ...
        let foreign_procedure = foreign_procedure
            ...
            .map_err(|err| {
                validation_errors::SingleFieldError::from(err)
                    .rename_field(
                        InsertableFreezeDryingProcedureAttributes::ForeignProcedure,
                    )
            })?;
    ...
    fn freeze_dryed_container(
        ...
        let freeze_dryed_container = freeze_dryed_container
            .try_into()
            .map_err(|err| {
                validation_errors::SingleFieldError::from(err)
                    .rename_field(
                        InsertableFreezeDryingProcedureAttributes::FreezeDryedContainer,
                    )
            })?;
    ...
    fn freeze_dryed_with(
        ...
        let freeze_dryed_with = freeze_dryed_with
            .try_into()
            .map_err(|err| {
                validation_errors::SingleFieldError::from(err)
                    .rename_field(
                        InsertableFreezeDryingProcedureAttributes::FreezeDryedWith,
                    )
            })?;
    ...
    fn freeze_dryed_with_model(
        ...
        let freeze_dryed_with_model = freeze_dryed_with_model
            .try_into()
            .map_err(|err| {
                validation_errors::SingleFieldError::from(err)
                    .rename_field(
                        InsertableFreezeDryingProcedureAttributes::FreezeDryedWithModel,
                    )
            })?;
        self.freeze_dryed_with_model = Some(freeze_dryed_with_model);
        Ok(self)
    }
}
impl<
...
for InsertableFreezeDryingProcedureBuilder<Procedure> {
    ...
    fn procedure_template(
        ...
        <Self as FreezeDryingProcedureBuildable>::procedure_template(
            self,
            procedure_template,
        )
    }
...
where
    Self: web_common_traits::database::InsertableVariant<
        ...
        Error = web_common_traits::database::InsertError<
            InsertableFreezeDryingProcedureAttributes,
        >,
    >,
    ...
    >,
{
    type Attributes = InsertableFreezeDryingProcedureAttributes;
    fn is_complete(&self) -> bool {
        self.procedure.is_complete() && self.procedure_template.is_some()
            && self.foreign_procedure_template.is_some()
            && self.foreign_procedure.is_some() && self.freeze_dryed_container.is_some()
            && self.freeze_dryed_with_model.is_some()
    }
    fn mint_primary_key(
        self,
        user_id: i32,
