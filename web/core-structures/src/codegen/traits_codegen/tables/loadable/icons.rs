...
impl web_common_traits::prelude::Loadable for crate::codegen::structs_codegen::tables::icons::Icon {
    ...
    async fn load_all(conn: &mut Self::Conn) -> Result<Vec<Self>, diesel::result::Error> {
        ...
        use diesel_async::RunQueryDsl;
        crate::codegen::structs_codegen::tables::icons::Icon::table().load::<Self>(conn).await
    }
}
