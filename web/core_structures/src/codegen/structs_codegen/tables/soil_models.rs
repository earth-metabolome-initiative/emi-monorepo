...
impl web_common_traits::prelude::TableName for SoilModel {
    const TABLE_NAME: &'static str = "soil_models";
}
impl<'a> From<&'a SoilModel>
    for web_common_traits::database::IdOrBuilder<
        i32,
        crate::codegen::structs_codegen::tables::insertables::InsertableSoilModelBuilder,
    >
{
    fn from(value: &'a SoilModel) -> Self {
...
impl diesel::Identifiable for SoilModel {
    type Id = i32;
    fn id(self) -> Self::Id {
        self.id
    }
}
impl web_common_traits::database::PrimaryKeyLike for SoilModel {
    type PrimaryKey = i32;
...
impl SoilModel {
    ...
    where
        ...
        <Self as diesel::associations::HasTable>::Table: diesel::query_dsl::methods::FilterDsl<
            <crate::codegen::diesel_codegen::tables::soil_models::soil_models::id as diesel::expression_methods::EqAll<
                i32,
            >>::Output,
        >,
        ...
        >>::Output: diesel::query_dsl::methods::OrderDsl<
            diesel::helper_types::Asc<
                crate::codegen::diesel_codegen::tables::soil_models::soil_models::id,
            >,
        >,
        <<<Self as diesel::associations::HasTable>::Table as diesel::query_dsl::methods::FilterDsl<
            <crate::codegen::diesel_codegen::tables::soil_models::soil_models::id as diesel::expression_methods::EqAll<
            ...
            + for<'a> diesel::query_dsl::LoadQuery<'a, C, Self>,
    {
        ...
        Self::table()
            .filter(soil_models::id.eq(id))
            .order_by(soil_models::id.asc())
            .load::<Self>(conn)
    }
    ...
    pub fn from_parent_model(
        ...
        use crate::codegen::diesel_codegen::tables::{
            physical_asset_models::physical_asset_models, soil_models::soil_models,
        };
        Self::table()
            .inner_join(
                physical_asset_models::table.on(soil_models::id.eq(physical_asset_models::id)),
            )
    ...
    pub fn from_name(
        ...
        use crate::codegen::diesel_codegen::tables::{
            asset_models::asset_models, soil_models::soil_models,
        };
        Self::table()
            .inner_join(asset_models::table.on(soil_models::id.eq(asset_models::id)))
...
impl AsRef<SoilModel> for SoilModel {
    fn as_ref(&self) -> &SoilModel {
        self
    }
}
