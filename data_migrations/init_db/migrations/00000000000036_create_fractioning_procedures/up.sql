...
CREATE TABLE IF NOT EXISTS fractioning_procedures (
	...
	fractioning_procedure_template INTEGER NOT NULL REFERENCES fractioning_procedure_templates(id),
	...
	FOREIGN KEY (id, fractioning_procedure_template) REFERENCES procedures(id, procedure_template),
	-- We enforce that the `procedure_template_weighed_with_model` is associated with the `procedure_template`.
	FOREIGN KEY (
		fractioning_procedure_template,
		procedure_template_weighed_with_model
