...
pub struct BallMillProcedureTemplateForeignKeys {
    ...
    pub ball_mill_procedure_templates_milled_with_model_milled_con_fkey:
        Option<crate::AssetCompatibilityRule>,
    pub ball_mill_procedure_templates_milled_with_model_bead_model_fkey:
        Option<crate::AssetCompatibilityRule>,
    pub ball_mill_procedure_templates_bead_model_milled_container_fkey:
        Option<crate::AssetCompatibilityRule>,
}
impl web_common_traits::prelude::HasForeignKeys for crate::BallMillProcedureTemplate {
    ...
    fn foreign_keys_loaded(&self, foreign_keys: &Self::ForeignKeys) -> bool {
        foreign_keys.procedure_template.is_some()
            ...
            && foreign_keys
                ...
                .is_some()
            && foreign_keys.ball_mill_procedure_templates_bead_model_milled_container_fkey.is_some()
    }
    fn update(
        &self,
        ...
        match (row, crud) {
            (
                ...
                {
                    foreign_keys.ball_mill_procedure_templates_milled_with_model_milled_con_fkey =
                ...
                {
                    foreign_keys.ball_mill_procedure_templates_milled_with_model_bead_model_fkey =
                        Some(asset_compatibility_rules);
                    updated = true;
                }
                if self.bead_model == asset_compatibility_rules.left_asset_model
                    && self.milled_container_model == asset_compatibility_rules.right_asset_model
                {
                    foreign_keys.ball_mill_procedure_templates_bead_model_milled_container_fkey =
                        Some(asset_compatibility_rules);
                    updated = true;
                }
            }
