...
#[diesel(table_name = crate::database::schema::colors)]
...
impl Color {
    ...
    pub fn all_viewable(
        ...
        use crate::database::schema::colors;
    ...
    pub fn strict_word_similarity_search_viewable(
        ...
        colors::dsl::colors
            .select(Color::as_select())
            .filter(
                crate::database::sql_function_bindings::concat_colors_name(
                    colors::dsl::name,
                    colors::dsl::description,
                )
                .strict_word_similarity_commutator_op(query)
                .or(crate::database::sql_function_bindings::concat_colors_name(
                    colors::dsl::name,
                    colors::dsl::description,
                )
                .ilike(format!("%{}%", query))),
