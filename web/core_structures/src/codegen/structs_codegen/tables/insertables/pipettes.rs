...
impl core::fmt::Display for PipetteExtensionAttribute {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            Self::PhysicalAsset(e) => write!(f, "pipettes({e})"),
        }
    }
}
...
impl From<common_traits::builder::EmptyTuple> for PipetteExtensionAttribute {
...
impl<T1> common_traits::builder::Attributed
    for crate::codegen::structs_codegen::tables::insertables::InsertablePipetteBuilder<T1>
{
    type Attribute = PipetteAttribute;
}
impl web_common_traits::database::TableField for PipetteAttribute {}
impl web_common_traits::database::HasTableType for PipetteAttribute {
    ...
    > for PipetteAttribute
{
    fn from_extension(
        ...
        PipetteAttribute::Extension(From::from(attribute))
    }
}
...
impl<PhysicalAsset> diesel::associations::HasTable for InsertablePipetteBuilder<PhysicalAsset> {
    type Table = crate::codegen::diesel_codegen::tables::pipettes::pipettes::table;
    fn table() -> Self::Table {
        crate::codegen::diesel_codegen::tables::pipettes::pipettes::table
    }
}
...
where
    Self: common_traits::builder::Attributed<
            Attribute = crate::codegen::structs_codegen::tables::insertables::PipetteAttribute,
        >,
{
...
{
    type Error = web_common_traits::database::InsertError<PipetteAttribute>;
