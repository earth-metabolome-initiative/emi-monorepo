    ...
    >
{
    type InsertableVariant =
        crate::codegen::structs_codegen::tables::insertables::InsertableBallMillProcedure;
}
#[cfg(feature = "backend")]
...
where
    ...
    Self: web_common_traits::database::InsertableVariant<
        C,
        InsertableVariant = crate::codegen::structs_codegen::tables::insertables::InsertableBallMillProcedure,
    ...
    crate::codegen::structs_codegen::tables::insertables::BallMillProcedureExtensionAttribute: From<
        ...
        let procedure = self
            ...
            .map_err(|err| {
                err.into_field_name(|attribute| {
                    crate::codegen::structs_codegen::tables::insertables::BallMillProcedureAttribute::Extension(
                        From::from(attribute),
                    )
                })
            })?;
