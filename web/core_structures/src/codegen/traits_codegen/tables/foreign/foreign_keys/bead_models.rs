...
pub struct BeadModelForeignKeys {
    pub id: Option<crate::PhysicalAssetModel>,
}
impl web_common_traits::prelude::HasForeignKeys for crate::BeadModel {
    type ForeignKeys = BeadModelForeignKeys;
...
impl web_common_traits::prelude::ForeignKeys for BeadModelForeignKeys {}
