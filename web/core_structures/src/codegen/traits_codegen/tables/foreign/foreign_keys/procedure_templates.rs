...
pub struct ProcedureTemplateForeignKeys {
    pub created_by: Option<crate::User>,
    pub updated_by: Option<crate::User>,
}
impl web_common_traits::prelude::HasForeignKeys for crate::ProcedureTemplate {
    type ForeignKeys = ProcedureTemplateForeignKeys;
...
impl web_common_traits::prelude::ForeignKeys for ProcedureTemplateForeignKeys {}
