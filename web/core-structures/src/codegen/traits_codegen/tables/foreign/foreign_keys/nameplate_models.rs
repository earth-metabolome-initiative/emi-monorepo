...
pub struct NameplateModelForeignKeys {
...
{
    type ForeignKeys = NameplateModelForeignKeys;
...
impl web_common_traits::prelude::ForeignKeys for NameplateModelForeignKeys {}
