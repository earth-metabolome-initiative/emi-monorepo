    ...
    >,
{
    ...
    fn try_insert(
        ...
        let id = self
            ...
            .map_err(|err| {
                err.into_field_name(|_| crate::codegen::structs_codegen::tables::insertables::InsertablePackagingModelAttributes::Extension(
                    crate::codegen::structs_codegen::tables::insertables::InsertablePackagingModelExtensionAttributes::PhysicalAssetModel(
