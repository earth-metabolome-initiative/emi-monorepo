...
pub struct SpecimenForeignKeys {
    pub user_created:
...
impl web_common_traits::prelude::HasForeignKeys
    for crate::codegen::structs_codegen::tables::specimens::Specimen
{
    type ForeignKeys = SpecimenForeignKeys;
...
impl web_common_traits::prelude::ForeignKeys for SpecimenForeignKeys {}
