...
#[diesel(
    belongs_to(
        ...
        foreign_key = cleaned_model
    )
)]
#[diesel(
    belongs_to(
        crate::codegen::structs_codegen::tables::volumetric_container_models::VolumetricContainerModel,
        foreign_key = cleaned_with_model
    )
)]
...
pub struct CleaningProcedureTemplate {
    pub procedure_template: i32,
    pub cleaned_with_model: i32,
    pub procedure_template_cleaned_with_model: i32,
    pub cleaned_model: i32,
    pub procedure_template_cleaned_model: i32,
    pub liters: f32,
}
impl web_common_traits::prelude::TableName for CleaningProcedureTemplate {
    const TABLE_NAME: &'static str = "cleaning_procedure_templates";
}
impl<'a> From<&'a CleaningProcedureTemplate>
for web_common_traits::database::IdOrBuilder<
    i32,
    crate::codegen::structs_codegen::tables::insertables::InsertableCleaningProcedureTemplateBuilder,
> {
    fn from(value: &'a CleaningProcedureTemplate) -> Self {
...
where
    for<'a> &'a Self: diesel::Identifiable<Id = &'a i32>,
{}
impl diesel::Identifiable for CleaningProcedureTemplate {
    type Id = i32;
    fn id(self) -> Self::Id {
        self.procedure_template
    }
}
impl web_common_traits::database::PrimaryKeyLike for CleaningProcedureTemplate {
    type PrimaryKey = i32;
    fn primary_key(&self) -> Self::PrimaryKey {
        self.procedure_template
    }
}
impl CleaningProcedureTemplate {
    ...
    #[cfg(feature = "postgres")]
    pub fn from_procedure_template_cleaned_model_and_cleaned_model(
        ...
        Self::table()
            .filter(
                cleaning_procedure_templates::procedure_template_cleaned_model
                    ...
                    .and(cleaning_procedure_templates::cleaned_model.eq(cleaned_model)),
            )
            .order_by(cleaning_procedure_templates::procedure_template.asc())
            .load::<Self>(conn)
    }
    ...
    where
        ...
        <Self as diesel::associations::HasTable>::Table: diesel::query_dsl::methods::FilterDsl<
            <crate::codegen::diesel_codegen::tables::cleaning_procedure_templates::cleaning_procedure_templates::procedure_template_cleaned_model as diesel::expression_methods::EqAll<
                i32,
            >>::Output,
        >,
        ...
        >>::Output: diesel::query_dsl::methods::OrderDsl<
            diesel::helper_types::Asc<
                crate::codegen::diesel_codegen::tables::cleaning_procedure_templates::cleaning_procedure_templates::procedure_template,
            >,
        >,
        <<<Self as diesel::associations::HasTable>::Table as diesel::query_dsl::methods::FilterDsl<
            <crate::codegen::diesel_codegen::tables::cleaning_procedure_templates::cleaning_procedure_templates::procedure_template_cleaned_model as diesel::expression_methods::EqAll<
    ...
    #[cfg(feature = "postgres")]
    pub fn from_procedure_template_cleaned_with_model_and_cleaned_with_model(
        procedure_template_cleaned_with_model: i32,
        cleaned_with_model: i32,
        conn: &mut diesel::PgConnection,
    ) -> Result<Vec<Self>, diesel::result::Error> {
        use diesel::{
            BoolExpressionMethods, ExpressionMethods, QueryDsl, RunQueryDsl, associations::HasTable,
        ...
        Self::table()
            .filter(
                cleaning_procedure_templates::procedure_template_cleaned_with_model
                    ...
                    .and(cleaning_procedure_templates::cleaned_with_model.eq(cleaned_with_model)),
            )
            .order_by(cleaning_procedure_templates::procedure_template.asc())
            .load::<Self>(conn)
    }
    ...
    where
        C: diesel::connection::LoadConnection,
        <Self as diesel::associations::HasTable>::Table: diesel::query_dsl::methods::FilterDsl<
            <crate::codegen::diesel_codegen::tables::cleaning_procedure_templates::cleaning_procedure_templates::procedure_template_cleaned_with_model as diesel::expression_methods::EqAll<
                i32,
            >>::Output,
        >,
        <<Self as diesel::associations::HasTable>::Table as diesel::query_dsl::methods::FilterDsl<
    ...
    pub fn from_name(
        ...
        Self::table()
            .inner_join(
                procedure_templates::table.on(cleaning_procedure_templates::procedure_template
...
impl AsRef<CleaningProcedureTemplate> for CleaningProcedureTemplate {
    fn as_ref(&self) -> &CleaningProcedureTemplate {
        self
    }
}
