...
impl From<std::rc::Rc<crate::codegen::structs_codegen::tables::email_providers::EmailProvider>>
    for super::Rows
{
    fn from(
        value: std::rc::Rc<crate::codegen::structs_codegen::tables::email_providers::EmailProvider>,
    ) -> Self {
        Self::from(vec![value])
    }
}
...
impl From<Vec<std::rc::Rc<crate::codegen::structs_codegen::tables::email_providers::EmailProvider>>>
    for super::Rows
{
    fn from(
        value: Vec<
            std::rc::Rc<crate::codegen::structs_codegen::tables::email_providers::EmailProvider>,
        >,
    ) -> Self {
        Self::from(std::rc::Rc::new(value))
    }
}
impl From<std::rc::Rc<Vec<crate::codegen::structs_codegen::tables::email_providers::EmailProvider>>>
    for super::Rows
{
    fn from(
        value: std::rc::Rc<
...
impl TryFrom<super::Rows>
    for std::rc::Rc<
        Vec<std::rc::Rc<crate::codegen::structs_codegen::tables::email_providers::EmailProvider>>,
    >
{
