...
impl Tabular for SampleTaxon {
    const TABLE: crate::database::Table = crate::database::Table::SampleTaxa;
}
impl Describable for SampleTaxon {
    fn description(&self) -> Option<&str> {
        None
    }
}
impl Colorable for SampleTaxon {
    fn color(&self) -> Option<&str> {
        None
    }
}

impl Filtrable for crate::database::flat_variants::SampleTaxon {
    type Filter = crate::database::filter_variants::SampleTaxonFilter;
}
#[cfg(feature = "frontend")]
impl AllRecords for SampleTaxon {
...
impl SampleTaxon {
    ...
    /// Insert the SampleTaxon into the database.
    ///
