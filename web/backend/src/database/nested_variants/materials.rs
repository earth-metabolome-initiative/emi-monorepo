...
impl From<web_common::database::nested_variants::NestedMaterial> for NestedMaterial {
...
impl From<NestedMaterial> for web_common::database::nested_variants::NestedMaterial {
