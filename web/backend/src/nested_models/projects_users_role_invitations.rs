...
impl NestedProjectsUsersRoleInvitation {
    ...
    pub fn similarity_search_viewable(
        ...
        ProjectsUsersRoleInvitation::similarity_search_viewable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn word_similarity_search_viewable(
        ...
        ProjectsUsersRoleInvitation::word_similarity_search_viewable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn similarity_search_updatable(
        ...
        ProjectsUsersRoleInvitation::similarity_search_updatable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn word_similarity_search_updatable(
        ...
        ProjectsUsersRoleInvitation::word_similarity_search_updatable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn similarity_search_administrable(
        ...
        ProjectsUsersRoleInvitation::similarity_search_administrable(
            filter,
            author_user_id,
            query,
            limit,
    ...
    pub fn word_similarity_search_administrable(
        ...
        ProjectsUsersRoleInvitation::word_similarity_search_administrable(
            filter,
            author_user_id,
            query,
            limit,
