...
pub struct CommercialPositioningDeviceLotForeignKeys {
    pub commercial_positioning_device_lots_id_fkey: Option<crate::CommercialProductLot>,
    pub commercial_positioning_device_lots_id_fkey1: Option<crate::PositioningDeviceModel>,
    pub product_model: Option<crate::CommercialPositioningDeviceModel>,
}
impl web_common_traits::prelude::HasForeignKeys for crate::CommercialPositioningDeviceLot {
        ...
        match (row, crud) {
            (
                ...
                if self.product_model == commercial_positioning_device_models.id {
                    foreign_keys.product_model = Some(commercial_positioning_device_models);
                    updated = true;
                }
            }
            (
            ...
            (
                ...
                if self.id == commercial_product_lots.id {
                    foreign_keys.commercial_positioning_device_lots_id_fkey =
            ...
            (
                ...
                if self.id == positioning_device_models.id {
                    foreign_keys.commercial_positioning_device_lots_id_fkey1 =
