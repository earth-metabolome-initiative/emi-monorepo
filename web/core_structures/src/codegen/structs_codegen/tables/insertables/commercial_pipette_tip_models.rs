...
impl<CommercialProduct, PipetteTipModel, C> web_common_traits::database::TryInsertGeneric<C>
    for InsertableCommercialPipetteTipModelBuilder<CommercialProduct, PipetteTipModel>
where
    Self: web_common_traits::database::InsertableVariant<
            C,
            UserId = i32,
            Row = crate::CommercialPipetteTipModel,
            Error = web_common_traits::database::InsertError<CommercialPipetteTipModelAttribute>,
        >,
...
{
    type Attributes = CommercialPipetteTipModelAttribute;
    fn mint_primary_key(
        self,
        user_id: i32,
        conn: &mut C,
        ...
        let insertable: crate::CommercialPipetteTipModel = self.insert(user_id, conn)?;
        Ok(insertable.id())
    }
}
