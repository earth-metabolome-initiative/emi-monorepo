...
impl core::fmt::Display for FreezerModelExtensionAttribute {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            Self::PhysicalAssetModel(e) => write!(f, "freezer_models({e})"),
        }
    }
}
...
impl From<common_traits::builder::EmptyTuple> for FreezerModelExtensionAttribute {
...
impl<T1> common_traits::builder::Attributed
    for crate::codegen::structs_codegen::tables::insertables::InsertableFreezerModelBuilder<T1>
{
    type Attribute = FreezerModelAttribute;
}
impl web_common_traits::database::TableField for FreezerModelAttribute {}
impl web_common_traits::database::HasTableType for FreezerModelAttribute {
    type Table = crate::codegen::tables::table_names::TableName;
}
impl
    web_common_traits::database::FromExtension<
        crate::codegen::structs_codegen::tables::insertables::PhysicalAssetModelAttribute,
    > for FreezerModelAttribute
{
    fn from_extension(
        attribute: crate::codegen::structs_codegen::tables::insertables::PhysicalAssetModelAttribute,
    ) -> Self {
        FreezerModelAttribute::Extension(From::from(attribute))
    }
}
...
impl core::fmt::Display for FreezerModelAttribute {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            ...
            Self::Id => write!(f, "freezer_models.id"),
        }
    }
}
#[derive(Debug)]
...
///
/// ```rust,ignore
/// use core_structures::FreezerModel;
...
///
/// let freezer_model = FreezerModel::new()
...
{
    type Table = crate::codegen::diesel_codegen::tables::freezer_models::freezer_models::table;
    fn table() -> Self::Table {
        crate::codegen::diesel_codegen::tables::freezer_models::freezer_models::table
    }
}
...
impl<PhysicalAssetModel> FreezerModelSettable for InsertableFreezerModelBuilder<PhysicalAssetModel>
where
...
{
    type Error = web_common_traits::database::InsertError<FreezerModelAttribute>;
