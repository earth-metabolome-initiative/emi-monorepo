...
impl RowToBadge for NestedUsersUsersRoleInvitation {
    ...
    fn children(&self, props: &super::BadgeProps<Self>) -> Option<yew::prelude::Html> {
        Some(html! {
            <>
                ...
                <Badge<NestedUser> badge={self.table.clone()} onclick={props.onclick.clone()} li={true} query={props.query.clone()} size={BadgeSize::Small} />
