...
impl crate::database::Tabular for NestedRole {
    const TABLE: crate::database::Table = crate::database::Table::Roles;
}
impl crate::database::Filtrable for NestedRole {
    type Filter = crate::database::filter_variants::RoleFilter;
}
impl crate::database::Describable for NestedRole {
    fn description(&self) -> Option<&str> {
        self.inner.description()
    }
}
impl crate::database::Colorable for NestedRole {
    fn color(&self) -> Option<&str> {
        Some(self.color.name.as_str())
    }
}
#[cfg(feature = "frontend")]
impl crate::database::AllRecords for NestedRole {
...
impl NestedRole {
    ...
    pub(crate) async fn from_flat(
        flat_variant: crate::database::flat_variants::Role,
    ...
    /// Get the Role from the database by its ID.
    ///
    ...
    pub async fn get<C: gluesql::core::store::GStore + gluesql::core::store::GStoreMut>(
        ...
        if let Some(flat_variant) =
            crate::database::flat_variants::Role::get(id, connection).await?
        {
    ...
    >(
        ...
        crate::database::flat_variants::Role::delete_from_id(id, connection).await
    }
    ...
    pub async fn all<C: gluesql::core::store::GStore + gluesql::core::store::GStoreMut>(
        filter: Option<&crate::database::filter_variants::RoleFilter>,
        limit: Option<i64>,
        offset: Option<i64>,
        connection: &mut gluesql::prelude::Glue<C>,
        ...
        for flat_variant in
            crate::database::flat_variants::Role::all(filter, limit, offset, connection)
                .await?
                .into_iter()
        {
            roles.push(Self::from_flat(flat_variant, connection).await?);
        }
        Ok(roles)
    }
    ...
    >(
        ...
        crate::database::flat_variants::Color::update_or_insert(self.color.as_ref(), connection)
            .await?;
        crate::database::flat_variants::Role::update_or_insert(self.inner.as_ref(), connection)
            .await
    }
}
