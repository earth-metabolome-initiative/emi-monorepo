...
impl From<
    crate::codegen::structs_codegen::tables::insertables::InsertablePhysicalAssetModelAttributes,
> for InsertableBallMillMachineModelExtensionAttributes {
    fn from(
...
> for InsertableBallMillMachineModelAttributes {
    fn from(
        ...
        Self::Extension(
            InsertableBallMillMachineModelExtensionAttributes::PhysicalAssetModel(
                physical_asset_models,
            ),
        )
    }
}
impl core::str::FromStr for InsertableBallMillMachineModelAttributes {
...
pub trait BallMillMachineModelBuildable:
    crate::codegen::structs_codegen::tables::insertables::PhysicalAssetModelBuildable
{
}
impl BallMillMachineModelBuildable for Option<i32> {}
impl<
...
for InsertableBallMillMachineModelBuilder<PhysicalAssetModel> {
    type Attributes = crate::codegen::structs_codegen::tables::insertables::InsertableBallMillMachineModelAttributes;
    #[inline]
