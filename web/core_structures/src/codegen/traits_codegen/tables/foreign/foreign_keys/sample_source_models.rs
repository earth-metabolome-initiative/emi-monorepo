...
pub struct SampleSourceModelForeignKeys {
    pub id:
...
{
    type ForeignKeys = SampleSourceModelForeignKeys;
...
impl web_common_traits::prelude::ForeignKeys for SampleSourceModelForeignKeys {}
