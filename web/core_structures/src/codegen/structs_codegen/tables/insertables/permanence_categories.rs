...
pub enum PermanenceCategoryAttribute {
    Name,
    Description,
    Icon,
    ColorId,
...
impl core::str::FromStr for PermanenceCategoryAttribute {
...
{
    type Attribute = PermanenceCategoryAttribute;
}
impl web_common_traits::database::TableField for PermanenceCategoryAttribute {}
impl web_common_traits::database::HasTableType for PermanenceCategoryAttribute {
...
///
/// ```rust,ignore
/// use core_structures::PermanenceCategory;
/// use core_structures::tables::insertables::PermanenceCategorySettable;
/// use web_common_traits::database::Insertable;
/// use web_common_traits::database::InsertableVariant;
///
/// let permanence_category = PermanenceCategory::new()
...
impl diesel::associations::HasTable for InsertablePermanenceCategoryBuilder {
    type Table =
...
impl From<InsertablePermanenceCategoryBuilder>
    for web_common_traits::database::IdOrBuilder<i16, InsertablePermanenceCategoryBuilder>
{
    fn from(builder: InsertablePermanenceCategoryBuilder) -> Self {
...
pub trait PermanenceCategorySettable: Sized {
    ...
    ///
    /// # Arguments
    /// * `name`: The value to set for the `public.permanence_categories.name`
    ///   column.
    ///
    /// # Implementation details
    ...
    /// Sets the value of the `public.permanence_categories.description` column.
    ///
    /// # Arguments
    /// * `description`: The value to set for the
    ///   `public.permanence_categories.description` column.
    ///
    /// # Implementation details
    /// This method accepts a reference to a generic value which can be
    /// converted to the required type for the column. This allows passing
    ...
    /// Sets the value of the `public.permanence_categories.icon` column.
    ///
    /// # Arguments
    /// * `icon`: The value to set for the `public.permanence_categories.icon`
    ///   column.
    ///
    /// # Implementation details
    /// This method accepts a reference to a generic value which can be
    ...
    /// Sets the value of the `public.permanence_categories.color_id` column.
    ///
    /// # Arguments
    /// * `color_id`: The value to set for the
    ///   `public.permanence_categories.color_id` column.
    ///
    /// # Implementation details
    /// This method accepts a reference to a generic value which can be
    /// converted to the required type for the column. This allows passing
...
where
    Self: common_traits::builder::Attributed<
        Attribute = crate::codegen::structs_codegen::tables::insertables::PermanenceCategoryAttribute,
    >,
{
        ...
        let name = name
            ...
            .map_err(|err| {
                validation_errors::prelude::SingleFieldError::from(err)
                    .rename_field(PermanenceCategoryAttribute::Name)
            })?;
        self.name = Some(name);
        Ok(self)
    }
        ...
        validation_errors::prelude::SingleFieldError: From<<D as TryInto<String>>::Error>,
    {
        let description = description
            ...
            .map_err(|err| {
                validation_errors::prelude::SingleFieldError::from(err)
                    .rename_field(PermanenceCategoryAttribute::Description)
            })?;
        ...
        validation_errors::prelude::SingleFieldError: From<<I as TryInto<String>>::Error>,
    {
        let icon = icon
            ...
            .map_err(|err| {
                validation_errors::prelude::SingleFieldError::from(err)
                    .rename_field(PermanenceCategoryAttribute::Icon)
            })?;
        self.icon = Some(icon);
        Ok(self)
    }
...
{
    type Error = web_common_traits::database::InsertError<PermanenceCategoryAttribute>;
    fn mint_primary_key(
        self,
        user_id: i32,
        conn: &mut C,
