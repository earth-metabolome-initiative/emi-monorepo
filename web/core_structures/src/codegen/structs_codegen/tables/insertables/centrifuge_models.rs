...
impl core::fmt::Display for InsertableCentrifugeModelAttributes {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            InsertableCentrifugeModelAttributes::Id(id) => write!(f, "{}", id),
        }
    }
}
...
impl InsertableCentrifugeModelBuilder {
    pub fn id<P>(
        mut self,
        id: P,
        ...
        <P as TryInto<::rosetta_uuid::Uuid>>::Error: Into<validation_errors::SingleFieldError>,
    {
        self.id = self
            .id
            .id(id)
            .map_err(|err| err.into_field_name(InsertableCentrifugeModelAttributes::Id))?;
        Ok(self)
    }
    pub fn name<P>(
        mut self,
...
impl InsertableCentrifugeModelBuilder {
    pub(crate) fn try_insert<C>(
        ...
        InsertableCentrifugeModel,
        web_common_traits::database::InsertError<InsertableCentrifugeModelAttributes>,
    >
    where
        ...
        >,
    {
        ...
        let id = self
            ...
            .map_err(|err| err.into_field_name(InsertableCentrifugeModelAttributes::Id))?
            .id();
        Ok(InsertableCentrifugeModel { id })
    }
}
