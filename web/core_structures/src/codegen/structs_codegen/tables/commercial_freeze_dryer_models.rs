...
pub struct CommercialFreezeDryerModel {
    pub id: i32,
    pub freeze_dryer_model: i32,
}
impl web_common_traits::prelude::TableName for CommercialFreezeDryerModel {
    const TABLE_NAME: &'static str = "commercial_freeze_dryer_models";
}
impl<'a> From<&'a CommercialFreezeDryerModel>
for web_common_traits::database::IdOrBuilder<
    i32,
    crate::codegen::structs_codegen::tables::insertables::InsertableCommercialFreezeDryerModelBuilder,
> {
    fn from(value: &'a CommercialFreezeDryerModel) -> Self {
        web_common_traits::database::IdOrBuilder::Id(value.id)
    }
}
impl web_common_traits::prelude::ExtensionTable<crate::AssetModel> for CommercialFreezeDryerModel where
...
impl web_common_traits::prelude::ExtensionTable<crate::FreezeDryerModel>
    for CommercialFreezeDryerModel
where
    for<'a> &'a Self: diesel::Identifiable<Id = &'a i32>,
{
...
impl web_common_traits::prelude::ExtensionTable<crate::CommercialFreezeDryerModel>
    for CommercialFreezeDryerModel
where
    for<'a> &'a Self: diesel::Identifiable<Id = &'a i32>,
{
}
impl diesel::Identifiable for CommercialFreezeDryerModel {
    type Id = i32;
    fn id(self) -> Self::Id {
        self.id
    }
}
impl CommercialFreezeDryerModel {
        ...
        crate::FreezeDryerModel: web_common_traits::database::Read<C>,
    {
        ...
        crate::FreezeDryerModel::read(self.freeze_dryer_model, conn)
    }
    ...
    {
        use web_common_traits::database::Read;
        crate::FreezeDryerModel::read(self.id, conn)
    }
    pub fn commercial_freeze_dryer_models_id_fkey1<C: diesel::connection::LoadConnection>(
        &self,
        conn: &mut C,
    ...
    pub fn commercial_freeze_dryer_models_id_freeze_dryer_model_fkey(
        &self,
                ...
                crate::codegen::diesel_codegen::tables::asset_models::asset_models::dsl::id
                    ...
                    .and(
                        crate::codegen::diesel_codegen::tables::asset_models::asset_models::dsl::parent_model
                            .eq(&self.freeze_dryer_model),
                    ),
            )
            .first::<crate::AssetModel>(conn)
    }
    pub fn from_freeze_dryer_model<C>(
    ...
    where
        ...
        <Self as diesel::associations::HasTable>::Table: diesel::query_dsl::methods::FilterDsl<
            <crate::codegen::diesel_codegen::tables::commercial_freeze_dryer_models::commercial_freeze_dryer_models::freeze_dryer_model as diesel::expression_methods::EqAll<
                i32,
            >>::Output,
        >,
        ...
        >>::Output: diesel::query_dsl::methods::OrderDsl<
            diesel::helper_types::Asc<
                crate::codegen::diesel_codegen::tables::commercial_freeze_dryer_models::commercial_freeze_dryer_models::id,
            >,
        >,
        <<<Self as diesel::associations::HasTable>::Table as diesel::query_dsl::methods::FilterDsl<
            <crate::codegen::diesel_codegen::tables::commercial_freeze_dryer_models::commercial_freeze_dryer_models::freeze_dryer_model as diesel::expression_methods::EqAll<
            ...
            + for<'a> diesel::query_dsl::LoadQuery<'a, C, Self>,
    {
        ...
        Self::table()
            .filter(commercial_freeze_dryer_models::freeze_dryer_model.eq(freeze_dryer_model))
    ...
    where
        C: diesel::connection::LoadConnection,
        <Self as diesel::associations::HasTable>::Table: diesel::query_dsl::methods::FilterDsl<
            <crate::codegen::diesel_codegen::tables::commercial_freeze_dryer_models::commercial_freeze_dryer_models::id as diesel::expression_methods::EqAll<
                i32,
            >>::Output,
        >,
        <<Self as diesel::associations::HasTable>::Table as diesel::query_dsl::methods::FilterDsl<
    ...
    pub fn from_id_and_freeze_dryer_model(
        ...
        Self::table()
            .filter(
                commercial_freeze_dryer_models::id
                    .eq(id)
                    .and(commercial_freeze_dryer_models::freeze_dryer_model.eq(freeze_dryer_model)),
            )
            .order_by(commercial_freeze_dryer_models::id.asc())
            .load::<Self>(conn)
    }
    ...
    pub fn from_deprecation_date(
        ...
        use crate::codegen::diesel_codegen::tables::{
            commercial_freeze_dryer_models::commercial_freeze_dryer_models,
            commercial_products::commercial_products,
        };
        Self::table()
            .inner_join(
                commercial_products::table
                    .on(commercial_freeze_dryer_models::id.eq(commercial_products::id)),
            )
        ...
        Self::table()
            .inner_join(
                physical_asset_models::table
                    .on(commercial_freeze_dryer_models::id.eq(physical_asset_models::id)),
            )
    ...
    pub fn from_name(
        ...
        Self::table()
            .inner_join(
                asset_models::table.on(commercial_freeze_dryer_models::id.eq(asset_models::id)),
            )
...
impl AsRef<CommercialFreezeDryerModel> for CommercialFreezeDryerModel {
    fn as_ref(&self) -> &CommercialFreezeDryerModel {
        self
    }
}
