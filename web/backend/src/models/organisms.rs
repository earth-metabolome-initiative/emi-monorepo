...
impl Organism {
    ...
    pub fn all_viewable(
        ...
        let mut query = organisms::dsl::organisms.into_boxed();
    ...
    pub fn similarity_search_viewable(
        ...
        if let Some(nameplate_id) = filter.and_then(|f| f.nameplate_id) {
            return organisms::dsl::organisms
                ...
                .filter(
                    organisms::dsl::host_organism_id.eq(filter.and_then(|f| f.host_organism_id)),
                )
