...
impl crate::database::Tabular for NestedOrganismBioOttTaxonItem {
    const TABLE: crate::database::Table = crate::database::Table::OrganismBioOttTaxonItems;
}
impl crate::database::Filtrable for NestedOrganismBioOttTaxonItem {
    type Filter = crate::database::filter_variants::OrganismBioOttTaxonItemFilter;
}
impl crate::database::Describable for NestedOrganismBioOttTaxonItem {
    fn description(&self) -> Option<&str> {
        self.inner.description()
    }
}
impl crate::database::Colorable for NestedOrganismBioOttTaxonItem {
    fn color(&self) -> Option<&str> {
        None
    }
}
#[cfg(feature = "frontend")]
impl crate::database::AllRecords for NestedOrganismBioOttTaxonItem {
...
impl NestedOrganismBioOttTaxonItem {
    ...
    pub(crate) async fn from_flat(
        flat_variant: crate::database::flat_variants::OrganismBioOttTaxonItem,
    ...
    pub async fn get<C: gluesql::core::store::GStore + gluesql::core::store::GStoreMut>(
        ...
        if let Some(flat_variant) = crate::database::flat_variants::OrganismBioOttTaxonItem::get(
    ...
    /// Delete the OrganismBioOttTaxonItem from the database.
    ///
    /// * `connection` - The connection to the database.
    ...
    /// Delete the OrganismBioOttTaxonItem from the database by its ID.
    ///
    ...
    >(
        ...
        crate::database::flat_variants::OrganismBioOttTaxonItem::delete_from_id(
            (organism_id, taxon_id),
            connection,
        )
        .await
    ...
    pub async fn all<C: gluesql::core::store::GStore + gluesql::core::store::GStoreMut>(
        filter: Option<&crate::database::filter_variants::OrganismBioOttTaxonItemFilter>,
        limit: Option<i64>,
        offset: Option<i64>,
        connection: &mut gluesql::prelude::Glue<C>,
