...
pub struct ExtractionMethodForeignKeys {
    pub user_created:
...
impl web_common_traits::prelude::HasForeignKeys
    for crate::codegen::structs_codegen::tables::extraction_methods::ExtractionMethod
{
    type ForeignKeys = ExtractionMethodForeignKeys;
...
impl web_common_traits::prelude::ForeignKeys for ExtractionMethodForeignKeys {}
