...
pub struct MixingProcedureModelForeignKeys {
    ...
    >,
    pub procedure_mixed_into: Option<
        crate::codegen::structs_codegen::tables::procedure_model_trackables::ProcedureModelTrackable,
    >,
}
    ...
    for crate::codegen::structs_codegen::tables::mixing_procedure_models::MixingProcedureModel
{
    ...
    fn foreign_keys_loaded(&self, foreign_keys: &Self::ForeignKeys) -> bool {
        foreign_keys.procedure_model.is_some()
            ...
            && foreign_keys.procedure_mixed_into.is_some()
    }
    fn update(
        &self,
        ...
        match (row, crud) {
            (
                ...
                if self.procedure_measured_with == procedure_model_trackables.id {
                    foreign_keys.procedure_measured_with = Some(procedure_model_trackables.clone());
                    updated = true;
                }
                ...
                if self.procedure_mixed_into == procedure_model_trackables.id {
                    foreign_keys.procedure_mixed_into = Some(procedure_model_trackables.clone());
                    updated = true;
                }
            }
            (
                ...
                if self.procedure_mixed_into == procedure_model_trackables.id {
                    foreign_keys.procedure_mixed_into = None;
                    updated = true;
                }
            }
            (
