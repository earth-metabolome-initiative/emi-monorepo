...
pub struct BuildingForeignKeys {
    pub user_created:
...
impl web_common_traits::prelude::HasForeignKeys
    for crate::codegen::structs_codegen::tables::buildings::Building
{
    type ForeignKeys = BuildingForeignKeys;
        ...
        C: web_common_traits::crud::Connector<Row = Self::Row>,
    {
        ...
        if let Some(university) = self.university {
            connector.send(web_common_traits::crud::CrudPrimaryKeyOperation::Read(
                crate::codegen::tables::table_primary_keys::TablePrimaryKey::University(university),
            ));
        }
    }
    fn foreign_keys_loaded(&self, foreign_keys: &Self::ForeignKeys) -> bool {
        (foreign_keys.user_created.is_some() || self.user_created.is_none())
            ...
            && (foreign_keys.university.is_some() || self.university.is_none())
    }
    fn update(
        &self,
        ...
        match (row, crud) {
            ...
            (
                ...
                if let Some(university) = self.university {
                    if universities.id == university {
                        foreign_keys.university = Some(universities);
                        updated = true;
                    }
                }
            }
...
impl web_common_traits::prelude::ForeignKeys for BuildingForeignKeys {}
