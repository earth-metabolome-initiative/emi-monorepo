...
{
    type ForeignKeys = PpeReminderProcedureForeignKeys;
    ...
    fn foreign_keys_loaded(&self, foreign_keys: &Self::ForeignKeys) -> bool {
        foreign_keys.procedure.is_some()
            && foreign_keys.procedure_ppe_asset.is_some()
            && foreign_keys.procedure_template.is_some()
            && foreign_keys.procedure_template_ppe_asset_model.is_some()
    }
    fn update(
        &self,
        ...
        match (row, crud) {
            (
                crate::codegen::tables::row::Row::PpeReminderProcedureTemplate(
                ...
                if self.procedure_template == ppe_reminder_procedure_templates.procedure_template {
                    foreign_keys.procedure_template = Some(ppe_reminder_procedure_templates);
                    updated = true;
                }
            }
            (
            ...
            (
                ...
                if self.procedure_ppe_asset == procedure_assets.id {
                    foreign_keys.procedure_ppe_asset = Some(procedure_assets);
                    updated = true;
                }
            }
            (
                ...
                if self.procedure_ppe_asset == procedure_assets.id {
                    foreign_keys.procedure_ppe_asset = None;
                    updated = true;
                }
            }
            (
                ...
                if self.procedure_template_ppe_asset_model == procedure_template_asset_models.id {
                    foreign_keys.procedure_template_ppe_asset_model =
            ...
            (
                ...
                if self.procedure_template_ppe_asset_model == procedure_template_asset_models.id {
                    foreign_keys.procedure_template_ppe_asset_model = None;
                    updated = true;
                }
            }
            (
...
impl web_common_traits::prelude::ForeignKeys for PpeReminderProcedureForeignKeys {}
