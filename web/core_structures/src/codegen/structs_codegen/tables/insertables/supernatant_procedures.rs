...
pub enum InsertableSupernatantProcedureExtensionAttribute {
    Procedure(crate::codegen::structs_codegen::tables::insertables::InsertableProcedureAttribute),
}
impl core::fmt::Display for InsertableSupernatantProcedureExtensionAttribute {
...
impl From<crate::codegen::structs_codegen::tables::insertables::InsertableProcedureAttribute>
    for InsertableSupernatantProcedureExtensionAttribute
{
    fn from(
...
#[derive(Copy, Clone, PartialEq, Eq, PartialOrd, Ord, Hash, core::fmt::Debug)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub enum InsertableSupernatantProcedureAttribute {
    Extension(InsertableSupernatantProcedureExtensionAttribute),
    Procedure,
    ProcedureTemplate,
...
impl core::str::FromStr for InsertableSupernatantProcedureAttribute {
...
impl core::fmt::Display for InsertableSupernatantProcedureAttribute {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
...
> SupernatantProcedureSettable for InsertableSupernatantProcedureBuilder<Procedure> {
    type Attributes = crate::codegen::structs_codegen::tables::insertables::InsertableSupernatantProcedureAttribute;
...
where
    Self: web_common_traits::database::InsertableVariant<
        ...
        Error = web_common_traits::database::InsertError<
            InsertableSupernatantProcedureAttribute,
        >,
    >,
    ...
    >,
{
    type Attributes = InsertableSupernatantProcedureAttribute;
