...
pub struct DocumentFormatForeignKeys {
...
for crate::codegen::structs_codegen::tables::document_formats::DocumentFormat {
    type ForeignKeys = DocumentFormatForeignKeys;
...
impl web_common_traits::prelude::ForeignKeys for DocumentFormatForeignKeys {}
